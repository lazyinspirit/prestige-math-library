...
These examples compute a Wiener norm, separate absolute convergence from $C^2$ regularity, and show why neither continuity nor the Hölder-one-half endpoint is enough. The final example isolates the necessary nonvanishing condition in Wiener inversion.
