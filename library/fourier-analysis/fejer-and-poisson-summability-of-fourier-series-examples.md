...
The companion page records the clean coefficient computations behind the two
positive kernels, a standard square-wave summation example, and two boundary
counterexamples: uniform convergence fails without continuity of the target
representative, and Abel summability does not reverse to ordinary convergence.
