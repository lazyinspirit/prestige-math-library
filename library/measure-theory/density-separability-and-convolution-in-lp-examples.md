...
The companion page collects the concrete models behind the main page: the tent-function convolution, explicit mollification pictures, concrete dense families and separated families, the Gaussian approximate identity, and the endpoint failures the A page warns about. The $L^2 * L^2$ counterexample is written with a correct tail-decay witness rather than the invalid local-singularity sketch from the design prose.
