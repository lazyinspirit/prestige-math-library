...
This page upgrades the affine algebraic-set dictionary from objects to
morphisms. It treats regular functions concretely, identifies local rings with
localisations, and then uses those affine tools to package rational maps,
dominance, and birational equivalence in the classical irreducible setting.
