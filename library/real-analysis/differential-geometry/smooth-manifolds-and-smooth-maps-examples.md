...
These examples exhibit the standard atlas constructions that drive the page:
Euclidean spaces, spheres, projective space, products, and countable disjoint
unions. The counterexamples isolate exactly where second countability,
two-sided compatibility, and smooth inverses are needed.
