...
items: [def-integers, lem-int-equivalence, def-int-operations,
        ...
        lem-rat-ops-well-defined, lem-rat-inverse-well-defined, thm-rat-field,
        def-rat-order, lem-rat-positive-denominator, thm-rat-ordered-field,
        lem-int-embeds-rat, lem-rat-archimedean,
        def-dedekind-cut, def-real-dedekind, lem-rational-cut-is-cut,
        def-cut-order, lem-cut-order-total,
