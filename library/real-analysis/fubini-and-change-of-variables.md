...
Multidimensional Darboux integration and Jordan content provide rectangles, grids, null boundaries, and integration over Jordan sets. Euclidean differentiation supplies $C^1$ maps, Jacobian matrices, inverse functions, and derivative estimates; row reduction and determinants supply the algebraic volume factor. Together these declared prerequisites support finite section arguments and local linearization without measure theory.
