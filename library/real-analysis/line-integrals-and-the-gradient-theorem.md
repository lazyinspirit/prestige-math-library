...
[[def-path-polygonal-length-and-rectifiability-in-rn]] and [[cor-piecewise-c1-paths-have-additive-speed-integral-length]] supply piecewise-$C^1$ paths and their speed-integral lengths. The one-variable substitution and fundamental theorems of calculus govern changes of parameter and endpoint increments, while [[thm-fubini-over-a-region-between-continuous-graphs]] and [[thm-jordan-fubini-by-sections]] provide the iterated-integral formulas used for graph-bounded regions.
