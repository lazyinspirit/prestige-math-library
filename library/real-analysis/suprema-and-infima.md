...
$\mathbb{R}$. It is the first page of the real analysis track, and almost
everything later rests on it: completeness is used through the supremum, and the
supremum is used through the epsilon characterisation proved here.
...
empty set for the first and $\mathbb{N}$ for the second. Distinguishing supremum
