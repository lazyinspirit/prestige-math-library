...
These examples isolate the two concrete mechanisms used on the A page: the
parameter choices in the final Erdős-Hajnal deduction, and the two ways a large
restricted or blocked configuration immediately produces a polynomial clique or
stable set.
