...
These examples keep the source figures explicit by finite adjacency data. They
verify the two six-vertex prime $\mathcal H$-graphs, record concrete labelled
models for $E$, co-$E$, Bird, and co-Bird, and turn the recursive $H_0,\dots,H_5$
descriptions into on-page graph checks.
