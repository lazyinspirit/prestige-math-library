...
The examples calculate integral bases and discriminants while keeping the
index of a power order explicit. The pure-cubic entry records that a
squarefree-discriminant maximality certificate is unavailable there; no
nonmonogenic field is asserted without a complete source.
