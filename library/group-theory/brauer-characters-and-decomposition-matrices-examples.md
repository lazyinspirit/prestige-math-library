...
These examples keep the page concrete: a $p$-group, the $2$-modular character
table of $S_3$, the resulting decomposition and Cartan matrices, a one-row
block, and a direct witness that ordinary traces on $p$-singular elements are
not Brauer-character values.
