---
page: "distributions-test-functions-and-differentiation-examples"
title: "Distributions Test Functions and Differentiation — Examples"
status: "draft"
items: ["ex-derivative-of-the-heaviside-function-is-dirac-delta", "ex-derivatives-of-piecewise-smooth-functions-include-jump-deltas", "ex-distributional-laplacian-of-the-newtonian-kernel", "ex-principal-value-distribution-one-over-x", "cex-not-every-distribution-is-a-locally-integrable-function", "cex-pointwise-convergent-functions-need-not-converge-as-distributions-without-local-control", "ex-compactly-supported-distributions-have-global-finite-order", "rem-sobolev-weak-derivatives-belong-to-pde"]
examples: []
---
