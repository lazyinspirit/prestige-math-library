...
items:
  ...
  - def-cfg-equivalence-and-ambiguity-problems
...
This page records the two standard pumping obstructions for context-free
languages, uses them to isolate nonclosure phenomena, and then turns to parsing
and decision procedures through the CNF-based CYK algorithm and basic CFG graph
tests.
