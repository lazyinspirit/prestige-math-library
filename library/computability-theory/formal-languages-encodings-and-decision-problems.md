...
This page fixes the pre-machine vocabulary for the computability theory track:
finite words over an alphabet, languages and their basic operations, reversal
and induced letter-to-word maps, effective encodings with total decoders, and
the encoded-size convention used later for complexity bounds.
