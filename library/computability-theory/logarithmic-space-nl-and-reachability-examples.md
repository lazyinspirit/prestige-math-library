...
These worked cases expose the virtual-output-tape convention, a concrete
tableau-to-circuit compilation, and the existential-branch error in trying to
complement nondeterminism by terminal-state swapping.
