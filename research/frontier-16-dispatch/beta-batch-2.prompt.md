<!-- Dispatched as-is. `frontier-16` and `2` are substituted by tools/dispatch.mjs
...
# Scaffolding brief — run `frontier-16`, batch `2` (steps 1 and 2)
...
You are **Beta-2**, running **GPT 5.6 Sol via the Codex subscription plan
...
`research/frontier-16-batch-2.notes.md`: current substage, owned artifact paths,
...
`research/frontier-16-batch-2.coverage.json`:
...
```
node tools/source-fetch-check.mjs --coverage research/frontier-16-batch-2.coverage.json --stamp
```
...
```
node tools/coverage-checklist.mjs research/frontier-16-batch-2.coverage.json
```
...
- `research/frontier-16-batch-2.pages.json` — your batch's page objects in final
...
- `research/frontier-16-batch-2.notes.md` — prose-scaffold amendments as precise
  ...
  route, and necessity.
- `research/frontier-16-batch-2.proof-contracts.json` — the version-1
...
# Batch 2 of run `frontier-16` — Areas of Elementary Plane Figures · Improper and Parameter-Dependent Multiple Integrals
...
| | |
|---|---|
| A page | `areas-of-elementary-plane-figures` · order **288.00007** · `real-analysis` |
| B page | `areas-of-elementary-plane-figures-examples` |
...
| design | `plan-realanalysis-completion-track.md` L293 |
...
| | |
|---|---|
| A page | `improper-and-parameter-dependent-multiple-integrals` · order **288.00011** · `real-analysis` |
| B page | `improper-and-parameter-dependent-multiple-integrals-examples` |
...
| design | `plan-realanalysis-completion-track.md` L372 |
