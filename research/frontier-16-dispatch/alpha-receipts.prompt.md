...
label: receipts
covers: all
output: research/frontier-16-audit-coverage.json

# The whole-level receipts, run `frontier-16`
...
```
node tools/level-coverage.mjs --template research/frontier-16-audit-coverage.json \
  --contracts research/frontier-16-proof-contracts.json \
  --judge-ledger research/frontier-16-judge.jsonl \
  research/frontier-16-batch-*.pages.json
```
...
node tools/level-coverage.mjs \
  --contracts research/frontier-16-proof-contracts.json \
  --judge-ledger research/frontier-16-judge.jsonl \
  --judge-adjudications research/frontier-16-judge-adjudications.jsonl \
  --spine-receipt research/frontier-16-spine-audit.json \
  --audit-receipt research/frontier-16-audit-coverage.json \
  --verify-current-context research/frontier-16-batch-*.pages.json
```
