...
label: final-v2
covers: all
output: research/frontier-16-sigma-final.json

# Final rendering adjudication

Read `research/frontier-16-render-final.json`, `research/frontier-16-sigma-initial.json`, and
`research/frontier-16-tau.json`, then inspect every attached final image independently.
Set `capture_manifest` to `research/frontier-16-render-final.json`, `phase` to `final`,
