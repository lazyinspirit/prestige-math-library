...
> `research/frontier-16-alpha-<your-group>-…` path for your own group label.
...
- the reader report for each of your batches (findings `R<i>-…`, in the
  reader's output file under `research/frontier-16-dispatch/`)
- the items themselves, on disk
- `research/frontier-16-batch-<i>.proof-contracts.json`
...
1. **The prose report**, `research/frontier-16-alpha-<your-group>-6b.md`: per finding
...
2. **`research/frontier-16-alpha-<your-group>-6b-findings.json`** — a JSON array,
