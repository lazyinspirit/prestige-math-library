...
1. Read your own report:
   `research/frontier-16-alpha-<your-group>-step3-scaffold-review.md`
2. Read each Beta's `## Step-3 fix pass` section in
   `research/frontier-16-batch-<i>.notes.md`
...
1. **The prose report** — `research/frontier-16-alpha-<your-group>-recheck.md`,
...
2. **UPDATE YOUR GROUP'S VERDICT FILE** —
   `research/frontier-16-alpha-<your-group>-step3-verdicts.json`. This is the ONLY
