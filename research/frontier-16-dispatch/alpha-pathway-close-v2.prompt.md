...
run: frontier-16
role: alpha
label: pathway-close-v2
covers: all
output: research/frontier-16-pathway-closure.json

# Step 10 pathway closure — run `frontier-16`

Read `research/frontier-16-pathway.json` and
`research/frontier-16-pathway-closure.json`. For every pending row, read the full
...
```
node tools/pathway-closure.mjs check --run frontier-16
