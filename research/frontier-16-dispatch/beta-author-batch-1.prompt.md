...
# Authoring brief — run `frontier-16`, batch `1` (step 5)
...
- update only your own `research/frontier-16-batch-1.proof-contracts.json` so it
...
- keep your own `research/frontier-16-batch-1.coverage.json` **true of what you
...
research/frontier-16-batch-1.proof-contracts.json --strict` before reporting.
