<!-- Dispatched as-is. `frontier-16` and `7` are substituted by tools/dispatch.mjs
...
# Scaffolding brief — run `frontier-16`, batch `7` (steps 1 and 2)
...
`research/frontier-16-batch-7.notes.md`: current substage, owned artifact paths,
...
`research/frontier-16-batch-7.coverage.json`:
...
```
node tools/source-fetch-check.mjs --coverage research/frontier-16-batch-7.coverage.json --stamp
```
...
```
node tools/coverage-checklist.mjs research/frontier-16-batch-7.coverage.json
```
...
- `research/frontier-16-batch-7.pages.json` — your batch's page objects in final
...
- `research/frontier-16-batch-7.notes.md` — prose-scaffold amendments as precise
  ...
  route, and necessity.
- `research/frontier-16-batch-7.proof-contracts.json` — the version-1
