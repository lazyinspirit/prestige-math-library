...
# Authoring brief — run `frontier-16`, batch `5` (step 5)
...
- update only your own `research/frontier-16-batch-5.proof-contracts.json` so it
...
- keep your own `research/frontier-16-batch-5.coverage.json` **true of what you
...
research/frontier-16-batch-5.proof-contracts.json --strict` before reporting.
