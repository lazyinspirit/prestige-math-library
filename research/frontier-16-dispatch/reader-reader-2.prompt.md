...
update `research/frontier-16-batch-2.proof-contracts.json` whenever you change
...
`research/frontier-16-reader-2.md`, every change and every finding in it.
...
`research/frontier-16-reader-2.md`. Per finding: item id, exact location, what is
...
label: reader-2
covers: 2
output: research/frontier-16-reader-2.md
