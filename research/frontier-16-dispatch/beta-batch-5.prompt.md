<!-- Dispatched as-is. `frontier-16` and `5` are substituted by tools/dispatch.mjs
...
# Scaffolding brief — run `frontier-16`, batch `5` (steps 1 and 2)
...
`research/frontier-16-batch-5.notes.md`: current substage, owned artifact paths,
...
`research/frontier-16-batch-5.coverage.json`:
...
```
node tools/source-fetch-check.mjs --coverage research/frontier-16-batch-5.coverage.json --stamp
```
...
```
node tools/coverage-checklist.mjs research/frontier-16-batch-5.coverage.json
```
...
- `research/frontier-16-batch-5.pages.json` — your batch's page objects in final
...
- `research/frontier-16-batch-5.notes.md` — prose-scaffold amendments as precise
  ...
  route, and necessity.
- `research/frontier-16-batch-5.proof-contracts.json` — the version-1
...
# Batch 5 of run `frontier-16` — Measures and Their Basic Properties
...
| | |
|---|---|
| A page | `measures-and-their-basic-properties` · order **288.003** · `measure-theory` |
| B page | `measures-and-their-basic-properties-examples` |
| title | Measures and Their Basic Properties |
| requires | `sigma-algebras-and-borel-sets-examples` |
| design | `plan-measure-theory-track.md` L1752 |
