...
update `research/frontier-16-batch-5.proof-contracts.json` whenever you change
...
`research/frontier-16-reader-5.md`, every change and every finding in it.
...
`research/frontier-16-reader-5.md`. Per finding: item id, exact location, what is
...
label: reader-5
covers: 5
output: research/frontier-16-reader-5.md
