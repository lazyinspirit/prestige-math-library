<!-- Dispatched as-is. `frontier-16` and `6` are substituted by tools/dispatch.mjs
...
# Scaffolding brief — run `frontier-16`, batch `6` (steps 1 and 2)
...
You are **Beta-6**, running **GPT 5.6 Sol via the Codex subscription plan
...
`research/frontier-16-batch-6.notes.md`: current substage, owned artifact paths,
...
```
node tools/source-fetch-check.mjs --coverage research/frontier-16-batch-6.coverage.json --stamp
```
...
```
node tools/coverage-checklist.mjs research/frontier-16-batch-6.coverage.json
```
...
- `research/frontier-16-batch-6.pages.json` — your batch's page objects in final
...
- `research/frontier-16-batch-6.notes.md` — prose-scaffold amendments as precise
  ...
  route, and necessity.
- `research/frontier-16-batch-6.proof-contracts.json` — the version-1
...
# Batch 6 of run `frontier-16` — The Seifert–van Kampen Theorem · Classification of Covering Spaces

2 A/B pairs, topology. You own every page here and you author them all at step 5.

## `the-seifert-van-kampen-theorem`

| | |
|---|---|
| A page | `the-seifert-van-kampen-theorem` · order **297** · `topology` |
| B page | `the-seifert-van-kampen-theorem-examples` |
| title | The Seifert–van Kampen Theorem |
| requires | `the-fundamental-group-of-the-circle`, `free-products-and-amalgamation` |
| design | `plan-topology-set-theory-track.md` L982 |
...
| | |
|---|---|
| A page | `classification-of-covering-spaces` · order **299** · `topology` |
| B page | `classification-of-covering-spaces-examples` |
| title | Classification of Covering Spaces |
| requires | `covering-spaces-and-lifting`, `the-fundamental-group-of-the-circle` |
| design | `plan-topology-set-theory-track.md` L1039 |
