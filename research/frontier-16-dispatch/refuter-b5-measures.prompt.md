# Proof-refuter brief — run `frontier-16`
...
# Read-only proof refutation task — frontier-16 batch 5, measures pair

Audit the current post-reader text for the A/B pair
`measures-and-their-basic-properties` and
`measures-and-their-basic-properties-examples`, using
`research/frontier-16-batch-5.pages.json` as the exact item scope and
`research/frontier-16-batch-5.proof-contracts.json` as the contract. Open every
...
in the sequence `F5-1`, `F5-2`, and so on, the item id, exact
