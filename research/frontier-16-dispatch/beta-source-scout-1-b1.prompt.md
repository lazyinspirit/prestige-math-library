...
```
node tools/source-fetch-check.mjs --coverage research/frontier-16-batch-<i>.coverage.json
```
...
```
node tools/source-fetch-check.mjs --coverage research/frontier-16-batch-<i>.coverage.json --stamp
```
...
`research/frontier-16-batch-<i>.coverage.json` and `.notes.md` only. Keep
