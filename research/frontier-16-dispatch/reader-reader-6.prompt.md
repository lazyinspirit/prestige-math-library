...
update `research/frontier-16-batch-6.proof-contracts.json` whenever you change
...
`research/frontier-16-reader-6.md`, every change and every finding in it.
...
`research/frontier-16-reader-6.md`. Per finding: item id, exact location, what is
...
label: reader-6
covers: 6
output: research/frontier-16-reader-6.md
