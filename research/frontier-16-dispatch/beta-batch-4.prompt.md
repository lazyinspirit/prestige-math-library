<!-- Dispatched as-is. `frontier-16` and `4` are substituted by tools/dispatch.mjs
...
# Scaffolding brief — run `frontier-16`, batch `4` (steps 1 and 2)
...
`research/frontier-16-batch-4.notes.md`: current substage, owned artifact paths,
...
`research/frontier-16-batch-4.coverage.json`:
...
```
node tools/coverage-checklist.mjs research/frontier-16-batch-4.coverage.json
```
...
- `research/frontier-16-batch-4.pages.json` — your batch's page objects in final
...
- `research/frontier-16-batch-4.notes.md` — prose-scaffold amendments as precise
  ...
  route, and necessity.
- `research/frontier-16-batch-4.proof-contracts.json` — the version-1
...
# Batch 4 of run `frontier-16` — Trigonometric and Oscillatory Examples in One Variable
...
| | |
|---|---|
| A page | `trigonometric-and-oscillatory-examples-in-one-variable` · order **288.00023** · `real-analysis` |
| B page | `trigonometric-and-oscillatory-examples-in-one-variable-examples` |
...
| design | `plan-realanalysis-completion-track.md` L599 |
