<!-- Dispatched as-is. `frontier-16` and `3` are substituted by tools/dispatch.mjs
...
# Scaffolding brief — run `frontier-16`, batch `3` (steps 1 and 2)
...
scaffolding run `frontier-16` of the public math library, whose checkout is the
...
`research/frontier-16-batch-3.notes.md`: current substage, owned artifact paths,
...
`research/frontier-16-batch-3.coverage.json`:
...
```
node tools/coverage-checklist.mjs research/frontier-16-batch-3.coverage.json
```
...
- `research/frontier-16-batch-3.pages.json` — your batch's page objects in final
...
- `research/frontier-16-batch-3.notes.md` — prose-scaffold amendments as precise
  ...
  route, and necessity.
- `research/frontier-16-batch-3.proof-contracts.json` — the version-1
...
6. **Cross-batch dependencies** — anything your batch needs from the other
   batch of run `frontier-16`, or that you believe the other batch will need from you.
...
# Batch 3 of run `frontier-16` — Picard-Lindelof and First-Order Ordinary Differential Equations · The Gauge Integral and Cousin's Lemma
...
| | |
|---|---|
| A page | `picard-lindelof-and-first-order-odes` · order **288.00019** · `real-analysis` |
| B page | `picard-lindelof-and-first-order-odes-examples` |
| title | Picard-Lindelof and First-Order Ordinary Differential Equations |
| requires | `the-fundamental-theorems-of-calculus`, `approximation-and-compactness-in-ck` |
| design | `plan-differential-geometry-track.md` L2097 (id mention, not a heading — locate the section yourself)<br>`plan-realanalysis-completion-track.md` L58 (id mention, not a heading — locate the section yourself) |
...
| | |
|---|---|
| A page | `the-gauge-integral-and-cousins-lemma` · order **288.00021** · `real-analysis` |
| B page | `the-gauge-integral-and-cousins-lemma-examples` |
| title | The Gauge Integral and Cousin's Lemma |
| requires | `the-fundamental-theorems-of-calculus` |
| design | `plan-realanalysis-completion-track.md` L556 |
