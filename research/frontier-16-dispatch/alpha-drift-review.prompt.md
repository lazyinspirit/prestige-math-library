...
## Step-0 prerequisite drift review — run `frontier-16`
...
**Evidence assembled for you:** `research/frontier-16-drift-evidence.json`
...
Write `research/frontier-16-alpha-step0-drift.md`, one section per A page:
