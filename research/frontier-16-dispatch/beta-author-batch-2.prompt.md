...
# Authoring brief — run `frontier-16`, batch `2` (step 5)
...
- update only your own `research/frontier-16-batch-2.proof-contracts.json` so it
...
- keep your own `research/frontier-16-batch-2.coverage.json` **true of what you
...
research/frontier-16-batch-2.proof-contracts.json --strict` before reporting.
...
# Batch `<i>` of run `frontier-16` — step 5, authoring
...
- `research/frontier-16-batch-<i>.pages.json` — the spliced scaffold
- `research/frontier-16-batch-<i>.notes.md` — your source ledger and rationales
- `research/frontier-16-batch-<i>.coverage.json` — the harvest
- `research/frontier-16-batch-<i>.proof-contracts.json` — extend it as you author
- group Alpha's step-3 review and re-check, for the findings you resolved
- `research/frontier-16-beta-<i>.task.md` — your batch's pages and design section;
...
node tools/content-policy.mjs research/frontier-16-batch-<i>.pages.json
```
...
Append `## Step-5 authoring` to `research/frontier-16-batch-<i>.notes.md`: items
