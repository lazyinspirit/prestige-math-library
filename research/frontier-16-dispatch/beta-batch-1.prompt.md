<!-- Dispatched as-is. `frontier-16` and `1` are substituted by tools/dispatch.mjs
...
# Scaffolding brief — run `frontier-16`, batch `1` (steps 1 and 2)
...
You are **Beta-1**, running **GPT 5.6 Sol via the Codex subscription plan
...
`research/frontier-16-batch-1.notes.md`: current substage, owned artifact paths,
...
`research/frontier-16-batch-1.coverage.json`:
...
```
node tools/source-fetch-check.mjs --coverage research/frontier-16-batch-1.coverage.json --stamp
```
...
```
node tools/coverage-checklist.mjs research/frontier-16-batch-1.coverage.json
```
...
- `research/frontier-16-batch-1.pages.json` — your batch's page objects in final
...
- `research/frontier-16-batch-1.notes.md` — prose-scaffold amendments as precise
  ...
  route, and necessity.
- `research/frontier-16-batch-1.proof-contracts.json` — the version-1
...
# Batch 1 of run `frontier-16` — The Inverse Function Theorem Completed · Convex and Semicontinuous Functions on R^n
...
| | |
|---|---|
| A page | `the-inverse-function-theorem-completed` · order **288.00001** · `real-analysis` |
| B page | `the-inverse-function-theorem-completed-examples` |
| title | The Inverse Function Theorem Completed |
| requires | `inverse-and-implicit-function-theorems`, `the-topology-of-euclidean-space` |
| design | `plan-realanalysis-completion-track.md` L184 |
...
| | |
|---|---|
| A page | `convex-and-semicontinuous-functions-on-rn` · order **288.00005** · `real-analysis` |
| B page | `convex-and-semicontinuous-functions-on-rn-examples` |
...
| design | `plan-realanalysis-completion-track.md` L51 (id mention, not a heading — locate the section yourself) |
