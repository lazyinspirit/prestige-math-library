...
run: frontier-16
role: alpha
label: owner-report-v2
covers: all
output: research/frontier-16-step10-report.md

# Step 10 owner report — run `frontier-16`

Write the final evidence-led account to
`research/frontier-16-step10-report.md`. Do not edit mathematics, prompts, workflow
...
final Sigma adjudication, and `research/frontier-16-publication-readiness.json`.
