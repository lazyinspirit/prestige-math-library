# Batch 10 of run `frontier-33` — Fibre Products Base Change and Scheme Theoretic Fibres

1 A/B pair, scheme-theory. You own every page here and you author them all at step 5.

## `fibre-products-base-change-and-scheme-theoretic-fibres`

| | |
|---|---|
| A page | `fibre-products-base-change-and-scheme-theoretic-fibres` · order **366.065** · `scheme-theory` |
| B page | `fibre-products-base-change-and-scheme-theoretic-fibres-examples` |
| title | Fibre Products Base Change and Scheme Theoretic Fibres |
| requires | `schemes-subschemes-and-morphisms-locally-of-finite-type-examples` |
| design | `research/plan-algebraic-geometry-track.md` L778 |
