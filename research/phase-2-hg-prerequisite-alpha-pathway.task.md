# Step 10 — pathway closure, `phase-2-hg-prerequisite`

Read `research/phase-2-hg-prerequisite-pathway.json` and
`research/phase-2-hg-prerequisite-pathway-closure.json`. For every pending receipt row, rewrite
