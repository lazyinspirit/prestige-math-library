# Batch 10 of run `frontier-28` — Whitney Embedding Tubular Neighbourhoods and Approximation
...
| | |
|---|---|
| A page | `whitney-embedding-tubular-neighbourhoods-and-approximation` · order **455** · `differential-geometry` |
...
| requires | `smooth-partitions-of-unity-and-exhaustions`, `smooth-vector-bundles-and-sections`, `sard-theorem-and-transversality`, `homotopy-and-homotopy-equivalence` |
| design | `plan-differential-geometry-track.md` L2014 |
