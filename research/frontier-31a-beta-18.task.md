# Batch 18 of run `frontier-31a` — Verma Modules and Shapovalov Forms
...
| | |
|---|---|
| A page | `verma-modules-and-shapovalov-forms` · order **510.003** · `lie-theory` |
| B page | `verma-modules-and-shapovalov-forms-examples` |
| title | Verma Modules and Shapovalov Forms |
| requires | `harish-chandra-isomorphism-casimir-and-central-characters-examples` |
| design | `research/plan-representation-theory-lie-track.md` L108 |
