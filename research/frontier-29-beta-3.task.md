# Batch 3 of run `frontier-29` — Henselian Rings and Equicharacteristic Cohen Structure
...
| | |
|---|---|
| A page | `henselian-rings-and-equicharacteristic-cohen-structure` · order **194.001** · `commutative-algebra` |
| B page | `henselian-rings-and-equicharacteristic-cohen-structure-examples` |
| title | Henselian Rings and Equicharacteristic Cohen Structure |
| requires | `inverse-limits-and-noetherian-completion-examples`, `formal-power-series` |
| design | `plan-commutative-algebra-track.md` L1184<br>`plan-commutative-algebra-track.md` L3626 |
