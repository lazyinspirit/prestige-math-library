# Batch 2 of run `frontier-24` — Induced Representations, Frobenius Reciprocity and Applications
...
| | |
|---|---|
| A page | `induced-representations-and-frobenius-reciprocity` · order **149** · `abstract-algebra` |
| B page | `induced-representations-and-frobenius-reciprocity-examples` |
| title | Induced Representations, Frobenius Reciprocity and Applications |
| requires | `characters-and-the-orthogonality-relations`, `free-modules-and-exact-sequences` |
| design | `plan-algebra-track-expansion.md` L1612 |
