# Batch 10 of run `frontier-20-full` — Preadditive and Additive Categories and Biproducts
...
| | |
|---|---|
| A page | `preadditive-and-additive-categories-and-biproducts` · order **365.013** · `category-theory` |
...
| requires | `kan-extensions-density-and-the-free-cocompletion-examples` |
| design | `plan-category-theory-track.md` L1699 |
