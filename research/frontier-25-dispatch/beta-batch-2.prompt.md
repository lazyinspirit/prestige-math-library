...
# Batch 2 of run `frontier-25` — The Moore--Penrose Pseudoinverse and Regularised Least Squares · Eigenvalue Iterations and the QR Algorithm
...
| | |
|---|---|
| A page | `the-moore-penrose-pseudoinverse-and-regularised-least-squares` · order **168.005** · `linear-algebra` |
| B page | `the-moore-penrose-pseudoinverse-and-regularised-least-squares-examples` |
...
| design | `plan-algebra-track-expansion-v2.md` L728 |
...
| | |
|---|---|
| A page | `eigenvalue-iterations-and-the-qr-algorithm` · order **168.007** · `linear-algebra` |
| B page | `eigenvalue-iterations-and-the-qr-algorithm-examples` |
| title | Eigenvalue Iterations and the QR Algorithm |
| requires | `direct-matrix-factorisations-lu-cholesky-and-qr` |
| design | `plan-algebra-track-expansion-v2.md` L774 |
