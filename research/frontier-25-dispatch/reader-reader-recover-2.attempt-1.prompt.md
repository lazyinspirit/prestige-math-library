...
run: frontier-25
role: reader
label: reader-recover-2
covers: 2
output: research/frontier-25-step6-scope-2.json

# Step 6 reader routing-artifact correction

Correct research/frontier-25-reader-findings-2.json for batch 2.
Set the top-level `batch` field to exactly "2"; it identifies this batch, not the run number.
