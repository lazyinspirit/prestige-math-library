...
covers: 8
output: research/frontier-25-batch-8.proof-contracts.json

> The dispatch block supplies batch `8`.

# Step 5 — author batch `8`, `frontier-25`

Use `research/frontier-25-batch-8.pages.json`, `.notes.md`, `.coverage.json`,
