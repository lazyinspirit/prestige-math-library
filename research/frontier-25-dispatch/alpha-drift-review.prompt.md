...
label: drift-review
covers: drift
output: research/frontier-25-alpha-step0-drift.md

## Step-0 prerequisite drift review — run `frontier-25`
...
**Evidence assembled for you:** `research/frontier-25-drift-evidence.json`
...
Write `research/frontier-25-alpha-step0-drift.md`, one section per A page:
