...
covers: 11
output: research/frontier-25-batch-11.proof-contracts.json

> The dispatch block supplies batch `11`.

# Step 5 — author batch `11`, `frontier-25`

Use `research/frontier-25-batch-11.pages.json`, `.notes.md`, `.coverage.json`,
