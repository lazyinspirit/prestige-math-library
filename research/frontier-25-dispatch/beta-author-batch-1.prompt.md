...
covers: 1
output: research/frontier-25-batch-1.proof-contracts.json

> The dispatch block supplies batch `1`.

# Step 5 — author batch `1`, `frontier-25`

Use `research/frontier-25-batch-1.pages.json`, `.notes.md`, `.coverage.json`,
