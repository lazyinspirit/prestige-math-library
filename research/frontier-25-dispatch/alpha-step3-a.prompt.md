...
Run `node tools/scope-decisions.mjs refresh --run frontier-25 --group <your-group>`.
Resolve every pending row in
`research/frontier-25-alpha-<your-group>-scope-decisions.json` as `stands` or
`owner-decision` with current evidence, then run its `check` command.

Write `research/frontier-25-alpha-<your-group>-step3-scaffold-review.md` and
`research/frontier-25-alpha-<your-group>-step3-verdicts.json`. The verdict file
