...
run: frontier-25
role: alpha
label: contract-audit-7

# Contract-detector adjudication — `frontier-25`
...
Merge the batch contracts into `research/frontier-25-proof-contracts.json` and
rerun the failed detector. Write `research/frontier-25-alpha-contract-audit.md`
