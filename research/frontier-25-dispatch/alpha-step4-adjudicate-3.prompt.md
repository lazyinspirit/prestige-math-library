...
run: frontier-25
role: alpha
label: step4-adjudicate-3

# Step 4 — splice-refusal adjudication, `frontier-25`

Read `research/frontier-25-splice-refusals.json` and every reported undeclared
...
`research/frontier-25-alpha-step4.md` with each edge, evidence, disposition, edit,
