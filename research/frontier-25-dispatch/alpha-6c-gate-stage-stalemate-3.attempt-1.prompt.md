...
run: frontier-25
role: alpha
label: 6c-gate-stage-stalemate-3

# Step 6c repair — stage-stalemate

This file is the authority for repair cycle 3.
Primary gate: `stage-stalemate`
Reason: unit(s) all covered but artifact-incomplete and no longer running
