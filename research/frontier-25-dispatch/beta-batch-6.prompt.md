...
# Batch 6 of run `frontier-25` — Monoidal Categories and Monoidal Functors
...
| | |
|---|---|
| A page | `monoidal-categories-and-monoidal-functors` · order **365.023** · `category-theory` |
| B page | `monoidal-categories-and-monoidal-functors-examples` |
| title | Monoidal Categories and Monoidal Functors |
| requires | `the-diagram-lemmas-in-an-abelian-category-examples` |
| design | `plan-category-theory-track.md` L2338<br>`plan-category-theory-track.md` L2418 |
