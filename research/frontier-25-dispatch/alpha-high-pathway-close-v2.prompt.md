...
covers: all
output: research/frontier-25-pathway-closure.json

# Step 10 — pathway closure, `frontier-25`

Read `research/frontier-25-pathway.json` and
`research/frontier-25-pathway-closure.json`. For every pending receipt row, rewrite
