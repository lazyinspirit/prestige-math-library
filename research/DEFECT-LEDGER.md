...
> GENERATED from `research/defect-ledger.jsonl` @ 94a94fda8e72 by `tools/defect-ledger.mjs render` — do not edit.

## What the numbers mean, first

| | |
|---|---|
| defects caught before publication | 1212 |
| now mechanically prevented | 231 |
