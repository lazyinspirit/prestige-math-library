# Batch 5 of run `frontier-27` — Closed Monoidal Categories and the Internal Hom
...
| | |
|---|---|
| A page | `closed-monoidal-categories-and-the-internal-hom` · order **365.027** · `category-theory` |
| B page | `closed-monoidal-categories-and-the-internal-hom-examples` |
| title | Closed Monoidal Categories and the Internal Hom |
| requires | `strictification-and-mac-lanes-coherence-theorem-examples` |
| design | `plan-category-theory-track.md` L2540<br>`plan-category-theory-track.md` L2607 |
