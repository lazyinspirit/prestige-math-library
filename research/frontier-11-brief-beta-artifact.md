...
2. Your own `research/frontier-11-batch-<i>.notes.md` and
...
**1. `research/frontier-11-batch-<i>.proof-contracts.json` must be true of disk.**
...
Verify: `node tools/proof-contract.mjs research/frontier-11-batch-<i>.proof-contracts.json --strict`

**2. `research/frontier-11-batch-<i>.coverage.json` must still be true of disk.**
...
Verify: `node tools/coverage-checklist.mjs research/frontier-11-batch-<i>.coverage.json`
