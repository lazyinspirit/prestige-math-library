# Step 9 — whole-level receipts, `phase-2-catchup-24`
...
Generate `research/phase-2-catchup-24-spine-audit.json` with `spine-audit --template` and
read every selected proof before completing its current-hash evidence.

Generate `research/phase-2-catchup-24-audit-coverage.json` with
...
`--terminal-resolutions research/phase-2-catchup-24-step8-terminal-resolutions.jsonl`,
