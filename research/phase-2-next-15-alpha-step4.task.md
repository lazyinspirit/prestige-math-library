# Step 4 — splice-refusal adjudication, `phase-2-next-15`

Read `research/phase-2-next-15-splice-refusals.json` and every reported undeclared
...
`research/phase-2-next-15-alpha-step4.md` with each edge, evidence, disposition, edit,
