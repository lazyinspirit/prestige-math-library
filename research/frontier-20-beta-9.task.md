# Batch 9 of run `frontier-20` — The Residue Theorem and the Evaluation of Real Integrals · The Hartogs Phenomena
...
| | |
|---|---|
| A page | `the-hartogs-phenomena` · order **351** · `complex-analysis` |
| B page | `the-hartogs-phenomena-examples` |
| title | The Hartogs Phenomena |
| requires | `subharmonic-functions-and-the-dirichlet-problem`, `holomorphic-functions-of-several-variables`, `complete-metrizability-and-baire`, `isolated-singularities-and-laurent-series` |
| design | `plan-complex-analysis-track.md` L3238 |
