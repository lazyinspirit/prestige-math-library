# Batch 7 of run `frontier-28` — Braided and Symmetric Monoidal Categories
...
| | |
|---|---|
| A page | `braided-and-symmetric-monoidal-categories` · order **365.029** · `category-theory` |
| B page | `braided-and-symmetric-monoidal-categories-examples` |
| title | Braided and Symmetric Monoidal Categories |
| requires | `closed-monoidal-categories-and-the-internal-hom-examples` |
| design | `plan-category-theory-track.md` L2642<br>`plan-category-theory-track.md` L2723 |
