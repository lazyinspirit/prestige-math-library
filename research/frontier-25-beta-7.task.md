# Batch 7 of run `frontier-25` — Chain Homotopy and the Homotopy Category
...
| | |
|---|---|
| A page | `chain-homotopy-and-the-homotopy-category` · order **365.039** · `homological-algebra` |
| B page | `chain-homotopy-and-the-homotopy-category-examples` |
| title | Chain Homotopy and the Homotopy Category |
| requires | `chain-complexes-and-homology-examples` |
| design | `plan-homological-algebra-track.md` L601<br>`plan-homological-algebra-track.md` L735 |
