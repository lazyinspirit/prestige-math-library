...
# Batch `<i>` of run `frontier-19` — a source is gone; its results are not
...
```
node tools/source-backing.mjs --coverage research/frontier-19-batch-<i>.coverage.json \
...
```
node tools/source-backing.mjs --coverage research/frontier-19-batch-<i>.coverage.json --liveness research/frontier-19-url-liveness.json
node tools/coverage-checklist.mjs research/frontier-19-batch-<i>.coverage.json --require-destination
node tools/url-sweep.mjs --coverage research/frontier-19-batch-<i>.coverage.json --recover --fail-on-dead
node tools/source-fetch-check.mjs --coverage research/frontier-19-batch-<i>.coverage.json --stamp
```

## Report

Append `## Re-harvest round` to `research/frontier-19-batch-<i>.notes.md`: the dead
...
`research/frontier-19-batch-<i>.coverage.json` and `.notes.md`. Keep `original_url`
