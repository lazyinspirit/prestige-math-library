...
Read `research/frontier-31-alpha-<group>-step3-scaffold-review.md` and each
...
Refresh and check `research/frontier-31-alpha-<your-group>-scope-decisions.json`
with `tools/scope-decisions.mjs`. Resolve any newly pending row from current
evidence before the check.

Write `research/frontier-31-alpha-<your-group>-recheck.md` with one disposition per
finding. Update `research/frontier-31-alpha-<your-group>-step3-verdicts.json` only
