...
covers: 9
output: research/frontier-26-batch-9.proof-contracts.json

> The dispatch block supplies batch `9`.

# Step 5 — author batch `9`, `frontier-26`

Use `research/frontier-26-batch-9.pages.json`, `.notes.md`, `.coverage.json`,
