...
# Batch 8 of run `frontier-26` — Star Expansions and the Erdős–Hajnal Property · Iterative Sparsification and the Five-Vertex Path
...
| | |
|---|---|
| A page | `star-expansions-and-erdos-hajnal` · order **417** · `combinatorics` |
| B page | `star-expansions-and-erdos-hajnal-examples` |
| title | Star Expansions and the Erdős–Hajnal Property |
| requires | `the-five-cycle-and-erdos-hajnal` |
| design | `plan-combinatorics-and-categories.md` L3908 (id mention, not a heading — locate the section yourself) |
...
| | |
|---|---|
| A page | `iterative-sparsification-and-the-five-vertex-path` · order **419** · `combinatorics` |
| B page | `iterative-sparsification-and-the-five-vertex-path-examples` |
| title | Iterative Sparsification and the Five-Vertex Path |
| requires | `the-five-cycle-and-erdos-hajnal` |
| design | `plan-combinatorics-and-categories.md` L3909 (id mention, not a heading — locate the section yourself) |
