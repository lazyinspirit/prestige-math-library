...
run: frontier-26
role: reader
label: reader-recover-9
covers: 9
output: research/frontier-26-step6-scope-9.json

# Step 6 reader routing-artifact correction

Correct research/frontier-26-reader-findings-9.json for batch 9.
Set the top-level `batch` field to exactly "9"; it identifies this batch, not the run number.
