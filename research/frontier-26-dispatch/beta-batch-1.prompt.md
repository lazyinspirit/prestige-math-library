...
# Batch 1 of run `frontier-26` — Dedekind Domains and Ideal Classes
...
| | |
|---|---|
| A page | `dedekind-domains-and-ideal-classes` · order **111.017** · `commutative-algebra` |
| B page | `dedekind-domains-and-ideal-classes-examples` |
| title | Dedekind Domains and Ideal Classes |
| requires | `valuation-rings-and-discrete-valuation-rings-examples` |
| design | `plan-algebraic-geometry-track.md` L64 (id mention, not a heading — locate the section yourself)<br>`plan-commutative-algebra-track.md` L820 (id mention, not a heading — locate the section yourself) |
