...
covers: 11
output: research/frontier-26-batch-11.proof-contracts.json

> The dispatch block supplies batch `11`.

# Step 5 — author batch `11`, `frontier-26`

Use `research/frontier-26-batch-11.pages.json`, `.notes.md`, `.coverage.json`,
