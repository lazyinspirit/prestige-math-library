...
label: drift-review
covers: drift
output: research/frontier-26-alpha-step0-drift.md

## Step-0 prerequisite drift review — run `frontier-26`
...
**Evidence assembled for you:** `research/frontier-26-drift-evidence.json`
...
Write `research/frontier-26-alpha-step0-drift.md`, one section per A page:
