...
covers: 4
output: research/frontier-26-batch-4.proof-contracts.json

> The dispatch block supplies batch `4`.

# Step 5 — author batch `4`, `frontier-26`

Use `research/frontier-26-batch-4.pages.json`, `.notes.md`, `.coverage.json`,
