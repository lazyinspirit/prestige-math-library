...
covers: all
output: research/frontier-26-pathway-closure.json

# Step 10 — pathway closure, `frontier-26`

Read `research/frontier-26-pathway.json` and
`research/frontier-26-pathway-closure.json`. For every pending receipt row, rewrite
