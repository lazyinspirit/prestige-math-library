...
# Contract-detector adjudication — `frontier-26`
...
Merge the batch contracts into `research/frontier-26-proof-contracts.json` and
rerun the failed detector. Write `research/frontier-26-alpha-contract-audit.md`
