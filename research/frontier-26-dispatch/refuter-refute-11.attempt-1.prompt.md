...
The task and `research/frontier-26-step6-scope-11.json` define `refuter_scope`.
...
label: refute-11
covers: 11
output: research/frontier-26-refute-11.json

# Step 6a — refuter

Read `research/frontier-26-step6-scope-11.json` and audit exactly its `refuter_scope`,
