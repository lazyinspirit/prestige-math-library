...
run: frontier-26
role: reader
label: reader-recover-4
covers: 4
output: research/frontier-26-step6-scope-4.json

# Step 6 reader routing-artifact correction

Correct research/frontier-26-reader-findings-4.json for batch 4.
Set the top-level `batch` field to exactly "4"; it identifies this batch, not the run number.
