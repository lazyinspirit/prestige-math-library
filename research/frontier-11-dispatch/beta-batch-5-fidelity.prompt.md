...
```
node tools/proof-contract.mjs research/frontier-11-batch-5.proof-contracts.json --strict
```
...
# frontier-11, batch 5 — contract fidelity, ARTIFACT-ONLY

You are **Beta-frontier-11-5**. Edit only
`research/frontier-11-batch-5.proof-contracts.json` and append to
