...
2. Your own `research/frontier-11-batch-2.notes.md` and
...
**1. `research/frontier-11-batch-2.proof-contracts.json` must be true of disk.**
...
Verify: `node tools/proof-contract.mjs research/frontier-11-batch-2.proof-contracts.json --strict`

**2. `research/frontier-11-batch-2.coverage.json` must still be true of disk.**
...
Verify: `node tools/coverage-checklist.mjs research/frontier-11-batch-2.coverage.json`
...
# frontier-11, batch 2 — artifact reconciliation after step-6 repairs

You are **Beta-frontier-11-2**. Your artifacts are
`research/frontier-11-batch-2.*`.

## Your reader

`research/frontier-11-reader-1.findings.md` — reader 1 audited your
