...
```
node tools/proof-contract.mjs research/frontier-11-batch-1.proof-contracts.json --strict
```
...
# frontier-11, batch 1 — contract fidelity, ARTIFACT-ONLY

You are **Beta-frontier-11-1**. Edit only
`research/frontier-11-batch-1.proof-contracts.json` and append to
