...
`research/frontier-11-batch-1.coverage.json`. Per A page: at least two
...
- `research/frontier-11-batch-1.pages.json` — the machine scaffold
- `research/frontier-11-batch-1.notes.md` — source ledger, provenance
  rationales, convention disagreements, split proposals, licensing notes
- `research/frontier-11-batch-1.coverage.json` — the harvest
- `research/frontier-11-batch-1.proof-contracts.json` — begun at scaffold time
