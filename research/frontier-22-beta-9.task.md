# Batch 9 of run `frontier-22` — Cographs, Perfect Patterns and Pure Pairs
...
| | |
|---|---|
| A page | `cographs-perfect-patterns-and-pure-pairs` · order **413** · `combinatorics` |
| B page | `cographs-perfect-patterns-and-pure-pairs-examples` |
...
| design | `plan-combinatorics-and-categories.md` L3906 (id mention, not a heading — locate the section yourself) |
