# Step 4 — splice-refusal adjudication, `frontier-34`

Read `research/frontier-34-splice-refusals.json` and every reported undeclared
...
`research/frontier-34-alpha-step4.md` with each edge, evidence, disposition, edit,
