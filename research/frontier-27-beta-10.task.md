# Batch 10 of run `frontier-27` — Primitive Recursive and Partial Computable Functions · Resource Bounds and Machine Invariance
...
| | |
|---|---|
| A page | `primitive-recursive-and-partial-computable-functions` · order **609** · `computability-theory` |
...
| design | `plan-computability-theory-track.md` L685<br>`plan-computability-theory-track.md` L709 |
...
| | |
|---|---|
| A page | `resource-bounds-and-machine-invariance` · order **617** · `computability-theory` |
...
| design | `plan-computability-theory-track.md` L837<br>`plan-computability-theory-track.md` L859 |
