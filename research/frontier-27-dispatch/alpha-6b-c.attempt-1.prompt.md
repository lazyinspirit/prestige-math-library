...
label: 6b-c
covers: 8
output: research/frontier-27-alpha-c-6b.md

# Step 6b — routed group adjudication

Work only on the dispatched group. For every batch, read its
`research/frontier-27-step6-scope-8.json`, reader report and findings JSON, refuter
...
Write `research/frontier-27-alpha-<g>-6b.md` and
`research/frontier-27-alpha-<g>-6b-decisions.json` with `{version:1,run,group,decisions}`.
