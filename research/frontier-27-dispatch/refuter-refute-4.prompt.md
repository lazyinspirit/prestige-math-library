...
The task and `research/frontier-27-step6-scope-4.json` define `refuter_scope`.
...
label: refute-4
covers: 4
output: research/frontier-27-refute-4.json

# Step 6a — refuter

Read `research/frontier-27-step6-scope-4.json` and audit exactly its `refuter_scope`,
