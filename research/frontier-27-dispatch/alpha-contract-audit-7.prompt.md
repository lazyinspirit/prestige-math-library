...
# Contract-detector adjudication — `frontier-27`
...
Merge the batch contracts into `research/frontier-27-proof-contracts.json` and
rerun the failed detector. Write `research/frontier-27-alpha-contract-audit.md`
