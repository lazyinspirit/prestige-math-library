...
covers: all
output: research/frontier-27-pathway-closure.json

# Step 10 — pathway closure, `frontier-27`

Read `research/frontier-27-pathway.json` and
`research/frontier-27-pathway-closure.json`. For every pending receipt row, rewrite
