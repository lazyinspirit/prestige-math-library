...
run: frontier-27
role: alpha
label: step4-adjudicate-4

# Step 4 — splice-refusal adjudication, `frontier-27`

Read `research/frontier-27-splice-refusals.json` and every reported undeclared
...
`research/frontier-27-alpha-step4.md` with each edge, evidence, disposition, edit,
