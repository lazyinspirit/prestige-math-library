...
covers: 10
output: research/frontier-27-batch-10.proof-contracts.json

> The dispatch block supplies batch `10`.

# Step 5 — author batch `10`, `frontier-27`

Use `research/frontier-27-batch-10.pages.json`, `.notes.md`, `.coverage.json`,
