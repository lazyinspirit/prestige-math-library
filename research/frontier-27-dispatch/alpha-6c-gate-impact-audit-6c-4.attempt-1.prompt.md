...
Reason: ERROR receipt-reviewer: research/frontier-27-impact-6c.json: reviewer is required
...
ERROR receipt-reviewer: research/frontier-27-impact-6c.json: reviewer is required
...
Read `research/frontier-27-cross-group-edges.json`, the post-6b carriers, and every
...
`research/frontier-27-6c-verdicts.jsonl`; use the exact kind and verdict vocabulary
accepted by `tools/cross-group-edges.mjs`. Obtain a current carrier hash with
`node tools/cross-group-edges.mjs carrier --run frontier-27 --id <id>` after edits.
...
Write `research/frontier-27-alpha-6c.md` with the evidence, disposition, edits, and
