# Batch 3 of run `frontier-30` — Differentiation of Monotone Functions and the Vitali Covering Theorem
...
| | |
|---|---|
| A page | `differentiation-of-monotone-functions-and-the-vitali-covering-theorem` · order **288.035** · `measure-theory` |
...
| requires | `the-maximal-function-and-lebesgue-differentiation-examples` |
| design | `plan-measure-theory-track.md` L3384 |
