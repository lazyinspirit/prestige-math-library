...
You are the group Alpha for batches **1**, **5**, **9**: 4 A/B pair(s), 8 page(s), 163 item(s), 7 open rejection(s) over 7 item(s).
...
|---|---|---|---|
| `cex-an-arbitrary-transversal-does-not-give-the-reduced-schreier-basis` | `subgroups-of-free-groups-and-schreier-rewriting-examples` | gpt-5.6-terra | `608446b2c7a75e5017c41e2f1b2aa9f7cf550ee3fb746247f84a1d2f88dd713a` |
| `fs-folner-sequences-exist-for-every-uncountable-amenable-group` | `amenable-groups-and-folner-criteria` | gpt-5.6-terra | `1f1560e39f5e03fc3b35a16f28d473785702810d94621a0e7fa89dd3c126f35b` |
| `lem-schreier-rewriting-is-invariant-under-free-reduction` | `subgroups-of-free-groups-and-schreier-rewriting` | gpt-5.6-terra | `0cd5c5c0c62df42ddb77e5bbe7d864cc0e5c45ebe3d7893f45ef914973c25ff7` |
| `thm-folner-criterion-for-amenability` | `amenable-groups-and-folner-criteria` | gpt-5.6-terra | `962fc409d188ca82af97b8ed7ac216a75dfcdd53665a099217697e73d56bb615` |
| `thm-free-group-of-rank-two-is-nonamenable` | `amenable-groups-and-folner-criteria` | gpt-5.6-terra | `8dc90ca4cbb552fe1f9346417f6b0b25e9f9a287fb971a61ed47f67c1b44f0d1` |
| `thm-kernel-and-cokernel-are-mutually-inverse-order-anti-isomorphisms-between-subobjects-and-quotient-objects` | `abelian-categories` | gpt-5.6-terra | `047bc2b26530649504ed03a6e345de4ea27e7435699bb19fe0a5d651a4ce54c7` |
| `thm-tarski-alternative` | `amenable-groups-and-folner-criteria` | gpt-5.6-terra | `d4b3a377cf17cbc866ec1f9d7e46c2f770d8d184f32ad0789d7730e337204506` |
