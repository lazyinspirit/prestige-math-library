...
run: frontier-21
role: alpha
label: contract-audit-5

# Contract-detector adjudication — `frontier-21`
...
Merge the batch contracts into `research/frontier-21-proof-contracts.json` and
rerun the failed detector. Write `research/frontier-21-alpha-contract-audit.md`
