...
run: frontier-21
role: beta
label: author-recover-8
covers: 8
output: research/frontier-21-step6-scope-8.json

> The dispatch block supplies batch `8`.

# Step 5 — author batch `8`, `frontier-21`

Use `research/frontier-21-batch-8.pages.json`, `.notes.md`, `.coverage.json`,
