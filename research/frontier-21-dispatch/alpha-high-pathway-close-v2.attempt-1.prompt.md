...
covers: all
output: research/frontier-21-pathway-closure.json

# Step 10 — pathway closure, `frontier-21`

Read `research/frontier-21-pathway.json` and
`research/frontier-21-pathway-closure.json`. For every pending receipt row, rewrite
