...
# Batch 6 of run `frontier-21` — Integer Partitions and the Twelvefold Way · Counting up to Symmetry: Burnside and Pólya
...
| | |
|---|---|
| A page | `integer-partitions-and-the-twelvefold-way` · order **201** · `combinatorics` |
| B page | `integer-partitions-and-the-twelvefold-way-examples` |
| title | Integer Partitions and the Twelvefold Way |
| requires | `set-partitions-stirling-numbers-and-exponential-generating-functions`, `formal-power-series` |
| design | `plan-combinatorics-and-categories.md` L1643<br>`plan-combinatorics-and-categories.md` L4829 |
...
| | |
|---|---|
| A page | `counting-up-to-symmetry-burnside-and-polya` · order **205** · `combinatorics` |
| B page | `counting-up-to-symmetry-burnside-and-polya-examples` |
| title | Counting up to Symmetry: Burnside and Pólya |
| requires | `group-actions-and-cayleys-theorem`, `symmetric-groups-and-the-sign-homomorphism`, `set-partitions-stirling-numbers-and-exponential-generating-functions`, `symmetric-polynomials` |
| design | `plan-combinatorics-and-categories.md` L1748 |
