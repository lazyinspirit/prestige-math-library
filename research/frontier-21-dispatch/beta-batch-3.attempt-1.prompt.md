...
# Batch 3 of run `frontier-21` — Artinian Rings and Length
...
| | |
|---|---|
| A page | `artinian-rings-and-length` · order **111.007** · `commutative-algebra` |
| B page | `artinian-rings-and-length-examples` |
| title | Artinian Rings and Length |
| requires | `prime-spectra-and-radicals-examples` |
| design | `plan-commutative-algebra-track.md` L452 (id mention, not a heading — locate the section yourself) |
