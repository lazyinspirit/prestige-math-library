...
run: frontier-21
role: alpha
label: step9-changes-adjudicate-1

# Step 9 — changed-mathematics adjudication, `frontier-21`

Act only on ids in `research/frontier-21-step9-changes.json`. Read their current
...
`research/frontier-21-alpha-step9-adjudicate.md` with every tuple, outcome,
