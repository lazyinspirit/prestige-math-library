  ...
  "failures": [
    {
      "id": "step8-published",
      "stage": "8-rejudge",
      "why": "`thm-baire-category-r`: gpt-5.6-terra rejected the repaired text and nothing adjudicated it",
      "output": "step8-scope --published: 2 problem(s):\n  `thm-dirichlet-and-thomae-continuity-sets`: gpt-5.6-terra rejected the repaired text and nothing adjudicated it\n  `thm-baire-category-r`: gpt-5.6-terra rejected the repaired text and nothing adjudicated it\n",
      "named_ids": [
    ...
    },
    {
      "id": "judge-closure",
      "stage": "8-rejudge",
      "why": "ERROR judge-coverage-missing [cex-an-arbitrary-transversal-does-not-give-the-reduced-schreier-basis]: cex-an-arbitrary-transversal-does-not-give-the-reduced-schreier-basis: no complete verdict set from gpt-5.6-terra for the current frozen c",
      "output": "level-coverage --judge-only: 425/433 current configured-judge verdict set(s); 0 terminal manual resolution(s), 8 need rejudge, 0 unadjudicated, 0 open fatal, 217 adjudicated rejection(s) closed nonfatally; legacy gate counter 425/433 current pairs (one per-item configured verdict set, including singleton lineups)\nERROR judge-coverage-missing [cex-an-arbitrary-transversal-does-not-give-the-reduced-schreier-basis]: cex-an-arbitrary-transversal-does-not-give-the-reduced-schreier-basis: no complete verdict set from gpt-5.6-terra for the current frozen context, and none cast against the item's current text\nERROR judge-coverage-missing [def-weighted-zero-and-pole-counts-on-cycle]: def-weighted-zero-and-pole-counts-on-cycle: no complete verdict set from gpt-5.6-terra for the current frozen context, and none cast against the item's current text\nERROR judge-coverage-missing [fs-folner-sequences-exist-for-every-uncountable-amenable-group]: fs-folner-sequences-exist-for-every-uncountable-amenable-group: no complete verdict set from gpt-5.6-terra for the current frozen context, and none cast against the item's current text\nERROR judge-coverage-missing [lem-schreier-rewriting-is-invariant-under-free-reduction]: lem-schreier-rewriting-is-invariant-under-free-reduction: no complete verdict set from gpt-5.6-terra for the current frozen context, and none cast against the item's current text\nERROR judge-coverage-missing [thm-argument-principle-null-homologous-cycle]: thm-argument-principle-null-homologous-cycle: no complete verdict set from gpt-5.6-terra for the current frozen context, and none cast against the item's current text\nERROR judge-coverage-missing [thm-cartan-thullen-theorem]: thm-cartan-thullen-theorem: no complete verdict set from gpt-5.6-terra for the current frozen context, and none cast against the item's current text\nERROR judge-coverage-missing [thm-domains-of-holomorphy-are-hartogs-pseudoconvex]: thm-domains-of-holomorphy-are-hartogs-pseudoconvex: no complete verdict set from gpt-5.6-terra for the current frozen context, and none cast against the item's current text\nERROR judge-coverage-missing [thm-levi-and-hartogs-pseudoconvexity-for-c-two-domains]: thm-levi-and-hartogs-pseudoconvexity-for-c-two-domains: no complete verdict set from gpt-5.6-terra for the current frozen context, and none cast against the item's current text\n",
      "named_ids": [
  ...
  "live_tuples": [
    {
      "id": "thm-baire-category-r",
      "model": "gpt-5.6-terra",
      "context_sha256": "30c2cf60a96b8933b4f01a9213b20a0a4861c40d9957b20a87c0a286056a727a",
      "scope": "published",
    ...
    },
    {
      "id": "thm-dirichlet-and-thomae-continuity-sets",
      "model": "gpt-5.6-terra",
      "context_sha256": "e81ef2fed2dc73641f8e6a5a5be4e558c5257bd04628abc4f37a8395ede9c5ff",
      "scope": "published",
      "status": "unadjudicated"
    }
  ]
