...
The task and `research/frontier-21-step6-scope-3.json` define `refuter_scope`.
...
run: frontier-21
role: refuter
label: refute-recover-3
covers: 3
output: research/frontier-21-step6-scope-3.json

# Step 6a — refuter

Read `research/frontier-21-step6-scope-3.json` and audit exactly its `refuter_scope`,
