...
# Batch 2 of run `frontier-21` — Pell Equations and Generalized Pell Orbits
...
| | |
|---|---|
| A page | `pell-equations-and-generalized-pell-orbits` · order **78.5** · `number-theory` |
| B page | `pell-equations-and-generalized-pell-orbits-examples` |
| title | Pell Equations and Generalized Pell Orbits |
| requires | `regular-continued-fractions-and-diophantine-approximation-examples` |
| design | `plan-number-theory-track.md` L834 |
