...
# Post-recheck scaffold repair — batch `10`, `frontier-21`

Read `research/frontier-21-scaffold-closure.json` and take only `work[]` entries
whose pages belong to batch `10` in the scope ledger. Apply or push back on
