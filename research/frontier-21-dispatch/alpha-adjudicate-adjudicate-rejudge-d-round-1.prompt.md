...
You are the group Alpha for batches **6**, **10**: 4 A/B pair(s), 8 page(s), 97 item(s), 2 open rejection(s) over 2 item(s).
...
|---|---|---|---|
| `ex-a-vertex-can-be-mixed-on-a-quotient-block-while-pure-on-each-member-block` | `quotient-blockades-and-mixing-relations-examples` | gpt-5.6-terra | `23e4ca5f854fc31d16d55b7fec71801fd80edd88ccc8a258ef9b0c35e48a3706` |
| `thm-path-and-antipath-free-graphs-have-the-strong-erdos-hajnal-property` | `pure-pairs-forests-and-path-antipath-classes` | gpt-5.6-terra | `2b62c7d7a905d9593671e4101794aca70120ad0d92d60133c51ce232ae6071c7` |
