...
Reason: ERROR receipt-reviewer: research/frontier-21-impact-6c.json: reviewer is required
...
ERROR receipt-reviewer: research/frontier-21-impact-6c.json: reviewer is required
...
`research/frontier-21-6c-verdicts.jsonl`; also record the changed item/page verdict.
Extend prior retry artifacts and report the current gate result.

# Step 6c — cross-batch audit and closure

Read `research/frontier-21-cross-group-edges.json`, the post-6b carriers, and every
...
`research/frontier-21-6c-verdicts.jsonl`; use the exact kind and verdict vocabulary
accepted by `tools/cross-group-edges.mjs`. Obtain a current carrier hash with
`node tools/cross-group-edges.mjs carrier --run frontier-21 --id <id>` after edits.
...
Write `research/frontier-21-alpha-6c.md` with the evidence, disposition, edits, and
