# Step 8 — changed-mathematics adjudication, `phase-2-nine-step-25`

Act only on ids in `research/phase-2-nine-step-25-step8-changes.json`. Read their current
...
`research/phase-2-nine-step-25-alpha-step8-adjudicate.md` with every tuple, outcome,
