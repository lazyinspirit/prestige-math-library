# Batch 14 of run `frontier-31a` — Affine Schemes and the Structure Sheaf
...
| | |
|---|---|
| A page | `affine-schemes-and-the-structure-sheaf` · order **366.061** · `scheme-theory` |
| B page | `affine-schemes-and-the-structure-sheaf-examples` |
| title | Affine Schemes and the Structure Sheaf |
| requires | `sheaf-operations-exactness-ringed-spaces-and-module-pullback-examples`, `zariski-topology-on-prime-spectra` |
| design | `research/plan-algebraic-geometry-track.md` L663 |
