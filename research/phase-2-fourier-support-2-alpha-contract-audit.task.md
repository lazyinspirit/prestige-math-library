# Contract-detector adjudication — `phase-2-fourier-support-2`
...
Merge the batch contracts into `research/phase-2-fourier-support-2-proof-contracts.json` and
rerun the failed detector. Write `research/phase-2-fourier-support-2-alpha-contract-audit.md`
