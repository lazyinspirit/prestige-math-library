# Batch 16 of run `frontier-32` — Homomorphisms Between Verma Modules and Linkage
...
| | |
|---|---|
| A page | `homomorphisms-between-verma-modules-and-linkage` · order **510.005** · `lie-theory` |
| B page | `homomorphisms-between-verma-modules-and-linkage-examples` |
| title | Homomorphisms Between Verma Modules and Linkage |
| requires | `verma-modules-and-shapovalov-forms-examples` |
| design | `research/plan-representation-theory-lie-track.md` L147 |
