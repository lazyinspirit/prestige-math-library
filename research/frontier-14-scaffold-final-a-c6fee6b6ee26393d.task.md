...
Read any research/frontier-14-scaffold-owner-<A-page>.json decision first.
...
node tools/scaffold-resolution.mjs record --run frontier-14 --page A_ID --decision accept --confidence 1 --reason "Exact evidence and report path"
node tools/scaffold-resolution.mjs record --run frontier-14 --page A_ID --decision repaired --confidence 1 --reason "Applied repair, checks and report path"
node tools/scaffold-resolution.mjs record --run frontier-14 --page A_ID --decision escalate --reason "Exact uncertainty and owner decision needed"
...
Group: a. Assigned batches: 1, 2, 3.
