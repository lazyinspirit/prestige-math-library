# Step 9 — changed-mathematics adjudication, `frontier-26`

Act only on ids in `research/frontier-26-step9-changes.json`. Read their current
...
`research/frontier-26-alpha-step9-adjudicate.md` with every tuple, outcome,
