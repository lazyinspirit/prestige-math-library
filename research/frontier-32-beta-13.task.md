# Batch 13 of run `frontier-32` — Comb Structure in co-E-Free Graphs
...
| | |
|---|---|
| A page | `co-e-free-comb-structure` · order **437** · `combinatorics` |
| B page | `co-e-free-comb-structure-examples` |
| title | Comb Structure in co-E-Free Graphs |
| requires | `the-structural-criterion-for-property-star`, `quotient-blockades-and-mixing-relations` |
| design | `research/plan-combinatorics-and-categories.md` L3918 (id mention, not a heading — locate the section yourself) |
