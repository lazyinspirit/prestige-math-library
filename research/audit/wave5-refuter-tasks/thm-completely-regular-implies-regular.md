# Adversarial proof reading — `thm-completely-regular-implies-regular`

## The item under review, in full

`items/thm-completely-regular-implies-regular.md`
...
Read `thm-completely-regular-implies-regular` adversarially against the dependency text above and return
