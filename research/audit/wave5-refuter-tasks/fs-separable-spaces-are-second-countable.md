# Adversarial proof reading — `fs-separable-spaces-are-second-countable`

## The item under review, in full

`items/fs-separable-spaces-are-second-countable.md`
...
Read `fs-separable-spaces-are-second-countable` adversarially against the dependency text above and return
