...
## Target item — `fs-paracompactness-is-productive`

Normalized current SHA-256: `8b30bc1c43edb239bddfd7c6b7f96987312d3894a879988418285ec0c79593e3`
...
```json
{
  ...
  "rationale": "The sources give the standard Sorgenfrey/lower-limit-line counterexample: each factor is paracompact, while its square is not normal and hence not paracompact Hausdorff. The item presents the erroneous universal product claim and spells out the contradiction under explicit Choice.",
...
```json
{
  ...
  "derivations": [
    ...
    {
      "id": "step-2-1",
      "claim": "If paracompactness were productive, $L^2$ would be paracompact. [step 1.1]",
      "step": "2.1",
      "inputs": [
        "1.1"
      ]
    ...
    {
      "id": "step-3-1",
      "claim": "By [F1] and [L3], $L^2$ is Hausdorff; then [L4] would make it normal, contradicting [L2]. [F1, L2, L3, L4, step 2.1]",
      "step": "3.1",
      "inputs": [
        "F1",
        "L3",
    ...
    {
      "id": "step-4-1",
      "claim": "Hence the displayed productive assertion is refuted. [step 3.1]",
      "step": "4.1",
      "inputs": [
        "3.1"
      ]
  ...
  "boundaries": [
    ...
    },
    {
      "case": "zero",
      "status": "checked",
      "evidence": "Statement and steps 1.1--3.1 include 0 as an ordinary point of each factor."
    },
    {
      "case": "one",
      "status": "checked",
      "evidence": "Step 3.1 uses a binary product, the first nontrivial finite-product case."
    },
    {
      "case": "degenerate",
      "status": "not_applicable",
      "reason": "The fixed factors do not collapse to singleton spaces."
    },
    {
      "case": "endpoints",
      "status": "checked",
      "evidence": "Fact F1 and step 3.1 respect the half-open basis endpoints used to prove Hausdorffness."
    },
    {
...
[
  {
    "source": "fs-paracompactness-is-productive",
