...
- critical risk (10): 11 declared dependencies; 11 cited facts; 8 numbered proof steps; boundary-sensitive language; analytic limiting/completeness language

## Target item — `cor-cauchy-product-absolute`

Normalized current SHA-256: `fb28ba7c85a817206b78328bac433ac27a7055299b1e130b92612676b33b8a8a`
...
```json
{
  ...
  "rationale": "Hunter's Cauchy-product theorem gives exactly absolute convergence and the product formula when both factors converge absolutely.",
  ...
  "citations": [
    {
      ...
      "quote": "1. **A finite identity, holding for arbitrary sequences.** For every",
      "uses": [
        "2.2"
      ]
    },
