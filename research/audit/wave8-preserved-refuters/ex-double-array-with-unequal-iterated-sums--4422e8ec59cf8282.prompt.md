...
- critical risk (11): 8 declared dependencies; 8 cited facts; existence, choice, uniqueness, or well-definedness; boundary-sensitive language; analytic limiting/completeness language

## Target item — `ex-double-array-with-unequal-iterated-sums`

Normalized current SHA-256: `6bd19f7cb939893fb5881a964171984a2828ad04b68b7feecf0cf47604b09ddf`
  ...
  "citations": [
    {
      ...
      "quote": "such that every row series $\\sum_j a_{ij}$ converges, every column series",
      "uses": [
        "1.1"
      ]
    },
...
[
  {
    "source": "ex-double-array-with-unequal-iterated-sums",
    "sourcePage": "absolute-convergence-and-rearrangement-examples",
    "batch": "wave8-real-analysis-absolute-convergence",
    "target": "fs-iterated-double-sums-always-agree",
    "declared_target": "fs-iterated-double-sums-always-agree",
