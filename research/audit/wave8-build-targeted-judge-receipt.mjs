...
const id = 'cor-q-is-meager-and-not-g-delta';
const models = ['deepseek-v4-pro', 'gpt-5.6-terra'];
const rows = readFileSync('research/audit/wave8-judge.jsonl', 'utf8')
...
const receipt = {
  ...
  reviewer: 'Wave 8 audit orchestrator personal audit (owner-delegated)',
  lineup: models,
  targets: [{
    id,
...
writeFileSync('research/audit/wave8-targeted-judge-receipt.json', `${JSON.stringify(receipt, null, 2)}\n`);
console.log('wrote Wave 8 targeted judge receipt for exactly one A8 repair');
