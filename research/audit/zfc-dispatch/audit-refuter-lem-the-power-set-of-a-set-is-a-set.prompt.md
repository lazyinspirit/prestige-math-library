...
## Target item — `lem-the-power-set-of-a-set-is-a-set`
...
## Declared dependencies of `lem-the-power-set-of-a-set-is-a-set`
...
### `def-axiom-of-power-set` — The Axiom of Power Set: $\\forall x\\,\\exists y\\,\\forall z\\,(\\forall t\\,(t \\in z \\to t \\in x) \\to z \\in y)$
