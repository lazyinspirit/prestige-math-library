...
## Target item — `cex-the-cartesian-product-is-not-associative`
...
## Declared dependencies of `cex-the-cartesian-product-is-not-associative`
...
### `def-iterated-products-and-ordered-triples` — The ordered triple $(a,b,c) := ((a,b),c)$ and the iterated products $A \\times B \\times C := (A \\times B) \\times C$
