<!-- TEMPLATE. Copy into an Audit-Beta prompt and substitute 7 (wave) and
     topology-uniform. The published-page audit workflow is AUDIT-WORKFLOW.md; this
     brief is its Beta-side half for steps A1, A2, and A4. -->

# Audit-Beta brief — wave 7, topology-uniform batch (steps A1/A2/A4)
...
`research/audit/wave7-topology-uniform.pages.json`. Nothing here was authored by
...
in `research/audit/wave7-topology-uniform.provenance.jsonl`:
...
3. **Capture the full proof contract** for every proof-bearing item (owner
   decision D1) in `research/audit/wave7-topology-uniform.proof-contracts.json`:
...
`research/audit/wave7-topology-uniform.provenance.jsonl`, `.findings.md`,
