...
## Assigned exact-final target — `fs-substitution-holds-for-every-integrable-integrand`

Item path: `items/fs-substitution-holds-for-every-integrable-integrand.md`

Normalized final-text SHA-256 at dispatch: `5113884c1f600530219932dee9f022aa1bea6b5c20c552207a567358fc02118a`

Target type: `item-source-repair`

- A3 Pugh Chapter 3 Exercise 35 exact-source override; A6 source-correction certification candidate
...
```json
{
  ...
  "rationale": "Charles C. Pugh, Real Mathematical Analysis, 2nd ed., Chapter 3, Exercise 35(a)--(d), gives the same construction from a fat Cantor set F, psi(x)=integral_0^x dist(t,F) dt, nullity of psi(F), and the Riemann-integrable indicator of psi(F) whose composite with psi is not Riemann integrable. The repository's quantitative content-zero proof and dependency-explicit packaging are local.",
