...
## Assigned exact-final target — `thm-integration-by-parts`

Item path: `items/thm-integration-by-parts.md`

Normalized final-text SHA-256 at dispatch: `e95b3f47eb513512170b675d189183da7199e4abf7c1c6dc5b34ee93b8d02f73`
...
```json
{
  ...
  "rationale": "The sources state integration by parts for continuously differentiable functions. The item uses the sharper Riemann hypothesis that u and v are differentiable and u' and v' are integrable, then derives integrability of the products; the identity and direction are unchanged.",
