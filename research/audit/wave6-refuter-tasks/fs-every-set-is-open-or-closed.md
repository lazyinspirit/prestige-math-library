## Target item — `fs-every-set-is-open-or-closed`

Normalized current SHA-256: `8428a191b1184366cbc79b98ec247f4e8696c74824a60397743a3430ed79899e`
...
```json
{
  ...
  "derivations": [
    {
      "id": "step-1-1",
      "claim": "$0 \\in E$ and $1 \\notin E$, since $0 \\le 0 < 1$ while $1 < 1$ fails; so $1 \\in \\mathbb{R} \\setminus E$.",
      "step": "1.1",
      "inputs": [
        "given",
        "L5"
    ...
    {
      "id": "step-1-2",
      "claim": "$E$ is not open: let $\\varepsilon > 0$ be real and put $y := -(\\varepsilon \\cdot 2^{-1})$. Then $|y - 0| = \\varepsilon \\cdot 2^{-1} < \\varepsilon$ by [L4] and [L5], so $y \\in N_\\varepsilon(0)$; but $y < 0$, so $y \\notin E$. Hence no neighbourhood of the point $0$ of $E$ is contained in $E$.",
      "step": "1.2",
      "inputs": [
        "L1",
        "L2",
    ...
    {
      "id": "step-1-3",
      "claim": "$\\mathbb{R} \\setminus E$ is not open: let $\\varepsilon > 0$ be real, put $t := \\min\\{\\varepsilon, 1\\} \\cdot 2^{-1}$, which is positive and satisfies $t \\le \\varepsilon \\cdot 2^{-1} < \\varepsilon$ and $t \\le 1 \\cdot 2^{-1}$ by [L3] and [L5], and put $y := 1 - t$. Then $y \\ge 1 - 1 \\cdot 2^{-1} > 0$ and $y < 1$, so $y \\in E$; and $|y - 1| = t < \\varepsilon$ by [L4], so $y \\in N_\\varepsilon(1)$. Hence no neighbourhood of the point $1$ of $\\mathbb{R} \\setminus E$ is contained in $\\mathbb{R} \\setminus E$.",
      "step": "1.3",
      "inputs": [
        "L1",
        "L2",
    ...
    {
      "id": "step-2-1",
      "claim": "By step 1.2 the set $E$ is not open, and by steps 1.1 and 1.3 its complement is not open, so $E$ is not closed either. The subset $E$ of $\\mathbb{R}$ is therefore neither open nor closed, and the claim [A1] is false.",
      "step": "2.1",
      "inputs": [
        "step 1.1",
        "step 1.2",
  ...
  "boundaries": [
    {
      ...
      "reason": "The fs-every-set-is-open-or-closed statement has no empty-set or empty-family boundary."
    },
    {
      "case": "zero",
      "status": "checked",
    ...
    },
    {
      "case": "degenerate",
      "status": "not_applicable",
      "reason": "The fs-every-set-is-open-or-closed statement has no parameter degeneracy that changes the claim."
    },
    {
      "case": "endpoints",
      "status": "checked",
    ...
    },
    {
      ...
      "status": "not_applicable",
      "reason": "The fs-every-set-is-open-or-closed proof makes no selection from a set whose nonemptiness needs a separate discharge."
    },
    {
      "case": "iff-forward",
      "status": "not_applicable",
      "reason": "The fs-every-set-is-open-or-closed statement is not a biconditional requiring a forward implication."
    },
    {
      "case": "iff-reverse",
      "status": "not_applicable",
      "reason": "The fs-every-set-is-open-or-closed statement is not a biconditional requiring a reverse implication."
    }
  ],
  "finite_smoke": [],
  "risk_review": {
...
[
  ...
  },
  {
    ...
    "sourcePage": "topology-of-r",
    "batch": "wave6-real-analysis-limits",
    "target": "cex-half-open-interval-neither-open-nor-closed",
    "declared_target": "cex-half-open-interval-neither-open-nor-closed",
    "target_statement_provenance": null,
