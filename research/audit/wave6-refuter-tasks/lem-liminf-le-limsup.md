## Target item — `lem-liminf-le-limsup`

Normalized current SHA-256: `07ac8fcec5cdaeaefe51516f8f89e2a873fcc6ab2d8be7f950a44b243ab540dd`
...
```json
{
  ...
  "derivations": [
    {
      "id": "step-1-1",
      "claim": "Let $m, n \\in \\mathbb{N}$ be arbitrary. The order on $\\mathbb{N}$ is total, so either $m \\le n$ or $n \\le m$; let $p$ be whichever of $m$ and $n$ is the larger, so that $m \\le p$ and $n \\le p$.",
      "step": "1.1",
      "inputs": [
        "given",
        "L3",
    ...
    {
      "id": "step-2-1",
      "claim": "Monotonicity of the tail bounds gives $i_m \\le i_p$ and $s_p \\le s_n$, and $i_p \\le s_p$ holds because $T_p$ is nonempty; chaining these by transitivity yields $i_m \\le s_n$. As $m$ and $n$ were arbitrary, every tail infimum is below every tail supremum.",
      "step": "2.1",
      "inputs": [
        "step 1.1",
        "L2",
    ...
    {
      "id": "step-3-1",
      "claim": "Fix $n \\in \\mathbb{N}$. By step 2.1 the element $s_n$ is an upper bound of the family $\\{i_m : m \\in \\mathbb{N}\\}$, and $\\liminf_k x_k$ is its least upper bound, so $\\liminf_k x_k \\le s_n$.",
      "step": "3.1",
      "inputs": [
        "step 2.1",
        "L1",
    ...
    {
      "id": "step-4-1",
      "claim": "Since $n$ was arbitrary, $\\liminf_k x_k$ is a lower bound of the family $\\{s_n : n \\in \\mathbb{N}\\}$, and $\\limsup_k x_k$ is its greatest lower bound, so $\\liminf_k x_k \\le \\limsup_k x_k$.",
      "step": "4.1",
      "inputs": [
        "step 3.1",
        "L1",
  ...
  "boundaries": [
    {
      ...
      "reason": "The lem-liminf-le-limsup statement has no empty-set or empty-family boundary."
    },
    {
      "case": "zero",
      "status": "not_applicable",
      "reason": "The lem-liminf-le-limsup statement has no zero-valued boundary."
    },
    {
      "case": "one",
      "status": "checked",
    ...
    },
    {
      "case": "iff-forward",
      "status": "not_applicable",
      "reason": "The lem-liminf-le-limsup statement is not a biconditional requiring a forward implication."
    },
    {
      "case": "iff-reverse",
      "status": "not_applicable",
      "reason": "The lem-liminf-le-limsup statement is not a biconditional requiring a reverse implication."
    }
  ],
  "finite_smoke": [],
  "risk_review": {
