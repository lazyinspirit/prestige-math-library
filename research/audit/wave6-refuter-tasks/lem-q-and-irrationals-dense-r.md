## Target item — `lem-q-and-irrationals-dense-r`

Normalized current SHA-256: `99a6e4574f44f0384bf3c320234cfd7f4195973d9e5ddad6a674d44349e3cc8c`
...
```json
{
  ...
  "derivations": [
    ...
    {
      "id": "step-1-2",
      "claim": "$\\mathbb{Q}_{\\mathbb{R}}$ is at most countable: the embedding is an injection of $\\mathbb{Q}$ with image $\\mathbb{Q}_{\\mathbb{R}}$, hence a bijection onto it, so $\\mathbb{Q}_{\\mathbb{R}} \\approx \\mathbb{Q} \\approx \\mathbb{N}$.",
      "step": "1.2",
      "inputs": [
        "L4",
        "L5"
    ...
    {
      "id": "step-1-3",
      "claim": "For all reals $a < b$ the interval $(a,b)$ is uncountable.",
      "step": "1.3",
      "inputs": [
        "L7"
      ]
    ...
    {
      "id": "step-2-1",
      "claim": "For all reals $a < b$ the interval $(a,b)$ contains an irrational: if it did not, then $(a,b) \\subseteq \\mathbb{Q}_{\\mathbb{R}}$, so $(a,b)$ would be a subset of an at most countable set by step 1.2 and hence at most countable by [L6], contradicting step 1.3. So some $z \\in (a,b)$ lies in $X$.",
      "step": "2.1",
      "inputs": [
        "step 1.2",
        "step 1.3",
    ...
    {
      "id": "step-2-2",
      "claim": "Every nonempty open $U \\subseteq \\mathbb{R}$ is uncountable: fix $x \\in U$ and, by [L3], a real $\\varepsilon > 0$ with $N_\\varepsilon(x) \\subseteq U$; by [L2] the set $N_\\varepsilon(x)$ is the interval $(x - \\varepsilon, x + \\varepsilon)$ with $x - \\varepsilon < x + \\varepsilon$, hence uncountable by step 1.3. Were $U$ at most countable, its subset $N_\\varepsilon(x)$ would be at most countable by [L6], which it is not; so $U$ is uncountable, which is claim 3.",
      "step": "2.2",
      "inputs": [
        "step 1.3",
        "L2",
    ...
    {
      "id": "step-3-1",
      "claim": "$X$ is dense: let $x \\in \\mathbb{R}$ and let $\\varepsilon > 0$ be real; applying step 2.1 with $a = x - \\varepsilon$ and $b = x + \\varepsilon$ gives $z \\in (x - \\varepsilon, x + \\varepsilon) \\cap X$, which is $N_\\varepsilon(x) \\cap X$ by [L2]. Every real is therefore an adherent point of $X$, so $\\overline{X} = \\mathbb{R}$ by [L1], which is claim 2.",
      "step": "3.1",
      "inputs": [
        "step 2.1",
        "L1",
    ...
    {
      "id": "step-4-1",
      "claim": "Claims 1, 2 and 3 are steps 1.1, 3.1 and 2.2, so both $\\mathbb{Q}_{\\mathbb{R}}$ and its complement are dense in $\\mathbb{R}$ and every nonempty open subset of $\\mathbb{R}$ is uncountable.",
      "step": "4.1",
      "inputs": [
        "step 1.1",
        "step 2.2",
  ...
  "boundaries": [
    {
      ...
      "reason": "The lem-q-and-irrationals-dense-r statement has no empty-set or empty-family boundary."
    },
    {
      "case": "zero",
      "status": "not_applicable",
      "reason": "The lem-q-and-irrationals-dense-r statement has no zero-valued boundary."
    },
    {
      "case": "one",
      "status": "checked",
    ...
    },
    {
      "case": "endpoints",
      "status": "not_applicable",
      "reason": "The lem-q-and-irrationals-dense-r statement has no interval or extended-real endpoint convention."
    },
    {
    ...
    },
    {
      "case": "iff-forward",
      "status": "not_applicable",
      "reason": "The lem-q-and-irrationals-dense-r statement is not a biconditional requiring a forward implication."
    },
    {
      "case": "iff-reverse",
      "status": "not_applicable",
      "reason": "The lem-q-and-irrationals-dense-r statement is not a biconditional requiring a reverse implication."
    }
  ],
  "finite_smoke": [],
  "risk_review": {
...
[
  ...
  },
  {
    ...
    "sourcePage": "topology-of-r",
    "batch": "wave6-real-analysis-limits",
    "target": "ex-closure-interior-boundary-of-q",
    "declared_target": "ex-closure-interior-boundary-of-q",
    "target_statement_provenance": null,
