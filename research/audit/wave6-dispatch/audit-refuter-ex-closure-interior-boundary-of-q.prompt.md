...
## Target item — `ex-closure-interior-boundary-of-q`

Normalized current SHA-256: `1f887fa6501154d56ce347c8a485b080f9f75339e36f70f1cf2adb4f7fa2a4ee`
...
```json
{
  ...
  "derivations": [
    {
      "id": "step-1-1",
      "claim": "$\\overline{\\mathbb{Q}_{\\mathbb{R}}} = \\mathbb{R}$: this is the density of $\\mathbb{Q}_{\\mathbb{R}}$ in [L2].",
      "step": "1.1",
      "inputs": [
        "L2"
      ]
    ...
    {
      "id": "step-1-3",
      "claim": "By [L1] the boundary is $\\partial \\mathbb{Q}_{\\mathbb{R}} = \\overline{\\mathbb{Q}_{\\mathbb{R}}} \\setminus (\\mathbb{Q}_{\\mathbb{R}})^{\\circ}$.",
      "step": "1.3",
      "inputs": [
        "L1"
      ]
    ...
    {
      "id": "step-2-1",
      "claim": "Substituting steps 1.1 and 1.2 into step 1.3 gives $\\partial \\mathbb{Q}_{\\mathbb{R}} = \\mathbb{R} \\setminus \\varnothing = \\mathbb{R}$, so all three assertions hold.",
      "step": "2.1",
      "inputs": [
        "step 1.1",
        "step 1.2",
  ...
  "boundaries": [
    {
      ...
      "reason": "The ex-closure-interior-boundary-of-q statement has no empty-set or empty-family boundary."
    },
    {
      "case": "zero",
      "status": "not_applicable",
      "reason": "The ex-closure-interior-boundary-of-q statement has no zero-valued boundary."
    },
    {
      "case": "one",
      "status": "not_applicable",
      "reason": "The ex-closure-interior-boundary-of-q statement has no unit or first-index boundary."
    },
    {
      "case": "degenerate",
      "status": "not_applicable",
      "reason": "The ex-closure-interior-boundary-of-q statement has no parameter degeneracy that changes the claim."
    },
    {
      "case": "endpoints",
      "status": "not_applicable",
      "reason": "The ex-closure-interior-boundary-of-q statement has no interval or extended-real endpoint convention."
    },
    {
      "case": "nonempty-choice",
      "status": "not_applicable",
      "reason": "The ex-closure-interior-boundary-of-q proof makes no selection from a set whose nonemptiness needs a separate discharge."
    },
    {
      "case": "iff-forward",
      "status": "not_applicable",
      "reason": "The ex-closure-interior-boundary-of-q statement is not a biconditional requiring a forward implication."
    },
    {
      "case": "iff-reverse",
      "status": "not_applicable",
      "reason": "The ex-closure-interior-boundary-of-q statement is not a biconditional requiring a reverse implication."
    }
  ],
  "finite_smoke": [],
  "risk_review": {
...
[
  {
    "source": "ex-closure-interior-boundary-of-q",
