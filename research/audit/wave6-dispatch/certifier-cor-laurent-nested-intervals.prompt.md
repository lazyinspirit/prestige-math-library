# Independent repair certifier brief — Wave 6, step A6
...
## Assigned repair — `cor-laurent-nested-intervals`

Item path: `items/cor-laurent-nested-intervals.md`

Normalized final-text SHA-256 at dispatch: `1c3033bcffeb0936dfbfb5a684522749f0ddf3c0c0fcaf77d2ce0d505782a8e5`

Named repair: Added the natural-number linear-order source needed for monotonicity of the indexed interval endpoints; verify the repaired licensing and the complete proof.
