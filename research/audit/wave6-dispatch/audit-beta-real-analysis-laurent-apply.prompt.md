<!-- TEMPLATE. Copy into an Audit-Beta prompt and substitute 6 (wave) and
     real-analysis-laurent. The published-page audit workflow is AUDIT-WORKFLOW.md; this
     brief is its Beta-side half for steps A1, A2, and A4. -->

# Audit-Beta brief — wave 6, real-analysis-laurent batch (steps A1/A2/A4)
...
`research/audit/wave6-real-analysis-laurent.pages.json`. Nothing here was authored by
...
in `research/audit/wave6-real-analysis-laurent.provenance.jsonl`:
...
3. **Capture the full proof contract** for every proof-bearing item (owner
   decision D1) in `research/audit/wave6-real-analysis-laurent.proof-contracts.json`:
...
`research/audit/wave6-real-analysis-laurent.provenance.jsonl`, `.findings.md`,
