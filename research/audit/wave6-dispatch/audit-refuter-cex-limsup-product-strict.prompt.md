...
## Target item — `cex-limsup-product-strict`

Normalized current SHA-256: `d52e962734edd031d73d8a235f98aca00fa8a9a4be5e5c26e66b917a28a6f17f`
...
```json
{
  ...
  "derivations": [
    {
      "id": "step-1-1",
      "claim": "Each $s_k$ is $1$ or $-1$. When $s_k = 1$ the pair $(x_k, y_k)$ is $(2, 0)$, and when $s_k = -1$ it is $(0, 2)$. In either case $0 \\le x_k \\le 2$ and $0 \\le y_k \\le 2$, so both sequences are bounded and nonnegative, and $x_k y_k = 0$ because one of the two factors is $0$.",
      "step": "1.1",
      "inputs": [
        "given",
        "L1",
    ...
    {
      "id": "step-1-2",
      "claim": "For every $n$ both cases occur at an index $\\ge n$: $s_{e_n} = 1$ with $e_n \\ge n$ and $s_{o_n} = -1$ with $o_n \\ge n$.",
      "step": "1.2",
      "inputs": [
        "given",
        "L1"
    ...
    {
      "id": "step-2-1",
      "claim": "Hence $T_n(x) = \\{0, 2\\}$ and $T_n(y) = \\{0, 2\\}$ for every $n$, each with least upper bound $2$ in $\\overline{\\mathbb{R}}$, since $2$ bounds both elements and belongs to the set; so $\\limsup_k x_k = \\limsup_k y_k = 2$. The product sequence is constantly $0$, so $T_n(x y) = \\{0\\}$ and $\\limsup_k (x_k y_k) = 0$.",
      "step": "2.1",
      "inputs": [
        "step 1.1",
        "step 1.2",
    ...
    {
      "id": "step-3-1",
      "claim": "The hypotheses of [L5] are met by step 1.1, and the inequality it gives reads $0 \\le 2 \\cdot 2 = 4$. Since $0 < 4$, it is strict, so the equality asserted above fails for this pair and the refuted claim is false.",
      "step": "3.1",
      "inputs": [
        "step 2.1",
        "step 1.1",
  ...
  "boundaries": [
    {
      ...
      "reason": "The cex-limsup-product-strict statement has no empty-set or empty-family boundary."
    },
    {
      "case": "zero",
      "status": "checked",
    ...
    },
    {
      "case": "endpoints",
      "status": "not_applicable",
      "reason": "The cex-limsup-product-strict statement has no interval or extended-real endpoint convention."
    },
    {
      "case": "nonempty-choice",
      "status": "not_applicable",
      "reason": "The cex-limsup-product-strict proof makes no selection from a set whose nonemptiness needs a separate discharge."
    },
    {
      "case": "iff-forward",
      "status": "not_applicable",
      "reason": "The cex-limsup-product-strict statement is not a biconditional requiring a forward implication."
    },
    {
      "case": "iff-reverse",
      "status": "not_applicable",
      "reason": "The cex-limsup-product-strict statement is not a biconditional requiring a reverse implication."
    }
  ],
  "finite_smoke": [],
  "risk_review": {
...
[
  {
    "source": "cex-limsup-product-strict",
