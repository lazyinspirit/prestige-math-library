<!-- TEMPLATE. Copy into an Audit-Beta prompt and substitute 6 (wave) and
     real-analysis-limits. The published-page audit workflow is AUDIT-WORKFLOW.md; this
     brief is its Beta-side half for steps A1, A2, and A4. -->

# Audit-Beta brief — wave 6, real-analysis-limits batch (steps A1/A2/A4)
...
`research/audit/wave6-real-analysis-limits.pages.json`. Nothing here was authored by
...
in `research/audit/wave6-real-analysis-limits.provenance.jsonl`:
...
3. **Capture the full proof contract** for every proof-bearing item (owner
   decision D1) in `research/audit/wave6-real-analysis-limits.proof-contracts.json`:
...
`research/audit/wave6-real-analysis-limits.provenance.jsonl`, `.findings.md`,
