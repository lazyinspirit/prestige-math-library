...
## Target item — `cex-closed-bounded-in-q-not-compact`

Normalized current SHA-256: `2916d7b9de18b9b1952106e5c62d63531ccd8b40de2da3361a10c2f7f2e5feaf`
...
```json
{
  ...
  "derivations": [
    {
      "id": "step-1-1",
      "claim": "$\\mathbb{Q}$ is an ordered field by [L2], so it is a legitimate instance of the claim [A1].",
      "step": "1.1",
      "inputs": [
        "A1",
        "L2"
    ...
    {
      "id": "step-1-2",
      "claim": "$S$ is bounded and closed in $\\mathbb{Q}$ by [L1]; the closedness rests on the fact that no rational squares to $2$ ([L3]), which is what makes the complement of $S$ split into the rationals below $0$ and those whose square exceeds $2$, and on the monotonicity of squaring ([L4]), which is what makes each of those two pieces open in $\\mathbb{Q}$.",
      "step": "1.2",
      "inputs": [
        "L1",
        "L2",
    ...
    {
      "id": "step-1-3",
      "claim": "$S$ is not compact in $\\mathbb{Q}$: the cover exhibited in [L1] consists of sets open in $\\mathbb{Q}$, covers $S$ because $S$ has no greatest element, and admits no finite subfamily covering $S$, since the largest index of such a subfamily is itself a member of $S$ that the subfamily leaves uncovered.",
      "step": "1.3",
      "inputs": [
        "L1",
        "L2"
    ...
    {
      "id": "step-2-1",
      "claim": "So the ordered field $\\mathbb{Q}$ carries a bounded set that is closed in $\\mathbb{Q}$ and not compact in $\\mathbb{Q}$, and the claim [A1] is refuted.",
      "step": "2.1",
      "inputs": [
        "step 1.1",
        "step 1.2",
  ...
  "boundaries": [
    {
      ...
      "reason": "The cex-closed-bounded-in-q-not-compact statement has no empty-set or empty-family boundary."
    },
    {
      "case": "zero",
      "status": "checked",
    ...
    },
    {
      "case": "one",
      "status": "not_applicable",
      "reason": "The cex-closed-bounded-in-q-not-compact statement has no unit or first-index boundary."
    },
    {
      "case": "degenerate",
      "status": "not_applicable",
      "reason": "The cex-closed-bounded-in-q-not-compact statement has no parameter degeneracy that changes the claim."
    },
    {
      "case": "endpoints",
      "status": "not_applicable",
      "reason": "The cex-closed-bounded-in-q-not-compact statement has no interval or extended-real endpoint convention."
    },
    {
      "case": "nonempty-choice",
      "status": "not_applicable",
      "reason": "The cex-closed-bounded-in-q-not-compact proof makes no selection from a set whose nonemptiness needs a separate discharge."
    },
    {
      "case": "iff-forward",
      "status": "not_applicable",
      "reason": "The cex-closed-bounded-in-q-not-compact statement is not a biconditional requiring a forward implication."
    },
    {
      "case": "iff-reverse",
      "status": "not_applicable",
      "reason": "The cex-closed-bounded-in-q-not-compact statement is not a biconditional requiring a reverse implication."
    }
  ],
  "finite_smoke": [],
  "risk_review": {
...
[
  {
    "source": "cex-closed-bounded-in-q-not-compact",
