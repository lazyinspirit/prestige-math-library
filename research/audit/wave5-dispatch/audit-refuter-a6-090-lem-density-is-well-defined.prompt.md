...
# Adversarial proof reading — `lem-density-is-well-defined`

## The item under review, in full

`items/lem-density-is-well-defined.md`
...
Read `lem-density-is-well-defined` adversarially against the dependency text above and return
