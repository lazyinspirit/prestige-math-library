...
# Certify the wave-5 repair of `ex-contractive-sequence-fixed-point`

**Item file:** `items/ex-contractive-sequence-fixed-point.md` — read it in full from disk, and read every
