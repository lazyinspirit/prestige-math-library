...
# Adversarial proof reading — `ex-babylonian-sqrt-two`

## The item under review, in full

`items/ex-babylonian-sqrt-two.md`
...
### `lem-of-square-positive` — lemma — Squares of nonzero elements are positive
...
Read `ex-babylonian-sqrt-two` adversarially against the dependency text above and return
