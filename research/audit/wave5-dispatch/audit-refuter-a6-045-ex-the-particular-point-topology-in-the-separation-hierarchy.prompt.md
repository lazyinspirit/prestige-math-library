...
# Adversarial proof reading — `ex-the-particular-point-topology-in-the-separation-hierarchy`

## The item under review, in full

`items/ex-the-particular-point-topology-in-the-separation-hierarchy.md`
...
### `ex-sierpinski-space-is-t0-normal-and-not-regular` — example — Sierpinski space is $T_0$ and normal but neither $T_1$ nor regular: normality without $T_1$ implies nothing
...
Read `ex-the-particular-point-topology-in-the-separation-hierarchy` adversarially against the dependency text above and return
