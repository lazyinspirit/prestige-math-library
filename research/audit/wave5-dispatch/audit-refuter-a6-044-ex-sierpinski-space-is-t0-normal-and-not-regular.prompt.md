...
# Adversarial proof reading — `ex-sierpinski-space-is-t0-normal-and-not-regular`

## The item under review, in full

`items/ex-sierpinski-space-is-t0-normal-and-not-regular.md`
...
Read `ex-sierpinski-space-is-t0-normal-and-not-regular` adversarially against the dependency text above and return
