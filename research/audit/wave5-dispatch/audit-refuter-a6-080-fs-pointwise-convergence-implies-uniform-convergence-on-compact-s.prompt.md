...
# Adversarial proof reading — `fs-pointwise-convergence-implies-uniform-convergence-on-compact-sets`

## The item under review, in full

`items/fs-pointwise-convergence-implies-uniform-convergence-on-compact-sets.md`
...
Read `fs-pointwise-convergence-implies-uniform-convergence-on-compact-sets` adversarially against the dependency text above and return
