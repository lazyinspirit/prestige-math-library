...
# Adversarial proof reading — `lem-geometric-sequence-null`
...
### `lem-bernoulli-inequality` — lemma — Bernoulli's inequality $(1+x)^n \\ge 1 + nx$
...
Read `lem-geometric-sequence-null` adversarially against the dependency text above and return
