...
# Adversarial proof reading — `ex-the-cofinite-topology-in-the-separation-hierarchy`

## The item under review, in full

`items/ex-the-cofinite-topology-in-the-separation-hierarchy.md`
...
### `fs-every-t1-space-is-hausdorff` — false-statement — FALSE: every $T_1$ space is Hausdorff
...
Read `ex-the-cofinite-topology-in-the-separation-hierarchy` adversarially against the dependency text above and return
