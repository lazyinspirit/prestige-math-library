...
# Adversarial proof reading — `lem-normality-via-shrinking`

## The item under review, in full

`items/lem-normality-via-shrinking.md`
...
Read `lem-normality-via-shrinking` adversarially against the dependency text above and return
