...
# Adversarial proof reading — `lem-alternating-sequence`

## The item under review, in full

`items/lem-alternating-sequence.md`
...
### `def-natural-numbers` — definition — The natural numbers $\\mathbb{N}$ (von Neumann)
...
### `def-nat-addition` — definition — Addition of natural numbers
...
### `lem-nat-successor-neq-self` — lemma — No natural number equals its own successor
...
Read `lem-alternating-sequence` adversarially against the dependency text above and return
