...
# Adversarial proof reading — `lem-the-k-topology-is-hausdorff-and-not-regular`

## The item under review, in full

`items/lem-the-k-topology-is-hausdorff-and-not-regular.md`
...
Read `lem-the-k-topology-is-hausdorff-and-not-regular` adversarially against the dependency text above and return
