...
# Adversarial proof reading — `lem-finite-powers-of-countable-sets-are-countable`

## The item under review, in full

`items/lem-finite-powers-of-countable-sets-are-countable.md`
...
Read `lem-finite-powers-of-countable-sets-are-countable` adversarially against the dependency text above and return
