...
# Adversarial proof reading — `fs-every-t1-space-is-hausdorff`

## The item under review, in full

`items/fs-every-t1-space-is-hausdorff.md`
...
Read `fs-every-t1-space-is-hausdorff` adversarially against the dependency text above and return
