...
# Certify the wave-5 repair of `thm-radial-straight-line-map-on-punctured-rn`

**Item file:** `items/thm-radial-straight-line-map-on-punctured-rn.md` — read it in full from disk, and read every
