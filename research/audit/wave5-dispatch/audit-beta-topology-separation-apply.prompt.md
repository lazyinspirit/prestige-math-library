<!-- TEMPLATE. Copy into an Audit-Beta prompt and substitute 5 (wave) and
     topology-separation. The published-page audit workflow is AUDIT-WORKFLOW.md; this
     brief is its Beta-side half for steps A1, A2, and A4. -->

# Audit-Beta brief — wave 5, topology-separation batch (steps A1/A2/A4)
...
`research/audit/wave5-topology-separation.pages.json`. Nothing here was authored by
...
in `research/audit/wave5-topology-separation.provenance.jsonl`:
...
3. **Capture the full proof contract** for every proof-bearing item (owner
   decision D1) in `research/audit/wave5-topology-separation.proof-contracts.json`:
...
`research/audit/wave5-topology-separation.provenance.jsonl`, `.findings.md`,
