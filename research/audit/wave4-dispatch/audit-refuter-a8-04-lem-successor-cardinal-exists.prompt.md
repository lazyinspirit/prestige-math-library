# Wave 4 audit — A8 rejection lane `a8-04-lem-successor-cardinal-exists`
...
`items/lem-successor-cardinal-exists.md` — read the whole file from disk, including frontmatter
...
> The remark claims the cardinal successor is always written aleph(kappa) on this page, never kappa^+. But sibling def-aleph-and-beth-hierarchies, on the same page, defines kappa^+ := aleph(kappa) as the page's standard cardinal-successor notation ('Notation rule, in force on this page and its companion'), and other siblings (e.g. ex-aleph-one-is-at-most-the-continuum) write aleph_1 = aleph_0^+ throughout. This is a false claim about the page's own contents.
