<!-- TEMPLATE. Copy into an Audit-Beta prompt and substitute 4 (wave) and
     foundations. The published-page audit workflow is AUDIT-WORKFLOW.md; this
     brief is its Beta-side half for steps A1, A2, and A4. -->

# Audit-Beta brief — wave 4, foundations batch (steps A1/A2/A4)
...
`research/audit/wave4-foundations.pages.json`. Nothing here was authored by
...
in `research/audit/wave4-foundations.provenance.jsonl`:
...
3. **Capture the full proof contract** for every proof-bearing item (owner
   decision D1) in `research/audit/wave4-foundations.proof-contracts.json`:
...
`research/audit/wave4-foundations.provenance.jsonl`, `.findings.md`,
