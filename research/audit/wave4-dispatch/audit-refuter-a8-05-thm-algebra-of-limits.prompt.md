# Wave 4 audit — A8 rejection lane `a8-05-thm-algebra-of-limits`
...
`items/thm-algebra-of-limits.md` — read the whole file from disk, including frontmatter
...
> Reported a confirmed page-sibling contradiction: the item's closing remark claims verbatim transfer of the theorem to sequences of rationals, contradicting rem-sequence-conventions on the same page.
