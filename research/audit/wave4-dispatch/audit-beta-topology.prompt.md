...
# Audit-Beta brief — wave 4, topology batch (steps A1/A2/A4)
...
`research/audit/wave4-topology.pages.json`. Nothing here was authored by
...
in `research/audit/wave4-topology.provenance.jsonl`:
...
3. **Capture the full proof contract** for every proof-bearing item (owner
   decision D1) in `research/audit/wave4-topology.proof-contracts.json`:
...
`research/audit/wave4-topology.provenance.jsonl`, `.findings.md`,
