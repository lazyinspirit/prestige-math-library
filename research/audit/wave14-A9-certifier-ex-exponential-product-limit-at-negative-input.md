# Wave 14 A9 exact-final formatting-repair certification — `ex-exponential-product-limit-at-negative-input`

Normalized verification-stripped SHA-256: `9d72aaa4e7848e6ed95a587788aa20e5f215cae642f3b96c5673a3da54cba736`

## Current A9 formatting repair

The A8 mathematical repair below was independently certified and passed both
targeted judge lanes. A final `rendercheck` found that the displayed piecewise
sequence definition contained a hard source-line break inside `$$...$$`.
The A9 repair removed only that hard line break; the rendered formula,
mathematical claim, dependencies, proof, and contract are unchanged. The stale
A8 `verification.verified` and `verification.judge` blocks were removed before
this exact-current certification. Independently confirm both the formatting
closure and the unchanged mathematical/citation validity at the new hash.
