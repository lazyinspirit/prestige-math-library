...
# Audit-Beta brief — wave 14, real-analysis batch (steps A1/A2/A4)
...
`research/audit/wave14-real-analysis.pages.json`. Nothing here was authored by
...
in `research/audit/wave14-real-analysis.provenance.jsonl`:
...
3. **Capture the full proof contract** for every proof-bearing item (owner
   decision D1) in `research/audit/wave14-real-analysis.proof-contracts.json`:
...
`research/audit/wave14-real-analysis.provenance.jsonl`, `.findings.md`,
