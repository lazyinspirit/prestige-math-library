...
## Assigned exact-final target — `cor-exponential-reciprocal-and-positivity`

Item path: `items/cor-exponential-reciprocal-and-positivity.md`

Normalized final-text SHA-256 at dispatch: `ae974cbdde71c3f705e8a8f76acb1b9467e59db22a49fe7570ff09fcac57a80f`

Target type(s): `A4-material`

- A4 replaced two insufficient ordered-field dependencies with the exact nonzero-square positivity lemma

Read these exact-current cited/dependency ids from disk (3): `def-real-exponential-function-and-e`, `lem-of-square-positive`, `thm-exponential-addition-formula`.
...
```json
{
  ...
  "rationale": "Hunter states E(-x)=1/E(x) and E(x)>0 for every real x immediately after the addition formula; Johnson also derives reciprocal and positivity from the multiplicative equation. The local square argument is an adapted proof.",
