...
Normalized current SHA-256: `ac272bfaf4e15135c355d59fac9ceaa915bc0d8f8cdeb2dac096d64e7cae47a8`
...
```json
{
  ...
  "derivations": [
    {
      "id": "step-1.1",
      "claim": "The three coordinate sequences of $\\bigl(x^{(k)}\\bigr)$ are $k \\mapsto 1/\\iota(k+1)$, $k \\mapsto 1 - 1/\\iota(k+1)$ and the constant $2$. Given a real $\\varepsilon>0$, take $K$ with $1/\\iota(K+1)<\\varepsilon$; then for $k \\ge K$ one has $0 < 1/\\iota(k+1) \\le 1/\\iota(K+1) < \\varepsilon$, so the first converges to $0$, the second to $1$ and the third to $2$.",
      "step": "1.1",
      "inputs": [
        "L2"
      ]
