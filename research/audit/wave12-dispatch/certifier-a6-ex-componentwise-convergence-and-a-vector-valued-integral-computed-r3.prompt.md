...
## Assigned exact-final target — `ex-componentwise-convergence-and-a-vector-valued-integral-computed`

Item path: `items/ex-componentwise-convergence-and-a-vector-valued-integral-computed.md`

Normalized final-text SHA-256 at dispatch: `ac272bfaf4e15135c355d59fac9ceaa915bc0d8f8cdeb2dac096d64e7cae47a8`

Target type(s): `A6-source-correction`, `A6-major-repair`

- A6 replaced an off-topic vector-derivative route with exact Lebl/APEX componentwise sequence and integral sources
- A6 corrected the convergence proof from rational epsilon to every positive real epsilon
