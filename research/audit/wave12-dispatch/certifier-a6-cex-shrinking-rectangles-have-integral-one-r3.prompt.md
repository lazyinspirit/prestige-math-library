...
Normalized final-text SHA-256 at dispatch: `5fda26ecb5e81bc28ee0d7953113ea4d50d8d60a63938fa9167d5cf3a68b7ca7`
...
```json
{
  ...
  "urls": [
    "https://math.arizona.edu/~faris/real.pdf"
  ],
  "rationale": "Faris, Real Analysis: Part I, Section 13.2, gives the standard shrinking-rectangle witness f_n=n 1_(0,1/n): it converges pointwise to zero while every integral is one, so the integral of the limit is not the limit of the integrals. The item reindexes at zero, restricts the witness to [0,1], fixes its endpoint value, and proves the same phenomenon directly for the Riemann/Darboux integral using the library’s endpoint and dependency conventions. The supplied numbered argument was audited as a local proof rather than a transcription or identifiable adaptation of a source proof.",
...
sources:
  scraped: []
  references:
    - title: "William Faris, Real Analysis: Part I, §13.2"
      url: "https://math.arizona.edu/~faris/real.pdf"
pipeline_run: null
---
