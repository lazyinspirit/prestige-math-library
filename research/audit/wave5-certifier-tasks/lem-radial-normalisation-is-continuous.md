# Certify the wave-5 repair of `lem-radial-normalisation-is-continuous`

**Item file:** `items/lem-radial-normalisation-is-continuous.md` — read it in full from disk, and read every
