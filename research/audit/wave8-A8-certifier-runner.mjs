...
const indexPath = join(REPO, 'research/audit/wave8-A8-certifier-index.json');
...
for (;;) {
  ...
  const result = join(REPO, 'research/audit/wave8-dispatch', `certifier-${label}.result.json`);
