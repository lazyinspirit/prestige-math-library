...
- critical risk (10): 5 declared dependencies; 4 cited facts; boundary-sensitive language; quotient or equivalence-class construction; analytic limiting/completeness language
...
## Target item — `cex-lhopital-converse`

Normalized current SHA-256: `b5421fba66488fd96ce844183677d25edbad15697f52bcf7542213137883dcc4`
...
```json
{
  ...
  "evidence": "trivial",
  "urls": [],
  "rationale": "The exact counterexample is built from the bespoke periodic polynomial oscillator. With f(x)=x^2 psi(1/x) and g(x)=x, the quotient tends to zero by boundedness, but f'/g'=2x psi(1/x)-psi'(1/x) has two recurring subsequential limits. This directly refutes the converse without a literature-dependent step.",
...
```json
{
  ...
  "derivations": [
    {
      "id": "cex-lhopital-converse-step-1-1",
      "claim": "Both $f(x)$ and $g(x)$ tend to $0$, and $f(x)/g(x)=x\\psi(1/x)\\to0$ because $\\psi$ is bounded. [given]",
      "step": "1.1",
      "inputs": [
        "given"
      ]
    ...
    {
      "id": "cex-lhopital-converse-step-1-2",
      "claim": "Yet $f'(x)/g'(x)=2x\\psi(1/x)-\\psi'(1/x)$, which has no limit because $\\psi'$ has separated recurring values. [L1, given]",
      "step": "1.2",
      "inputs": [
        "L1",
        "given"
    ...
    {
      "id": "cex-lhopital-converse-step-2-1",
      "claim": "The quotient limit exists while the derivative-quotient limit does not, so the converse fails. [step 1.1, step 1.2, L2] ∎",
      "step": "2.1",
      "inputs": [
        "step 1.1",
        "step 1.2",
  ...
  "boundaries": [
    {
      ...
      "reason": "cex-lhopital-converse concerns stipulated functions and points; no empty family, empty sum, or empty choice domain changes its assertion."
    },
    {
      "case": "zero",
      "status": "checked",
    ...
    },
    {
      "case": "one",
      "status": "not_applicable",
      "reason": "cex-lhopital-converse has no counting, exponent, or unit parameter whose one case changes the proof."
    },
    {
      "case": "degenerate",
      "status": "not_applicable",
      "reason": "cex-lhopital-converse has no interval-length or denominator parameter that may collapse degenerately."
    },
    {
      "case": "endpoints",
      "status": "not_applicable",
      "reason": "cex-lhopital-converse contains no interval-endpoint assertion requiring a separate endpoint case."
    },
    {
    ...
    },
    {
      "case": "iff-forward",
      "status": "not_applicable",
      "reason": "The Statement of cex-lhopital-converse is not a biconditional, so it has no forward iff direction."
    },
    {
      "case": "iff-reverse",
      "status": "not_applicable",
      "reason": "The Statement of cex-lhopital-converse is not a biconditional, so it has no reverse iff direction."
    }
  ],
  "finite_smoke": [],
  "risk_review": {
...
[
  {
    "id": "cex-lhopital-converse",
    "file": "items/cex-lhopital-converse.md",
    "source": "provenance",
    "cone_size": 0,
    "logical_consumers": [],
