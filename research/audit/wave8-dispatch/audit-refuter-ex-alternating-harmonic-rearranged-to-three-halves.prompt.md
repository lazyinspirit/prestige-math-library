...
- critical risk (15): 18 declared dependencies; 18 cited facts; 12 numbered proof steps; existence, choice, uniqueness, or well-definedness; boundary-sensitive language; induction, recursion, or minimality; analytic limiting/completeness language

## Target item — `ex-alternating-harmonic-rearranged-to-three-halves`

Normalized current SHA-256: `353e57de03cea4b9c7db476d5cdadb73b21108db3c4680bc16b4d735cd752291`
  ...
  "boundaries": [
    {
      "case": "empty",
      "status": "checked",
      "evidence": "Statement and step 1.2 account for the empty-index case."
    },
    {
      "case": "zero",
      "status": "checked",
    ...
    },
    {
      "case": "endpoints",
      "status": "checked",
      "evidence": "Statement and step 9.1 retain the threshold endpoints."
    },
    {
...
[
  {
    "source": "ex-alternating-harmonic-rearranged-to-three-halves",
