...
- critical risk (13): 15 declared dependencies; 15 cited facts; 9 numbered proof steps; biconditional / both-direction claim; boundary-sensitive language; analytic limiting/completeness language

## Target item — `fs-convergent-implies-absolutely-convergent`

Normalized current SHA-256: `14c4f5b11981d05963e7b0677a00678313b35a582f23ea8b1e2a2b2d3cb96b52`
...
```json
{
  "citations": [
    ...
    },
    {
      ...
      "source_section": "Statement",
      "quote": "([[lem-of-naturals-positive]]), and write $k^{p} := \\iota(k)^{p}$ for its rational",
      "uses": [
        "3.2",
        "4.1"
      ]
    ...
    },
    {
      ...
      "source_section": "Definition",
      "quote": "the set $\\mathbb{R}$, the starting element $1$ and the function",
      "uses": [
        "3.2",
        "4.1"
      ]
...
[
  {
    "source": "fs-convergent-implies-absolutely-convergent",
