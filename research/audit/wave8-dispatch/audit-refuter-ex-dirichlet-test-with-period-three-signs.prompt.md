...
- critical risk (15): 21 declared dependencies; 22 cited facts; 9 numbered proof steps; biconditional / both-direction claim; boundary-sensitive language; induction, recursion, or minimality; analytic limiting/completeness language
...
## Target item — `ex-dirichlet-test-with-period-three-signs`

Normalized current SHA-256: `6d1cb54e7a8dc516580b1cfb22cfc208d5b3b29071f0aaba5f6d5bee2defb2a0`
...
```json
{
  "citations": [
    ...
    },
    {
      ...
      "source_section": "Statement",
      "quote": "says so before using it: a nonincreasing sequence is bounded below by each of its",
      "uses": [
        "4.1"
      ]
    },
    {
      ...
      "source_section": "Definition",
      "quote": "bounded below by its first term $x_0$, and a nonincreasing sequence is bounded",
      "uses": [
        "4.1"
      ]
    },
...
[
  {
    "source": "ex-dirichlet-test-with-period-three-signs",
...
[
  {
    "id": "ex-dirichlet-test-with-period-three-signs",
    "file": "items/ex-dirichlet-test-with-period-three-signs.md",
    "source": "provenance",
    "cone_size": 0,
    "logical_consumers": [],
