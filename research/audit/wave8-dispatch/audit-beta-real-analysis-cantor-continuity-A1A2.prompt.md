...
This assignment owns exactly the two A/B pairs in that manifest. It must read
all 67 scoped items, every proof step, every declared dependency target needed
to verify citation semantics, Remarks, and both A-page summaries. Perform real
reputable-literature searches for each provenance determination. Produce one
ledger row per scoped item, full strict contracts for all 58 proof-bearing
...
- `research/audit/wave8-real-analysis-cantor-continuity.provenance.jsonl`
- `research/audit/wave8-real-analysis-cantor-continuity.findings.md`
