...
Normalized current SHA-256: `b75c01ceeddc77713337678d82db7a98f0947a4e9bce0d7f16db436f07cff63c`
...
```json
{
  ...
  "urls": [
    "https://sites.math.rutgers.edu/~sussmann/exam-311-April-30-2018-answers.pdf"
  ],
  "rationale": "The Rutgers examination solutions give exactly f(x)=g(x)=x on the real line as uniformly continuous factors whose product x squared is not uniformly continuous. This live source supersedes the inaccessible Johns Hopkins Spring 2019 solutions URL.",
