...
## Target item — `cex-grouped-series-converges-original-diverges`

Normalized current SHA-256: `93a978ef7e0db0d5f0025cec43fd815e5795a6b4277dbcd9be32b28f2048681f`
...
```json
{
  "citations": [
    {
      "fact": "L1",
      "source": "fs-grouping-can-be-undone",
      "source_section": "Statement",
      "quote": "$0 + 0 + \\dots$ and converges to $0$; but $\\sum \\varepsilon_k$ diverges, its terms",
      "uses": [
        "1.3",
        "2.1"
      ]
    ...
    },
    {
      ...
      "source_section": "Statement",
      "quote": "Both are **strictly increasing**.",
      "uses": [
        "1.1",
        "1.2",
        "1.3",
    ...
    },
    {
      ...
      "source_section": "Definition",
      "quote": "- **increasing** (or *strictly increasing*) when $x_j < x_k$ for all $j < k$;",
      "uses": [
        "1.1",
        "1.2",
        "1.3",
    ...
    {
      "fact": "L4",
      "source": "thm-grouping-of-series",
      "source_section": "Statement",
      "quote": "Let $(a_k)$ be a sequence of reals whose series converges ([[def-series]]), with",
      "uses": [
        "1.1",
        "4.1"
      ]
...
[
  {
    "source": "cex-grouped-series-converges-original-diverges",
    "sourcePage": "absolute-convergence-and-rearrangement-examples",
    "batch": "wave8-real-analysis-absolute-convergence",
    "target": "fs-grouping-can-be-undone",
    "declared_target": "fs-grouping-can-be-undone",
  ...
  },
  {
    ...
    "sourcePage": "absolute-convergence-and-rearrangement-examples",
    "batch": "wave8-real-analysis-absolute-convergence",
    "target": "thm-grouping-of-series",
    "declared_target": "thm-grouping-of-series",
