...
```json
{
  ...
  "evidence": "trivial",
  "urls": [],
  "rationale": "The two exact interval families are bespoke elementary witnesses. Directly, each point lies in finitely many members of both families; every neighbourhood of 0 meets infinitely many intervals (1/(n+1),1/n), whereas bounded neighbourhoods meet only finitely many translates (n-1,n+1).",
