...
## Wave 10 target — `cex-differentiable-with-unbounded-derivative-is-not-lipschitz`

Selection: mandatory Wave 10 high/critical proof-bearing route (risk report classifies all 49 contracts critical).

Normalized current SHA-256: `0766c3134a980d2dbde5883e1303b0fc510f87b1395a56af7557fee8c9b8c8f8`
...
```json
{
  ...
  "urls": [
    ...
    "https://www.mate.unlp.edu.ar/practicas/51_5_0505202117553.pdf"
  ],
  "rationale": "Hunter supports the bounded-derivative implication. The UNLP exercise sheet explicitly gives the square-root function as non-Lipschitz on $(0,1)$; the item harmlessly extends the domain to $(0,1]$ and proves the unbounded-derivative and Lipschitz-contradiction details locally.",
...
[
  {
    "source": "cex-differentiable-with-unbounded-derivative-is-not-lipschitz",
...
## Complete current text of every declared or cited item (27)
