## Wave 10 target — `cex-mean-value-theorem-fails-without-continuity-at-the-endpoints`

Selection: mandatory Wave 10 high/critical proof-bearing route (risk report classifies all 49 contracts critical).

Normalized current SHA-256: `fc236788ec8b351791cb94153d3dd046b60c578d84829d8d973564a44306355a`
...
```json
{
  ...
  "rationale": "The source identifies endpoint continuity as part of the mean value theorem. The item supplies a simple endpoint-modified affine witness and computes why no mean-value point exists.",
...
```json
{
  ...
  "derivations": [
    {
      "id": "cex-mean-value-theorem-fails-without-continuity-at-the-endpoints-step-1-1",
      "claim": "By [L1] the function $f$ is differentiable at every $c \\in (0,1)$ with $f'(c) = 1$, satisfies $f(0) = f(1) = 0$, and admits no $c \\in (0,1)$ with $f(1)-f(0) = f'(c)(1-0)$. So the refuted claim fails at $a := 0$, $b := 1$. [L1]",
      "step": "1.1",
      "inputs": [
        "L1"
      ]
    ...
    {
      "id": "cex-mean-value-theorem-fails-without-continuity-at-the-endpoints-step-1-2",
      "claim": "The point $1$ is a limit point of $[0,1]$ and of $[0,1] \\cap (-\\infty,1) = [0,1)$: for every real $\\varepsilon > 0$ the point $y := \\max\\{1-\\varepsilon/2,\\ 1/2\\}$ satisfies $1/2 \\le y < 1$, hence $y \\in [0,1)$, and $0 < |y - 1| \\le \\varepsilon/2 < \\varepsilon$. [L2, L3]",
      "step": "1.2",
      "inputs": [
        "L2",
        "L3"
    ...
    {
      "id": "cex-mean-value-theorem-fails-without-continuity-at-the-endpoints-step-2-1",
      "claim": "$\\lim_{x \\to 1} f(x) = 1$, the limit taken over the domain $[0,1]$. Given a real $\\varepsilon > 0$, take $\\delta := \\varepsilon$; every $x \\in [0,1]$ with $0 < |x - 1| < \\delta$ has $x \\ne 1$ by [L3], hence $x \\in [0,1)$ and $f(x) = x$, so $|f(x) - 1| = |x-1| < \\varepsilon$. Since the same quantifier ranges over the same points when the domain is cut down to $[0,1)$, this also says $\\lim_{x \\to 1^{-}} f(x) = 1$ by [L2]. The right limit at $1$ is not defined, since $[0,1] \\cap (1,\\infty)$ is empty and $1$ is therefore not a limit point of it. [step 1.2, L2, L3]",
      "step": "2.1",
      "inputs": [
        "L3",
        "L2",
    ...
    {
      "id": "cex-mean-value-theorem-fails-without-continuity-at-the-endpoints-step-3-1",
      "claim": "$f$ is not continuous at $1$. By step 1.2 the point $1$ is a limit point of $[0,1]$, so [L4] makes continuity there equivalent to $\\lim_{x \\to 1} f(x) = f(1)$; by step 2.1 the left side is $1$ and by [L1] the right side is $0$, and $0 \\ne 1$ by [L7]. So exactly one hypothesis of [L5] fails, at exactly one point, and it is the deleted one. [step 2.1, L1, L4, L5, L7]",
      "step": "3.1",
      "inputs": [
        "1.2",
        "L4",
    ...
    {
      "id": "cex-mean-value-theorem-fails-without-continuity-at-the-endpoints-step-4-1",
      "claim": "**The repair.** The identity $h$ agrees with $f$ at every point of $[0,1]$ except $1$, where $h(1) = 1$ and $f(1) = 0$. By [L6] the function $h$ is continuous on $[0,1]$ and differentiable at every point of $(0,1)$ with $h'(c) = 1$, so [L5] applies to $h$; and indeed $h(1) - h(0) = 1 = 1 \\cdot (1-0) = h'(c)(1-0)$ for **every** $c \\in (0,1)$. So moving the single value $f(1)$ back to $1$ turns a function with no admissible $c$ into one for which every $c$ is admissible. [step 1.1, step 3.1, L5, L6]",
      "step": "4.1",
      "inputs": [
        "L6",
        "L5",
    ...
    {
      "id": "cex-mean-value-theorem-fails-without-continuity-at-the-endpoints-step-5-1",
      "claim": "The same witness refutes the corresponding weakening of Rolle's theorem: $f(0) = f(1) = 0$ by step 1.1, and yet $f'(c) = 1 \\ne 0$ at every $c \\in (0,1)$ by step 1.1 and [L7]. So neither theorem in [L5] survives the deletion of continuity on the closed interval. [step 1.1, step 4.1, L5, L7] ∎",
      "step": "5.1",
      "inputs": [
        "1.1",
        "L7",
...
[
  {
    "source": "cex-mean-value-theorem-fails-without-continuity-at-the-endpoints",
    "sourcePage": "the-derivative-and-mean-value-theorems-examples",
    "batch": "wave10-real-analysis",
    "target": "fs-mean-value-theorem-needs-no-continuity-at-the-endpoints",
    "declared_target": "fs-mean-value-theorem-needs-no-continuity-at-the-endpoints",
