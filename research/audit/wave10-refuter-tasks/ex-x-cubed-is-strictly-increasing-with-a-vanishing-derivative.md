## Wave 10 target — `ex-x-cubed-is-strictly-increasing-with-a-vanishing-derivative`

Selection: mandatory Wave 10 high/critical proof-bearing route (risk report classifies all 49 contracts critical).

Normalized current SHA-256: `067c1fbdb0531ff46a054fd8af5233af8150401b043770d5d131834ce7281f68`
...
```json
{
  ...
  "rationale": "The sources give x cubed as strictly increasing while its derivative vanishes at zero. The item verifies both properties using the library’s power and monotonicity results.",
...
```json
{
  ...
  "derivations": [
    {
      "id": "ex-x-cubed-is-strictly-increasing-with-a-vanishing-derivative-step-1-1",
      "claim": "**Claims 1 and 2.** By [L1] the function $f$ is differentiable at every $c \\in \\mathbb{R}$ with $f'(c) = \\iota(3)c^{2}$, its derivative at $0$ is $0$, and $f$ is increasing on $\\mathbb{R}$. [L1]",
      "step": "1.1",
      "inputs": [
        "L1"
      ]
    ...
    {
      "id": "ex-x-cubed-is-strictly-increasing-with-a-vanishing-derivative-step-2-1",
      "claim": "$f$ is injective by [L2], being increasing; it is continuous on $\\mathbb{R}$ by [L3]; and $\\mathbb{R}$ is order-convex with at least two elements by [L4]. So $f$ satisfies every hypothesis of [L5] with $I := \\mathbb{R}$. [step 1.1, L2, L3, L4, L5]",
      "step": "2.1",
      "inputs": [
        "L2",
        "L3",
    ...
    {
      "id": "ex-x-cubed-is-strictly-increasing-with-a-vanishing-derivative-step-2-2",
      "claim": "**Claim 3.** The hypothesis of claim 2 of [L6] fails for $f$ on $\\mathbb{R}$, since $f'(0) = 0$ is not positive, and yet the conclusion holds, $f$ being increasing on $\\mathbb{R}$ by step 1.1. So that hypothesis is sufficient and not necessary. Likewise the conclusion $f' \\ge 0$ of claim 5 of [L6] is attained with equality at $0$ by step 1.1, so it cannot be strengthened to $f' > 0$. [step 1.1, L6]",
      "step": "2.2",
      "inputs": [
        "L6",
        "1.1"
    ...
    {
      "id": "ex-x-cubed-is-strictly-increasing-with-a-vanishing-derivative-step-3-1",
      "claim": "**Claim 4.** By step 2.1 the hypotheses of [L5] hold, and by step 1.1 the function $f$ is differentiable at $0$ with $f'(0) = 0$. So [L5] gives that the inverse $g : f[\\mathbb{R}] \\to \\mathbb{R}$ is not differentiable at $f(0)$, which is $0$ by [L7]. [step 1.1, step 2.1, L5, L7]",
      "step": "3.1",
      "inputs": [
        "2.1",
        "L5",
    ...
    {
      "id": "ex-x-cubed-is-strictly-increasing-with-a-vanishing-derivative-step-4-1",
      "claim": "All four claims are verified: claims 1 and 2 by step 1.1, claim 3 by step 2.2 and claim 4 by step 3.1. [step 1.1, step 2.2, step 3.1] ∎",
      "step": "4.1",
      "inputs": [
        "1.1",
        "2.2",
...
[
  {
    "source": "ex-x-cubed-is-strictly-increasing-with-a-vanishing-derivative",
    "sourcePage": "the-derivative-and-mean-value-theorems-examples",
    "batch": "wave10-real-analysis",
    "target": "fs-vanishing-derivative-forbids-strict-increase",
    "declared_target": "fs-vanishing-derivative-forbids-strict-increase",
