...
## Target item — `def-multidimensional-grid-partition`

Normalized current SHA-256: `6f17d4edda45456596d4bb6c32e507d16e471d6d3ca9dbce2648ebdee6fdc912`
...
```json
{
  ...
  "rationale": "The source defines partitions of rectangles into coordinate cells. The item packages coordinatewise grids, cell indexing, mesh, refinement, and exact volume splitting in repository notation.",
