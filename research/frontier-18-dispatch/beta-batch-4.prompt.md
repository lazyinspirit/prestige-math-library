<!-- Dispatched as-is. `frontier-18` and `4` are substituted by tools/dispatch.mjs
...
# Scaffolding brief — run `frontier-18`, batch `4` (steps 1 and 2)
...
You are **Beta-4**, running **Claude Opus 5 via the claude CLI
...
`research/frontier-18-batch-4.notes.md`: current substage, owned artifact paths,
...
```
node tools/source-fetch-check.mjs --coverage research/frontier-18-batch-4.coverage.json --stamp
```
...
- `research/frontier-18-batch-4.pages.json` — your batch's page objects in final
...
- `research/frontier-18-batch-4.notes.md` — prose-scaffold amendments as precise
  ...
  route, and necessity.
- `research/frontier-18-batch-4.proof-contracts.json` — the version-1
...
# Batch 4 of run `frontier-18` — Noetherian Rings and Hilbert Basis

1 A/B pair, commutative-algebra. You own every page here and you author them all at step 5.

## `noetherian-rings-and-hilbert-basis`

| | |
|---|---|
| A page | `noetherian-rings-and-hilbert-basis` · order **111.001** · `commutative-algebra` |
| B page | `noetherian-rings-and-hilbert-basis-examples` |
| title | Noetherian Rings and Hilbert Basis |
| requires | `modules-over-a-pid-and-canonical-forms-examples` |
| design | `plan-commutative-algebra-track.md` L3086 |
