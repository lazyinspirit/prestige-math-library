<!-- Dispatched as-is. `frontier-18` and `1` are substituted by tools/dispatch.mjs
...
# Scaffolding brief — run `frontier-18`, batch `1` (steps 1 and 2)
...
`research/frontier-18-batch-1.notes.md`: current substage, owned artifact paths,
...
- `research/frontier-18-batch-1.pages.json` — your batch's page objects in final
...
- `research/frontier-18-batch-1.notes.md` — prose-scaffold amendments as precise
  ...
  route, and necessity.
- `research/frontier-18-batch-1.proof-contracts.json` — the version-1
...
# Batch 1 of run `frontier-18` — Lagrange Four Square Theorem
...
| | |
|---|---|
| A page | `lagrange-four-square-theorem` · order **57.009** · `number-theory` |
| B page | `lagrange-four-square-theorem-examples` |
| title | Lagrange Four Square Theorem |
| requires | `sums-of-two-squares-examples` |
| design | `plan-number-theory-track.md` L580 (id mention, not a heading — locate the section yourself) |
