...
run: frontier-18
role: alpha
label: rejudge-contract-review-1

# Contract-detector adjudication, run `frontier-18`
...
`research/frontier-18-batch-<i>.proof-contracts.json` entry. Then re-merge and
...
why. Write `research/frontier-18-alpha-contract-audit.md`: per candidate, the
