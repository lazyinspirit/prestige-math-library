...
update `research/frontier-18-batch-5.proof-contracts.json` whenever you change
...
`research/frontier-18-reader-5.md`, every change and every finding in it.
...
`research/frontier-18-reader-5.md`. Per finding: item id, exact location, what is
...
label: reader-5
covers: 5
output: research/frontier-18-reader-5.md

# Step 6a — independent read of batch `5` of run `frontier-18`
...
**Write your report to:** `research/frontier-18-reader-5.md`

Both `5` and `research/frontier-18-reader-5.md` are substituted by the dispatcher from values the
