<!-- Dispatched as-is. `frontier-18` and `6` are substituted by tools/dispatch.mjs
...
# Scaffolding brief — run `frontier-18`, batch `6` (steps 1 and 2)
...
`research/frontier-18-batch-6.notes.md`: current substage, owned artifact paths,
...
```
node tools/source-fetch-check.mjs --coverage research/frontier-18-batch-6.coverage.json --stamp
```
...
- `research/frontier-18-batch-6.pages.json` — your batch's page objects in final
...
- `research/frontier-18-batch-6.notes.md` — prose-scaffold amendments as precise
  ...
  route, and necessity.
- `research/frontier-18-batch-6.proof-contracts.json` — the version-1
...
# Batch 6 of run `frontier-18` — The Divergence Theorem and Classical Stokes
...
| | |
|---|---|
| A page | `the-divergence-theorem-and-classical-stokes` · order **288.00017** · `real-analysis` |
| B page | `the-divergence-theorem-and-classical-stokes-examples` |
| title | The Divergence Theorem and Classical Stokes |
| requires | `regular-surfaces-and-surface-integrals` |
| design | `plan-realanalysis-completion-track.md` L487 |
