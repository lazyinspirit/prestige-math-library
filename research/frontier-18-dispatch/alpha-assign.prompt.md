...
label: assign
covers: all
output: research/frontier-18-alpha-groups.json

# Assign batches to group Alphas — run `frontier-18`
...
`research/frontier-18-alpha-groups.json` and stop.
...
```
node tools/alpha-groups.mjs --run frontier-18 --facts
```
...
`research/frontier-18-alpha-groups.json`:
...
```
node tools/alpha-groups.mjs --run frontier-18
```
