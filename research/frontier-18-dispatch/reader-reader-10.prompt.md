# Independent reader brief — run `frontier-18`, step 6a
...
update `research/frontier-18-batch-10.proof-contracts.json` whenever you change
...
`research/frontier-18-reader-10.md`, every change and every finding in it.
...
`research/frontier-18-reader-10.md`. Per finding: item id, exact location, what is
...
label: reader-10
covers: 10
output: research/frontier-18-reader-10.md

# Step 6a — independent read of batch `10` of run `frontier-18`
...
`research/frontier-18-batch-10.pages.json`.

**Write your report to:** `research/frontier-18-reader-10.md`

Both `10` and `research/frontier-18-reader-10.md` are substituted by the dispatcher from values the
...
Findings numbered `R10-1`, `R10-2`, … and **stable**: a later pass refers to
