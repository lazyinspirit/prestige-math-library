...
update `research/frontier-18-batch-2.proof-contracts.json` whenever you change
...
`research/frontier-18-reader-2.md`, every change and every finding in it.
...
`research/frontier-18-reader-2.md`. Per finding: item id, exact location, what is
...
label: reader-2
covers: 2
output: research/frontier-18-reader-2.md

# Step 6a — independent read of batch `2` of run `frontier-18`
...
**Write your report to:** `research/frontier-18-reader-2.md`

Both `2` and `research/frontier-18-reader-2.md` are substituted by the dispatcher from values the
