<!-- Dispatched as-is. `frontier-18` and `10` are substituted by tools/dispatch.mjs
...
# Scaffolding brief — run `frontier-18`, batch `10` (steps 1 and 2)
...
You are **Beta-10**, running **Claude Opus 5 via the claude CLI
...
`research/frontier-18-batch-10.notes.md`: current substage, owned artifact paths,
...
```
node tools/source-fetch-check.mjs --coverage research/frontier-18-batch-10.coverage.json --stamp
```
...
```
node tools/coverage-checklist.mjs research/frontier-18-batch-10.coverage.json
```
...
- `research/frontier-18-batch-10.pages.json` — your batch's page objects in final
...
- `research/frontier-18-batch-10.notes.md` — prose-scaffold amendments as precise
  ...
  route, and necessity.
- `research/frontier-18-batch-10.proof-contracts.json` — the version-1
...
# Batch 10 of run `frontier-18` — Modules, Substitution and Prime Graphs · Sparse Restricted Subgraphs and the Rödl–Nikiforov Theorems
...
| | |
|---|---|
| A page | `modules-substitution-and-prime-graphs` · order **397** · `combinatorics` |
| B page | `modules-substitution-and-prime-graphs-examples` |
| title | Modules, Substitution and Prime Graphs |
| requires | `erdos-hajnal-property-and-homogeneous-sets` |
| design | `plan-combinatorics-and-categories.md` L3898 (id mention, not a heading — locate the section yourself) |
...
| | |
|---|---|
| A page | `sparse-restricted-subgraphs-and-rodl-nikiforov` · order **401** · `combinatorics` |
| B page | `sparse-restricted-subgraphs-and-rodl-nikiforov-examples` |
| title | Sparse Restricted Subgraphs and the Rödl–Nikiforov Theorems |
| requires | `regular-pairs-and-induced-counting` |
| design | `plan-combinatorics-and-categories.md` L3900 (id mention, not a heading — locate the section yourself) |
