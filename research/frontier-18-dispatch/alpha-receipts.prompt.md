...
label: receipts
covers: all
output: research/frontier-18-audit-coverage.json

# The whole-level receipts, run `frontier-18`
...
```
node tools/level-coverage.mjs --template research/frontier-18-audit-coverage.json \
  --contracts research/frontier-18-proof-contracts.json \
  --judge-ledger research/frontier-18-judge.jsonl \
  research/frontier-18-batch-*.pages.json
```
...
node tools/level-coverage.mjs \
  --contracts research/frontier-18-proof-contracts.json \
  --judge-ledger research/frontier-18-judge.jsonl \
  --judge-adjudications research/frontier-18-judge-adjudications.jsonl \
  --spine-receipt research/frontier-18-spine-audit.json \
  --audit-receipt research/frontier-18-audit-coverage.json \
  --verify-current-context research/frontier-18-batch-*.pages.json
```
