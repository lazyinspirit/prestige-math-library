...
update `research/frontier-18-batch-9.proof-contracts.json` whenever you change
...
`research/frontier-18-reader-9.md`, every change and every finding in it.
...
`research/frontier-18-reader-9.md`. Per finding: item id, exact location, what is
...
label: reader-9
covers: 9
output: research/frontier-18-reader-9.md

# Step 6a — independent read of batch `9` of run `frontier-18`
...
**Write your report to:** `research/frontier-18-reader-9.md`

Both `9` and `research/frontier-18-reader-9.md` are substituted by the dispatcher from values the
...
Findings numbered `R9-1`, `R9-2`, … and **stable**: a later pass refers to
