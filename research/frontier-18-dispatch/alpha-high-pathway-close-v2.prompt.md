...
covers: all
output: research/frontier-18-pathway-closure.json

# Step 10 pathway closure — run `frontier-18`

Read `research/frontier-18-pathway.json` and
`research/frontier-18-pathway-closure.json`. For every pending row, read the full
...
```
node tools/pathway-closure.mjs check --run frontier-18
