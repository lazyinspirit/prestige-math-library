...
update `research/frontier-18-batch-1.proof-contracts.json` whenever you change
...
`research/frontier-18-reader-1.md`, every change and every finding in it.
...
`research/frontier-18-reader-1.md`. Per finding: item id, exact location, what is
...
label: reader-1
covers: 1
output: research/frontier-18-reader-1.md

# Step 6a — independent read of batch `1` of run `frontier-18`
...
**Write your report to:** `research/frontier-18-reader-1.md`

Both `1` and `research/frontier-18-reader-1.md` are substituted by the dispatcher from values the
