...
# Authoring brief — run `frontier-18`, batch `6` (step 5)
...
- update only your own `research/frontier-18-batch-6.proof-contracts.json` so it
...
- keep your own `research/frontier-18-batch-6.coverage.json` **true of what you
...
research/frontier-18-batch-6.proof-contracts.json --strict` before reporting.
...
# Batch `6` of run `frontier-18` — step 5, authoring
...
- `research/frontier-18-batch-6.pages.json` — the spliced scaffold
- `research/frontier-18-batch-6.notes.md` — your source ledger and rationales
- `research/frontier-18-batch-6.coverage.json` — the harvest
- `research/frontier-18-batch-6.proof-contracts.json` — extend it as you author
- group Alpha's step-3 review and re-check, for the findings you resolved
- `research/frontier-18-beta-6.task.md` — your batch's pages and design section;
...
Append `## Step-5 authoring` to `research/frontier-18-batch-6.notes.md`: items
