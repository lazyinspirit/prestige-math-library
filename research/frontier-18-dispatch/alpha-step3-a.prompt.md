...
> `research/frontier-18-alpha-<your-group>-…` paths for your own group label.
...
**Write:** `research/frontier-18-alpha-<your-group>-step3-scaffold-review.md`,
findings numbered `B<batch>-1, B<batch>-2, …`, stable ids, a severity table,
and per-pair verdicts. **And** the machine half:
`research/frontier-18-alpha-<your-group>-step3-verdicts.json`, which is the only
