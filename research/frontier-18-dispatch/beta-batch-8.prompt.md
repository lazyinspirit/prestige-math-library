<!-- Dispatched as-is. `frontier-18` and `8` are substituted by tools/dispatch.mjs
...
# Scaffolding brief — run `frontier-18`, batch `8` (steps 1 and 2)
...
You are **Beta-8**, running **Claude Opus 5 via the claude CLI
at `xhigh` reasoning with a 1,000,000-token context window** (owner, 2026-08-23),
scaffolding run `frontier-18` of the public math library, whose checkout is the
...
`research/frontier-18-batch-8.notes.md`: current substage, owned artifact paths,
...
```
node tools/source-fetch-check.mjs --coverage research/frontier-18-batch-8.coverage.json --stamp
```
...
```
node tools/coverage-checklist.mjs research/frontier-18-batch-8.coverage.json
```
...
- `research/frontier-18-batch-8.pages.json` — your batch's page objects in final
...
- `research/frontier-18-batch-8.notes.md` — prose-scaffold amendments as precise
  ...
  route, and necessity.
- `research/frontier-18-batch-8.proof-contracts.json` — the version-1
...
6. **Cross-batch dependencies** — anything your batch needs from the other
   batch of run `frontier-18`, or that you believe the other batch will need from you.
...
# Batch 8 of run `frontier-18` — The Winding Number and the Global Cauchy Theorem · Holomorphic Functions of Several Complex Variables

2 A/B pairs, complex-analysis. You own every page here and you author them all at step 5.

## `the-winding-number-and-the-global-cauchy-theorem`

| | |
|---|---|
| A page | `the-winding-number-and-the-global-cauchy-theorem` · order **315** · `complex-analysis` |
| B page | `the-winding-number-and-the-global-cauchy-theorem-examples` |
| title | The Winding Number and the Global Cauchy Theorem |
| requires | `the-identity-theorem-and-the-open-mapping-theorem`, `the-topology-of-euclidean-space` |
| design | `plan-complex-analysis-track.md` L1304 |
...
| | |
|---|---|
| A page | `holomorphic-functions-of-several-variables` · order **349** · `complex-analysis` |
| B page | `holomorphic-functions-of-several-variables-examples` |
| title | Holomorphic Functions of Several Complex Variables |
| requires | `the-identity-theorem-and-the-open-mapping-theorem`, `goursat-and-cauchys-theorem-in-a-convex-domain`, `the-total-derivative`, `fubini-and-change-of-variables`, `rn-as-a-normed-space` |
| design | `plan-complex-analysis-track.md` L3115 |
