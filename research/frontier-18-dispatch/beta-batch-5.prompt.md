<!-- Dispatched as-is. `frontier-18` and `5` are substituted by tools/dispatch.mjs
...
# Scaffolding brief — run `frontier-18`, batch `5` (steps 1 and 2)
...
`research/frontier-18-batch-5.notes.md`: current substage, owned artifact paths,
...
- `research/frontier-18-batch-5.pages.json` — your batch's page objects in final
...
- `research/frontier-18-batch-5.notes.md` — prose-scaffold amendments as precise
  ...
  route, and necessity.
- `research/frontier-18-batch-5.proof-contracts.json` — the version-1
...
# Batch 5 of run `frontier-18` — Lattice Paths and Catalan Numbers · Linear Algebra Methods in Combinatorics
...
| | |
|---|---|
| A page | `lattice-paths-and-catalan-numbers` · order **197** · `combinatorics` |
| B page | `lattice-paths-and-catalan-numbers-examples` |
| title | Lattice Paths and Catalan Numbers |
| requires | `linear-recurrences-and-rational-generating-functions`, `formal-power-series` |
| design | `plan-combinatorics-and-categories.md` L1552 |
...
| | |
|---|---|
| A page | `linear-algebra-methods-in-combinatorics` · order **223** · `combinatorics` |
| B page | `linear-algebra-methods-in-combinatorics-examples` |
| title | Linear Algebra Methods in Combinatorics |
| requires | `finite-probability-and-the-probabilistic-method`, `inner-product-spaces-and-orthogonality`, `gaussian-elimination-and-row-reduction`, `polynomial-rings-and-roots` |
| design | `plan-combinatorics-and-categories.md` L2265 |
