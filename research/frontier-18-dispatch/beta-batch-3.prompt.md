<!-- Dispatched as-is. `frontier-18` and `3` are substituted by tools/dispatch.mjs
...
# Scaffolding brief — run `frontier-18`, batch `3` (steps 1 and 2)
...
`research/frontier-18-batch-3.notes.md`: current substage, owned artifact paths,
...
- `research/frontier-18-batch-3.pages.json` — your batch's page objects in final
...
- `research/frontier-18-batch-3.notes.md` — prose-scaffold amendments as precise
  ...
  route, and necessity.
- `research/frontier-18-batch-3.proof-contracts.json` — the version-1
...
# Batch 3 of run `frontier-18` — Finite Fields and Cyclotomic Extensions
...
| | |
|---|---|
| A page | `finite-fields-and-cyclotomic-extensions` · order **101.2** · `abstract-algebra` |
...
| design | `plan-algebra-track.md` L32 (id mention, not a heading — locate the section yourself) |
