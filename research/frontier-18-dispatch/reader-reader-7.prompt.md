...
update `research/frontier-18-batch-7.proof-contracts.json` whenever you change
...
`research/frontier-18-reader-7.md`, every change and every finding in it.
...
`research/frontier-18-reader-7.md`. Per finding: item id, exact location, what is
...
label: reader-7
covers: 7
output: research/frontier-18-reader-7.md

# Step 6a — independent read of batch `7` of run `frontier-18`
...
**Write your report to:** `research/frontier-18-reader-7.md`

Both `7` and `research/frontier-18-reader-7.md` are substituted by the dispatcher from values the
