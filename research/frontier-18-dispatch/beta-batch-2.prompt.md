<!-- Dispatched as-is. `frontier-18` and `2` are substituted by tools/dispatch.mjs
...
# Scaffolding brief — run `frontier-18`, batch `2` (steps 1 and 2)
...
You are **Beta-2**, running **Claude Opus 5 via the claude CLI
...
`research/frontier-18-batch-2.notes.md`: current substage, owned artifact paths,
...
```
node tools/coverage-checklist.mjs research/frontier-18-batch-2.coverage.json
```
...
- `research/frontier-18-batch-2.pages.json` — your batch's page objects in final
...
- `research/frontier-18-batch-2.notes.md` — prose-scaffold amendments as precise
  ...
  route, and necessity.
- `research/frontier-18-batch-2.proof-contracts.json` — the version-1
...
# Batch 2 of run `frontier-18` — Extraspecial P Groups and Central Products · Cayley Graphs Word Metrics and Quasi Isometry
...
| | |
|---|---|
| A page | `extraspecial-p-groups-and-central-products` · order **71.003** · `group-theory` |
| B page | `extraspecial-p-groups-and-central-products-examples` |
| title | Extraspecial P Groups and Central Products |
| requires | `frattini-subgroups-and-the-burnside-basis-theorem-examples` |
| design | `plan-group-theory-track.md` L571<br>`plan-group-theory-track.md` L643 |
...
| | |
|---|---|
| A page | `cayley-graphs-word-metrics-and-quasi-isometry` · order **302.001** · `group-theory` |
...
| design | `plan-group-theory-track.md` L1449<br>`plan-group-theory-track.md` L1517 |
