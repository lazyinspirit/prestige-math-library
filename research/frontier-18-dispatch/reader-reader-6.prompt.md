...
update `research/frontier-18-batch-6.proof-contracts.json` whenever you change
...
`research/frontier-18-reader-6.md`, every change and every finding in it.
...
`research/frontier-18-reader-6.md`. Per finding: item id, exact location, what is
...
label: reader-6
covers: 6
output: research/frontier-18-reader-6.md

# Step 6a — independent read of batch `6` of run `frontier-18`
...
**Write your report to:** `research/frontier-18-reader-6.md`

Both `6` and `research/frontier-18-reader-6.md` are substituted by the dispatcher from values the
