...
# Batch `10` of run `frontier-18` — step-3 fix pass

The group Alpha that reviewed your batch returned numbered findings. **Find
which Alpha reviewed you**: check each
`research/frontier-18-alpha-<group>-step3-scaffold-review.md` for your batch
...
5. Append `## Step-3 fix pass` to `research/frontier-18-batch-10.notes.md`, one
