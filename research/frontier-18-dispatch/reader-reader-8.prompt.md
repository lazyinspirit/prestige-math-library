...
update `research/frontier-18-batch-8.proof-contracts.json` whenever you change
...
`research/frontier-18-reader-8.md`, every change and every finding in it.
...
`research/frontier-18-reader-8.md`. Per finding: item id, exact location, what is
...
label: reader-8
covers: 8
output: research/frontier-18-reader-8.md

# Step 6a — independent read of batch `8` of run `frontier-18`
...
**Write your report to:** `research/frontier-18-reader-8.md`

Both `8` and `research/frontier-18-reader-8.md` are substituted by the dispatcher from values the
