# Contract-detector adjudication — `frontier-34-fa-prereqs`
...
Merge the batch contracts into `research/frontier-34-fa-prereqs-proof-contracts.json` and
rerun the failed detector. Write `research/frontier-34-fa-prereqs-alpha-contract-audit.md`
