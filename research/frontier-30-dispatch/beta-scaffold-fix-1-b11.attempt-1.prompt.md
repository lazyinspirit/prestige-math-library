...
run: frontier-30
role: beta
label: scaffold-fix-1-b11
covers: 11

> The dispatch block supplies batch `11`.

# Post-recheck scaffold repair — batch `11`, `frontier-30`

Read `research/frontier-30-scaffold-closure.json` and take only `work[]` entries
whose pages belong to batch `11` in the scope ledger. Apply or push back on
