...
The task and `research/frontier-30-step6-scope-13.json` define `refuter_scope`.
...
label: refute-13
covers: 13
output: research/frontier-30-refute-13.json

# Step 6a — refuter

Read `research/frontier-30-step6-scope-13.json` and audit exactly its `refuter_scope`,
