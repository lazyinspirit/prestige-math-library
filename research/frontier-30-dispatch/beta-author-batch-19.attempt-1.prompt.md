...
covers: 19
output: research/frontier-30-batch-19.proof-contracts.json

> The dispatch block supplies batch `19`.

# Step 5 — author batch `19`, `frontier-30`

Use `research/frontier-30-batch-19.pages.json`, `.notes.md`, `.coverage.json`,
