...
The task and `research/frontier-30-step6-scope-16.json` define `refuter_scope`.
...
label: refute-16
covers: 16
output: research/frontier-30-refute-16.json

# Step 6a — refuter

Read `research/frontier-30-step6-scope-16.json` and audit exactly its `refuter_scope`,
