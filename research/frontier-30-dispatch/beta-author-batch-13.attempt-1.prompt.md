...
covers: 13
output: research/frontier-30-batch-13.proof-contracts.json

> The dispatch block supplies batch `13`.

# Step 5 — author batch `13`, `frontier-30`

Use `research/frontier-30-batch-13.pages.json`, `.notes.md`, `.coverage.json`,
