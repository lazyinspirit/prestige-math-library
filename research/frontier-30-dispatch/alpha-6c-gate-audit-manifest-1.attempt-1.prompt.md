...
run: frontier-30
role: alpha
label: 6c-gate-audit-manifest-1

# Step 6c repair — audit-manifest

This file is the authority for repair cycle 1.
Primary gate: `audit-manifest`
Reason: - [dependency; published-backward] thm-pairwise-independent-borel-cantelli-frequency-law (independence-borel-cantelli-and-zero-one-laws, frontier-30-batch-5) -> prop-indicator-function-is-measurable-iff-its-set-is-measurable (measurable-fun
...
- [dependency; published-backward] cor-covariance-vanishes-under-independence (independence-borel-cantelli-and-zero-one-laws, frontier-30-batch-5) -> def-moments-variance-and-covariance (probability-spaces-random-variables-and-expectation)
- [dependency; published-backward] cor-covariance-vanishes-under-independence (independence-borel-cantelli-and-zero-one-laws, frontier-30-batch-5) -> lem-variance-and-covariance-identities-for-random-variables (probability-spaces-random-variables-and-expectation)
- [dependency; published-backward] def-limsup-and-infinitely-often-event (independence-borel-cantelli-and-zero-one-laws, frontier-30-batch-5) -> def-set-limsup-and-liminf (sigma-algebras-and-borel-sets)
- [dependency; published-backward] cor-first-borel-cantelli-lemma-for-events (independence-borel-cantelli-and-zero-one-laws, frontier-30-batch-5) -> thm-first-borel-cantelli (measures-and-their-basic-properties)
- [dependency; published-backward] thm-pairwise-independent-borel-cantelli-frequency-law (independence-borel-cantelli-and-zero-one-laws, frontier-30-batch-5) -> prop-indicator-function-is-measurable-iff-its-set-is-measurable (measurable-functions-and-simple-approximation)
