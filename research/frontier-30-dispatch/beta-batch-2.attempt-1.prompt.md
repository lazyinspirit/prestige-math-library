...
# Batch 2 of run `frontier-30` — Zariski Topology on Prime Spectra
...
| | |
|---|---|
| A page | `zariski-topology-on-prime-spectra` · order **256.001** · `commutative-algebra` |
| B page | `zariski-topology-on-prime-spectra-examples` |
| title | Zariski Topology on Prime Spectra |
| requires | `henselian-rings-and-equicharacteristic-cohen-structure-examples`, `topological-spaces-and-continuity`, `compactness` |
| design | `plan-commutative-algebra-track.md` L1244<br>`plan-commutative-algebra-track.md` L3670 |
