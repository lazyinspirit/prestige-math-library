...
covers: 3
output: research/frontier-30-batch-3.proof-contracts.json

> The dispatch block supplies batch `3`.

# Step 5 — author batch `3`, `frontier-30`

Use `research/frontier-30-batch-3.pages.json`, `.notes.md`, `.coverage.json`,
