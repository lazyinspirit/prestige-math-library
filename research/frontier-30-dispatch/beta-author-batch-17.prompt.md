...
covers: 17
output: research/frontier-30-batch-17.proof-contracts.json

> The dispatch block supplies batch `17`.

# Step 5 — author batch `17`, `frontier-30`

Use `research/frontier-30-batch-17.pages.json`, `.notes.md`, `.coverage.json`,
