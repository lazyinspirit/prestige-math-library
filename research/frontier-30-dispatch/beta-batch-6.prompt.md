...
# Batch 6 of run `frontier-30` — Fejer and Poisson Summability of Fourier Series

1 A/B pair, fourier-analysis. You own every page here and you author them all at step 5.

## `fejer-and-poisson-summability-of-fourier-series`

| | |
|---|---|
| A page | `fejer-and-poisson-summability-of-fourier-series` · order **288.14006** · `fourier-analysis` |
| B page | `fejer-and-poisson-summability-of-fourier-series-examples` |
| title | Fejer and Poisson Summability of Fourier Series |
| requires | `dirichlet-kernel-localisation-and-pointwise-fourier-convergence-examples`, `the-maximal-function-and-lebesgue-differentiation` |
| design | `plan-fourier-analysis-track.md` L22 (id mention, not a heading — locate the section yourself)<br>`plan-realanalysis-completion-track.md` L719 (id mention, not a heading — locate the section yourself) |
