...
The task and `research/frontier-30-step6-scope-20.json` define `refuter_scope`.
...
label: refute-20
covers: 20
output: research/frontier-30-refute-20.json

# Step 6a — refuter

Read `research/frontier-30-step6-scope-20.json` and audit exactly its `refuter_scope`,
