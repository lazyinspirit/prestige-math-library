...
The task and `research/frontier-30-step6-scope-8.json` define `refuter_scope`.
...
label: refute-8
covers: 8
output: research/frontier-30-refute-8.json

# Step 6a — refuter

Read `research/frontier-30-step6-scope-8.json` and audit exactly its `refuter_scope`,
