...
# Step 4 — splice-refusal adjudication, `frontier-30`

Read `research/frontier-30-splice-refusals.json` and every reported undeclared
...
`research/frontier-30-alpha-step4.md` with each edge, evidence, disposition, edit,
