...
covers: 14
output: research/frontier-30-batch-14.proof-contracts.json

> The dispatch block supplies batch `14`.

# Step 5 — author batch `14`, `frontier-30`

Use `research/frontier-30-batch-14.pages.json`, `.notes.md`, `.coverage.json`,
