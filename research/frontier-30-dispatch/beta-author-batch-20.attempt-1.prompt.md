...
covers: 20
output: research/frontier-30-batch-20.proof-contracts.json

> The dispatch block supplies batch `20`.

# Step 5 — author batch `20`, `frontier-30`

Use `research/frontier-30-batch-20.pages.json`, `.notes.md`, `.coverage.json`,
