...
# Contract-detector adjudication — `frontier-30`
...
Merge the batch contracts into `research/frontier-30-proof-contracts.json` and
rerun the failed detector. Write `research/frontier-30-alpha-contract-audit.md`
