...
covers: 5
output: research/frontier-30-batch-5.proof-contracts.json

> The dispatch block supplies batch `5`.

# Step 5 — author batch `5`, `frontier-30`

Use `research/frontier-30-batch-5.pages.json`, `.notes.md`, `.coverage.json`,
