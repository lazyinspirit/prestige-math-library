...
covers: all
output: research/frontier-30-pathway-closure.json

# Step 10 — pathway closure, `frontier-30`

Read `research/frontier-30-pathway.json` and
`research/frontier-30-pathway-closure.json`. For every pending receipt row, rewrite
