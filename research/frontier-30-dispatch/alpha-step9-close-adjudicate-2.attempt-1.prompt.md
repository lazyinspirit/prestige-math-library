...
run: frontier-30
role: alpha
label: step9-close-adjudicate-2

# Step 9 — changed-mathematics adjudication, `frontier-30`

Act only on ids in `research/frontier-30-step9-changes.json`. Read their current
...
`research/frontier-30-alpha-step9-adjudicate.md` with every tuple, outcome,
