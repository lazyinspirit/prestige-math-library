...
# Batch 9 of run `frontier-30` — Enriched Categories
...
| | |
|---|---|
| A page | `enriched-categories` · order **365.033** · `category-theory` |
| B page | `enriched-categories-examples` |
| title | Enriched Categories |
| requires | `duality-and-rigidity-in-monoidal-categories-examples` |
| design | `plan-category-theory-track.md` L2858<br>`plan-category-theory-track.md` L2962<br>`plan-category-theory-track.md` L3849 |
