...
# Batch 12 of run `frontier-30` — Morphisms Local Rings and Rational Maps of Affine Varieties
...
| | |
|---|---|
| A page | `morphisms-local-rings-and-rational-maps-of-affine-varieties` · order **366.043** · `algebraic-geometry` |
| B page | `morphisms-local-rings-and-rational-maps-of-affine-varieties-examples` |
| title | Morphisms Local Rings and Rational Maps of Affine Varieties |
| requires | `affine-algebraic-sets-and-coordinate-rings-examples` |
| design | `plan-algebraic-geometry-track.md` L152 |
