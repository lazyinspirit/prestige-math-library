...
covers: 12
output: research/frontier-30-batch-12.proof-contracts.json

> The dispatch block supplies batch `12`.

# Step 5 — author batch `12`, `frontier-30`

Use `research/frontier-30-batch-12.pages.json`, `.notes.md`, `.coverage.json`,
