...
You are the group Alpha for batches **14**, **18**: 3 A/B pair(s), 6 page(s), 38 item(s), 19 open rejection(s) over 19 item(s).
...
|---|---|---|---|
| `def-property-star-for-a-finite-family` | `property-star-and-comb-outcomes` | gpt-5.6-terra | `b6bfa6c45799ea9d56247c4c384cebd875d50db875685b1db67a0a119ad8029d` |
| `ex-a-four-tooth-comb-with-a-special-vertex-triggers-property-star` | `property-star-and-comb-outcomes-examples` | gpt-5.6-terra | `e9d4c57532822be2c73f35162a2e4e5583f02f88daf96af5413c996dbccf5837` |
| `ex-generic-and-exceptional-height-directions-on-a-torus` | `morse-functions-critical-values-and-genericity-examples` | gpt-5.6-terra | `bad9276df0a022902425bfc0c3d54a28babca7e6de57f34d58c901affad3a0e8` |
| `ex-separating-equal-critical-values-by-bump-functions` | `morse-functions-critical-values-and-genericity-examples` | gpt-5.6-terra | `47e457569ea1084fd5cb8e934e12c7c8cf8a68cac70c90d7611ff6526c44493b` |
| `ex-the-epsilon-to-five-d-substitution-in-lemma-four-five-one` | `property-star-and-comb-outcomes-examples` | gpt-5.6-terra | `d0d8d78f089a6ae706c449312492f0cce0b7a3345dcaeee7f62350234f6a7d3f` |
| `ex-the-lemma-three-five-parameter-choice-on-a-large-graph` | `from-generalized-niceness-to-erdos-hajnal-examples` | gpt-5.6-terra | `e227491b0ab4f04a09560d54a19d695b86208cf1a5dda5c736d311795193f845` |
| `ex-the-square-root-rescaling-in-lemma-four-four` | `property-star-and-comb-outcomes-examples` | gpt-5.6-terra | `d8bbfdc6807f7c8dab476575e52653b586732946d0a4c57bec29c01cec51fbac` |
| `lem-a-large-y-ten-thirds-restricted-induced-subgraph-forces-a-y-eleven-thirds-restricted-induced-subgraph` | `property-star-and-comb-outcomes` | gpt-5.6-terra | `b52cc5cbcb694afb18e653e8ec19e84eec3234967077151b45e2cc6db6dcd6a5` |
| `lem-compact-morse-critical-points-have-uniform-hessian-gaps` | `morse-functions-critical-values-and-genericity` | gpt-5.6-terra | `c147f0a2159bb4f295469b2c1099dfb6aa5fdfc963eaeb761fbe5dbb5d082936` |
| `lem-constant-scale-restricted-property-star-yields-a-restricted-subgraph-a-polynomial-clique-or-stable-set-or-two-blockade-alternatives` | `property-star-and-comb-outcomes` | gpt-5.6-terra | `d00832d533ab2a0d77a337b1b8f4377216521f3e857fffb3af95e0ae8570ec7c` |
| `lem-finitely-many-critical-values-can-be-separated-locally` | `morse-functions-critical-values-and-genericity` | gpt-5.6-terra | `1c160f2fafb7d3a63ea902396d3565ee66b61a1753c8fb3e2b40cfa3a91abfb5` |
| `lem-morse-functions-are-transverse-differentials` | `morse-functions-critical-values-and-genericity` | gpt-5.6-terra | `e9fdc1bad6f2b420c5bfbb76671c6a640a6b5e276641f8b27a002fa720975615` |
| `lem-no-new-critical-points-under-a-compact-c1-small-perturbation` | `morse-functions-critical-values-and-genericity` | gpt-5.6-terra | `26424fa6912703b93836398beed2e15bdd26848399c4a33e37f0bc180d5d2efd` |
| `lem-property-star-and-leaf-reducibility-yield-five-comb-outcomes` | `property-star-and-comb-outcomes` | gpt-5.6-terra | `74c3a7839dfc993953df5753876b104f26e9e1405ad52881a0a13d47ddc864c6` |
| `lem-rodl-initialization-removes-the-constant-scale-restriction-in-the-property-star-four-outcome-theorem` | `property-star-and-comb-outcomes` | gpt-5.6-terra | `b04a9b804b1a61362cc249c5b15451558381ed891b75dd06d236bd0199e0f528` |
| `lem-rodl-initialization-upgrades-generalized-niceness-to-a-restricted-set-blockade-or-polynomial-clique-or-stable-set` | `from-generalized-niceness-to-erdos-hajnal` | gpt-5.6-terra | `69c4d6f9c3c698dfd845a5540fc46e77c88bac66584327b3ed071385c96c24b8` |
| `prop-proper-morse-exhaustions-exist-on-smooth-manifolds` | `morse-functions-critical-values-and-genericity` | gpt-5.6-terra | `15913e26b5ba698791e351221b448bf56ea762903a1228b11aa08b3d47e0ffa0` |
| `thm-morse-functions-are-dense-by-relative-jet-transversality` | `morse-functions-critical-values-and-genericity` | gpt-5.6-terra | `c3fe7f1edb216bf2696c0a76ca987d8d1ad8d93ae4d17a87517a300a29bbcd24` |
| `thm-property-star-and-leaf-reducibility-imply-generalized-niceness` | `property-star-and-comb-outcomes` | gpt-5.6-terra | `dc7cba6e40bcdbe6de5009f3b0c688c2a97d37e6245035b0792e01187f4ce88e` |
