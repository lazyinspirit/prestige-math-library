...
# Batch 16 of run `frontier-30` — Harish Chandra Isomorphism Casimir and Central Characters
...
| | |
|---|---|
| A page | `harish-chandra-isomorphism-casimir-and-central-characters` · order **510.001** · `lie-theory` |
| B page | `harish-chandra-isomorphism-casimir-and-central-characters-examples` |
| title | Harish Chandra Isomorphism Casimir and Central Characters |
| requires | `real-forms-and-real-semisimple-lie-algebras-examples` |
| design | `plan-representation-theory-lie-track.md` L65 |
