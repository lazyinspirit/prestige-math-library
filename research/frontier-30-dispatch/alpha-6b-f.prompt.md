...
`research/frontier-30-step6-scope-<i>.json`, reader report and findings JSON, refuter
...
Write `research/frontier-30-alpha-<g>-6b.md` and
`research/frontier-30-alpha-<g>-6b-decisions.json` with `{version:1,run,group,decisions}`.
