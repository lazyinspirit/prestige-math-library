...
run: frontier-30
role: reader
label: reader-recover-12

# Step 6 reader routing-artifact correction

Correct research/frontier-30-reader-findings-12.json for batch 12.
Set the top-level `batch` field to exactly "12"; it identifies this batch, not the run number.
