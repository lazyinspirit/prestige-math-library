...
You are the group Alpha for batches **2**, **12**, **13**: 3 A/B pair(s), 6 page(s), 103 item(s), 24 open rejection(s) over 24 item(s).
...
|---|---|---|---|
| `cex-birational-does-not-imply-isomorphic` | `morphisms-local-rings-and-rational-maps-of-affine-varieties-examples` | gpt-5.6-terra | `687ac49ef0cd454d0db29049936466484c867003f29b4a70c993187f810f649f` |
| `cex-rational-map-with-indeterminacy` | `morphisms-local-rings-and-rational-maps-of-affine-varieties-examples` | gpt-5.6-terra | `79171765bb4478377de2471441fcd34b8cf0983ba8ded32ec1fa321ab4605582` |
| `cor-closed-points-dense-in-affine-spectra` | `zariski-topology-on-prime-spectra` | gpt-5.6-terra | `a9de858751741b0e8edf01715a563a41b59ad0cc4bcec1e2f670dbbed64b3feb` |
| `cor-closed-points-of-spectrum-are-maximal-ideals` | `zariski-topology-on-prime-spectra` | gpt-5.6-terra | `40144880f2544427e40e86c56ac85ad1e688b8704d608be24c8f164c334416d0` |
| `def-direct-image-sheaf` | `sheaf-operations-exactness-ringed-spaces-and-module-pullback` | gpt-5.6-terra | `57531cfc0219d332718500e4b7edbc8702d56a9b7c70532c4bbcf74d2d1c3150` |
| `def-dominant-morphism-and-rational-map` | `morphisms-local-rings-and-rational-maps-of-affine-varieties` | gpt-5.6-terra | `a029c35603cac2867002d3cafdeb89c288bf4803e72bb844a4bca66a09637743` |
| `def-pullback-module-ringed-spaces` | `sheaf-operations-exactness-ringed-spaces-and-module-pullback` | gpt-5.6-terra | `7e87ffc7861b64212ef85e3adc6f5311dfd15ce23c69f840d22d2dce91118e5c` |
| `def-rational-function-regular-at-point` | `morphisms-local-rings-and-rational-maps-of-affine-varieties` | gpt-5.6-terra | `e0864e8d986275cc7b681f70b43d812ee23cb3af038095264b774dd02824bc9d` |
| `def-rational-map-varieties` | `morphisms-local-rings-and-rational-maps-of-affine-varieties` | gpt-5.6-terra | `098b2f23efc6473494c25c29578a25be4b0bacee31566eaf478206f3549b7dd3` |
| `ex-hyperbola-is-multiplicative-group-variety` | `morphisms-local-rings-and-rational-maps-of-affine-varieties-examples` | gpt-5.6-terra | `84aaa8ad83f424db5c960afe5880a51e9b313d3a57be4a0554357331dae2ca56` |
| `ex-idempotent-clopen-product-ring` | `zariski-topology-on-prime-spectra-examples` | gpt-5.6-terra | `9813dd294261819f9e25ce022697ef71e7bee4b1ef710a40ffc243e5316d19e4` |
| `ex-local-ring-affine-line-at-origin` | `morphisms-local-rings-and-rational-maps-of-affine-varieties-examples` | gpt-5.6-terra | `2b9355f9c997ce2963a8d449aeff841bcfa512d4c61690d1b0891b9c87ed243e` |
| `ex-nonclosed-support-without-finiteness` | `zariski-topology-on-prime-spectra-examples` | gpt-5.6-terra | `864ebcfd0670c479f0c4198ea6b292878cadd5684451d21b0a6a43403f884abe` |
| `ex-polynomial-map-coordinate-pullback` | `morphisms-local-rings-and-rational-maps-of-affine-varieties-examples` | gpt-5.6-terra | `0505cff4259fdee00d33711574a39cb55942bed1efd1609fac68afb4e71a9c03` |
| `lem-closure-of-a-point-is-its-vanishing-set` | `zariski-topology-on-prime-spectra` | gpt-5.6-terra | `afcf38b4dc1d8b76a935e18884caa33fa46a06fae54291071a67aa8930cbc35d` |
| `lem-global-sections-left-exact` | `sheaf-operations-exactness-ringed-spaces-and-module-pullback` | gpt-5.6-terra | `41dea57b50aceffe253c4fc8335d865e0f0658658a9cf140e77b4030a38a6aa7` |
| `lem-idempotent-gives-clopen-spectrum-partition` | `zariski-topology-on-prime-spectra` | gpt-5.6-terra | `b67bc1f17973cf3c5236ce43d3736e1ec7001415f41f622b8be83d0350f934a8` |
| `lem-pullback-modules-right-exact` | `sheaf-operations-exactness-ringed-spaces-and-module-pullback` | gpt-5.6-terra | `c111265ee150047e435050fc2f4aa518a27dc46e22d315edfff632af197fdc44` |
| `lem-rational-map-equivalence-transitive` | `morphisms-local-rings-and-rational-maps-of-affine-varieties` | gpt-5.6-terra | `8004c865809d26b67e153ad9e5b6b17b85130d0db97ebc3dc51b7e0f57b678b4` |
| `thm-affine-morphisms-coordinate-ring-anti-equivalence` | `morphisms-local-rings-and-rational-maps-of-affine-varieties` | gpt-5.6-terra | `8a05ae17363e3c3e9420850bdc51116e918089926cbcb46a6a81fc7f0f092da2` |
| `thm-exactness-of-sheaves-stalkwise` | `sheaf-operations-exactness-ringed-spaces-and-module-pullback` | gpt-5.6-terra | `8a5aed63e5cd27f6cb396ce66bb37ad83b1c4a15fa4d80af023a71f0f9abb82d` |
| `thm-function-field-independent-affine-open` | `morphisms-local-rings-and-rational-maps-of-affine-varieties` | gpt-5.6-terra | `fe1bebf628897a73ceb9c8b0e000e7ddae3e3910a00f4c23187b59447d760d9b` |
| `thm-global-regular-functions-affine-variety-coordinate-ring` | `morphisms-local-rings-and-rational-maps-of-affine-varieties` | gpt-5.6-terra | `52503227dae38615086247c2a5c44dd7fcf25553e70fcbc8062d6aaa2f7d46c1` |
| `thm-local-ring-affine-variety-localization` | `morphisms-local-rings-and-rational-maps-of-affine-varieties` | gpt-5.6-terra | `aaf68fdf6d57f560579697f943a36436495dbaf735f293877b8d625a650a9ec4` |
