...
covers: 6
output: research/frontier-30-batch-6.proof-contracts.json

> The dispatch block supplies batch `6`.

# Step 5 — author batch `6`, `frontier-30`

Use `research/frontier-30-batch-6.pages.json`, `.notes.md`, `.coverage.json`,
