...
run: frontier-30
role: reader
label: reader-recover-19

# Step 6 reader routing-artifact correction

Correct research/frontier-30-reader-findings-19.json for batch 19.
Set the top-level `batch` field to exactly "19"; it identifies this batch, not the run number.
