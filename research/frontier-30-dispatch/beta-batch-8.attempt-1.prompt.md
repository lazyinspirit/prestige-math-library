...
# Batch 8 of run `frontier-30` — Dirichlet Characters L Functions and Primes in Progressions · Hilbert Symbols and the Quadratic Local Global Principle
...
| | |
|---|---|
| A page | `dirichlet-characters-l-functions-and-primes-in-progressions` · order **348.009** · `number-theory` |
| B page | `dirichlet-characters-l-functions-and-primes-in-progressions-examples` |
| title | Dirichlet Characters L Functions and Primes in Progressions |
| requires | `dirichlet-series-and-euler-products-examples`, `characters-and-the-orthogonality-relations` |
| design | `plan-number-theory-track.md` L1210 |
...
| | |
|---|---|
| A page | `hilbert-symbols-and-the-quadratic-local-global-principle` · order **348.017** · `number-theory` |
| B page | `hilbert-symbols-and-the-quadratic-local-global-principle-examples` |
| title | Hilbert Symbols and the Quadratic Local Global Principle |
| requires | `absolute-values-completions-and-p-adic-numbers-examples`, `quadratic-residues-and-the-legendre-symbol`, `quadratic-reciprocity-and-the-jacobi-symbol`, `dirichlet-characters-l-functions-and-primes-in-progressions` |
| design | `plan-number-theory-track.md` L1574 |
