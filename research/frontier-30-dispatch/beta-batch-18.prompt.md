...
# Batch 18 of run `frontier-30` — Morse Functions Critical Values and Genericity
...
| | |
|---|---|
| A page | `morse-functions-critical-values-and-genericity` · order **519** · `differential-topology` |
| B page | `morse-functions-critical-values-and-genericity-examples` |
| title | Morse Functions Critical Values and Genericity |
| requires | `morse-critical-points-hessians-and-indices-examples` |
| design | `plan-differential-topology-track.md` L358 |
