...
The task and `research/frontier-30-step6-scope-18.json` define `refuter_scope`.
...
label: refute-18
covers: 18
output: research/frontier-30-refute-18.json

# Step 6a — refuter

Read `research/frontier-30-step6-scope-18.json` and audit exactly its `refuter_scope`,
