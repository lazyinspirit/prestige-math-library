...
The task and `research/frontier-30-step6-scope-<i>.json` define `refuter_scope`.
...
Read `research/frontier-30-step6-scope-<i>.json` and audit exactly its `refuter_scope`,
