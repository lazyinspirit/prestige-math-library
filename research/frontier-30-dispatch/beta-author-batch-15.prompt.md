...
covers: 15
output: research/frontier-30-batch-15.proof-contracts.json

> The dispatch block supplies batch `15`.

# Step 5 — author batch `15`, `frontier-30`

Use `research/frontier-30-batch-15.pages.json`, `.notes.md`, `.coverage.json`,
