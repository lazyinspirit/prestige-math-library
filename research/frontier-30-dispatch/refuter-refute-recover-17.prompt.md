...
The task and `research/frontier-30-step6-scope-17.json` define `refuter_scope`.
...
run: frontier-30
role: refuter
label: refute-recover-17
covers: 17
output: research/frontier-30-refute-17.json

# Step 6a — refuter

Read `research/frontier-30-step6-scope-17.json` and audit exactly its `refuter_scope`,
