...
run: frontier-30
role: alpha
label: 6c-gate-impact-audit-6c-4

# Step 6c repair — impact-audit-6c

This file is the authority for repair cycle 4.
Primary gate: `impact-audit-6c`
Reason: ERROR receipt-changed-scope: research/frontier-30-impact-6c.json: changed_interfaces must exactly match the computed interface changes
Owning Alpha group: (repository-scoped or mixed)
Live item ids: `rem-hahn-banach-open-choice-questions`
...
```text
impact-audit: 1 changed public interface(s), 1 affected item(s)
  rem-choice-strength-of-hahn-banach: 1 logical, 1 direct citation consumer(s)
ERROR receipt-changed-scope: research/frontier-30-impact-6c.json: changed_interfaces must exactly match the computed interface changes
ERROR receipt-impact-scope: research/frontier-30-impact-6c.json: required_review must exactly match the computed downstream impact set
ERROR receipt-missing-impact: research/frontier-30-impact-6c.json: no disposition for affected item rem-hahn-banach-open-choice-questions
