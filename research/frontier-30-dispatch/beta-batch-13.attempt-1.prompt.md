...
# Batch 13 of run `frontier-30` — Sheaf Operations Exactness Ringed Spaces and Module Pullback
...
| | |
|---|---|
| A page | `sheaf-operations-exactness-ringed-spaces-and-module-pullback` · order **366.059** · `scheme-theory` |
| B page | `sheaf-operations-exactness-ringed-spaces-and-module-pullback-examples` |
| title | Sheaf Operations Exactness Ringed Spaces and Module Pullback |
| requires | `presheaves-sheaves-stalks-and-sheafification-examples` |
| design | `plan-algebraic-geometry-track.md` L603 |
