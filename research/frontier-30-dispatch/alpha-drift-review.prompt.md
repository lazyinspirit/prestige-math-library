...
label: drift-review
covers: drift
output: research/frontier-30-alpha-step0-drift.md

## Step-0 prerequisite drift review — run `frontier-30`
...
**Evidence assembled for you:** `research/frontier-30-drift-evidence.json`
...
Write `research/frontier-30-alpha-step0-drift.md`, one section per A page:
