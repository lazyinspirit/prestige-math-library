# Batch 4 of run `frontier-21` — The Spectral Theorem, Positive Operators and Singular Value Decomposition

1 A/B pair, linear-algebra. You own every page here and you author them all at step 5.

## `the-spectral-theorem-and-singular-value-decomposition`

| | |
|---|---|
| A page | `the-spectral-theorem-and-singular-value-decomposition` · order **141** · `linear-algebra` |
| B page | `the-spectral-theorem-and-singular-value-decomposition-examples` |
...
| design | `plan-algebra-track-expansion.md` L89 (id mention, not a heading — locate the section yourself)<br>`plan-algebra-track.md` L38 (id mention, not a heading — locate the section yourself)<br>`plan-combinatorics-and-categories.md` L502 (id mention, not a heading — locate the section yourself) |
