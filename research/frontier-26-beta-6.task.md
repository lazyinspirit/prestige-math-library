# Batch 6 of run `frontier-26` — Strictification and Mac Lanes Coherence Theorem
...
| | |
|---|---|
| A page | `strictification-and-mac-lanes-coherence-theorem` · order **365.025** · `category-theory` |
| B page | `strictification-and-mac-lanes-coherence-theorem-examples` |
| title | Strictification and Mac Lanes Coherence Theorem |
| requires | `monoidal-categories-and-monoidal-functors-examples` |
| design | `plan-category-theory-track.md` L2514 |
