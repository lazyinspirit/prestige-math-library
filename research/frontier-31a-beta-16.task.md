# Batch 16 of run `frontier-31a` — Quasilinear Characteristics and Cauchy Kovalevskaya

1 A/B pair, pde. You own every page here and you author them all at step 5.

## `quasilinear-characteristics-and-cauchy-kovalevskaya`

| | |
|---|---|
| A page | `quasilinear-characteristics-and-cauchy-kovalevskaya` · order **458.001** · `pde` |
...
| requires | `partial-differential-equations-and-characteristics-examples`, `euclidean-ordinary-differential-equations-with-smooth-dependence` |
| design | `research/plan-pde-track.md` L567 |
