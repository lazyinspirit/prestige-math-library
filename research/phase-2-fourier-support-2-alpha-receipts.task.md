# Step 8 — whole-level receipts, `phase-2-fourier-support-2`
...
Generate `research/phase-2-fourier-support-2-spine-audit.json` with `spine-audit --template` and
read every selected proof before completing its current-hash evidence.

Generate `research/phase-2-fourier-support-2-audit-coverage.json` with
...
`--terminal-resolutions research/phase-2-fourier-support-2-step7-terminal-resolutions.jsonl`,
