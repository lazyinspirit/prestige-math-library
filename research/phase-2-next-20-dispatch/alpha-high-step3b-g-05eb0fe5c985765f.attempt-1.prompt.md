...
run: phase-2-next-20
role: alpha-high
label: step3b-g-05eb0fe5c985765f
covers: 12
output: research/phase-2-next-20-batch-12.pages.json

# step3b: group g

- Run: phase-2-next-20
- Batches: 12
- A pages: effective-numberings-reductions-resources-and-randomness
- Read current manifests, coverage, prose, plan and dependency records.
- Write research/phase-2-next-20-step3b-g.md.
