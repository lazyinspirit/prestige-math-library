...
# Final Adjudicator queue — phase-2-next-20, group h, round 1

This is the exact queue frozen in `research/phase-2-next-20-step7-fa-h-round-1.json`. It contains 1 item(s).
Work in the numbered order below. Do not substantively review the next item until the recorder accepts the current one.

## 1. `ex-lc-first-inaccessible-is-not-mahlo` (run)

1. Read `items/ex-lc-first-inaccessible-is-not-mahlo.md`, its cited dependencies, pair/page context, proof contract, judge and Alpha evidence, and this group's conventions.
...
3. Write concrete evidence to `research/phase-2-next-20-step7-fa-h-1-ex-lc-first-inaccessible-is-not-mahlo.md`, including exact source URLs and what they support, or explain why the mathematics was familiar.
...
```bash
node tools/step7-terminal-resolution.mjs record --run phase-2-next-20 --id ex-lc-first-inaccessible-is-not-mahlo --resolved-by final-adjudicator --group h --queue research/phase-2-next-20-step7-fa-h-round-1.json --state-dir /home/lazyinspirit/Projects/prestige-math-library/.autopilot/phase-2-next-20 --disposition accepted-after-review --source-status verified --basis-file research/phase-2-next-20-step7-fa-h-1-ex-lc-first-inaccessible-is-not-mahlo.md
node tools/step7-terminal-resolution.mjs record --run phase-2-next-20 --id ex-lc-first-inaccessible-is-not-mahlo --resolved-by final-adjudicator --group h --queue research/phase-2-next-20-step7-fa-h-round-1.json --state-dir /home/lazyinspirit/Projects/prestige-math-library/.autopilot/phase-2-next-20 --disposition repaired --source-status verified --basis-file research/phase-2-next-20-step7-fa-h-1-ex-lc-first-inaccessible-is-not-mahlo.md
```
