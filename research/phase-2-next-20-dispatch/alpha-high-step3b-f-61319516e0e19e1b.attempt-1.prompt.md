...
run: phase-2-next-20
role: alpha-high
label: step3b-f-61319516e0e19e1b
covers: 10, 11
...
- Run: phase-2-next-20
- Batches: 10, 11
- A pages: finite-weyl-invariants-bruhat-and-kostant-harmonics, integrable-highest-weight-kac-moody-modules, vertices-sources-and-the-green-correspondence
- Read current manifests, coverage, prose, plan and dependency records.
- Write research/phase-2-next-20-step3b-f.md.
