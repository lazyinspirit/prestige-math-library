...
label: 5a-g
covers: 12
output: research/phase-2-next-20-alpha-g-5a.md

# Step 5A — authored-content review

- Work on your dispatched group, one item at a time. Read each batch manifest, `research/phase-2-next-20-step5-scope-12.json`, current authored items and A/B pages, contracts, and dependencies needed to verify the arguments.
