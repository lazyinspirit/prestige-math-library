...
You are the group Alpha for batches **12**: 1 A/B pair(s), 2 page(s), 22 item(s), 8 open rejection(s) over 8 item(s).
...
|---|---|---|---|
| `def-acceptable-numbering-with-universal-evaluation` | `effective-numberings-reductions-resources-and-randomness` | gpt-5.6-terra | `447c97faf789e4bff97553d10c91f315c430320b406c56a739a58de703ecd1b1` |
| `def-polynomial-time-verifier-and-reduction-interface` | `effective-numberings-reductions-resources-and-randomness` | gpt-5.6-terra | `d94b219825d9b73cf8d51a25cec03efc9a6c7ba5e9542f619e1d2bb418544169` |
| `def-uniform-asymptotic-time-space-comparison` | `effective-numberings-reductions-resources-and-randomness` | gpt-5.6-terra | `e32fa9f26acf0207f856df82cfbdddaa62105cdc2a7b9d1900c84ffa69e9d8cf` |
| `ex-smn-specializes-a-two-argument-index` | `effective-numberings-reductions-resources-and-randomness-examples` | gpt-5.6-terra | `539524904276555b2dc6b2aaa98af2dcb4cf512a7480b79fc5c4b98145116f50` |
| `thm-clocked-universal-simulation-with-time-and-space-bounds` | `effective-numberings-reductions-resources-and-randomness` | gpt-5.6-terra | `a5264d1de235d100ef0c56a3001e1e4ef5ed352906e006a01bb92fdd61681f66` |
| `thm-kleene-fixed-point-theorem-for-program-indices` | `effective-numberings-reductions-resources-and-randomness` | gpt-5.6-terra | `8995904dd643173290d6a7ffaf15368c608b518a829c358a953ab8326481b0e1` |
| `thm-kleene-normal-form-for-the-fixed-machine-coding` | `effective-numberings-reductions-resources-and-randomness` | gpt-5.6-terra | `3632cafa837e71698ed8aee15b7098a87b1ee182a6d10c6de0c32bb2a8fff6bb` |
| `thm-smn-for-the-fixed-acceptable-numbering` | `effective-numberings-reductions-resources-and-randomness` | gpt-5.6-terra | `d07959022ffaa946e8d3e06121018ec3281d566be35d1ad7affad669c6443e16` |
