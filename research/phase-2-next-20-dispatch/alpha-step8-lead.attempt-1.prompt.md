...
label: step8-lead
covers: all
output: research/phase-2-next-20-alpha-step8-review.md

# Step 8 — scope-denial delta review, `phase-2-next-20`

First follow `briefs/tasks/frontier-dependency-ledger.md`. Refresh and read
`research/phase-2-next-20-cross-batch-dependencies.json` for cross-batch scope and impact.

Read only pending rows in `research/phase-2-next-20-step8-scope-delta.json`. Verify each
...
If `research/phase-2-next-20-step8-mathematical-review.task.md` exists, also perform its
...
`research/phase-2-next-20-alpha-step8-review.md`. Inspect each open run ledger row and
