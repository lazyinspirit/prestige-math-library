...
run: phase-2-next-20
role: alpha-high
label: step3b-d-cae868a4c13e9a27
covers: 6
output: research/phase-2-next-20-batch-6.pages.json

# step3b: group d

- Run: phase-2-next-20
- Batches: 6
- A pages: quantitative-hyperbolic-geometry-toolkit
- Read current manifests, coverage, prose, plan and dependency records.
- Write research/phase-2-next-20-step3b-d.md.
