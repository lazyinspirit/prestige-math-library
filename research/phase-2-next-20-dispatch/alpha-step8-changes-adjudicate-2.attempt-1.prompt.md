...
run: phase-2-next-20
role: alpha
label: step8-changes-adjudicate-2

# Step 8 — changed-mathematics adjudication, `phase-2-next-20`

Act only on ids in `research/phase-2-next-20-step8-changes.json`. Read their current
...
`research/phase-2-next-20-alpha-step8-adjudicate.md` with every tuple, outcome,
