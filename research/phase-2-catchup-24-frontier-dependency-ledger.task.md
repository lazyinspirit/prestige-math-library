...
group. It is separate from the Step-6 verdicts and the published-consumer ledger.
...
ledger by hand. Step 9's serial lead may reconcile all batch inputs after the
...
Step 9's lead refreshes and reads the unified ledger before reviewing scope or
...
Record dispositions in the owning input rows and Step-9 report. Do not replace
the required Step-6 edge verdicts or Step-9 certification with this ledger.
