...
3. Your own `research/frontier-11-batch-<i>.notes.md` — you wrote it; stay
...
- `research/frontier-11-batch-<i>.pages.json`
- `research/frontier-11-batch-<i>.notes.md`
- `research/frontier-11-batch-<i>.coverage.json`
- `research/frontier-11-batch-<i>.proof-contracts.json`
