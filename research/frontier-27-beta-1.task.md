# Batch 1 of run `frontier-27` — Krull Dimension and Height Theorems
...
| | |
|---|---|
| A page | `krull-dimension-and-height-theorems` · order **111.019** · `commutative-algebra` |
| B page | `krull-dimension-and-height-theorems-examples` |
| title | Krull Dimension and Height Theorems |
| requires | `dedekind-domains-and-ideal-classes-examples` |
| design | `plan-algebraic-geometry-track.md` L61 (id mention, not a heading — locate the section yourself)<br>`plan-commutative-algebra-track.md` L912 (id mention, not a heading — locate the section yourself) |
