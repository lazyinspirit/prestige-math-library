...
Read only pending rows in `research/frontier-24-step9-scope-delta.json`. Verify each
...
`research/frontier-24-alpha-step9-review.md`. Inspect each open run ledger row and
