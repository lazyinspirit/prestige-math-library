# Batch 13 of run `frontier-33` — Integration of Forms and the General Stokes Theorem

1 A/B pair, differential-geometry. You own every page here and you author them all at step 5.

## `integration-of-forms-and-the-general-stokes-theorem`

| | |
|---|---|
| A page | `integration-of-forms-and-the-general-stokes-theorem` · order **469** · `differential-geometry` |
...
| requires | `smooth-partitions-of-unity-and-exhaustions`, `rank-theorems-and-embedded-submanifolds`, `tensor-fields-exterior-algebra-and-differential-forms`, `the-exterior-derivative-and-cartan-calculus`, `manifolds-with-boundary-collars-and-orientations`, `the-divergence-theorem-and-classical-stokes` |
| design | `research/plan-differential-geometry-track.md` L3482 |
