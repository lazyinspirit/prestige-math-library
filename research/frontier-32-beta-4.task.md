# Batch 4 of run `frontier-32` — The Baire Principles of Functional Analysis
...
| | |
|---|---|
| A page | `the-baire-principles-of-functional-analysis` · order **288.057** · `functional-analysis` |
| B page | `the-baire-principles-of-functional-analysis-examples` |
| title | The Baire Principles of Functional Analysis |
| requires | `geometric-hahn-banach-and-convex-separation-examples` |
| design | `research/plan-functional-analysis-track.md` L573 |
