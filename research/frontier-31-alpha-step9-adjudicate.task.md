# Step 9 — changed-mathematics adjudication, `frontier-31`

Act only on ids in `research/frontier-31-step9-changes.json`. Read their current
...
`research/frontier-31-alpha-step9-adjudicate.md` with every tuple, outcome,
