...
const RA06_ITEMS = [
  ...
  { id: 'thm-subsequential-limit-set-closed', kind: 'theorem',
    ...
    strategy: 'constructive',
    deps: ['def-subsequential-limit', 'def-real-limit', 'thm-recursion', 'lem-index-map-grows', 'lem-of-triangle-inequality', 'cor-archimedean-reciprocal', 'thm-of-archimedean', 'lem-of-inverse-positive', 'lem-rat-embeds-dense'] },
  ...
  { id: 'lem-nth-root-of-n-tends-to-one', kind: 'lemma',
    title: '$n^{1/n} \\to 1$',
    strategy: 'direct',
    deps: ['thm-nth-roots-exist', 'thm-am-gm', 'def-rational-power', 'lem-rational-power-monotone', 'thm-squeeze', 'cor-archimedean-reciprocal', 'thm-of-archimedean', 'lem-of-inverse-positive', 'def-real-limit', 'def-finite-sum'] },
  { id: 'lem-nth-root-of-constant-tends-to-one', kind: 'lemma',
    title: 'For every $a > 0$, $a^{1/n} \\to 1$',
    strategy: 'cases',
    deps: ['thm-nth-roots-exist', 'lem-bernoulli-inequality', 'lem-power-monotone', 'cor-archimedean-reciprocal', 'thm-of-archimedean', 'lem-of-inverse-positive', 'thm-squeeze', 'def-rational-power', 'lem-rational-power-monotone', 'def-real-limit'] },
  ...
  { id: 'fs-limsup-additive', kind: 'false-statement',
    ...
    strategy: 'direct',
    deps: ['thm-limsup-subadditive', 'def-limsup-liminf', 'def-extended-reals', 'lem-alternating-sequence'] },
  { id: 'fs-ratio-and-root-limits-always-agree', kind: 'false-statement',
    ...
    strategy: 'direct',
    deps: ['thm-ratio-root-inequality', 'def-limsup-liminf', 'def-rational-power', 'lem-alternating-sequence'] },
...
const RA06_B_ITEMS = [
  { id: 'ex-limsup-of-alternating-sequence', kind: 'example',
    ...
    deps: ['def-limsup-liminf', 'thm-convergence-iff-limsup-equals-liminf', 'lem-alternating-sequence'] },
  { id: 'ex-subsequential-limits-fill-unit-interval', kind: 'example',
    ...
    deps: ['def-subsequential-limit', 'thm-subsequential-limit-set-closed', 'lem-rat-embeds-dense', 'cor-archimedean-reciprocal', 'thm-of-archimedean', 'lem-of-inverse-positive', 'def-limsup-liminf', 'def-interval'] },
  { id: 'ex-ratio-fails-root-succeeds', kind: 'example',
    ...
    deps: ['thm-ratio-root-inequality', 'def-limsup-liminf', 'def-integer-power', 'def-rational-power', 'lem-power-laws', 'lem-alternating-sequence'] },
  { id: 'ex-strict-ratio-root-chain', kind: 'example',
    ...
    deps: ['thm-ratio-root-inequality', 'def-limsup-liminf', 'ex-ratio-fails-root-succeeds', 'lem-alternating-sequence'] },
  ...
  { id: 'cex-limsup-subadditivity-strict', kind: 'counterexample',
    ...
    deps: ['fs-limsup-additive', 'thm-limsup-subadditive', 'def-limsup-liminf', 'lem-alternating-sequence'] },
  { id: 'cex-limsup-infinite-not-attained-in-r', kind: 'counterexample',
    ...
    deps: ['def-limsup-liminf', 'thm-limsup-is-greatest-subsequential-limit', 'def-extended-reals', 'def-divergence-to-infinity', 'lem-alternating-sequence'] },
  { id: 'cex-limsup-product-strict', kind: 'counterexample',
    title: '$x_k = 1 + (-1)^k$, $y_k = 1 + (-1)^{k+1}$ give $\\limsup(x_k y_k) = 0 < 4$',
    deps: ['thm-limsup-submultiplicative', 'def-limsup-liminf', 'lem-alternating-sequence'] },
  { id: 'cex-zero-times-infinity-indeterminate', kind: 'counterexample',
    ...
    deps: ['def-extended-reals', 'def-divergence-to-infinity', 'thm-algebra-of-limits', 'cor-archimedean-reciprocal', 'thm-of-archimedean', 'lem-of-inverse-positive', 'rem-extended-real-conventions'] },
];
...
const RA07_ITEMS = [
  ...
  { id: 'thm-cesaro-mean-theorem', kind: 'theorem',
    ...
    strategy: 'direct',
    deps: ['def-cesaro-mean', 'def-finite-sum', 'lem-finite-sum-laws', 'lem-triangle-inequality-finite', 'cor-archimedean-reciprocal', 'thm-of-archimedean', 'lem-of-inverse-positive', 'def-real-limit', 'lem-convergent-implies-bounded'] },
  { id: 'thm-stolz-cesaro', kind: 'theorem',
    ...
    strategy: 'direct',
    deps: ['def-sequence', 'def-monotone-sequence', 'def-divergence-to-infinity', 'lem-monotone-unbounded-diverges', 'def-finite-sum', 'lem-finite-sum-laws', 'def-real-limit', 'thm-of-archimedean', 'lem-of-inverse-positive', 'lem-of-add-order', 'thm-algebra-of-limits'] },
  ...
  { id: 'cor-cesaro-matrix-is-regular', kind: 'corollary',
    ...
    strategy: 'direct',
    deps: ['thm-silverman-toeplitz', 'def-summability-matrix', 'def-cesaro-mean', 'thm-cesaro-mean-theorem', 'cor-archimedean-reciprocal', 'thm-of-archimedean', 'lem-of-inverse-positive'] },
  ...
  { id: 'fs-cesaro-converse', kind: 'false-statement',
    ...
    strategy: 'direct',
    deps: ['thm-cesaro-mean-theorem', 'def-cesaro-mean', 'lem-alternating-sequence'] },
...
const RA07_B_ITEMS = [
  ...
  { id: 'ex-cesaro-means-of-alternating', kind: 'example',
    ...
    deps: ['def-cesaro-mean', 'fs-cesaro-converse', 'lem-alternating-sequence', 'thm-induction-principle', 'cor-archimedean-reciprocal', 'thm-of-archimedean', 'lem-of-inverse-positive'] },
  ...
  { id: 'cex-stolz-cesaro-converse-fails', kind: 'counterexample',
    ...
    deps: ['thm-stolz-cesaro', 'def-limsup-liminf', 'lem-alternating-sequence', 'thm-induction-principle', 'cor-archimedean-reciprocal', 'thm-of-archimedean', 'lem-of-inverse-positive'] },
...
const RA08_ITEMS = [
  ...
  { id: 'fs-ratio-limsup-at-least-one-diverges', kind: 'false-statement',
    ...
    strategy: 'direct',
    deps: ['thm-ratio-test', 'cor-root-test-dominates-ratio-test', 'def-limsup-liminf', 'def-series', 'lem-alternating-sequence'] },
...
const RA08_B_ITEMS = [
  ...
  { id: 'cex-ratio-inconclusive-root-decides', kind: 'counterexample',
    ...
    deps: ['thm-ratio-test', 'thm-root-test', 'cor-root-test-dominates-ratio-test', 'def-limsup-liminf', 'def-integer-power', 'lem-alternating-sequence'] },
...
const RA10_ITEMS = [
  ...
  { id: 'lem-sequential-characterisation-of-closure-r', kind: 'lemma',
    ...
    strategy: 'direct',
    deps: ['thm-closure-characterisations-r', 'def-limit-point-r', 'def-real-limit', 'def-sequence', 'cor-archimedean-reciprocal', 'thm-of-archimedean', 'lem-of-inverse-positive', 'def-countable-choice', 'def-neighbourhood-r'] },
  ...
  { id: 'fs-arbitrary-intersection-of-open-is-open', kind: 'false-statement',
    ...
    strategy: 'direct',
    deps: ['thm-open-set-algebra-r', 'def-open-and-closed-in-r', 'cor-archimedean-reciprocal', 'thm-of-archimedean', 'def-neighbourhood-r'] },
...
const RA10_B_ITEMS = [
  ...
  { id: 'ex-reciprocals-with-zero-are-compact', kind: 'example',
    ...
    deps: ['thm-heine-borel-characterisation-r', 'def-limit-point-r', 'thm-closure-characterisations-r', 'cor-archimedean-reciprocal', 'thm-of-archimedean', 'lem-of-inverse-positive'] },
  ...
  { id: 'cex-intersection-of-shrinking-intervals-not-open', kind: 'counterexample',
    ...
    deps: ['fs-arbitrary-intersection-of-open-is-open', 'def-open-and-closed-in-r', 'cor-archimedean-reciprocal', 'thm-of-archimedean'] },
  ...
  { id: 'cex-open-cover-of-unit-interval-no-finite-subcover', kind: 'counterexample',
    ...
    deps: ['def-open-cover-r', 'thm-heine-borel-characterisation-r', 'cor-archimedean-reciprocal', 'thm-of-archimedean', 'def-interval'] },
...
const RA11_ITEMS = [
  ...
  { id: 'thm-baire-category-r', kind: 'theorem',
    ...
    strategy: 'constructive',
    deps: ['def-nowhere-dense-meager', 'thm-nested-interval-property', 'def-interval', 'def-open-and-closed-in-r', 'def-limit-point-r', 'thm-closure-characterisations-r', 'def-countable', 'lem-countable-iff-surjection-from-n', 'thm-recursion', 'cor-archimedean-reciprocal', 'thm-of-archimedean', 'lem-of-inverse-positive', 'def-neighbourhood-r'] },
...
const RA12_ITEMS = [
  ...
  { id: 'thm-sequential-criterion-for-function-limits', kind: 'theorem',
    ...
    strategy: 'direct',
    deps: ['def-function-limit', 'def-sequence', 'def-real-limit', 'def-limit-point-r', 'cor-archimedean-reciprocal', 'thm-of-archimedean', 'lem-of-inverse-positive', 'def-countable-choice', 'lem-sequential-characterisation-of-closure-r', 'lem-rat-embeds-dense'] },
  ...
  { id: 'fs-limit-exists-implies-bounded-on-the-domain', kind: 'false-statement',
    ...
    strategy: 'direct',
    deps: ['lem-limit-implies-local-boundedness', 'def-function-limit', 'def-bounded-set', 'thm-of-archimedean', 'lem-of-inverse-positive'] },
...
const RA12_B_ITEMS = [
  ...
  { id: 'ex-limit-at-infinity-of-a-rational-function', kind: 'example',
    ...
    deps: ['def-limits-at-infinity', 'thm-algebra-of-function-limits', 'def-integer-power', 'thm-of-archimedean', 'lem-of-inverse-positive'] },
  { id: 'cex-psi-of-one-over-x-has-no-limit-at-zero', kind: 'counterexample',
    ...
    deps: ['ex-distance-to-the-integers', 'cor-sequential-criterion-for-nonexistence', 'cor-archimedean-reciprocal', 'thm-of-archimedean', 'lem-of-inverse-positive', 'def-function-limit'] },
...
const T1_ITEMS = [
  ...
  { id: 'lem-metric-ball-neighbourhood-base', kind: 'lemma',
    ...
    strategy: 'direct',
    deps: ['def-metric-ball', 'def-metric-topology', 'cor-archimedean-reciprocal', 'thm-of-archimedean', 'lem-of-inverse-positive', 'def-natural-numbers', 'def-countable', 'def-equinumerous'] },
...
const T1_B_ITEMS = [
  ...
  { id: 'cex-set-distance-is-not-a-metric', kind: 'counterexample',
    ...
    deps: ['def-metric-bounded-diameter', 'def-metric-space', 'thm-metric-closure-characterisation', 'def-integers', 'cor-archimedean-reciprocal', 'thm-of-archimedean', 'lem-of-inverse-positive'] },
...
const T2_B_ITEMS = [
  ...
  { id: 'cex-strict-contraction-without-a-fixed-point', kind: 'counterexample',
    ...
    deps: ['fs-strict-contraction-has-a-fixed-point', 'thm-banach-fixed-point', 'def-lipschitz-holder-contraction', 'def-complete-metric-space', 'thm-of-archimedean', 'lem-of-inverse-positive', 'thm-complete-subspace-iff-closed'] },
  { id: 'cex-cantor-intersection-needs-vanishing-diameters', kind: 'counterexample',
    ...
    deps: ['thm-cantor-intersection-metric', 'def-metric-space', 'def-complete-metric-space', 'def-metric-bounded-diameter', 'cor-archimedean-reciprocal', 'thm-of-archimedean', 'lem-of-inverse-positive'] },
  { id: 'cex-completeness-is-not-topological', kind: 'counterexample',
    ...
    deps: ['fs-completeness-is-a-topological-property', 'def-complete-metric-space', 'def-equivalent-metrics', 'def-metric-topology', 'cor-archimedean-reciprocal', 'thm-of-archimedean', 'lem-of-inverse-positive'] },
  { id: 'cex-same-topology-different-cauchy-sequences', kind: 'counterexample',
    ...
    deps: ['fs-equivalent-metrics-share-cauchy-sequences', 'def-cauchy-in-metric', 'def-equivalent-metrics', 'cor-archimedean-reciprocal', 'thm-of-archimedean', 'lem-of-inverse-positive'] },
  { id: 'cex-continuous-map-destroying-cauchyness', kind: 'counterexample',
    ...
    deps: ['thm-uniform-continuity-preserves-cauchy', 'def-metric-uniform-continuity', 'def-metric-continuity', 'def-cauchy-in-metric', 'cor-archimedean-reciprocal', 'thm-of-archimedean', 'lem-of-inverse-positive', 'def-interval'] },
  { id: 'cex-uniform-bijection-with-non-uniform-inverse', kind: 'counterexample',
    ...
    deps: ['def-metric-uniform-continuity', 'thm-metric-regularity-hierarchy', 'thm-nth-roots-exist', 'def-rational-power', 'lem-rational-power-monotone', 'cor-archimedean-reciprocal', 'thm-of-archimedean', 'lem-of-inverse-positive', 'lem-power-difference-factorisation'] },
];
