# Step 4 — splice-refusal adjudication, `frontier-24`

Read `research/frontier-24-splice-refusals.json` and every reported undeclared
...
`research/frontier-24-alpha-step4.md` with each edge, evidence, disposition, edit,
