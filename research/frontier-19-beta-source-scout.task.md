...
# Batch `<i>` of run `frontier-19` — scout a live full-text URL
...
```
node tools/source-fetch-check.mjs --coverage research/frontier-19-batch-<i>.coverage.json
```
...
`research/frontier-19-batch-<i>.coverage.json` and `.notes.md` only. Keep
