...
`research/frontier-10-batch-<i>.coverage.json`. Per A page: at least two
...
- `research/frontier-10-batch-<i>.pages.json` — the machine scaffold
- `research/frontier-10-batch-<i>.notes.md` — source ledger, provenance
  rationales, convention disagreements, split proposals, licensing notes
- `research/frontier-10-batch-<i>.coverage.json` — the harvest
- `research/frontier-10-batch-<i>.proof-contracts.json` — begun at scaffold time
