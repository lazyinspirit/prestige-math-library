# Contract-detector adjudication — `phase-2-next-17`
...
Merge the batch contracts into `research/phase-2-next-17-proof-contracts.json` and
rerun the failed detector. Write `research/phase-2-next-17-alpha-contract-audit.md`
