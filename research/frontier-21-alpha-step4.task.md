# Step 4 — splice-refusal adjudication, `frontier-21`

Read `research/frontier-21-splice-refusals.json` and every reported undeclared
...
`research/frontier-21-alpha-step4.md` with each edge, evidence, disposition, edit,
