# Step 8 — changed-mathematics adjudication, `phase-2-fourier-support-2`

Act only on ids in `research/phase-2-fourier-support-2-step8-changes.json`. Read their current
...
`research/phase-2-fourier-support-2-alpha-step8-adjudicate.md` with every tuple, outcome,
