# Step 9 — changed-mathematics adjudication, `frontier-27`

Act only on ids in `research/frontier-27-step9-changes.json`. Read their current
...
`research/frontier-27-alpha-step9-adjudicate.md` with every tuple, outcome,
