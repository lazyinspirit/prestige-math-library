# Step 4 — adjudicate the splice refusals, run `frontier-19`
...
**Read `research/frontier-19-splice-refusals.json`.** Each row names the batch, the
...
3. **An edge the scaffold does not need, or one you judge wrong: strike it
   from the batch manifest** (`research/frontier-19-batch-<i>.pages.json`), with
...
**Write `research/frontier-19-alpha-step4.md`**: per edge — the evidence you read,
