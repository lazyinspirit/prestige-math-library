# Batch 5 of run `frontier-26` — Average Orders Divisor Sums and Representation Counts
...
| | |
|---|---|
| A page | `average-orders-divisor-sums-and-representation-counts` · order **348.003** · `number-theory` |
| B page | `average-orders-divisor-sums-and-representation-counts-examples` |
| title | Average Orders Divisor Sums and Representation Counts |
| requires | `arithmetic-functions-and-dirichlet-convolution-examples` |
| design | `plan-number-theory-track.md` L1004 |
