...
run: phase-2-next-17
role: alpha-high
label: step3b-a-7b213dc695bc4951
covers: 1, 3
...
- Run: phase-2-next-17
- Batches: 1, 3
- A pages: measure-preserving-transformations-and-poincare-recurrence, central-limit-theorems
- Read current manifests, coverage, prose, plan and dependency records.
- Write research/phase-2-next-17-step3b-a.md.
