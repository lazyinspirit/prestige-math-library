...
# Batch 1 of run `phase-2-next-17` — Measure Preserving Transformations and Poincare Recurrence
...
| design | `research/plan-differential-geometry-track.md` L9015 (id mention, not a heading — locate the section yourself)<br>`research/plan-measure-theory-track.md` L437 (id mention, not a heading — locate the section yourself) |
