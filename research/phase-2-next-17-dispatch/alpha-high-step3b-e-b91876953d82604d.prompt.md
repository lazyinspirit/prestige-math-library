...
run: phase-2-next-17
role: alpha-high
label: step3b-e-b91876953d82604d
covers: 8, 9
...
- Run: phase-2-next-17
- Batches: 8, 9
- A pages: affine-lie-algebras-and-loop-central-extensions, the-weyl-kac-character-formula, brauers-first-main-theorem
- Read current manifests, coverage, prose, plan and dependency records.
- Write research/phase-2-next-17-step3b-e.md.
