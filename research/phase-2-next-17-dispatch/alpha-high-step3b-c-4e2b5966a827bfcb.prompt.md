...
run: phase-2-next-17
role: alpha-high
label: step3b-c-4e2b5966a827bfcb
covers: 4
output: research/phase-2-next-17-batch-4.pages.json

# step3b: group c

- Run: phase-2-next-17
- Batches: 4
- A pages: grothendieck-spectral-sequences-and-computations
- Read current manifests, coverage, prose, plan and dependency records.
- Write research/phase-2-next-17-step3b-c.md.
