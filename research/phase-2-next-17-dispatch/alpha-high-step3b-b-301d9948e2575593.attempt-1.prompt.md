...
run: phase-2-next-17
role: alpha-high
label: step3b-b-301d9948e2575593
covers: 2
output: research/phase-2-next-17-batch-2.pages.json

# step3b: group b

- Run: phase-2-next-17
- Batches: 2
- A pages: weak-and-weak-star-topologies, distributions-test-functions-and-differentiation
- Read current manifests, coverage, prose, plan and dependency records.
- Write research/phase-2-next-17-step3b-b.md.
