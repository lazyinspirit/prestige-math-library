...
label: 5a-f
covers: 10
output: research/phase-2-next-17-alpha-f-5a.md

# Step 5A — authored-content review

- Work on your dispatched group, one item at a time. Read each batch manifest, `research/phase-2-next-17-step5-scope-10.json`, current authored items and A/B pages, contracts, and dependencies needed to verify the arguments.
