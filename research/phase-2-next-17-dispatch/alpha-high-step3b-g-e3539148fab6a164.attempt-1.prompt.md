...
run: phase-2-next-17
role: alpha-high
label: step3b-g-e3539148fab6a164
covers: 11
output: research/phase-2-next-17-batch-11.pages.json

# step3b: group g

- Run: phase-2-next-17
- Batches: 11
- A pages: condensation-gch-and-diamond-in-l, the-forcing-theorem-and-formal-consistency-transfer
- Read current manifests, coverage, prose, plan and dependency records.
- Write research/phase-2-next-17-step3b-g.md.
