...
run: phase-2-next-17
role: alpha-high
label: step3b-d-112ebc42766e49fd
covers: 5, 6, 7
...
- Run: phase-2-next-17
- Batches: 5, 6, 7
- A pages: cup-cap-cross-products-and-cohomology-rings, orientations-poincare-lefschetz-and-alexander-duality, hurewicz-whitehead-freudenthal-and-cw-approximation, the-de-rham-theorem-and-degree, geodesics-the-exponential-map-completeness-and-hopf-rinow
- Read current manifests, coverage, prose, plan and dependency records.
- Write research/phase-2-next-17-step3b-d.md.
