# Step 10 — pathway closure, `frontier-34-fa-prereqs`

Read `research/frontier-34-fa-prereqs-pathway.json` and
`research/frontier-34-fa-prereqs-pathway-closure.json`. For every pending receipt row, rewrite
