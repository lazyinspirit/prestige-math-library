# Batch 12 of run `frontier-29` — Simplicial Complexes and Simplicial Homology
...
| | |
|---|---|
| A page | `simplicial-complexes-and-simplicial-homology` · order **366.001** · `algebraic-topology` |
| B page | `simplicial-complexes-and-simplicial-homology-examples` |
| title | Simplicial Complexes and Simplicial Homology |
| requires | `schur-multipliers-and-universal-central-extensions-examples` |
| design | `plan-algebraic-topology-track.md` L336<br>`plan-algebraic-topology-track.md` L382 |
