# Batch 17 of run `frontier-32` — Schur Indices and Fields of Definition
...
| | |
|---|---|
| A page | `schur-indices-and-fields-of-definition` · order **510.035** · `representation-theory` |
| B page | `schur-indices-and-fields-of-definition-examples` |
| title | Schur Indices and Fields of Definition |
| requires | `brauer-induction-and-elementary-subgroups-examples` |
| design | `research/plan-representation-theory-groups-track.md` L305 |
