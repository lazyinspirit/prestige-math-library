# Batch 7 of run `frontier-30` — Partial Differential Equations and Characteristics
...
| | |
|---|---|
| A page | `partial-differential-equations-and-characteristics` · order **288.141** · `pde` |
...
| requires | `itos-formula-and-brownian-martingales-examples`, `picard-lindelof-and-first-order-odes`, `the-spectral-theorem-and-singular-value-decomposition` |
| design | `plan-pde-track.md` L496 |
