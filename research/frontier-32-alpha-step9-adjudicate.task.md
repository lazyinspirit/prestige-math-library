# Step 9 — changed-mathematics adjudication, `frontier-32`

Act only on ids in `research/frontier-32-step9-changes.json`. Read their current
...
`research/frontier-32-alpha-step9-adjudicate.md` with every tuple, outcome,
