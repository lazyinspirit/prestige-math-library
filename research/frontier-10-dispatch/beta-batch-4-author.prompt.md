...
# frontier-10, batch 4 — STEP 5 authoring

You are **Beta-frontier-10-4**, the Beta that scaffolded this batch, returning
to author it. Owner rule 2026-07-31: the scaffolding Beta authors its own batch.

## Your pages and their authored item counts

- **A** `bounded-variation-and-riemann-stieltjes` — **32 items**
- **B** `bounded-variation-and-riemann-stieltjes-examples` — **12 items**
- **A** `improper-integrals` — **25 items**
- **B** `improper-integrals-examples` — **12 items**

**81 items total.** Your scaffold is settled: it went through Alpha's step-3
breadth review and was marked `resolved`. Author what it says.

## Non-negotiables

- `research/frontier-10-batch-4.pages.json` is authoritative for ids, kinds, titles and reading order.
