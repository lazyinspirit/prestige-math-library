...
# frontier-10, batch 1 — STEP 5 authoring

You are **Beta-frontier-10-1**, the Beta that scaffolded this batch, returning
to author it. Owner rule 2026-07-31: the scaffolding Beta authors its own batch.

## Your pages and their authored item counts

- **A** `symmetric-groups-and-the-sign-homomorphism` — **13 items**
- **B** `symmetric-groups-and-the-sign-homomorphism-examples` — **7 items**
- **A** `matrices-and-the-matrix-of-a-linear-map` — **32 items**
- **B** `matrices-and-the-matrix-of-a-linear-map-examples` — **7 items**

**59 items total.** Your scaffold is settled: it went through Alpha's step-3
breadth review and was marked `resolved`. Author what it says.

## Non-negotiables

- `research/frontier-10-batch-1.pages.json` is authoritative for ids, kinds, titles and reading order.
