...
# frontier-10, batch 8 — B-leaf dependency repair
...
- `ex-class-equation-of-s-three` -> `ex-conjugation-in-symmetric-group-three`
- `ex-class-equation-of-the-dihedral-group-of-order-eight` -> `ex-symmetries-of-a-square`
- `ex-two-colourings-of-a-square-up-to-dihedral-symmetry` -> `ex-symmetries-of-a-square`
- `cex-groups-of-order-p-cubed-need-not-be-abelian` -> `ex-symmetries-of-a-square`
...
Only your own four `research/frontier-10-batch-8.*` artifacts. Any item you add
