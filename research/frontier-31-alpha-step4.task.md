# Step 4 — splice-refusal adjudication, `frontier-31`

Read `research/frontier-31-splice-refusals.json` and every reported undeclared
...
`research/frontier-31-alpha-step4.md` with each edge, evidence, disposition, edit,
