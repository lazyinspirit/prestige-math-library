...
covers: all
output: research/frontier-19-pathway-closure.json

# Step 10 pathway closure — run `frontier-19`

Read `research/frontier-19-pathway.json` and
`research/frontier-19-pathway-closure.json`. For every pending row, read the full
...
```
node tools/pathway-closure.mjs check --run frontier-19
