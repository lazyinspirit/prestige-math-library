<!-- Dispatched as-is. `frontier-19` and `1` are substituted by tools/dispatch.mjs
...
# Scaffolding brief — run `frontier-19`, batch `1` (steps 1 and 2)
...
You are **Beta-1**, running **Claude Opus 5 via the claude CLI
...
`research/frontier-19-batch-1.notes.md`: current substage, owned artifact paths,
...
`research/frontier-19-batch-1.coverage.json`:
...
```
node tools/source-fetch-check.mjs --coverage research/frontier-19-batch-1.coverage.json --stamp
```
...
```
node tools/coverage-checklist.mjs research/frontier-19-batch-1.coverage.json
```
...
- `research/frontier-19-batch-1.pages.json` — your batch's page objects in final
...
- `research/frontier-19-batch-1.notes.md` — prose-scaffold amendments as precise
  ...
  route, and necessity.
- `research/frontier-19-batch-1.proof-contracts.json` — the version-1
...
# Batch 1 of run `frontier-19` — Blocks Primitivity and Multiple Transitivity · Geometric Actions Svarc Milnor and Growth
...
| | |
|---|---|
| A page | `blocks-primitivity-and-multiple-transitivity` · order **71.005** · `group-theory` |
| B page | `blocks-primitivity-and-multiple-transitivity-examples` |
| title | Blocks Primitivity and Multiple Transitivity |
| requires | `extraspecial-p-groups-and-central-products-examples` |
| design | `plan-group-theory-track.md` L681<br>`plan-group-theory-track.md` L757 |
...
| | |
|---|---|
| A page | `geometric-actions-svarc-milnor-and-growth` · order **302.003** · `group-theory` |
| B page | `geometric-actions-svarc-milnor-and-growth-examples` |
| title | Geometric Actions Svarc Milnor and Growth |
| requires | `cayley-graphs-word-metrics-and-quasi-isometry-examples` |
| design | `plan-group-theory-track.md` L1621 |
