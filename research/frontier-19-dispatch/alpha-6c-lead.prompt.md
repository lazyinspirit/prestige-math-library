...
label: 6c-lead
covers: all
output: research/frontier-19-alpha-6c.md

# Step 6c — cross-batch audit and closure

You are the sole 6c lead. Open
`research/frontier-19-cross-group-edges.json`; it lists every dependency crossing
...
append one row to `research/frontier-19-6c-verdicts.jsonl`:
...
tools/cross-group-edges.mjs carrier --run frontier-19 --id <id>`. Page addition or
...
rows. Write `research/frontier-19-alpha-6c.md`; extend prior retry work and never
