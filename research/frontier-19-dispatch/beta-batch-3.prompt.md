...
# Batch 3 of run `frontier-19` — Solvability by Radicals and Kummer Theory

1 A/B pair, abstract-algebra. You own every page here and you author them all at step 5.

## `solvability-by-radicals-and-kummer-theory`

| | |
|---|---|
| A page | `solvability-by-radicals-and-kummer-theory` · order **101.6** · `abstract-algebra` |
| B page | `solvability-by-radicals-and-kummer-theory-examples` |
| title | Solvability by Radicals and Kummer Theory |
| requires | `finite-fields-and-cyclotomic-extensions-examples`, `composition-series-and-solvable-groups`, `dual-spaces-bilinear-forms-and-inertia` |
| design | `plan-algebra-track.md` L33 (id mention, not a heading — locate the section yourself) |
