...
run: frontier-19
role: beta
label: source-scout-1-b3
covers: 3

> **Source-scouting round.** Your batch number is in the "This dispatch"
> section appended below; substitute it wherever `3` appears.

# Batch `3` of run `frontier-19` — scout a live full-text URL
...
`research/frontier-19-batch-3.coverage.json` and `.notes.md` only. Keep
