...
label: reader-3
covers: 3
output: research/frontier-19-reader-3.md

# Step 6a reader task

Open `research/frontier-19-batch-3.pages.json`, every listed item, every assigned
...
Write the evidence report to `research/frontier-19-reader-3.md`. It must list:
...
Return `research/frontier-19-reader-findings-3.json` under
