...
label: reader-2
covers: 2
output: research/frontier-19-reader-2.md

# Step 6a reader task

Open `research/frontier-19-batch-2.pages.json`, every listed item, every assigned
...
Write the evidence report to `research/frontier-19-reader-2.md`. It must list:
...
Return `research/frontier-19-reader-findings-2.json` under
