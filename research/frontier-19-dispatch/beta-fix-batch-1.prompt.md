...
# Batch `1` of run `frontier-19` — step-3 fix pass

The group Alpha that reviewed your batch returned numbered findings. **Find
which Alpha reviewed you**: check each
`research/frontier-19-alpha-<group>-step3-scaffold-review.md` for your batch
...
5. Append `## Step-3 fix pass` to `research/frontier-19-batch-1.notes.md`, one
