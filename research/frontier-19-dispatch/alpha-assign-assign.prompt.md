...
label: assign
covers: all
output: research/frontier-19-alpha-groups.json

# Assign batches to group Alphas — run `frontier-19`
...
`research/frontier-19-alpha-groups.json` and stop.
...
```
node tools/alpha-groups.mjs --run frontier-19 --facts
```
...
`research/frontier-19-alpha-groups.json`:
...
```
node tools/alpha-groups.mjs --run frontier-19
```
