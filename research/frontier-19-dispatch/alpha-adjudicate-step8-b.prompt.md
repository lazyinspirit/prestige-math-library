...
You are the group Alpha for batches **2**, **3**, **4**: 3 A/B pair(s), 6 page(s), 120 item(s), 59 open rejection(s) over 59 item(s).
...
|---|---|---|---|
| `cex-indefinite-classes-have-cycles-of-reduced-forms` | `positive-definite-binary-quadratic-forms-and-reduction-examples` | gpt-5.6-terra | `39eb41ae94ae645e291dfdc6022b422b807aeaaaf1ce209965b5a69d92d40292` |
| `cex-same-represented-integers-do-not-imply-proper-equivalence` | `positive-definite-binary-quadratic-forms-and-reduction-examples` | gpt-5.6-terra | `c2a227d92344e830e42a4e9bcb297adf7ab88879e4f9068b0ae035961b2eaaa2` |
| `cor-binary-quadratic-form-equivalence-is-decidable` | `positive-definite-binary-quadratic-forms-and-reduction` | gpt-5.6-terra | `bad683f493d307f21632762f3958445e8cb2c166926b6d68dd186b683ccf0546` |
| `cor-degree-of-f-adjoin-an-nth-root-by-coset-order` | `solvability-by-radicals-and-kummer-theory` | gpt-5.6-terra | `2dc37ef5a1956e9b03d00d8d24bdae36fe231196f7d991b844234d162e65689e` |
| `cor-finiteness-of-positive-definite-binary-form-classes` | `positive-definite-binary-quadratic-forms-and-reduction` | gpt-5.6-terra | `5f53a86017d0cbe1d80bec735bdeffccc9bd2936f4d8c2749153801f7d78f17b` |
| `cor-localisation-commutes-with-finite-intersections-of-submodules` | `localisation-of-modules-and-support` | gpt-5.6-terra | `0cf2c74426d7d85c970a47666c97314f21eb87c485b5806bd21898d86f986b81` |
| `cor-localisation-commutes-with-kernels-images-and-cokernels` | `localisation-of-modules-and-support` | gpt-5.6-terra | `531cab68671d18c977ccc0296807c02c91c5720e71fc1b723801fe8378344f7a` |
| `cor-minimal-generators-over-a-local-ring` | `localisation-of-modules-and-support` | gpt-5.6-terra | `8c645301db9393cc962e8b6fe7cb3c73b57b043a33503238835e2a0f8d9485db` |
| `cor-polynomials-of-degree-at-most-four-are-solvable-by-radicals` | `solvability-by-radicals-and-kummer-theory` | gpt-5.6-terra | `04d4d95b4786e9770612b96386eac6e9b1b92a3606503c68e90dfa834d296917` |
| `def-kummer-extension` | `solvability-by-radicals-and-kummer-theory` | gpt-5.6-terra | `4a3991cd5879a824069da94293b4ada0ad91974e86c7a0849c0f36b0458bd00c` |
| `def-support-of-a-module` | `localisation-of-modules-and-support` | gpt-5.6-terra | `4f035f03188f6cb4a02aa74d1b281c72a326371c1c22b5fc5697be035a4b5d06` |
| `def-trace-form-of-a-finite-extension` | `solvability-by-radicals-and-kummer-theory` | gpt-5.6-terra | `019142cb9d943617980d575f6face7212e73639d222d4ee5d8da105bdc0be880` |
| `ex-a-quartic-solved-by-its-resolvent-cubic` | `solvability-by-radicals-and-kummer-theory-examples` | gpt-5.6-terra | `58f35936641f3b44190a2e32e5d4fed713b53f6134b57517bcacfa15ed4cfeba` |
| `ex-an-artin-schreier-extension-over-f-p-of-t` | `solvability-by-radicals-and-kummer-theory-examples` | gpt-5.6-terra | `e2e9d17b4c90086cd6c2af9621d844828ace923ed06f6637d8529054b5c94270` |
| `ex-cardano-from-the-lagrange-resolvent` | `solvability-by-radicals-and-kummer-theory-examples` | gpt-5.6-terra | `8611fa7d5ca0833db728c89775e39bd0ae0f643b321c3fe777d74ffe5e1cae23` |
| `ex-hilbert-90-and-pythagorean-triples` | `solvability-by-radicals-and-kummer-theory-examples` | gpt-5.6-terra | `e603220c2abd2a962480003a5b1e271825ca128f0f7f217ef25e1f03c310481d` |
| `ex-local-test-for-an-isomorphism` | `localisation-of-modules-and-support-examples` | gpt-5.6-terra | `be6973babed8e33f7f7742e0c313893c74b1b806b2c8f73b971f1c8e44bce3db` |
| `ex-localisation-does-not-commute-with-products` | `localisation-of-modules-and-support-examples` | gpt-5.6-terra | `c7ac8bda8d842d80d015a7f5a30df5188bd35587fa4ea248830bd6ab6724f99e` |
| `ex-localisation-kills-exactly-s-torsion` | `localisation-of-modules-and-support-examples` | gpt-5.6-terra | `e41bb5cb87ca83499fd9d8b108076506167f193ede7e0664e989b44136229fdb` |
| `ex-localised-hom-needs-finite-presentation` | `localisation-of-modules-and-support-examples` | gpt-5.6-terra | `87e6fb70754bad0edbbabcd9e04c577567086fd36db213774ff88df53deb89b2` |
| `ex-localising-an-abelian-group-at-a-prime` | `localisation-of-modules-and-support-examples` | gpt-5.6-terra | `de6b15471eaf1f5be7650147ffd454048ae33871e93851454595ccf9cb123df2` |
| `ex-nakayama-finite-generation-is-essential` | `localisation-of-modules-and-support-examples` | gpt-5.6-terra | `2f11f686d7318c2c09512159e600aec326d61de779fb9c941201503fc329a325` |
| `ex-nakayama-jacobson-hypothesis-is-essential` | `localisation-of-modules-and-support-examples` | gpt-5.6-terra | `90fc7389f295f992de8c96ab2adc7509b1edead37ff8fb2a0d5ee97c83837136` |
| `ex-norm-and-trace-in-a-quadratic-extension` | `solvability-by-radicals-and-kummer-theory-examples` | gpt-5.6-terra | `8e114a697984c6580c4146fe3589a49e79911c4cfbc4a0968c6615395123222f` |
| `ex-proper-versus-improper-equivalence-of-forms` | `positive-definite-binary-quadratic-forms-and-reduction-examples` | gpt-5.6-terra | `fd5c691486a610f37b0c5b3315903da305e9097c4fc20633b92db3f46e279f89` |
| `ex-q-zeta-three-cuberoot-two-cuberoot-three-is-a-kummer-extension` | `solvability-by-radicals-and-kummer-theory-examples` | gpt-5.6-terra | `3b9b300302c188a832d9fb4251a0ab7ff8a9ef2714c1cee28d31ce03c46265bf` |
| `ex-reduced-forms-of-discriminant-minus-eight` | `positive-definite-binary-quadratic-forms-and-reduction-examples` | gpt-5.6-terra | `0993230582ffeb6545b7bd77bf1d32183906ab16034d36fa9e5322ea2a17af19` |
| `ex-reduced-forms-of-discriminant-minus-four` | `positive-definite-binary-quadratic-forms-and-reduction-examples` | gpt-5.6-terra | `f352f744e40f93cb896ed2de247a7c476285c5ed758ea067e55975ae0ead3c97` |
| `ex-reduced-forms-of-discriminant-minus-twenty` | `positive-definite-binary-quadratic-forms-and-reduction-examples` | gpt-5.6-terra | `9bf0535b48494532abf784b36417e242ce8dd99727de0cf7fbdd52f2b331642d` |
| `ex-reduced-forms-of-discriminant-minus-twenty-three` | `positive-definite-binary-quadratic-forms-and-reduction-examples` | gpt-5.6-terra | `a71e488667de76e245e46b7a3b92e20f62505d8ae96824a4d34dc641e419166e` |
| `ex-support-of-an-infinite-direct-sum` | `localisation-of-modules-and-support-examples` | gpt-5.6-terra | `6b08f1a6350d1312350d2c96a25aed503af51407f64e5dac75e9f11793ba7ff2` |
| `fs-solvable-by-radicals-does-not-force-an-abelian-galois-group` | `solvability-by-radicals-and-kummer-theory-examples` | gpt-5.6-terra | `a70863884ca6c1410a9f3fa13e2a97b34310cd97a4cff4e77953f43d68d55775` |
| `lem-adjoining-roots-of-unity-to-a-galois-extension-adds-an-abelian-kernel` | `solvability-by-radicals-and-kummer-theory` | gpt-5.6-terra | `c4da943e9038b06057dceb4af2d5c4db5e86291b2d86f1cad6765247ab466e91` |
| `lem-determinant-trick-for-nakayama` | `localisation-of-modules-and-support` | gpt-5.6-terra | `83e5a6f81d67680247164642b556c6969bfb9f19cf1cdec718f691dce56fe8d8` |
| `lem-leading-coefficient-is-minimal-in-a-reduced-class` | `positive-definite-binary-quadratic-forms-and-reduction` | gpt-5.6-terra | `880408ad2edfeeef88b801be4a81cbf61277a2aabeead0afdcf045f8f7324771` |
| `lem-localised-hom-finite-free-case` | `localisation-of-modules-and-support` | gpt-5.6-terra | `2d16907b9de46795cf73668e52be37501f2f71ee96f2c82393b61ccc30f50e14` |
| `lem-localised-hom-finite-presentation-kernel-step` | `localisation-of-modules-and-support` | gpt-5.6-terra | `dc16dd7f9ee03f3d9824be22933007a588080fb9a9aaf2f3c2e3163e0272b7c6` |
| `lem-normal-closure-of-a-radical-extension-is-radical` | `solvability-by-radicals-and-kummer-theory` | gpt-5.6-terra | `9d5ab61016307d326646969cce92f9f9b6f7d16f90de7bf3b5e4600f9bbd6a00` |
| `lem-support-of-a-finite-module-is-union-of-generator-cyclic-supports` | `localisation-of-modules-and-support` | gpt-5.6-terra | `736fa50e7394b00a443de4c71efca24ea14a85ca3f8ce8f7c2b365289da6fc66` |
| `prop-binary-quadratic-form-discriminants-modulo-four` | `positive-definite-binary-quadratic-forms-and-reduction` | gpt-5.6-terra | `11e1736cf4a41ae568f2847f7f153f6a5e4e6e9e2f17fd4307555cfa48038d64` |
| `prop-positive-definite-binary-form-criterion` | `positive-definite-binary-quadratic-forms-and-reduction` | gpt-5.6-terra | `27d694e01bdf4875b8b46c27199f547a326cf502ba26ceb98aad94381a9fc740` |
| `thm-additive-hilberts-theorem-90` | `solvability-by-radicals-and-kummer-theory` | gpt-5.6-terra | `0e734836da1f4da11d55415c36c6a5056a135ed49291d62b80e76ed30fc82a27` |
| `thm-artin-schreier-characterization-of-cyclic-degree-p-extensions` | `solvability-by-radicals-and-kummer-theory` | gpt-5.6-terra | `c05ca75f567f96f78a8d32087b07f06b29a9291dbc9f7499cd5e8f4d5346ea82` |
| `thm-basic-laws-for-field-norm-and-trace` | `solvability-by-radicals-and-kummer-theory` | gpt-5.6-terra | `397f6bcbc545680972474b80c3d09e4ccb0e944ddb15e41ea309fee01ecc95ff` |
| `thm-cyclic-degree-n-extensions-with-roots-of-unity-are-kummer` | `solvability-by-radicals-and-kummer-theory` | gpt-5.6-terra | `e41aa11003b0d54c8b8a4a3f938c24df18b39f494a2d9ab1ef3cc92f325c7a24` |
| `thm-field-norm-and-trace-by-embeddings` | `solvability-by-radicals-and-kummer-theory` | gpt-5.6-terra | `28f995e8668a2cb9682c671f450034078c184268acde75f8870620f408ed7388` |
| `thm-general-polynomial-of-degree-n-has-galois-group-s-n` | `solvability-by-radicals-and-kummer-theory` | gpt-5.6-terra | `a4b4864184231f61c0d2861d7fac4e899735cf45bc1ef55b0bcb76a9ebea9d8d` |
| `thm-kummer-correspondence` | `solvability-by-radicals-and-kummer-theory` | gpt-5.6-terra | `94e7df8ff04d58ececa792087303319b516c49b8f249c9d0c49330f5b96cccb5` |
| `thm-local-criterion-for-zero-modules-and-maps` | `localisation-of-modules-and-support` | gpt-5.6-terra | `a81de50035abdaa27d0b0324be8bee9463c395f58670fc90b26c1ef2b7769ebe` |
| `thm-localisation-of-modules-commutes-with-quotients-and-sums` | `localisation-of-modules-and-support` | gpt-5.6-terra | `9327e773c4677727e0eea9e9c8765d60961a510658093e2dad05abcbc4c1d485` |
| `thm-localisation-of-modules-is-tensor-product` | `localisation-of-modules-and-support` | gpt-5.6-terra | `ddd14de18966c14f47ebf1dd982a8fe96af65c748448aff20096c0e793b1aa70` |
| `thm-reduction-of-positive-definite-binary-quadratic-forms` | `positive-definite-binary-quadratic-forms-and-reduction` | gpt-5.6-terra | `0a12fb3a77861473500f5af0217a78698383a779e8d775fcd9741ef3e56d39e2` |
| `thm-solvable-by-radicals-implies-a-solvable-galois-group` | `solvability-by-radicals-and-kummer-theory` | gpt-5.6-terra | `a586b27a35420116976eb161ea46db65210356c71ad951c71893732f1f3da420` |
| `thm-solvable-galois-group-implies-solvable-by-radicals` | `solvability-by-radicals-and-kummer-theory` | gpt-5.6-terra | `653c49600b7afe176b2f8e2e9e214d86ffcb79695e036b759bf68a67135dd6a0` |
| `thm-support-and-annihilator-of-a-finite-module` | `localisation-of-modules-and-support` | gpt-5.6-terra | `416572e63c3d1a9a1d7fd4ebb221c95e430229ee15d6ddcf4db5cda47560e7b7` |
| `thm-support-of-a-tensor-product-of-finite-modules` | `localisation-of-modules-and-support` | gpt-5.6-terra | `a19958dc88330771d8b9af86f7de1f60072bdf421ba70c49045c4669b9e9afcc` |
| `thm-support-under-localisation` | `localisation-of-modules-and-support` | gpt-5.6-terra | `ce659b667fe075886de36c6ec39672de501cef0ea8aacc0aa32c0d398bc55206` |
| `thm-unique-reduced-positive-definite-binary-quadratic-form` | `positive-definite-binary-quadratic-forms-and-reduction` | gpt-5.6-terra | `2789f32264fbb8fbb040cf4b9c21d2765ba368207e3b7a70f2c45444f1b0b6a2` |
| `thm-universal-property-localisation-of-a-module` | `localisation-of-modules-and-support` | gpt-5.6-terra | `b9a17d89f0e2302350f22241422acb6f842c967d1e91fe06e94464c25853f78a` |
