...
label: reader-1
covers: 1
output: research/frontier-19-reader-1.md

# Step 6a reader task

Open `research/frontier-19-batch-1.pages.json`, every listed item, every assigned
...
Write the evidence report to `research/frontier-19-reader-1.md`. It must list:
...
Return `research/frontier-19-reader-findings-1.json` under
