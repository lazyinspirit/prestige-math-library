...
run: frontier-19
role: alpha
label: contract-audit-3

# Contract-detector adjudication, run `frontier-19`
...
`research/frontier-19-batch-<i>.proof-contracts.json` entry. Then re-merge and
...
why. Write `research/frontier-19-alpha-contract-audit.md`: per candidate, the
