...
run: frontier-19
role: beta
label: reharvest-1-b8
covers: 8

> **Re-harvest round.** Your batch number is in the "This dispatch" section
> appended below; substitute it wherever `8` appears.

# Batch `8` of run `frontier-19` — a source is gone; its results are not
...
```
node tools/source-backing.mjs --coverage research/frontier-19-batch-8.coverage.json \
...
```
node tools/source-backing.mjs --coverage research/frontier-19-batch-8.coverage.json --liveness research/frontier-19-url-liveness.json
node tools/coverage-checklist.mjs research/frontier-19-batch-8.coverage.json --require-destination
node tools/url-sweep.mjs --coverage research/frontier-19-batch-8.coverage.json --recover --fail-on-dead
node tools/source-fetch-check.mjs --coverage research/frontier-19-batch-8.coverage.json --stamp
```

## Report

Append `## Re-harvest round` to `research/frontier-19-batch-8.notes.md`: the dead
...
`research/frontier-19-batch-8.coverage.json` and `.notes.md`. Keep `original_url`
