<!-- Dispatched as-is. `frontier-19` and `4` are substituted by tools/dispatch.mjs
...
# Scaffolding brief — run `frontier-19`, batch `4` (steps 1 and 2)
...
`research/frontier-19-batch-4.notes.md`: current substage, owned artifact paths,
...
- `research/frontier-19-batch-4.pages.json` — your batch's page objects in final
...
- `research/frontier-19-batch-4.notes.md` — prose-scaffold amendments as precise
  ...
  route, and necessity.
- `research/frontier-19-batch-4.proof-contracts.json` — the version-1
...
# Batch 4 of run `frontier-19` — Localisation of Modules and Support
...
| | |
|---|---|
| A page | `localisation-of-modules-and-support` · order **111.003** · `commutative-algebra` |
| B page | `localisation-of-modules-and-support-examples` |
| title | Localisation of Modules and Support |
| requires | `noetherian-rings-and-hilbert-basis-examples` |
| design | `plan-commutative-algebra-track.md` L297 (id mention, not a heading — locate the section yourself) |
