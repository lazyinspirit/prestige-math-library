...
You are the group Alpha for batches **7**, **8**: 3 A/B pair(s), 6 page(s), 97 item(s), 14 open rejection(s) over 14 item(s).
...
|---|---|---|---|
| `cex-a-proper-subgroup-of-r-can-be-nonmeasurable` | `non-measurable-sets-and-the-cost-of-choice-examples` | gpt-5.6-terra | `622a58bd1808b697952804f8adbc6fb4631da76c9ed9d95a988a5b6c43b6435b` |
| `cor-every-subset-of-r-of-positive-outer-measure-contains-a-nonmeasurable-subset` | `non-measurable-sets-and-the-cost-of-choice` | gpt-5.6-terra | `43a94d347becef3eaa5fa6ab88eebf24104af37c07e0d8621a5a4c371f03c85d` |
| `cor-residue-contour-integral-formula` | `isolated-singularities-and-laurent-series` | gpt-5.6-terra | `fab8033367f6c3c8600d149c7f2f3bd0bfa5c00dd525819f8ad900c472e5ca94` |
| `def-lebesgue-inner-measure-on-r` | `non-measurable-sets-and-the-cost-of-choice` | gpt-5.6-terra | `e9a74c50b3333b891579ccd63e01e4f165bd1ea5f3b43cb0a7580e53af1718ca` |
| `ex-harnack-inequality-for-a-poisson-kernel` | `harmonic-functions-and-the-poisson-integral-examples` | gpt-5.6-terra | `a6d9d45e80d58bbe91446b3f515f163bc39f67161a82746e87a943d65c6ae1c6` |
| `ex-singularities-at-infinity-for-polynomials-and-reciprocals` | `isolated-singularities-and-laurent-series-examples` | gpt-5.6-terra | `b272a24b5b433a2db0a653f0358088a7370c3dae87a9ff53eb2cc90ad19cb8cc` |
| `fs-a-nonmeasurable-set-can-be-constructed-without-the-axiom-of-choice` | `non-measurable-sets-and-the-cost-of-choice-examples` | gpt-5.6-terra | `f3557d7891b43ddce7ad36fd440c54bc4ff94111edf3ea2c8dba0e159e38142b` |
| `lem-compact-subsets-of-a-bernstein-set-are-countable` | `non-measurable-sets-and-the-cost-of-choice` | gpt-5.6-terra | `5e2c5ea0475bf226e71cf3592c01f0bc41c661d68322d305367e6d90b48d4a0b` |
| `lem-finite-binary-digit-changes-do-not-alter-zero-one-measure` | `non-measurable-sets-and-the-cost-of-choice` | gpt-5.6-terra | `683cb2b83d2512b830e3eeba967e30e8b18ce462b3c655f06348328ac72d18ab` |
| `thm-a-bernstein-set-has-inner-measure-zero-and-full-outer-measure-in-every-interval` | `non-measurable-sets-and-the-cost-of-choice` | gpt-5.6-terra | `7b1f7e6ec5155cb7430cef831b0a57efdfc06a4db4ec2a8ec9802d06f7bad688` |
| `thm-a-free-ultrafilter-on-n-is-not-lebesgue-measurable` | `non-measurable-sets-and-the-cost-of-choice` | gpt-5.6-terra | `67a5b8787841a2ee512270a83e28d651b0da4b221529e665a4e5816557ace119` |
| `thm-harmonic-and-holomorphic-schwarz-reflection-principles` | `harmonic-functions-and-the-poisson-integral` | gpt-5.6-terra | `75bb7753fda3883cc296ec58d5c23801a88af53132626444470dacc8c2383a1b` |
| `thm-laurent-expansion-annulus` | `isolated-singularities-and-laurent-series` | gpt-5.6-terra | `8473595e18901a59203d9646d83e4ad6fb790e81e18085e104cef5cb89f85fb4` |
| `thm-maximum-and-minimum-principles-for-plane-harmonic-functions` | `harmonic-functions-and-the-poisson-integral` | gpt-5.6-terra | `746dced26f76822bc76f0509dee5f44e245b9cbce5100cc43ba179e3a6c8a6b1` |
