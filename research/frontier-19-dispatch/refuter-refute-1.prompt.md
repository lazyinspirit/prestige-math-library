...
`research/frontier-19-step6-scope-1.json`: every reader-untouched item, every
...
Read `research/frontier-19-reader-1.md` for context, but verify from item and
...
dispatcher writes `research/frontier-19-refute-1.json`.
...
label: refute-1
covers: 1
output: research/frontier-19-refute-1.json

# Step 6a refutation — assigned batch

Derive the batch number from the dispatch label. Open
`research/frontier-19-step6-scope-1.json` and audit every id in `refuter_scope`:
all reader-untouched items, all high/critical-risk items, and the assigned page
prose.

Read `research/frontier-19-reader-1.md`, then verify from disk. Trace each proof,
