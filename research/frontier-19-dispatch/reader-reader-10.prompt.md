...
label: reader-10
covers: 10
output: research/frontier-19-reader-10.md

# Step 6a reader task

Open `research/frontier-19-batch-10.pages.json`, every listed item, every assigned
...
Write the evidence report to `research/frontier-19-reader-10.md`. It must list:
...
Return `research/frontier-19-reader-findings-10.json` under
