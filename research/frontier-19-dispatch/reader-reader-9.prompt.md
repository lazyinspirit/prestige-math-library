...
label: reader-9
covers: 9
output: research/frontier-19-reader-9.md

# Step 6a reader task

Open `research/frontier-19-batch-9.pages.json`, every listed item, every assigned
...
Write the evidence report to `research/frontier-19-reader-9.md`. It must list:
...
Return `research/frontier-19-reader-findings-9.json` under
