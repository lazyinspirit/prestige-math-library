...
label: reader-8
covers: 8
output: research/frontier-19-reader-8.md

# Step 6a reader task

Open `research/frontier-19-batch-8.pages.json`, every listed item, every assigned
...
Write the evidence report to `research/frontier-19-reader-8.md`. It must list:
...
Return `research/frontier-19-reader-findings-8.json` under
