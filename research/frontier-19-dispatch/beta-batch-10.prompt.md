<!-- Dispatched as-is. `frontier-19` and `10` are substituted by tools/dispatch.mjs
...
# Scaffolding brief — run `frontier-19`, batch `10` (steps 1 and 2)
...
`research/frontier-19-batch-10.notes.md`: current substage, owned artifact paths,
...
```
node tools/source-fetch-check.mjs --coverage research/frontier-19-batch-10.coverage.json --stamp
```
...
```
node tools/coverage-checklist.mjs research/frontier-19-batch-10.coverage.json
```
...
- `research/frontier-19-batch-10.pages.json` — your batch's page objects in final
...
- `research/frontier-19-batch-10.notes.md` — prose-scaffold amendments as precise
  ...
  route, and necessity.
- `research/frontier-19-batch-10.proof-contracts.json` — the version-1
...
# Batch 10 of run `frontier-19` — Polynomial Rödl, Virality and Erdős–Hajnal Equivalence

1 A/B pair, combinatorics. You own every page here and you author them all at step 5.

## `polynomial-rodl-and-viral-equivalence`

| | |
|---|---|
| A page | `polynomial-rodl-and-viral-equivalence` · order **405** · `combinatorics` |
| B page | `polynomial-rodl-and-viral-equivalence-examples` |
...
| design | `plan-combinatorics-and-categories.md` L3902 (id mention, not a heading — locate the section yourself) |
