<!-- Dispatched as-is. `frontier-19` and `5` are substituted by tools/dispatch.mjs
...
# Scaffolding brief — run `frontier-19`, batch `5` (steps 1 and 2)
...
You are **Beta-5**, running **Claude Opus 5 via the claude CLI
at `xhigh` reasoning with a 1,000,000-token context window** (owner, 2026-08-23),
scaffolding run `frontier-19` of the public math library, whose checkout is the
...
`research/frontier-19-batch-5.notes.md`: current substage, owned artifact paths,
...
```
node tools/source-fetch-check.mjs --coverage research/frontier-19-batch-5.coverage.json --stamp
```
...
```
node tools/coverage-checklist.mjs research/frontier-19-batch-5.coverage.json
```
...
- `research/frontier-19-batch-5.pages.json` — your batch's page objects in final
...
- `research/frontier-19-batch-5.notes.md` — prose-scaffold amendments as precise
  ...
  route, and necessity.
- `research/frontier-19-batch-5.proof-contracts.json` — the version-1
...
6. **Cross-batch dependencies** — anything your batch needs from the other
   batch of run `frontier-19`, or that you believe the other batch will need from you.
...
# Batch 5 of run `frontier-19` — Combinatorial Classes and the Symbolic Method · Permutation Statistics, Inversions and Eulerian Numbers
...
| | |
|---|---|
| A page | `combinatorial-classes-and-the-symbolic-method` · order **194.1** · `combinatorics` |
| B page | `combinatorial-classes-and-the-symbolic-method-examples` |
| title | Combinatorial Classes and the Symbolic Method |
| requires | `formal-power-series`, `finite-counting-and-binomial-coefficients`, `congruences-and-the-chinese-remainder-theorem`, `group-actions-and-cayleys-theorem` |
| design | `plan-combinatorics-and-categories.md` L4519 |
...
| | |
|---|---|
| A page | `permutation-statistics-inversions-and-eulerian-numbers` · order **198.1** · `combinatorics` |
| B page | `permutation-statistics-inversions-and-eulerian-numbers-examples` |
| title | Permutation Statistics, Inversions and Eulerian Numbers |
| requires | `symmetric-groups-and-the-sign-homomorphism`, `combinatorial-classes-and-the-symbolic-method`, `formal-power-series`, `finite-counting-and-binomial-coefficients` |
| design | `plan-combinatorics-and-categories.md` L4714 |
