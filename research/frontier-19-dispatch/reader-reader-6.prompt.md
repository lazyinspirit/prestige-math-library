...
label: reader-6
covers: 6
output: research/frontier-19-reader-6.md

# Step 6a reader task

Open `research/frontier-19-batch-6.pages.json`, every listed item, every assigned
...
Write the evidence report to `research/frontier-19-reader-6.md`. It must list:
...
Return `research/frontier-19-reader-findings-6.json` under
