...
`research/frontier-19-step6-scope-6.json`: every reader-untouched item, every
...
Read `research/frontier-19-reader-6.md` for context, but verify from item and
...
dispatcher writes `research/frontier-19-refute-6.json`.
...
label: refute-6
covers: 6
output: research/frontier-19-refute-6.json

# Step 6a refutation — assigned batch

Derive the batch number from the dispatch label. Open
`research/frontier-19-step6-scope-6.json` and audit every id in `refuter_scope`:
all reader-untouched items, all high/critical-risk items, and the assigned page
prose.

Read `research/frontier-19-reader-6.md`, then verify from disk. Trace each proof,
