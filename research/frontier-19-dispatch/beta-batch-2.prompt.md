<!-- Dispatched as-is. `frontier-19` and `2` are substituted by tools/dispatch.mjs
...
# Scaffolding brief — run `frontier-19`, batch `2` (steps 1 and 2)
...
`research/frontier-19-batch-2.notes.md`: current substage, owned artifact paths,
...
```
node tools/coverage-checklist.mjs research/frontier-19-batch-2.coverage.json
```
...
- `research/frontier-19-batch-2.pages.json` — your batch's page objects in final
...
- `research/frontier-19-batch-2.notes.md` — prose-scaffold amendments as precise
  ...
  route, and necessity.
- `research/frontier-19-batch-2.proof-contracts.json` — the version-1
...
# Batch 2 of run `frontier-19` — Positive Definite Binary Quadratic Forms and Reduction

1 A/B pair, number-theory. You own every page here and you author them all at step 5.

## `positive-definite-binary-quadratic-forms-and-reduction`

| | |
|---|---|
| A page | `positive-definite-binary-quadratic-forms-and-reduction` · order **78.1** · `number-theory` |
| B page | `positive-definite-binary-quadratic-forms-and-reduction-examples` |
| title | Positive Definite Binary Quadratic Forms and Reduction |
| requires | `lagrange-four-square-theorem-examples`, `group-actions-and-cayleys-theorem`, `matrices-and-the-matrix-of-a-linear-map` |
| design | `plan-number-theory-track.md` L657 |
