<!-- Dispatched as-is. `frontier-19` and `8` are substituted by tools/dispatch.mjs
...
# Scaffolding brief — run `frontier-19`, batch `8` (steps 1 and 2)
...
`research/frontier-19-batch-8.notes.md`: current substage, owned artifact paths,
...
`research/frontier-19-batch-8.coverage.json`:
...
```
node tools/source-fetch-check.mjs --coverage research/frontier-19-batch-8.coverage.json --stamp
```
...
- `research/frontier-19-batch-8.pages.json` — your batch's page objects in final
...
- `research/frontier-19-batch-8.notes.md` — prose-scaffold amendments as precise
  ...
  route, and necessity.
- `research/frontier-19-batch-8.proof-contracts.json` — the version-1
...
# Batch 8 of run `frontier-19` — Isolated Singularities and Laurent Series · Harmonic Functions and the Poisson Integral
...
| | |
|---|---|
| A page | `isolated-singularities-and-laurent-series` · order **317** · `complex-analysis` |
| B page | `isolated-singularities-and-laurent-series-examples` |
| title | Isolated Singularities and Laurent Series |
| requires | `the-winding-number-and-the-global-cauchy-theorem` |
| design | `plan-complex-analysis-track.md` L1409 |
...
| | |
|---|---|
| A page | `harmonic-functions-and-the-poisson-integral` · order **327** · `complex-analysis` |
| B page | `harmonic-functions-and-the-poisson-integral-examples` |
| title | Harmonic Functions and the Poisson Integral |
| requires | `the-winding-number-and-the-global-cauchy-theorem`, `the-identity-theorem-and-the-open-mapping-theorem`, `mixed-partials-taylor-and-extrema` |
| design | `plan-complex-analysis-track.md` L1922 |
