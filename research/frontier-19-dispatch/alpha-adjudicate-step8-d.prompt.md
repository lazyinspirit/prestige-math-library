...
You are the group Alpha for batches **5**, **6**, **10**: 5 A/B pair(s), 10 page(s), 123 item(s), 51 open rejection(s) over 51 item(s).
...
|---|---|---|---|
| `cex-same-descent-set-different-inversion-number` | `permutation-statistics-inversions-and-eulerian-numbers-examples` | gpt-5.6-terra | `040580797492f4365edb8636946f4e2ae44a6ac04db78333cafd5d826c04aefd` |
| `cex-two-latin-squares-need-not-be-orthogonal` | `block-designs-and-finite-projective-planes-examples` | gpt-5.6-terra | `c71e86e39772d43bdb8f38e98663c309570f03bd0bce4c22dd5ac05b46c63078` |
| `cor-binary-trees-satisfy-b-equals-one-plus-z-b-squared` | `combinatorial-classes-and-the-symbolic-method` | gpt-5.6-terra | `fa566e542d19e7ffa7bdd31b3cae50304938135837e613f639d11a0f19cfff6a` |
| `cor-binary-words-have-generating-function-one-over-one-minus-two-x` | `combinatorial-classes-and-the-symbolic-method` | gpt-5.6-terra | `3ce55b6af4068a8b5c05f1f23861d8fbfd1aa7d69959f264e6ac758a5d4911d5` |
| `cor-eulerian-numbers-are-symmetric` | `permutation-statistics-inversions-and-eulerian-numbers` | gpt-5.6-terra | `0b7ebe7d3298ec4d88c778071a26f85102ec46f866766e1a62d7a2c9926eb1be` |
| `cor-eulerian-polynomial-exponential-generating-function` | `permutation-statistics-inversions-and-eulerian-numbers` | gpt-5.6-terra | `2a723a57dee7a4159c3e59a2ad32fc50cab3ecb17e87a477b771711686f6cab3` |
| `cor-necklaces-over-an-m-letter-alphabet` | `combinatorial-classes-and-the-symbolic-method` | gpt-5.6-terra | `3ec1259d60dd0b48c2a3a72ea8b123dcb80409ce9422909d96eb2936ab49b23a` |
| `cor-plane-trees-satisfy-t-equals-z-over-one-minus-t` | `combinatorial-classes-and-the-symbolic-method` | gpt-5.6-terra | `7af36dae559683f93176cd3224e851a0e90e4032f1932ecd77250e3434037b44` |
| `cor-the-loglog-bound-eventually-dominates-the-classical-bound` | `classical-and-loglog-erdos-hajnal-bounds` | gpt-5.6-terra | `ef308fbbd76b58f3f6df951cc2faebb64c83b96e1732eef4676fafdcc46ceb6b` |
| `def-combinatorial-class-and-ordinary-generating-function` | `combinatorial-classes-and-the-symbolic-method` | gpt-5.6-terra | `d784f8cd999b4ea596018892c2872a564c616613e5e65728481d4997a43a18bd` |
| `def-combinatorial-specification-and-order-raising-recursion` | `combinatorial-classes-and-the-symbolic-method` | gpt-5.6-terra | `619601a88e2a7cc150b0a365f73f3eda91f264c827c060668207ff77365a3cc4` |
| `def-disjoint-union-and-cartesian-product-of-combinatorial-classes` | `combinatorial-classes-and-the-symbolic-method` | gpt-5.6-terra | `719e48da4a7a4cd95f80221c3ef0e5877dafa90fdaa4cb4ba8b8a63fc6e54d34` |
| `def-multiset-and-powerset-constructions` | `combinatorial-classes-and-the-symbolic-method` | gpt-5.6-terra | `aa8408b0d7982e671629652d6eeab4438f4eedd51332517ec3b2965e791fad80` |
| `def-standard-cycle-form-and-foata-fundamental-transformation` | `permutation-statistics-inversions-and-eulerian-numbers` | gpt-5.6-terra | `a6506cfd590821d92b4440a291d19bb227afed92e4c6ca3473e969c960cbca99` |
| `def-steiner-systems-and-steiner-triple-systems` | `block-designs-and-finite-projective-planes` | gpt-5.6-terra | `4a6374c610bf9af098fc836d19dbc2a914d4e5f397236d9ce09ae46fc38d7474` |
| `def-substitution-of-combinatorial-classes` | `combinatorial-classes-and-the-symbolic-method` | gpt-5.6-terra | `4107c45c712650eb8cc85db707797b8dedf2901e7d912cf6bddc35dec1a059e1` |
| `def-viral-property-for-a-finite-family` | `polynomial-rodl-and-viral-equivalence` | gpt-5.6-terra | `f1f776303cacecfab24c86010f17f35eb83207a57df2b4b0840aa7e3eff45f88` |
| `ex-a-family-containing-k-one-is-vacuously-viral` | `polynomial-rodl-and-viral-equivalence-examples` | gpt-5.6-terra | `47184cf3c9e43c0830ec6352213b9210e6b9bd033dec042279c4caf60cad9f47` |
| `ex-a-four-two-computed-three-ways` | `permutation-statistics-inversions-and-eulerian-numbers-examples` | gpt-5.6-terra | `ddbed5cd364232e4593087631f1fbc5f357567a74ed8a43d992b8a1371934de3` |
| `ex-choosing-x-for-the-classical-erdos-hajnal-bound` | `classical-and-loglog-erdos-hajnal-bounds-examples` | gpt-5.6-terra | `eae42047c7c99ca14b2fa190d80d2606cb818e79b2f8215c756d93e9f0f0fb6f` |
| `ex-choosing-x-for-the-loglog-erdos-hajnal-bound` | `classical-and-loglog-erdos-hajnal-bounds-examples` | gpt-5.6-terra | `7ad35d50e6f1e2c31a95e486f18e3758f7271dcc20d2b150efec3fe5ae4c79be` |
| `ex-p-three-free-graphs-have-much-larger-homogeneous-sets` | `classical-and-loglog-erdos-hajnal-bounds-examples` | gpt-5.6-terra | `b7f3baae72f15b6ec2888db78ee948ceb542130895cfc7d0fbeb91f69afe52c7` |
| `ex-partitions-with-parts-at-most-three` | `combinatorial-classes-and-the-symbolic-method-examples` | gpt-5.6-terra | `d77229571dd98efde71a1d0a075eab88e253c15814bcf45b3f3f7edce6417696` |
| `ex-pg-two-three-has-thirteen-points-and-thirteen-lines` | `block-designs-and-finite-projective-planes-examples` | gpt-5.6-terra | `852212ba65240f9142dd918a9625664abe7f87e4392dc4c886149255a42c11e1` |
| `ex-skolems-construction-gives-the-fano-plane` | `block-designs-and-finite-projective-planes-examples` | gpt-5.6-terra | `5516c1df03d5c146c9ba179093916a2c905ad5d59a27b01a24ddf87e8dde671d` |
| `ex-the-incidence-matrix-of-the-fano-plane` | `block-designs-and-finite-projective-planes-examples` | gpt-5.6-terra | `954c4862a184f6ac3f2635f100ce6beb6acea76fd4e1c036ba2966a7193b5883` |
| `ex-the-loglog-bound-is-still-subpolynomial` | `classical-and-loglog-erdos-hajnal-bounds-examples` | gpt-5.6-terra | `0ffc43adacace041c15897e874b295155025b96f95ca93bcc1cbd9afeaf77b59` |
| `ex-truncation-iteration-for-a-recursive-specification` | `combinatorial-classes-and-the-symbolic-method-examples` | gpt-5.6-terra | `14694e71cc2b6206e928c0b85677229c4b52ea1c54f819ce5fca6a95df1aabd5` |
| `ex-two-orthogonal-latin-squares-of-order-three` | `block-designs-and-finite-projective-planes-examples` | gpt-5.6-terra | `66cc281108f524262645d72359ff3c0db0bf35c8adcf5d2220e9d979dd8faf8d` |
| `fs-major-index-equals-inversion-number-pointwise` | `permutation-statistics-inversions-and-eulerian-numbers-examples` | gpt-5.6-terra | `85c206ea47bde4e7a843a0d70d38cd29aa1ef2dc6199ab81b21a3039c8e07367` |
| `fs-multiset-product-exists-for-every-coefficient-sequence` | `combinatorial-classes-and-the-symbolic-method-examples` | gpt-5.6-terra | `8342b297c5a641ce3f9c8d0a5082b0164e800009f70a1ded813f0c3135d0e167` |
| `lem-every-line-in-a-finite-projective-plane-has-the-same-number-of-points` | `block-designs-and-finite-projective-planes` | gpt-5.6-terra | `e522d38d6defea05054abe1e3040d05803a652dc966e54892a27d2e5b2bcec72` |
| `lem-many-good-two-t-vertex-sets-force-many-homogeneous-k-sets` | `polynomial-rodl-and-viral-equivalence` | gpt-5.6-terra | `3e35fcdabb89530aa711605c927cc657c3fd033d7161a6a836a259493157abbe` |
| `lem-no-large-epsilon-sparse-subgraph-bounds-k-stable-sets` | `polynomial-rodl-and-viral-equivalence` | gpt-5.6-terra | `17d38010e9d6fbffb84581797de21260a3825cad4ef35cce89d82e75643a1bfb` |
| `lem-small-total-copy-expectation-forces-many-homogeneous-k-sets` | `polynomial-rodl-and-viral-equivalence` | gpt-5.6-terra | `3483c16b8c491ba70d6a89b0378c18d7f5860ae76cb158631f0a04cb80a8b781` |
| `thm-a-finite-family-with-the-erdos-hajnal-property-is-viral` | `polynomial-rodl-and-viral-equivalence` | gpt-5.6-terra | `cb12dbc87ca0facaed5e8cc6285bfc08ba91778b84e29f0edfcca3470398fb8c` |
| `thm-bose-construction-produces-a-steiner-triple-system` | `block-designs-and-finite-projective-planes` | gpt-5.6-terra | `cee06e09cf79b3856a45f4e8c57260d22c3207896d6461c8bc0cc9af465eaf87` |
| `thm-classical-erdos-hajnal-bound` | `classical-and-loglog-erdos-hajnal-bounds` | gpt-5.6-terra | `a192d10f555dde17e185c8c4f24bc44ed62740409cf1cd15a8c8319c1c1ef251` |
| `thm-counting-identities-for-a-two-design` | `block-designs-and-finite-projective-planes` | gpt-5.6-terra | `f1d59a5b6a940df4037c662773b194c07103b183b2a161b5557b35cd1e57798d` |
| `thm-counts-in-a-finite-projective-plane` | `block-designs-and-finite-projective-planes` | gpt-5.6-terra | `cb07db7744804054571a875f7617967e60302f7eb1ba4e18dd38506030cea5a4` |
| `thm-cycle-construction-formula` | `combinatorial-classes-and-the-symbolic-method` | gpt-5.6-terra | `0dc96be6d25a2181942614ea8d35fa753b63db7dd5a50a5879d33fc5ee90cf13` |
| `thm-eulerian-recurrence` | `permutation-statistics-inversions-and-eulerian-numbers` | gpt-5.6-terra | `f6a03a35739a67a6581ab6271a4c109b00064bab64d8696ccf9f101832fcbb6b` |
| `thm-foata-transformation-sends-major-index-to-inversion-number` | `permutation-statistics-inversions-and-eulerian-numbers` | gpt-5.6-terra | `4f113b1584ebb38a543a34494f20fb25c2333aa2b079cfc6c267485c11c806ee` |
| `thm-incidence-matrix-identity-for-a-two-design` | `block-designs-and-finite-projective-planes` | gpt-5.6-terra | `5bb4bb7f24167116836b6e20b73b2272e1886c4ebf5448f0f9dcc7230510b003` |
| `thm-lehmer-code-is-a-bijection` | `permutation-statistics-inversions-and-eulerian-numbers` | gpt-5.6-terra | `62828d8423906002a6bff267193c2d4901cbe0cdc834f1407a3ca1c641e80136` |
| `thm-loglog-erdos-hajnal-bound` | `classical-and-loglog-erdos-hajnal-bounds` | gpt-5.6-terra | `22df6b31c921d0a5e68eac15a9a80b7380d025e3b94868780555e37ed718ab8c` |
| `thm-multiset-exponential-formula` | `combinatorial-classes-and-the-symbolic-method` | gpt-5.6-terra | `2dd46ed187c50bb493866f220c7a6806608f63321807883cf07506444d94d7d4` |
| `thm-order-raising-recursive-specifications-have-unique-solutions` | `combinatorial-classes-and-the-symbolic-method` | gpt-5.6-terra | `daf9a417d0fbc87940c39e72b36d7982a0e012db5b629eae702db63108319bd4` |
| `thm-pointing-rule-for-ordinary-generating-functions` | `combinatorial-classes-and-the-symbolic-method` | gpt-5.6-terra | `a54b4108f1752cb0d426d4189b58991583fbcb0bbfe2f51e6ba7a4688e4f4e1f` |
| `thm-q-factorial-counts-permutations-by-inversions` | `permutation-statistics-inversions-and-eulerian-numbers` | gpt-5.6-terra | `86f94a482a962d38b08fcb06562014608d9d02a288afa8781893d6a1bcc24ba4` |
| `thm-worpitzky-identity` | `permutation-statistics-inversions-and-eulerian-numbers` | gpt-5.6-terra | `cb9abe191c782bb63ca9d862e9585086dceb11480bfa3846385c00bd0279578b` |
