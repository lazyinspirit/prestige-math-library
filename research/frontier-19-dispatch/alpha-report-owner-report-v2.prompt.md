...
covers: all
output: research/frontier-19-step10-report.response.json

# Step 10 — interpret the final evidence for the owner, run `frontier-19`

You are a read-only reporting lane. The expensive mathematical validation is
finished. Read `research/frontier-19-step10-evidence.json`; consult a named source
