...
label: reader-5
covers: 5
output: research/frontier-19-reader-5.md

# Step 6a reader task

Open `research/frontier-19-batch-5.pages.json`, every listed item, every assigned
...
Write the evidence report to `research/frontier-19-reader-5.md`. It must list:
...
Return `research/frontier-19-reader-findings-5.json` under
