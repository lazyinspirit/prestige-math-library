...
Then edit `research/frontier-19-alpha-<your-group>-scope-decisions.json`. Replace
...
1. `research/frontier-19-alpha-<your-group>-step3-scaffold-review.md`, with stable
   finding ids `B<batch>-1`, a severity table, evidence, and per-pair verdicts.
2. `research/frontier-19-alpha-<your-group>-step3-verdicts.json`, one
   `sufficient`/`insufficient` row per A page. An insufficient row must name the
   exact missing result and source.
3. `research/frontier-19-alpha-<your-group>-scope-decisions.json`, with no pending
   or stale decision.
