...
label: receipts
covers: all
output: research/frontier-19-audit-coverage.json

# The whole-level receipts, run `frontier-19`
...
```
node tools/level-coverage.mjs --template research/frontier-19-audit-coverage.json \
