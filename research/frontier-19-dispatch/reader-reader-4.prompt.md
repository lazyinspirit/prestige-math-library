...
label: reader-4
covers: 4
output: research/frontier-19-reader-4.md

# Step 6a reader task

Open `research/frontier-19-batch-4.pages.json`, every listed item, every assigned
...
Write the evidence report to `research/frontier-19-reader-4.md`. It must list:
...
Return `research/frontier-19-reader-findings-4.json` under
