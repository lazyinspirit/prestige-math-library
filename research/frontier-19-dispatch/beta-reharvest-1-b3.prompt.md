<!-- Dispatched as-is. `frontier-19` and `3` are substituted by tools/dispatch.mjs
...
# Scaffolding brief — run `frontier-19`, batch `3` (steps 1 and 2)
...
You are **Beta-3**, running **Claude Opus 5 via the claude CLI
...
`research/frontier-19-batch-3.notes.md`: current substage, owned artifact paths,
...
- `research/frontier-19-batch-3.pages.json` — your batch's page objects in final
...
- `research/frontier-19-batch-3.notes.md` — prose-scaffold amendments as precise
  ...
  route, and necessity.
- `research/frontier-19-batch-3.proof-contracts.json` — the version-1
...
**`research/frontier-19-reharvest-plan.json`** — read `work[]`. Each entry gives
...
```
node tools/source-backing.mjs --coverage research/frontier-19-batch-3.coverage.json \
  --liveness research/frontier-19-url-liveness.json
```
...
node tools/url-sweep.mjs --coverage research/frontier-19-batch-3.coverage.json --recover --fail-on-dead
node tools/source-fetch-check.mjs --coverage research/frontier-19-batch-3.coverage.json --stamp
```

## Report

Append `## Re-harvest round` to `research/frontier-19-batch-3.notes.md`: the dead
...
`research/frontier-19-batch-3.coverage.json` and `.notes.md`. Keep `original_url`
