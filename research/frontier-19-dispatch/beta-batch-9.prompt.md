<!-- Dispatched as-is. `frontier-19` and `9` are substituted by tools/dispatch.mjs
...
# Scaffolding brief — run `frontier-19`, batch `9` (steps 1 and 2)
...
`research/frontier-19-batch-9.notes.md`: current substage, owned artifact paths,
...
`research/frontier-19-batch-9.coverage.json`:
...
- `research/frontier-19-batch-9.pages.json` — your batch's page objects in final
...
- `research/frontier-19-batch-9.notes.md` — prose-scaffold amendments as precise
  ...
  route, and necessity.
- `research/frontier-19-batch-9.proof-contracts.json` — the version-1
...
# Batch 9 of run `frontier-19` — Kan Extensions Density and the Free Cocompletion
...
| | |
|---|---|
| A page | `kan-extensions-density-and-the-free-cocompletion` · order **365.011** · `category-theory` |
| B page | `kan-extensions-density-and-the-free-cocompletion-examples` |
| title | Kan Extensions Density and the Free Cocompletion |
| requires | `ends-coends-and-weighted-limits-examples` |
| design | `plan-category-theory-track.md` L1516<br>`plan-category-theory-track.md` L1558 |
