...
# Authoring brief — run `frontier-19`, batch `3` (step 5)
...
- update only your own `research/frontier-19-batch-3.proof-contracts.json` so it
...
- keep your own `research/frontier-19-batch-3.coverage.json` **true of what you
...
research/frontier-19-batch-3.proof-contracts.json --strict` before reporting.
...
# Batch `3` of run `frontier-19` — step 5, authoring
...
- `research/frontier-19-batch-3.pages.json` — the spliced scaffold
- `research/frontier-19-batch-3.notes.md` — your source ledger and rationales
- `research/frontier-19-batch-3.coverage.json` — the harvest
- `research/frontier-19-batch-3.proof-contracts.json` — extend it as you author
- group Alpha's step-3 review and re-check, for the findings you resolved
- `research/frontier-19-beta-3.task.md` — your batch's pages and design section;
...
Append `## Step-5 authoring` to `research/frontier-19-batch-3.notes.md`: items
