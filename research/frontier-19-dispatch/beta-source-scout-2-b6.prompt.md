...
run: frontier-19
role: beta
label: source-scout-2-b6
covers: 6

> **Source-scouting round.** Your batch number is in the "This dispatch"
> section appended below; substitute it wherever `6` appears.

# Batch `6` of run `frontier-19` — scout a live full-text URL
...
`research/frontier-19-batch-6.coverage.json` and `.notes.md` only. Keep
