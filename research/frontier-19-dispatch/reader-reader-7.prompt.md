...
label: reader-7
covers: 7
output: research/frontier-19-reader-7.md

# Step 6a reader task

Open `research/frontier-19-batch-7.pages.json`, every listed item, every assigned
...
Write the evidence report to `research/frontier-19-reader-7.md`. It must list:
...
Return `research/frontier-19-reader-findings-7.json` under
