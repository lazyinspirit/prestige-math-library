...
`research/frontier-19-step6-scope-9.json`: every reader-untouched item, every
...
Read `research/frontier-19-reader-9.md` for context, but verify from item and
...
dispatcher writes `research/frontier-19-refute-9.json`.
...
label: refute-9
covers: 9
output: research/frontier-19-refute-9.json

# Step 6a refutation — assigned batch

Derive the batch number from the dispatch label. Open
`research/frontier-19-step6-scope-9.json` and audit every id in `refuter_scope`:
all reader-untouched items, all high/critical-risk items, and the assigned page
prose.

Read `research/frontier-19-reader-9.md`, then verify from disk. Trace each proof,
