...
You are the group Alpha for batches **5**, **6**, **10**: 5 A/B pair(s), 10 page(s), 123 item(s), 10 open rejection(s) over 10 item(s).
...
|---|---|---|---|
| `cor-binary-trees-satisfy-b-equals-one-plus-z-b-squared` | `combinatorial-classes-and-the-symbolic-method` | gpt-5.6-terra | `b31e9ecced9b46c40884f42b6e625c29ba30a0d64f1d5784e8d29e10556ec5b7` |
| `cor-eulerian-polynomial-exponential-generating-function` | `permutation-statistics-inversions-and-eulerian-numbers` | gpt-5.6-terra | `2a6f4b2c3a04a0ab82facc686559a29081d2b5005d26b9537de5fe36d79fd221` |
| `cor-plane-trees-satisfy-t-equals-z-over-one-minus-t` | `combinatorial-classes-and-the-symbolic-method` | gpt-5.6-terra | `944b303c915fdaa4437cc0f57f1209c92752d1784af621ab8001cfe4715583ee` |
| `def-combinatorial-specification-and-order-raising-recursion` | `combinatorial-classes-and-the-symbolic-method` | gpt-5.6-terra | `c4619a0b3dfc82738e6e63fa94cd8791f24e465360155c0eee25cbdec60f17de` |
| `ex-a-family-containing-k-one-is-vacuously-viral` | `polynomial-rodl-and-viral-equivalence-examples` | gpt-5.6-terra | `b0079b87b99b1dec7512fb82c1771a309a3ffc2eb13466d0ca787c37f58202ee` |
| `fs-multiset-product-exists-for-every-coefficient-sequence` | `combinatorial-classes-and-the-symbolic-method-examples` | gpt-5.6-terra | `d5e832fceeae1ed42d2e7e27bc484bffbd62f1a561768ba6de950d27b0d6ec9b` |
| `thm-a-finite-family-with-the-erdos-hajnal-property-is-viral` | `polynomial-rodl-and-viral-equivalence` | gpt-5.6-terra | `0565fa205aa4549a2d1efbf29c2ade0285b36ac437e88813e21cfcc6986713f5` |
| `thm-cycle-construction-formula` | `combinatorial-classes-and-the-symbolic-method` | gpt-5.6-terra | `c8fbee4aad209eab9c5f11fd0f2d7eeea7cbb7456a0cdf78549a063e0dfc99d6` |
| `thm-eulerian-recurrence` | `permutation-statistics-inversions-and-eulerian-numbers` | gpt-5.6-terra | `c3c774151c5ab345556ddd151534d43031431e6fa65bf1b0211d58a881195c8d` |
| `thm-worpitzky-identity` | `permutation-statistics-inversions-and-eulerian-numbers` | gpt-5.6-terra | `c3675e853940ef6b5200e0085cc920c48cad9dda74b2cd693da9dd3fb4d8ce10` |
