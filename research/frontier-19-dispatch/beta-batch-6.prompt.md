<!-- Dispatched as-is. `frontier-19` and `6` are substituted by tools/dispatch.mjs
...
# Scaffolding brief — run `frontier-19`, batch `6` (steps 1 and 2)
...
You are **Beta-6**, running **Claude Opus 5 via the claude CLI
...
`research/frontier-19-batch-6.notes.md`: current substage, owned artifact paths,
...
- `research/frontier-19-batch-6.pages.json` — your batch's page objects in final
...
- `research/frontier-19-batch-6.notes.md` — prose-scaffold amendments as precise
  ...
  route, and necessity.
- `research/frontier-19-batch-6.proof-contracts.json` — the version-1
...
# Batch 6 of run `frontier-19` — Block Designs and Finite Projective Planes · Classical and Log-Log Erdős–Hajnal Bounds
...
| | |
|---|---|
| A page | `block-designs-and-finite-projective-planes` · order **225** · `combinatorics` |
| B page | `block-designs-and-finite-projective-planes-examples` |
| title | Block Designs and Finite Projective Planes |
| requires | `linear-algebra-methods-in-combinatorics`, `algebraic-extensions-degree-and-finite-fields`, `congruences-and-the-chinese-remainder-theorem`, `eigenvalues-eigenvectors-and-the-characteristic-polynomial` |
| design | `plan-combinatorics-and-categories.md` L2322 |
...
| | |
|---|---|
| A page | `classical-and-loglog-erdos-hajnal-bounds` · order **403** · `combinatorics` |
| B page | `classical-and-loglog-erdos-hajnal-bounds-examples` |
| title | Classical and Log-Log Erdős–Hajnal Bounds |
| requires | `erdos-hajnal-property-and-homogeneous-sets`, `sparse-restricted-subgraphs-and-rodl-nikiforov` |
| design | `plan-combinatorics-and-categories.md` L3901 (id mention, not a heading — locate the section yourself) |
