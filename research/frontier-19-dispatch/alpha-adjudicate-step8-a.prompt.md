...
You are the group Alpha for batches **1**, **9**: 3 A/B pair(s), 6 page(s), 103 item(s), 38 open rejection(s) over 38 item(s).
...
|---|---|---|---|
| `cex-a-kan-extension-that-is-not-pointwise` | `kan-extensions-density-and-the-free-cocompletion-examples` | gpt-5.6-terra | `301960a062370aecd688486b7428c9b043e5817a1e85cf2bc32a82996af88325` |
| `cor-primitivity-is-equivalent-to-maximality-of-a-point-stabilizer` | `blocks-primitivity-and-multiple-transitivity` | gpt-5.6-terra | `583ef25bf15a254e52bbb6dcb69b4dae93cf273ec9d75be52f00877cfc2e13b4` |
| `def-absolute-kan-extension` | `kan-extensions-density-and-the-free-cocompletion` | gpt-5.6-terra | `f81dfdc7d85b8c62d5bab7c683c335c8db7b379902ef27524e85bf46d93096c2` |
| `def-dense-subcategory` | `kan-extensions-density-and-the-free-cocompletion` | gpt-5.6-terra | `84a8dc2f229341fdcd0951a71b5337253732ed12ff6df6fb7c1b4206e094df72` |
| `def-isometric-proper-and-cobounded-actions-on-metric-spaces` | `geometric-actions-svarc-milnor-and-growth` | gpt-5.6-terra | `a7e37dcb53d274b875817a0b727c93a437d9eb35dbfad47098b1256138b9764a` |
| `def-polynomial-subexponential-exponential-and-intermediate-growth` | `geometric-actions-svarc-milnor-and-growth` | gpt-5.6-terra | `02b327df47e771eaa8bc3c02ec3856b0121240628ddce8235319393065055f4e` |
| `def-primitive-and-imprimitive-actions` | `blocks-primitivity-and-multiple-transitivity` | gpt-5.6-terra | `355d137714579986c49ad41870273abee465504d3026c9bbe7dd95d65ba15260` |
| `ex-a-kan-extension-computing-a-free-functor` | `kan-extensions-density-and-the-free-cocompletion-examples` | gpt-5.6-terra | `22da6deab4fa66f3af3c3174cdbf3a19e8fa9fca59b141eb77d309cce698dc5b` |
| `ex-free-groups-acting-geometrically-on-regular-trees` | `geometric-actions-svarc-milnor-and-growth-examples` | gpt-5.6-terra | `a4a1c1b2a2353a65540a838a2e02fb2fcd362c24e026f37e9ea0952194f6b0ca` |
| `ex-imprimitive-wreath-product-block-system` | `blocks-primitivity-and-multiple-transitivity-examples` | gpt-5.6-terra | `ba95faad64c8cd03fc203d6068123e65cd2488864579f28acec6eba39335f44c` |
| `ex-induction-and-coinduction-of-group-representations` | `kan-extensions-density-and-the-free-cocompletion-examples` | gpt-5.6-terra | `5098060612edf0c4b52cc16e72b311abac32192fe81113783631d9354c95be58` |
| `ex-integers-acting-geometrically-on-the-line` | `geometric-actions-svarc-milnor-and-growth-examples` | gpt-5.6-terra | `697adc09fa1a4e5f2006903cd382f31a271b7126c9e90778fb9cfc81bac0830d` |
| `ex-lan-along-the-inclusion-of-the-rationals-in-the-reals` | `kan-extensions-density-and-the-free-cocompletion-examples` | gpt-5.6-terra | `96e96c059f82b4dd2e2eebea3ff3a2f41778556fd4fc6868ab76cf8a55013ef3` |
| `ex-left-kan-extension-along-a-full-subcategory-inclusion` | `kan-extensions-density-and-the-free-cocompletion-examples` | gpt-5.6-terra | `c142779e3e9cfde3b619fe7a781be7c3280918dc3901611b043cef43e0367f54` |
| `ex-projective-linear-action-and-iwasawas-hypotheses` | `blocks-primitivity-and-multiple-transitivity-examples` | gpt-5.6-terra | `08f2a44e80253780ee60b1523474c1a38307e0e9180ef9b859d090f4e969bf26` |
| `ex-z-n-acting-geometrically-on-euclidean-n-space` | `geometric-actions-svarc-milnor-and-growth-examples` | gpt-5.6-terra | `08c3ae871c701a8b24d07d74bf6626c7a1d7f18812a32bc7a65696a70b0b8ff8` |
| `fs-every-kan-extension-is-pointwise` | `kan-extensions-density-and-the-free-cocompletion` | gpt-5.6-terra | `0c1003b9543bdb0dc06fa5d993e2c01a42767c7f03e22ac7bf08798b50fa721f` |
| `fs-every-nontrivial-normal-subgroup-of-a-primitive-group-is-regular` | `blocks-primitivity-and-multiple-transitivity-examples` | gpt-5.6-terra | `f3603d57f18e4b85f71cf8bfab102ce734980a272a7e0732dc71b9ca27fdc4fd` |
| `fs-every-subexponential-growth-group-has-polynomial-growth` | `geometric-actions-svarc-milnor-and-growth-examples` | gpt-5.6-terra | `7b8bdfa3e3e59c70ef288abdabbe7db83c866b029f231c19d68341521724a720` |
| `fs-iwasawas-criterion-needs-only-transitivity` | `blocks-primitivity-and-multiple-transitivity-examples` | gpt-5.6-terra | `0ed2c3c7ce64e50d1cd4db4a96d4a554558cd4b0b4b5ba6b30c83b5fb1ecafba` |
| `fs-the-yoneda-embedding-preserves-colimits` | `kan-extensions-density-and-the-free-cocompletion` | gpt-5.6-terra | `7e8aa5272749cbec20f34ac0fe421a182e14a2385433e4819ced1c38e06ffedd` |
| `lem-cobounded-proper-geodesic-actions-produce-finite-generating-sets` | `geometric-actions-svarc-milnor-and-growth` | gpt-5.6-terra | `e8fdd54944927bcf320132042fab54c580effcee79b3d9310e288e8eeecdfb55` |
| `lem-metric-properness-agrees-with-proper-discontinuity-on-proper-discrete-metric-spaces` | `geometric-actions-svarc-milnor-and-growth` | gpt-5.6-terra | `d5e506b318587f03636f144a49d2cb62deccc480a971267e566800527e911bfa` |
| `lem-orbit-maps-of-isometric-actions-are-coarse-lipschitz` | `geometric-actions-svarc-milnor-and-growth` | gpt-5.6-terra | `48e7652bbeed8d92c01c1f1dd9ae05b0ad1c32529b95bb277975177577fe6c0a` |
| `prop-doubly-transitive-actions-are-primitive` | `blocks-primitivity-and-multiple-transitivity` | gpt-5.6-terra | `d79bbd26bd644fc9d8c01b21f8697ea8a1bed3645b8f20bc230354f9c20e1859` |
| `rem-bass-guivarch-growth-degree-formula` | `geometric-actions-svarc-milnor-and-growth` | gpt-5.6-terra | `13948be730983e9de4dd2494adda905c5043d72fa3256cb059ee4768dc431661` |
| `rem-gromov-polynomial-growth-theorem` | `geometric-actions-svarc-milnor-and-growth` | gpt-5.6-terra | `fcf1977ae28d33efc61d86b9838ca8ee0736e1030c90a463057fb71e0a569caf` |
| `thm-block-systems-and-g-invariant-equivalence-relations-correspond` | `blocks-primitivity-and-multiple-transitivity` | gpt-5.6-terra | `58ada684fccce02eeeed913966b3dba9cb11e489c10647751470ab965e050db4` |
| `thm-density-as-a-self-kan-extension-for-a-small-category` | `kan-extensions-density-and-the-free-cocompletion` | gpt-5.6-terra | `433f46a41486d373df56dc0ca29faabfdf54e3b0be77dcfd32897406ca0ab443` |
| `thm-free-groups-of-rank-at-least-two-have-exponential-growth` | `geometric-actions-svarc-milnor-and-growth` | gpt-5.6-terra | `ea2617c407b576b1af2fbecb339170424f2e60bf60642584cb0a4b742101c74a` |
| `thm-growth-type-is-a-quasi-isometry-invariant-of-finitely-generated-groups` | `geometric-actions-svarc-milnor-and-growth` | gpt-5.6-terra | `a0ff58be8dcee4bf38ccada71222ac1d0e0c0235ad566a1fab8c407799db8982` |
| `thm-kan-extensions-as-coends` | `kan-extensions-density-and-the-free-cocompletion` | gpt-5.6-terra | `0fa8271c1918d1fda4af251d87eb5a2ab76edb82137b4fde777a0a4fa9eebc68` |
| `thm-left-adjoints-preserve-left-kan-extensions` | `kan-extensions-density-and-the-free-cocompletion` | gpt-5.6-terra | `fa434d57e37d0984f22dd01d6d36d7d8007aecbf6ac43feb644903382f854628` |
| `thm-limits-and-colimits-are-kan-extensions-along-the-functor-to-the-terminal-category` | `kan-extensions-density-and-the-free-cocompletion` | gpt-5.6-terra | `84fc0b8269bd2057f34714dc0ad30742e461a48712671e723f41ee51fa5da4f6` |
| `thm-svarc-milnor-lemma` | `geometric-actions-svarc-milnor-and-growth` | gpt-5.6-terra | `a001f24c56b5b2a008dd3692fc63762ce1424a9481df0986b4816df521ecaa07` |
| `thm-the-codensity-monad-of-the-small-skeleton-of-finite-sets-is-the-ultrafilter-monad` | `kan-extensions-density-and-the-free-cocompletion` | gpt-5.6-terra | `369a0827fc5bad05e777cc3e8e858929f81b3a01b06b8d3dc0d075545965d6ca` |
| `thm-the-presheaf-category-on-a-small-category-is-the-free-cocompletion` | `kan-extensions-density-and-the-free-cocompletion` | gpt-5.6-terra | `0dda8191554ce240f396ff69d12a3c7b75620345cca999f0561d5353cd135322` |
| `thm-the-two-notions-of-pointwise-agree` | `kan-extensions-density-and-the-free-cocompletion` | gpt-5.6-terra | `976e928ed0d0fb1978a120ddead802cc30f4dcd630bf871f24a63deb720873ca` |
