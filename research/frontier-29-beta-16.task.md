# Batch 16 of run `frontier-29` — Vector Fields Flows and Lie Derivatives
...
| | |
|---|---|
| A page | `vector-fields-flows-and-lie-derivatives` · order **459** · `differential-geometry` |
| B page | `vector-fields-flows-and-lie-derivatives-examples` |
| title | Vector Fields Flows and Lie Derivatives |
| requires | `smooth-partitions-of-unity-and-exhaustions`, `tangent-cotangent-and-the-differential`, `rank-theorems-and-embedded-submanifolds`, `smooth-vector-bundles-and-sections`, `whitney-embedding-tubular-neighbourhoods-and-approximation`, `euclidean-ordinary-differential-equations-with-smooth-dependence` |
| design | `plan-differential-geometry-track.md` L2451 |
