...
The task and `research/phase-2-wave-1-step6-scope-7.json` define `refuter_scope`.
...
label: refute-7
covers: 7
output: research/phase-2-wave-1-refute-7.json

# Step 6a — refuter

Read `research/phase-2-wave-1-step6-scope-7.json` and audit exactly its `refuter_scope`,
