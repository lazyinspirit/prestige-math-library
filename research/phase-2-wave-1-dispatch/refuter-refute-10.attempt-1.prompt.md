...
The task and `research/phase-2-wave-1-step6-scope-10.json` define `refuter_scope`.
...
label: refute-10
covers: 10
output: research/phase-2-wave-1-refute-10.json

# Step 6a — refuter

Read `research/phase-2-wave-1-step6-scope-10.json` and audit exactly its `refuter_scope`,
