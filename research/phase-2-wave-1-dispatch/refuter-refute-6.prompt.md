...
The task and `research/phase-2-wave-1-step6-scope-6.json` define `refuter_scope`.
...
label: refute-6
covers: 6
output: research/phase-2-wave-1-refute-6.json

# Step 6a — refuter

Read `research/phase-2-wave-1-step6-scope-6.json` and audit exactly its `refuter_scope`,
