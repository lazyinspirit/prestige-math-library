...
The task and `research/phase-2-wave-1-step6-scope-2.json` define `refuter_scope`.
...
label: refute-2
covers: 2
output: research/phase-2-wave-1-refute-2.json

# Step 6a — refuter

Read `research/phase-2-wave-1-step6-scope-2.json` and audit exactly its `refuter_scope`,
