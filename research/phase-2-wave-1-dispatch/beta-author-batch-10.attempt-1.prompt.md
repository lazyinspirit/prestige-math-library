...
covers: 10
output: research/phase-2-wave-1-batch-10.pages.json

# Author batch `10` — `phase-2-wave-1`

Read these `research/` files:

- `phase-2-wave-1-batch-10.pages.json`, `phase-2-wave-1-batch-10.notes.md`, and
  `phase-2-wave-1-batch-10.coverage.json`;
- `phase-2-wave-1-beta-10.task.md` and its assigned design sections;
...
complete `research/phase-2-wave-1-batch-10.proof-contracts.json`, creating it if absent.
