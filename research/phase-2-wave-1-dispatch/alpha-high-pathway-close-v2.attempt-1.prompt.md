...
covers: all
output: research/phase-2-wave-1-pathway-closure.json

# Step 10 — pathway closure, `phase-2-wave-1`

Read `research/phase-2-wave-1-pathway.json` and
`research/phase-2-wave-1-pathway-closure.json`. For every pending receipt row, rewrite
