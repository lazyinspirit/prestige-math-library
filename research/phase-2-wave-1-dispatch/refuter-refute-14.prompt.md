...
The task and `research/phase-2-wave-1-step6-scope-14.json` define `refuter_scope`.
...
label: refute-14
covers: 14
output: research/phase-2-wave-1-refute-14.json

# Step 6a — refuter

Read `research/phase-2-wave-1-step6-scope-14.json` and audit exactly its `refuter_scope`,
