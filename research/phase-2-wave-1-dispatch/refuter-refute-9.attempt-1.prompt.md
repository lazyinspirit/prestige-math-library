...
The task and `research/phase-2-wave-1-step6-scope-9.json` define `refuter_scope`.
...
label: refute-9
covers: 9
output: research/phase-2-wave-1-refute-9.json

# Step 6a — refuter

Read `research/phase-2-wave-1-step6-scope-9.json` and audit exactly its `refuter_scope`,
