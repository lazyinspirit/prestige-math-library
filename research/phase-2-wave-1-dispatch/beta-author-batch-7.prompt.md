...
covers: 7
output: research/phase-2-wave-1-batch-7.pages.json

# Author batch `7` — `phase-2-wave-1`

Read these `research/` files:

- `phase-2-wave-1-batch-7.pages.json`, `phase-2-wave-1-batch-7.notes.md`, and
  `phase-2-wave-1-batch-7.coverage.json`;
- `phase-2-wave-1-beta-7.task.md` and its assigned design sections;
...
complete `research/phase-2-wave-1-batch-7.proof-contracts.json`, creating it if absent.
...
- `node tools/content-policy.mjs research/phase-2-wave-1-batch-7.pages.json`;
- `node tools/proof-contract.mjs research/phase-2-wave-1-batch-7.proof-contracts.json --strict`.
