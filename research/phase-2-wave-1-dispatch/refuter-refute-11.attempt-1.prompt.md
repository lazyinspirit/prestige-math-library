...
The task and `research/phase-2-wave-1-step6-scope-11.json` define `refuter_scope`.
...
label: refute-11
covers: 11
output: research/phase-2-wave-1-refute-11.json

# Step 6a — refuter

Read `research/phase-2-wave-1-step6-scope-11.json` and audit exactly its `refuter_scope`,
