...
covers: 5
output: research/phase-2-wave-1-batch-5.pages.json

# Author batch `5` — `phase-2-wave-1`

Read these `research/` files:

- `phase-2-wave-1-batch-5.pages.json`, `phase-2-wave-1-batch-5.notes.md`, and
  `phase-2-wave-1-batch-5.coverage.json`;
- `phase-2-wave-1-beta-5.task.md` and its assigned design sections;
...
complete `research/phase-2-wave-1-batch-5.proof-contracts.json`, creating it if absent.
