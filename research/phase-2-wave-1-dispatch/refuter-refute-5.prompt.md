...
The task and `research/phase-2-wave-1-step6-scope-5.json` define `refuter_scope`.
...
label: refute-5
covers: 5
output: research/phase-2-wave-1-refute-5.json

# Step 6a — refuter

Read `research/phase-2-wave-1-step6-scope-5.json` and audit exactly its `refuter_scope`,
