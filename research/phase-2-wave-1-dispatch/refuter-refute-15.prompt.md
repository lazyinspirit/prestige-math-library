...
The task and `research/phase-2-wave-1-step6-scope-15.json` define `refuter_scope`.
...
label: refute-15
covers: 15
output: research/phase-2-wave-1-refute-15.json

# Step 6a — refuter

Read `research/phase-2-wave-1-step6-scope-15.json` and audit exactly its `refuter_scope`,
