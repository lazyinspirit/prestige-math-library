...
covers: 13
output: research/phase-2-wave-1-batch-13.pages.json

# Author batch `13` — `phase-2-wave-1`

Read these `research/` files:

- `phase-2-wave-1-batch-13.pages.json`, `phase-2-wave-1-batch-13.notes.md`, and
  `phase-2-wave-1-batch-13.coverage.json`;
- `phase-2-wave-1-beta-13.task.md` and its assigned design sections;
...
complete `research/phase-2-wave-1-batch-13.proof-contracts.json`, creating it if absent.
