...
The task and `research/phase-2-wave-1-step6-scope-4.json` define `refuter_scope`.
...
label: refute-4
covers: 4
output: research/phase-2-wave-1-refute-4.json

# Step 6a — refuter

Read `research/phase-2-wave-1-step6-scope-4.json` and audit exactly its `refuter_scope`,
