...
label: drift-review
covers: drift
output: research/phase-2-wave-1-alpha-step0-drift.md

## Step-0 prerequisite drift review — run `phase-2-wave-1`
...
**Evidence assembled for you:** `research/phase-2-wave-1-drift-evidence.json`
...
Write `research/phase-2-wave-1-alpha-step0-drift.md`, one section per A page:
