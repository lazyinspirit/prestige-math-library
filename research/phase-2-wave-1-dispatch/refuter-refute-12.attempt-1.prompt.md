...
The task and `research/phase-2-wave-1-step6-scope-12.json` define `refuter_scope`.
...
label: refute-12
covers: 12
output: research/phase-2-wave-1-refute-12.json

# Step 6a — refuter

Read `research/phase-2-wave-1-step6-scope-12.json` and audit exactly its `refuter_scope`,
