...
run: phase-2-wave-1
role: beta
label: author-check-repair-10-d24fbf91342d
covers: 10
output: research/phase-2-wave-1-step6-hash-10-pre.json

Repair batch 10 using every finding in research/phase-2-wave-1-author-check-10.json. Work only on this batch's items, pages, manifest and contract. Preserve its scope. Run focused checks and explain any detector defect; do not edit tools.
