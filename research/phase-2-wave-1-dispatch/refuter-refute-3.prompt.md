...
The task and `research/phase-2-wave-1-step6-scope-3.json` define `refuter_scope`.
...
label: refute-3
covers: 3
output: research/phase-2-wave-1-refute-3.json

# Step 6a — refuter

Read `research/phase-2-wave-1-step6-scope-3.json` and audit exactly its `refuter_scope`,
