...
covers: 1
output: research/phase-2-wave-1-batch-1.pages.json

# Author batch `1` — `phase-2-wave-1`

Read these `research/` files:

- `phase-2-wave-1-batch-1.pages.json`, `phase-2-wave-1-batch-1.notes.md`, and
  `phase-2-wave-1-batch-1.coverage.json`;
- `phase-2-wave-1-beta-1.task.md` and its assigned design sections;
...
complete `research/phase-2-wave-1-batch-1.proof-contracts.json`, creating it if absent.
...
- `node tools/content-policy.mjs research/phase-2-wave-1-batch-1.pages.json`;
- `node tools/proof-contract.mjs research/phase-2-wave-1-batch-1.proof-contracts.json --strict`.
