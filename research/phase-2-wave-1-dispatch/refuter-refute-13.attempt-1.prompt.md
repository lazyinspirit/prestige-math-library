...
The task and `research/phase-2-wave-1-step6-scope-13.json` define `refuter_scope`.
...
label: refute-13
covers: 13
output: research/phase-2-wave-1-refute-13.json

# Step 6a — refuter

Read `research/phase-2-wave-1-step6-scope-13.json` and audit exactly its `refuter_scope`,
