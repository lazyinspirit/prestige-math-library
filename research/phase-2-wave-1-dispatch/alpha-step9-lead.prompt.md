...
label: step9-lead
covers: all
output: research/phase-2-wave-1-alpha-step9-review.md

# Step 9 — scope-denial delta review, `phase-2-wave-1`

First follow `briefs/tasks/frontier-dependency-ledger.md`. Refresh and read
`research/phase-2-wave-1-cross-batch-dependencies.json` for cross-batch scope and impact.

Read only pending rows in `research/phase-2-wave-1-step9-scope-delta.json`. Verify each
...
If `research/phase-2-wave-1-step9-mathematical-review.task.md` exists, also perform its
...
`research/phase-2-wave-1-alpha-step9-review.md`. Inspect each open run ledger row and
