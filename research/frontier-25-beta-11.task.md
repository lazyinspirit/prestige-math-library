# Batch 11 of run `frontier-25` — Turing Machines, Configurations, and Computation
...
| | |
|---|---|
| A page | `turing-machines-configurations-and-computation` · order **597** · `computability-theory` |
...
| design | `plan-computability-theory-track.md` L472<br>`plan-computability-theory-track.md` L496 |
