# Step 10 — pathway closure, `frontier-31`

Read `research/frontier-31-pathway.json` and
`research/frontier-31-pathway-closure.json`. For every pending receipt row, rewrite
