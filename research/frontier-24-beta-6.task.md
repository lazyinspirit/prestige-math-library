# Batch 6 of run `frontier-24` — Mittag-Leffler and Runge's Theorem · The Gamma Function
...
| | |
|---|---|
| A page | `mittag-leffler-and-runges-theorem` · order **339** · `complex-analysis` |
| B page | `mittag-leffler-and-runges-theorem-examples` |
| title | Mittag-Leffler and Runge's Theorem |
| requires | `infinite-products-and-weierstrass-factorisation`, `the-riemann-sphere-and-mobius-transformations`, `the-residue-theorem` |
| design | `plan-complex-analysis-track.md` L2529 |
...
| | |
|---|---|
| A page | `the-gamma-function` · order **343** · `complex-analysis` |
| B page | `the-gamma-function-examples` |
| title | The Gamma Function |
| requires | `infinite-products-and-weierstrass-factorisation`, `the-residue-theorem`, `improper-integrals`, `analyticity-liouville-and-morera` |
| design | `plan-complex-analysis-track.md` L2718 |
