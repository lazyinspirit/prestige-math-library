...
Correct research/no-such-run-at-all-refute-7.json for batch 7.
Read research/no-such-run-at-all-step6-scope-7.json and audit exactly its frozen `refuter_scope`.
Set the top-level `batch` field to exactly "7".
