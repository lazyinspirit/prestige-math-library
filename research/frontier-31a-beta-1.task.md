# Batch 1 of run `frontier-31a` — The Finite Simple Group Classification Landscape · Schur Multipliers and Universal Central Extensions
...
| | |
|---|---|
| A page | `the-finite-simple-group-classification-landscape` · order **150.005** · `group-theory` |
| B page | `the-finite-simple-group-classification-landscape-examples` |
| title | The Finite Simple Group Classification Landscape |
| requires | `brauer-characters-and-decomposition-matrices-examples`, `socles-and-the-onan-scott-landscape` |
| design | `research/plan-group-theory-track.md` L2548<br>`research/plan-group-theory-track.md` L2620 |
...
| | |
|---|---|
| A page | `schur-multipliers-and-universal-central-extensions` · order **365.075** · `group-theory` |
...
| requires | `second-cohomology-and-abelian-kernel-extensions-examples`, `group-cohomology-as-a-derived-functor-examples` |
| design | `research/plan-group-theory-track.md` L2860<br>`research/plan-group-theory-track.md` L2940 |
