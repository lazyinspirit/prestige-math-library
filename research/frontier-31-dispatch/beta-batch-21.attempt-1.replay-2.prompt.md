...
# Batch 21 of run `frontier-31` — Boolean Circuits and Nonuniform Complexity · Counting Complexity and Sharp-P
...
| | |
|---|---|
| A page | `boolean-circuits-and-nonuniform-complexity` · order **631** · `computability-theory` |
...
| design | `research/plan-computability-theory-track.md` L1090<br>`research/plan-computability-theory-track.md` L1114 |
...
| | |
|---|---|
| A page | `counting-complexity-and-sharpp` · order **637** · `computability-theory` |
| B page | `counting-complexity-and-sharpp-examples` |
| title | Counting Complexity and Sharp-P |
| requires | `randomized-complexity-and-amplification`, `the-cook-levin-theorem` |
| design | `research/plan-computability-theory-track.md` L1199 |
