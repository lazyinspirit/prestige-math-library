...
The task and `research/frontier-31a-step6-scope-22.json` define `refuter_scope`.
...
label: refute-22
covers: 22
output: research/frontier-31a-refute-22.json

# Step 6a — refuter

Read `research/frontier-31a-step6-scope-22.json` and audit exactly its `refuter_scope`,
