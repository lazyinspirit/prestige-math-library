...
run: frontier-31a
role: beta
label: author-recover-22-2
covers: 22
output: research/frontier-31a-batch-22.proof-contracts.json

> The dispatch block supplies batch `22`.

# Step 5 — author batch `22`, `frontier-31a`

Required inputs are `research/frontier-31a-batch-22.pages.json`,
`research/frontier-31a-batch-22.notes.md`,
`research/frontier-31a-batch-22.coverage.json`, and
`research/frontier-31a-beta-22.task.md`. Use `research/frontier-31a-alpha-groups.json`
...
`research/frontier-31a-batch-22.proof-contracts.json` is an output to complete;
...
`node tools/content-policy.mjs research/frontier-31a-batch-22.pages.json`, and
`node tools/proof-contract.mjs research/frontier-31a-batch-22.proof-contracts.json --strict`.
