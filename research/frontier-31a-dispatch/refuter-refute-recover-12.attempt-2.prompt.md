...
The task and `research/frontier-31a-step6-scope-<i>.json` define `refuter_scope`.
...
run: frontier-31a
role: refuter
label: refute-recover-12

# Step 6a — refuter

Read `research/frontier-31a-step6-scope-<i>.json` and audit exactly its `refuter_scope`,
