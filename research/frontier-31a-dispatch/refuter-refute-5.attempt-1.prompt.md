...
The task and `research/frontier-31a-step6-scope-5.json` define `refuter_scope`.
...
label: refute-5
covers: 5
output: research/frontier-31a-refute-5.json

# Step 6a — refuter

Read `research/frontier-31a-step6-scope-5.json` and audit exactly its `refuter_scope`,
