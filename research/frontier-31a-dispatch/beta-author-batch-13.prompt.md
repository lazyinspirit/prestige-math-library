...
covers: 13
output: research/frontier-31a-batch-13.proof-contracts.json

> The dispatch block supplies batch `13`.

# Step 5 — author batch `13`, `frontier-31a`

Required inputs are `research/frontier-31a-batch-13.pages.json`,
`research/frontier-31a-batch-13.notes.md`,
`research/frontier-31a-batch-13.coverage.json`, and
`research/frontier-31a-beta-13.task.md`. Use `research/frontier-31a-alpha-groups.json`
...
`research/frontier-31a-batch-13.proof-contracts.json` is an output to complete;
...
`node tools/content-policy.mjs research/frontier-31a-batch-13.pages.json`, and
`node tools/proof-contract.mjs research/frontier-31a-batch-13.proof-contracts.json --strict`.
