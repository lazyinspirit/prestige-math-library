...
run: frontier-31a
role: reader
label: reader-recover-14

# Step 6 reader routing-artifact correction

Correct research/frontier-31a-reader-findings-14.json for batch 14.
Set the top-level `batch` field to exactly "14"; it identifies this batch, not the run number.
