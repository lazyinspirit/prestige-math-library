...
Read `research/frontier-31a-splice-refusals.json` and every reported undeclared
...
`research/frontier-31a-alpha-step4.md` with each edge, evidence, disposition, edit,
