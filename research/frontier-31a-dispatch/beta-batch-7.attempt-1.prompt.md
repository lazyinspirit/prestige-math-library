...
# Batch 7 of run `frontier-31a` — Tensor and Fusion Categories
...
| | |
|---|---|
| A page | `tensor-and-fusion-categories` · order **365.035** · `category-theory` |
| B page | `tensor-and-fusion-categories-examples` |
| title | Tensor and Fusion Categories |
| requires | `enriched-categories-examples` |
| design | `research/plan-category-theory-track.md` L2992<br>`research/plan-category-theory-track.md` L3169 |
