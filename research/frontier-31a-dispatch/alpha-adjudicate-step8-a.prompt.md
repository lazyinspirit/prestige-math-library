...
You are the group Alpha for batches **1**, **18**, **19**: 4 A/B pair(s), 8 page(s), 121 item(s), 29 open rejection(s) over 29 item(s).
...
|---|---|---|---|
| `cex-composition-factors-do-not-determine-the-extension` | `the-finite-simple-group-classification-landscape-examples` | gpt-5.6-terra | `cfdec7b930e5ecd786af29cd11578835f6baa1be6fd2958b4fbc8575a134cfe8` |
| `cor-elementary-local-integrality-criterion` | `brauer-induction-and-elementary-subgroups` | gpt-5.6-terra | `e06906a2b9e62b1d0d8913288e50390e6e8dc386c60d4360ba6ce7b023a8cd78` |
| `def-chevalley-contravariant-form` | `verma-modules-and-shapovalov-forms` | gpt-5.6-terra | `720b2b146b9fa9019f453fd7768e7f1849ffbf28465551544b682abb6229ad59` |
| `def-hopf-formula-quotient` | `schur-multipliers-and-universal-central-extensions` | gpt-5.6-terra | `393ac141fe6817757f1814671adc433c231005f1fc398a29eed142f9933c9406` |
| `def-induction-ideal-of-a-family-of-subgroups` | `brauer-induction-and-elementary-subgroups` | gpt-5.6-terra | `8e7f3e76155f48661e96c11625780bac3e7bed40e8810070cfa008660fb28454` |
| `def-one-dimensional-borel-module-of-weight-lambda` | `verma-modules-and-shapovalov-forms` | gpt-5.6-terra | `4fc713b1c1a1b5114923678c7b436d4f8b6018b314b12728ff8e67fece7193d6` |
| `def-supersolvable-groups-and-monomial-characters` | `brauer-induction-and-elementary-subgroups` | gpt-5.6-terra | `8060cdbe3356fe4a254e217181b5832405d706d172881792eacbbde6cabfd72e` |
| `def-universal-central-extension` | `schur-multipliers-and-universal-central-extensions` | gpt-5.6-terra | `f63cea9d1ec8b665d5724c693dbfc4ffe5ebe65e4869758531daf145bb340072` |
| `def-universal-central-extension-from-a-free-presentation` | `schur-multipliers-and-universal-central-extensions` | gpt-5.6-terra | `d1e67e2757ade9d71ae96a05d1b5e6db9cad53fa7d97085bbc56309eca16ec3d` |
| `ex-a-five-as-the-smallest-nonabelian-simple-group` | `the-finite-simple-group-classification-landscape-examples` | gpt-5.6-terra | `7fc601997c3f709729723f7aba9ab70ef023dcf06470e9650c7033c558712b6d` |
| `ex-sl2-verma-action-in-the-pbw-basis` | `verma-modules-and-shapovalov-forms-examples` | gpt-5.6-terra | `2bccf34242e58b5f01b57e7833b475347f3e6f30dfef5419315e403eb11616c4` |
| `ex-the-mathieu-groups-among-the-sporadics` | `the-finite-simple-group-classification-landscape-examples` | gpt-5.6-terra | `071a6735e8595912e35656996f71d3f65e1b5d4b5c682c2136c5b6c16f6106f1` |
| `fs-all-finite-simple-groups-are-alternating-or-cyclic` | `the-finite-simple-group-classification-landscape` | gpt-5.6-terra | `de35e6d8db7083ca70f7a0b21555c2a0f1fda066a1a063545b517c48f0d0c6fb` |
| `fs-the-library-proves-the-classification-of-finite-simple-groups` | `the-finite-simple-group-classification-landscape` | gpt-5.6-terra | `bf17bc5d389b7f7a7d7fee97ea7ee57f72494e24d7350c2bd3d1cc7a29530265` |
| `fs-the-schur-multiplier-is-defined-as-h-two-cohomology-with-complex-units` | `schur-multipliers-and-universal-central-extensions` | gpt-5.6-terra | `3d56971374d025ec448d5d7b8bde34d2df37f1958a2bde0e63db348a802b6817` |
| `fs-the-second-generation-cfsg-proof-is-complete-as-of-2026` | `the-finite-simple-group-classification-landscape` | gpt-5.6-terra | `7be6f54136a14f61475594b3e57e75147f73d53b9c13fc568e285e561a281ee5` |
| `fs-the-universal-coefficient-short-exact-sequence-splits-naturally` | `schur-multipliers-and-universal-central-extensions` | gpt-5.6-terra | `e467e4d8b4989e41424c2cefa98a696050789667df2ae4521c09a5637bf5bca7` |
| `lem-banaschewski-prime-obstruction` | `brauer-induction-and-elementary-subgroups` | gpt-5.6-terra | `68446dde4e40867735b0e3d9cbcfbf0d9580a772c96df051eaa20d0616a34e89` |
| `lem-hyperelementary-permutation-subring-reduction` | `brauer-induction-and-elementary-subgroups` | gpt-5.6-terra | `936d634bdd10de5b5dce272304eba9571cd638b667f58458a6bfe24fde21c978` |
| `lem-monomiality-lifts-along-a-quotient` | `brauer-induction-and-elementary-subgroups` | gpt-5.6-terra | `828551e4c0299ad5d6efc83bc8ff7e60f2096b2543ce28059a4f86c081e16a3d` |
| `lem-nonabelian-supersolvable-group-has-a-noncentral-normal-abelian-subgroup` | `brauer-induction-and-elementary-subgroups` | gpt-5.6-terra | `be7b550f9e92f41a433325a9ae9e5f911d33f4c294af5ceaba02356e813faf2e` |
| `prop-faithful-irreducible-character-is-induced-from-a-proper-inertia-subgroup` | `brauer-induction-and-elementary-subgroups` | gpt-5.6-terra | `4d321c8c328ad7dce4082b9d3cbb59d46b6734e9870b81e3a1a3d0a8bb29c0f4` |
| `prop-formal-character-of-a-verma-module` | `verma-modules-and-shapovalov-forms` | gpt-5.6-terra | `f5bd04d3ab9a27f3071c13da853c0cbacc835afc6af8b2b3d5e521c208d33a9b` |
| `rem-low-rank-coincidences-and-duplicate-family-names` | `the-finite-simple-group-classification-landscape` | gpt-5.6-terra | `48eda7fc904566ee414ff9b92b9043ef173a68373a9e360e1e91d111d0654297` |
| `rem-status-of-the-second-generation-proof` | `the-finite-simple-group-classification-landscape` | gpt-5.6-terra | `2dde047c04a592ebd1c5640688744d197bfb76586b9b4339c410bacca144397f` |
| `thm-free-presentation-construction-has-the-universal-property` | `schur-multipliers-and-universal-central-extensions` | gpt-5.6-terra | `117ac8ec330d08cbd1092633003a64d94ec68d57b20581cb4fc0c307c5235c16` |
| `thm-generalized-fitting-subgroup-contains-its-centralizer` | `the-finite-simple-group-classification-landscape` | gpt-5.6-terra | `9a3136e6c5fec2c1a1aadea3051e25c2dbeb12697877394d2cf61e92ee1e26e9` |
| `thm-shapovalov-determinant-formula` | `verma-modules-and-shapovalov-forms` | gpt-5.6-terra | `e01a86c2b28f08e9cad21b5b81e581076909a23dc11578c365782ea19f37afe3` |
| `thm-universal-property-of-verma-modules` | `verma-modules-and-shapovalov-forms` | gpt-5.6-terra | `078c49e7f5ee3f867bb64cc4721684a53427016cc5e7f91d0743a72925f60c6a` |
