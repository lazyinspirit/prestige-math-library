...
run: frontier-31a
role: beta
label: scaffold-fix-3-b21
covers: 21

> The dispatch block supplies batch `21`.

# Post-recheck scaffold repair — batch `21`, `frontier-31a`

Read `research/frontier-31a-scaffold-closure.json` and take only `work[]` entries
whose pages belong to batch `21` in the scope ledger. Apply or push back on
