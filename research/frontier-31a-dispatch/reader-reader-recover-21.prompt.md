...
run: frontier-31a
role: reader
label: reader-recover-21

# Step 6 reader routing-artifact correction

Correct research/frontier-31a-reader-findings-21.json for batch 21.
Set the top-level `batch` field to exactly "21"; it identifies this batch, not the run number.
