...
The task and `research/frontier-31a-step6-scope-15.json` define `refuter_scope`.
...
label: refute-15
covers: 15
output: research/frontier-31a-refute-15.json

# Step 6a — refuter

Read `research/frontier-31a-step6-scope-15.json` and audit exactly its `refuter_scope`,
