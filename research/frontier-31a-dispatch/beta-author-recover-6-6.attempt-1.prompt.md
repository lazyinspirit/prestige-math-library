...
run: frontier-31a
role: beta
label: author-recover-6-6
covers: 6
output: research/frontier-31a-batch-6.proof-contracts.json

> The dispatch block supplies batch `6`.

# Step 5 — author batch `6`, `frontier-31a`

Required inputs are `research/frontier-31a-batch-6.pages.json`,
`research/frontier-31a-batch-6.notes.md`,
`research/frontier-31a-batch-6.coverage.json`, and
`research/frontier-31a-beta-6.task.md`. Use `research/frontier-31a-alpha-groups.json`
...
`research/frontier-31a-batch-6.proof-contracts.json` is an output to complete;
...
`node tools/content-policy.mjs research/frontier-31a-batch-6.pages.json`, and
