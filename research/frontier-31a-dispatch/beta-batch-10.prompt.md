...
# Batch 10 of run `frontier-31a` — Group Cohomology as a Derived Functor

1 A/B pair, homological-algebra. You own every page here and you author them all at step 5.

## `group-cohomology-as-a-derived-functor`

| | |
|---|---|
| A page | `group-cohomology-as-a-derived-functor` · order **365.059** · `homological-algebra` |
| B page | `group-cohomology-as-a-derived-functor-examples` |
| title | Group Cohomology as a Derived Functor |
| requires | `universal-coefficients-and-kunneth-theorems-examples`, `the-group-algebra-and-representations` |
| design | `research/plan-homological-algebra-track.md` L2321<br>`research/plan-homological-algebra-track.md` L2461 |
