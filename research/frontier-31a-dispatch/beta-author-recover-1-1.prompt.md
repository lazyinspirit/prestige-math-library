...
run: frontier-31a
role: beta
label: author-recover-1-1
covers: 1
output: research/frontier-31a-batch-1.proof-contracts.json

> The dispatch block supplies batch `1`.

# Step 5 — author batch `1`, `frontier-31a`

Required inputs are `research/frontier-31a-batch-1.pages.json`,
`research/frontier-31a-batch-1.notes.md`,
`research/frontier-31a-batch-1.coverage.json`, and
`research/frontier-31a-beta-1.task.md`. Use `research/frontier-31a-alpha-groups.json`
...
`research/frontier-31a-batch-1.proof-contracts.json` is an output to complete;
...
`node tools/content-policy.mjs research/frontier-31a-batch-1.pages.json`, and
