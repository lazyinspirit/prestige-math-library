...
run: frontier-31a
role: beta
label: author-batch-21
covers: 21
output: research/frontier-31a-batch-21.proof-contracts.json

> The dispatch block supplies batch `21`.

# Step 5 — author batch `21`, `frontier-31a`

Required inputs are `research/frontier-31a-batch-21.pages.json`,
`research/frontier-31a-batch-21.notes.md`,
`research/frontier-31a-batch-21.coverage.json`, and
`research/frontier-31a-beta-21.task.md`. Use `research/frontier-31a-alpha-groups.json`
...
`research/frontier-31a-batch-21.proof-contracts.json` is an output to complete;
...
`node tools/content-policy.mjs research/frontier-31a-batch-21.pages.json`, and
`node tools/proof-contract.mjs research/frontier-31a-batch-21.proof-contracts.json --strict`.
