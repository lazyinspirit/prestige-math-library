...
covers: 2
output: research/frontier-31a-batch-2.proof-contracts.json

> The dispatch block supplies batch `2`.

# Step 5 — author batch `2`, `frontier-31a`

Required inputs are `research/frontier-31a-batch-2.pages.json`,
`research/frontier-31a-batch-2.notes.md`,
`research/frontier-31a-batch-2.coverage.json`, and
`research/frontier-31a-beta-2.task.md`. Use `research/frontier-31a-alpha-groups.json`
...
`research/frontier-31a-batch-2.proof-contracts.json` is an output to complete;
...
`node tools/content-policy.mjs research/frontier-31a-batch-2.pages.json`, and
