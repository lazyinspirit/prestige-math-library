...
# Batch 15 of run `frontier-31a` — The Structural Criterion for Property (*)
...
| | |
|---|---|
| A page | `the-structural-criterion-for-property-star` · order **433** · `combinatorics` |
| B page | `the-structural-criterion-for-property-star-examples` |
| title | The Structural Criterion for Property (*) |
| requires | `property-star-and-comb-outcomes` |
| design | `research/plan-combinatorics-and-categories.md` L3916 (id mention, not a heading — locate the section yourself) |
