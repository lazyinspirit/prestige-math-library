...
covers: 15
output: research/frontier-31a-batch-15.proof-contracts.json

> The dispatch block supplies batch `15`.

# Step 5 — author batch `15`, `frontier-31a`

Required inputs are `research/frontier-31a-batch-15.pages.json`,
`research/frontier-31a-batch-15.notes.md`,
`research/frontier-31a-batch-15.coverage.json`, and
`research/frontier-31a-beta-15.task.md`. Use `research/frontier-31a-alpha-groups.json`
...
`research/frontier-31a-batch-15.proof-contracts.json` is an output to complete;
...
`node tools/content-policy.mjs research/frontier-31a-batch-15.pages.json`, and
