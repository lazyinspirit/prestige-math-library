...
run: frontier-31a
role: beta
label: author-recover-14-4
covers: 14
output: research/frontier-31a-batch-14.proof-contracts.json

> The dispatch block supplies batch `14`.

# Step 5 — author batch `14`, `frontier-31a`

Required inputs are `research/frontier-31a-batch-14.pages.json`,
`research/frontier-31a-batch-14.notes.md`,
`research/frontier-31a-batch-14.coverage.json`, and
`research/frontier-31a-beta-14.task.md`. Use `research/frontier-31a-alpha-groups.json`
...
`research/frontier-31a-batch-14.proof-contracts.json` is an output to complete;
...
`node tools/content-policy.mjs research/frontier-31a-batch-14.pages.json`, and
`node tools/proof-contract.mjs research/frontier-31a-batch-14.proof-contracts.json --strict`.
