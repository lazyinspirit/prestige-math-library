...
# Final Adjudicator queue — frontier-31a, group e, round 1

This is the exact queue frozen in `research/frontier-31a-step8-fa-e-round-1.json`. It contains 1 item(s).
Work in the numbered order below. Do not substantively review the next item until the recorder accepts the current one.

## 1. `lem-chain-rule-for-an-indefinite-integral-after-an-absolutely-continuous-composition` (run)

1. Read `items/lem-chain-rule-for-an-indefinite-integral-after-an-absolutely-continuous-composition.md`, its cited dependencies, pair/page context, proof contract, judge and Alpha evidence, and this group's conventions.
...
3. Write concrete evidence to `research/frontier-31a-step8-fa-e-1-lem-chain-rule-for-an-indefinite-integral-after-an-absolutely-continuous-composition.md`, including exact source URLs and what they support, or explain why the mathematics was familiar.
...
```bash
node tools/step8-terminal-resolution.mjs record --run frontier-31a --id lem-chain-rule-for-an-indefinite-integral-after-an-absolutely-continuous-composition --resolved-by final-adjudicator --group e --queue research/frontier-31a-step8-fa-e-round-1.json --state-dir /home/lazyinspirit/Projects/prestige-math-library/.autopilot/frontier-31a --disposition accepted-after-review --source-status verified --basis-file research/frontier-31a-step8-fa-e-1-lem-chain-rule-for-an-indefinite-integral-after-an-absolutely-continuous-composition.md
node tools/step8-terminal-resolution.mjs record --run frontier-31a --id lem-chain-rule-for-an-indefinite-integral-after-an-absolutely-continuous-composition --resolved-by final-adjudicator --group e --queue research/frontier-31a-step8-fa-e-round-1.json --state-dir /home/lazyinspirit/Projects/prestige-math-library/.autopilot/frontier-31a --disposition repaired --source-status verified --basis-file research/frontier-31a-step8-fa-e-1-lem-chain-rule-for-an-indefinite-integral-after-an-absolutely-continuous-composition.md
```
