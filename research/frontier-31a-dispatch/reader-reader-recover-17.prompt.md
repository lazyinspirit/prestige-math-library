...
run: frontier-31a
role: reader
label: reader-recover-17

# Step 6 reader routing-artifact correction

Correct research/frontier-31a-reader-findings-17.json for batch 17.
Set the top-level `batch` field to exactly "17"; it identifies this batch, not the run number.
