...
covers: 4
output: research/frontier-31a-batch-4.proof-contracts.json

> The dispatch block supplies batch `4`.

# Step 5 — author batch `4`, `frontier-31a`

Required inputs are `research/frontier-31a-batch-4.pages.json`,
`research/frontier-31a-batch-4.notes.md`,
`research/frontier-31a-batch-4.coverage.json`, and
`research/frontier-31a-beta-4.task.md`. Use `research/frontier-31a-alpha-groups.json`
...
`research/frontier-31a-batch-4.proof-contracts.json` is an output to complete;
...
`node tools/content-policy.mjs research/frontier-31a-batch-4.pages.json`, and
`node tools/proof-contract.mjs research/frontier-31a-batch-4.proof-contracts.json --strict`.
