...
The task and `research/frontier-31a-step6-scope-12.json` define `refuter_scope`.
...
label: refute-12
covers: 12
output: research/frontier-31a-refute-12.json

# Step 6a — refuter

Read `research/frontier-31a-step6-scope-12.json` and audit exactly its `refuter_scope`,
