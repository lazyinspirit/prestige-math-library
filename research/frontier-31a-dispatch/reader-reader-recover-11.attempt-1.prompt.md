...
run: frontier-31a
role: reader
label: reader-recover-11

# Step 6 reader routing-artifact correction

Correct research/frontier-31a-reader-findings-11.json for batch 11.
Set the top-level `batch` field to exactly "11"; it identifies this batch, not the run number.
