...
# Batch 19 of run `frontier-31a` — Brauer Induction and Elementary Subgroups
...
| | |
|---|---|
| A page | `brauer-induction-and-elementary-subgroups` · order **510.033** · `representation-theory` |
| B page | `brauer-induction-and-elementary-subgroups-examples` |
| title | Brauer Induction and Elementary Subgroups |
| requires | `artin-induction-and-rational-characters-examples` |
| design | `research/plan-representation-theory-groups-track.md` L261 |
