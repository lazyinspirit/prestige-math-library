...
covers: 12
output: research/frontier-31a-batch-12.proof-contracts.json

> The dispatch block supplies batch `12`.

# Step 5 — author batch `12`, `frontier-31a`

Required inputs are `research/frontier-31a-batch-12.pages.json`,
`research/frontier-31a-batch-12.notes.md`,
`research/frontier-31a-batch-12.coverage.json`, and
`research/frontier-31a-beta-12.task.md`. Use `research/frontier-31a-alpha-groups.json`
...
`research/frontier-31a-batch-12.proof-contracts.json` is an output to complete;
...
`node tools/content-policy.mjs research/frontier-31a-batch-12.pages.json`, and
