...
The task and `research/frontier-31a-step6-scope-14.json` define `refuter_scope`.
...
label: refute-14
covers: 14
output: research/frontier-31a-refute-14.json

# Step 6a — refuter

Read `research/frontier-31a-step6-scope-14.json` and audit exactly its `refuter_scope`,
