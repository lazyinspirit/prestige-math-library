...
# Batch 11 of run `frontier-31a` — Koszul Complexes and Regular Sequences
...
| | |
|---|---|
| A page | `koszul-complexes-and-regular-sequences` · order **365.901** · `commutative-algebra` |
| B page | `koszul-complexes-and-regular-sequences-examples` |
| title | Koszul Complexes and Regular Sequences |
| requires | `zariski-topology-on-prime-spectra-examples`, `long-exact-sequences-in-homology` |
| design | `research/plan-commutative-algebra-track.md` L1314<br>`research/plan-commutative-algebra-track.md` L3716 |
