...
run: frontier-31a
role: beta
label: author-recover-8-1
covers: 8
output: research/frontier-31a-batch-8.proof-contracts.json

> The dispatch block supplies batch `8`.

# Step 5 — author batch `8`, `frontier-31a`

Required inputs are `research/frontier-31a-batch-8.pages.json`,
`research/frontier-31a-batch-8.notes.md`,
`research/frontier-31a-batch-8.coverage.json`, and
`research/frontier-31a-beta-8.task.md`. Use `research/frontier-31a-alpha-groups.json`
...
`research/frontier-31a-batch-8.proof-contracts.json` is an output to complete;
...
`node tools/content-policy.mjs research/frontier-31a-batch-8.pages.json`, and
