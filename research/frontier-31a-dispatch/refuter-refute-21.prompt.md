...
The task and `research/frontier-31a-step6-scope-21.json` define `refuter_scope`.
...
label: refute-21
covers: 21
output: research/frontier-31a-refute-21.json

# Step 6a — refuter

Read `research/frontier-31a-step6-scope-21.json` and audit exactly its `refuter_scope`,
