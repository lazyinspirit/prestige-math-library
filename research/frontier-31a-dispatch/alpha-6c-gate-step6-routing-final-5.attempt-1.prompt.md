...
run: frontier-31a
role: alpha
label: 6c-gate-step6-routing-final-5

# Step 6c repair — step6-routing-final

This file is the authority for repair cycle 5.
Primary gate: `step6-routing-final`
Reason: ERROR reader-findings-invalid: batch 14: finding 1 names unopened or out-of-scope item lem-sheaf-condition-check-on-basis
Owning Alpha group: (repository-scoped or mixed)
Live item ids: `lem-sheaf-condition-check-on-basis`
...
```text
step6-scope: 910 item(s) routed, 374 adjudication obligation(s), 1 error(s)
ERROR reader-findings-invalid: batch 14: finding 1 names unopened or out-of-scope item lem-sheaf-condition-check-on-basis
...
[
  {
    "stage": "6c-cross",
    "gate": "risk-report",
    "why": "ERROR risk-review-missing [lem-structure-presheaf-basic-open-well-defined]: lem-structure-presheaf-basic-open-well-defined is high risk and lacks a complete Alpha risk_review"
  },
  {
    "stage": "6c-cross",
