...
covers: all
output: research/frontier-31a-pathway-closure.json

# Step 10 — pathway closure, `frontier-31a`

Read `research/frontier-31a-pathway.json` and
`research/frontier-31a-pathway-closure.json`. For every pending receipt row, rewrite
