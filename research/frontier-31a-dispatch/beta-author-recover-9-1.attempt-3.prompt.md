...
run: frontier-31a
role: beta
label: author-recover-9-1
covers: 9
output: research/frontier-31a-batch-9.proof-contracts.json

> The dispatch block supplies batch `9`.

# Step 5 — author batch `9`, `frontier-31a`

Required inputs are `research/frontier-31a-batch-9.pages.json`,
`research/frontier-31a-batch-9.notes.md`,
`research/frontier-31a-batch-9.coverage.json`, and
`research/frontier-31a-beta-9.task.md`. Use `research/frontier-31a-alpha-groups.json`
...
`research/frontier-31a-batch-9.proof-contracts.json` is an output to complete;
...
`node tools/content-policy.mjs research/frontier-31a-batch-9.pages.json`, and
