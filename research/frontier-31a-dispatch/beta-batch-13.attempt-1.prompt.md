...
# Batch 13 of run `frontier-31a` — Projective Algebraic Sets Projective Morphisms and Cones
...
| | |
|---|---|
| A page | `projective-algebraic-sets-projective-morphisms-and-cones` · order **366.045** · `algebraic-geometry` |
| B page | `projective-algebraic-sets-projective-morphisms-and-cones-examples` |
| title | Projective Algebraic Sets Projective Morphisms and Cones |
| requires | `morphisms-local-rings-and-rational-maps-of-affine-varieties-examples` |
| design | `research/plan-algebraic-geometry-track.md` L210 |
