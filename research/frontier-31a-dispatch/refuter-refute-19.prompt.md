...
The task and `research/frontier-31a-step6-scope-19.json` define `refuter_scope`.
...
label: refute-19
covers: 19
output: research/frontier-31a-refute-19.json

# Step 6a — refuter

Read `research/frontier-31a-step6-scope-19.json` and audit exactly its `refuter_scope`,
