...
run: frontier-31a
role: reader
label: reader-recover-13

# Step 6 reader routing-artifact correction

Correct research/frontier-31a-reader-findings-13.json for batch 13.
Set the top-level `batch` field to exactly "13"; it identifies this batch, not the run number.
