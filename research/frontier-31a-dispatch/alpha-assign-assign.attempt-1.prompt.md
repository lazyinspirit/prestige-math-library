...
label: assign
covers: all
output: research/frontier-31a-alpha-groups.json

# Assign batches to group Alphas

This dispatch produces only `research/frontier-31a-alpha-groups.json`. It assigns the
...
```sh
node tools/alpha-groups.mjs --run frontier-31a --facts
```
...
```sh
node tools/alpha-groups.mjs --run frontier-31a
```
