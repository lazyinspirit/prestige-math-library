...
label: step9-lead
covers: all
output: research/frontier-31a-alpha-step9-review.md

# Step 9 — scope-denial delta review, `frontier-31a`

Read only pending rows in `research/frontier-31a-step9-scope-delta.json`. Verify each
...
`research/frontier-31a-alpha-step9-review.md`. Inspect each open run ledger row and
