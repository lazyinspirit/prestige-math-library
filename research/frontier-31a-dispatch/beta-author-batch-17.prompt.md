...
covers: 17
output: research/frontier-31a-batch-17.proof-contracts.json

> The dispatch block supplies batch `17`.

# Step 5 — author batch `17`, `frontier-31a`

Required inputs are `research/frontier-31a-batch-17.pages.json`,
`research/frontier-31a-batch-17.notes.md`,
`research/frontier-31a-batch-17.coverage.json`, and
`research/frontier-31a-beta-17.task.md`. Use `research/frontier-31a-alpha-groups.json`
...
`research/frontier-31a-batch-17.proof-contracts.json` is an output to complete;
...
`node tools/content-policy.mjs research/frontier-31a-batch-17.pages.json`, and
`node tools/proof-contract.mjs research/frontier-31a-batch-17.proof-contracts.json --strict`.
