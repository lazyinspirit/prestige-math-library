...
# Batch 6 of run `frontier-31a` — Primitive Dirichlet L Functions and Functional Equations · Number Fields Rings of Integers and Discriminants
...
| | |
|---|---|
| A page | `primitive-dirichlet-l-functions-and-functional-equations` · order **348.011** · `number-theory` |
| B page | `primitive-dirichlet-l-functions-and-functional-equations-examples` |
| title | Primitive Dirichlet L Functions and Functional Equations |
| requires | `dirichlet-characters-l-functions-and-primes-in-progressions-examples` |
| design | `research/plan-number-theory-track.md` L1286 |
...
| | |
|---|---|
| A page | `number-fields-rings-of-integers-and-discriminants` · order **365.911** · `number-theory` |
| B page | `number-fields-rings-of-integers-and-discriminants-examples` |
| title | Number Fields Rings of Integers and Discriminants |
| requires | `hilbert-symbols-and-the-quadratic-local-global-principle-examples` |
| design | `research/plan-number-theory-track.md` L1651 |
