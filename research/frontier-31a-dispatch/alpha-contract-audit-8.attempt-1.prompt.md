...
run: frontier-31a
role: alpha
label: contract-audit-8

# Contract-detector adjudication — `frontier-31a`
...
Merge the batch contracts into `research/frontier-31a-proof-contracts.json` and
rerun the failed detector. Write `research/frontier-31a-alpha-contract-audit.md`
