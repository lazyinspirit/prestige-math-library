...
run: frontier-31a
role: reader
label: reader-recover-10

# Step 6 reader routing-artifact correction

Correct research/frontier-31a-reader-findings-10.json for batch 10.
Set the top-level `batch` field to exactly "10"; it identifies this batch, not the run number.
