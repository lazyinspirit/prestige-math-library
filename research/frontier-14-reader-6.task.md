## Step 6a — independent read of batch 6
...
Scope: every item on the pages in `research/frontier-14-batch-6.pages.json`.
...
`research/frontier-14-reader-6.md`, findings numbered `R6-1`, `R6-2`, …
