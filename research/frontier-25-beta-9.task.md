# Batch 9 of run `frontier-25` — Rank Theorems and Embedded Submanifolds
...
| | |
|---|---|
| A page | `rank-theorems-and-embedded-submanifolds` · order **449** · `differential-geometry` |
| B page | `rank-theorems-and-embedded-submanifolds-examples` |
| title | Rank Theorems and Embedded Submanifolds |
| requires | `smooth-partitions-of-unity-and-exhaustions`, `tangent-cotangent-and-the-differential`, `constant-rank-submersions-and-regular-level-sets` |
| design | `plan-differential-geometry-track.md` L1118<br>`plan-differential-geometry-track.md` L1273 |
