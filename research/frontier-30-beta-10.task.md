# Batch 10 of run `frontier-30` — Delta Functors and Universality
...
| | |
|---|---|
| A page | `delta-functors-and-universality` · order **365.049** · `homological-algebra` |
| B page | `delta-functors-and-universality-examples` |
| title | Delta Functors and Universality |
| requires | `derived-functors-examples` |
| design | `plan-homological-algebra-track.md` L1625 |
