...
run: frontier-20-full
role: alpha
label: drift-review
covers: drift
output: research/frontier-20-full-alpha-step0-drift.md

## Step-0 prerequisite drift review — run `frontier-20-full`
...
**Evidence assembled for you:** `research/frontier-20-full-drift-evidence.json`
...
Write `research/frontier-20-full-alpha-step0-drift.md`, one section per A page:
