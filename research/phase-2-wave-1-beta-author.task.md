# Author batch `<i>` — `phase-2-wave-1`

Read these `research/` files:

- `phase-2-wave-1-batch-<i>.pages.json`, `phase-2-wave-1-batch-<i>.notes.md`, and
  `phase-2-wave-1-batch-<i>.coverage.json`;
- `phase-2-wave-1-beta-<i>.task.md` and its assigned design sections;
...
complete `research/phase-2-wave-1-batch-<i>.proof-contracts.json`, creating it if absent.
...
- `node tools/content-policy.mjs research/phase-2-wave-1-batch-<i>.pages.json`;
- `node tools/proof-contract.mjs research/phase-2-wave-1-batch-<i>.proof-contracts.json --strict`.
