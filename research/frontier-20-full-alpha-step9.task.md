# Step 9 — scope-denial delta review, `frontier-20-full`

Read only pending rows in `research/frontier-20-full-step9-scope-delta.json`. Verify each
...
`research/frontier-20-full-alpha-step9-review.md`. Inspect each open run ledger row and
