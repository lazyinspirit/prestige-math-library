...
## This dispatch — cluster `inner-product-basics` (batch 3)
...
**Theme:** the inner product axioms, Cauchy-Schwarz, Gram-Schmidt, Bessel and Parseval
...
- `items/thm-gram-schmidt-orthonormalisation.md`
- `items/thm-bessel-inequality-and-finite-parseval-identity.md`
- `items/ex-weighted-inner-product-on-finite-coordinate-space.md`
- `items/ex-frobenius-inner-product-on-matrix-space.md`
