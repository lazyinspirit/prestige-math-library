...
## This dispatch — cluster `adjoint-isometry` (batch 3)
...
**Theme:** the adjoint, least squares, self-adjoint idempotents and isometries

**Your items (7) — read every one in full:**

- `items/thm-adjoint-exists-and-is-unique-in-finite-dimension.md`
- `items/thm-matrix-of-the-adjoint-is-the-conjugate-transpose.md`
- `items/thm-adjoint-kernel-and-range-orthogonality.md`
- `items/thm-least-squares-solutions-and-normal-equation.md`
- `items/thm-self-adjoint-idempotents-are-exactly-orthogonal-projections.md`
- `items/thm-finite-dimensional-isometry-characterisations.md`
