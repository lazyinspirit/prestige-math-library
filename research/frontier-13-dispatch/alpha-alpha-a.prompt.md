# Alpha brief for run `frontier-13`
...
You are **Alpha on run `frontier-13`**, Claude Opus 5 on the `claude` runner at
...
`research/frontier-13-alpha-<a|b|c>-step3-scaffold-review.md` and the
...
`research/frontier-13-batch-<i>.{pages.json,notes.md,coverage.json,proof-contracts.json}`
for `<i>` in 1..7 — **the run prefix is `frontier-13`, never a level-numbered
...
Step-0 record: `research/frontier-13-step0-batching.md` — read it first, then
each batch's task file `research/frontier-13-beta-<i>.task.md`, which is the
...
`research/frontier-13-alpha-step3-scaffold-review.md`: per pair a verdict of
...
Read `research/frontier-13-step3-decisions.md` in full before you start. Every
