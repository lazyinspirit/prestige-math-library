...
## This dispatch — cluster `companion-transfer` (batch 7)
...
**Theme:** companion matrices, weighted walks, the formal matrix inverse and the cofactor formula

**Your items (8) — read every one in full:**

- `items/prop-companion-matrix-iterates-a-linear-recurrence.md`
- `items/thm-characteristic-polynomial-of-a-recurrence-companion-matrix.md`
- `items/thm-weighted-walks-are-entries-of-transfer-matrix-powers.md`
...
- `items/cor-closed-walk-trace-generating-functions.md`
