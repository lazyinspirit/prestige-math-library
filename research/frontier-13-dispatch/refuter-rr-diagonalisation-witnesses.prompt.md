...
## This dispatch — cluster `diagonalisation-witnesses` (batch 3)
...
**Theme:** worked minimal polynomials, the rotation example, and the false statements

**Your items (7) — read every one in full:**

- `items/ex-minimal-polynomials-of-scalar-diagonal-and-zero-dimensional-endomorphisms.md`
- `items/ex-same-characteristic-polynomial-different-minimal-polynomials.md`
- `items/ex-computing-a-minimal-polynomial-from-annihilating-polynomials.md`
- `items/ex-real-rotation-changes-diagonalisability-after-complex-scalar-extension.md`
- `items/cex-commuting-endomorphisms-need-not-be-diagonalisable.md`
- `items/fs-a-split-minimal-polynomial-always-gives-diagonalisability.md`
- `items/fs-the-characteristic-polynomial-determines-diagonalisability.md`
