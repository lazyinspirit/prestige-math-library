...
## This dispatch — cluster `closed-form` (batch 7)
...
**Theme:** partial fractions, repeated poles, and the polynomial-times-exponential closed form

**Your items (7) — read every one in full:**

- `items/lem-partial-fractions-for-a-split-recurrence-denominator.md`
- `items/lem-binomial-series-for-a-repeated-pole.md`
- `items/thm-closed-form-for-a-linear-recurrence-over-a-splitting-field.md`
- `items/ex-repeated-pole-produces-a-polynomial-factor.md`
- `items/cex-a-rational-recurrence-may-need-a-proper-splitting-field.md`
- `items/fs-split-characteristic-polynomials-give-only-pure-exponentials.md`
- `items/cex-factorial-generating-series-is-not-rational.md`
