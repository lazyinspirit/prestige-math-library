...
## This dispatch — cluster `projection-gram-qr` (batch 3)
...
**Theme:** orthogonal decomposition, nearest point, Gram determinant, QR, Riesz

**Your items (5) — read every one in full:**

- `items/thm-finite-dimensional-orthogonal-decomposition.md`
- `items/thm-orthogonal-projection-is-the-unique-nearest-point.md`
- `items/thm-gram-determinant-detects-linear-independence.md`
- `items/thm-qr-factorisation-over-r-or-c.md`
- `items/thm-riesz-representation-in-finite-dimensions.md`
