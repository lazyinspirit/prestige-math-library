...
## This dispatch — cluster `primary-decomposition` (batch 3)
...
**Theme:** coprime kernel decomposition, primary components, generalised eigenspaces

**Your items (5) — read every one in full:**

- `items/lem-coprime-kernel-decomposition.md`
- `items/thm-primary-decomposition-for-an-endomorphism.md`
- `items/cor-generalised-eigenspace-decomposition-for-a-split-minimal-polynomial.md`
- `items/ex-nilpotent-shift-and-its-single-primary-component.md`
- `items/ex-primary-decomposition-over-q-with-an-irreducible-quadratic.md`
