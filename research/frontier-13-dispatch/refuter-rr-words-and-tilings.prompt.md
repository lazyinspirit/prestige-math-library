...
## This dispatch — cluster `words-and-tilings` (batch 7)
...
**Theme:** avoided factors, Fibonacci and Lucas witnesses, tilings and lattice walks

**Your items (7) — read every one in full:**

- `items/thm-words-avoiding-finitely-many-factors-have-rational-generating-functions.md`
- `items/ex-fibonacci-generating-function-and-binet-formula.md`
- `items/ex-lucas-generating-function-and-closed-form.md`
- `items/ex-fibonacci-companion-matrix.md`
- `items/ex-fibonacci-monomer-domino-tilings-by-transfer-matrix.md`
- `items/ex-lucas-cyclic-tilings-and-the-trace-method.md`
- `items/ex-north-east-west-walks-without-immediate-horizontal-reversal.md`
