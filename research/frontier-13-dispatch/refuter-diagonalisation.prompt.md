...
## This dispatch — cluster `diagonalisation` (batch 3)
...
**Theme:** the diagonalisability criteria and simultaneous diagonalisation

**Your items (7) — read every one in full:**

- `items/thm-diagonalisability-eigenspace-direct-sum-criterion.md`
- `items/thm-diagonalisable-iff-characteristic-polynomial-splits-and-multiplicities-agree.md`
- `items/thm-diagonalisable-iff-minimal-polynomial-splits-with-distinct-roots.md`
- `items/cor-distinct-characteristic-roots-imply-diagonalisability.md`
- `items/cor-idempotent-endomorphisms-are-diagonalisable-projections.md`
- `items/thm-invariant-restrictions-of-diagonalisable-endomorphisms-are-diagonalisable.md`
- `items/thm-simultaneous-diagonalisation-of-commuting-diagonalisable-endomorphisms.md`
