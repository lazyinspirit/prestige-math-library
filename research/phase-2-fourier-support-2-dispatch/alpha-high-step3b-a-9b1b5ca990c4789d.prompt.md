...
role: alpha-high
label: step3b-a-9b1b5ca990c4789d
covers: 1
output: research/phase-2-fourier-support-2-batch-1.pages.json

# step3b: group a

- Run: phase-2-fourier-support-2
- Batches: 1
- A pages: fourier-transform-convolution-and-approximate-identities, schwartz-space-and-the-plancherel-theorem
- Read current manifests, coverage, prose, plan and dependency records.
- Write research/phase-2-fourier-support-2-step3b-a.md.
