...
role: alpha
label: 5b-gate-step5-routing-final-1

# Step 5b repair — step5-routing-final

This file is the authority for repair cycle 1.
Primary gate: `step5-routing-final`
Reason: ERROR step5-open: [5a-adjudicate unowned depcheck failure] p2-fourier2-5a-gate-unowned-depcheck remains open
...
```text
step5-scope: 57 item(s) routed, 61 adjudication obligation(s), 2 error(s)
ERROR step5-open: [5a-adjudicate unowned depcheck failure] p2-fourier2-5a-gate-unowned-depcheck remains open
ERROR step5-open: [5a-adjudicate unowned centralizer precheck failure] p2-fourier2-5a-gate-unowned-precheck remains open
...
[
  {
    "stage": "5b-cross",
    "gate": "impact-audit",
    "why": "ERROR receipt-disposition-status: research/phase-2-fourier-support-2-impact.json: cex-a-kac-moody-verma-module-is-not-integrable-in-general has an invalid or unresolved status"
  },
  {
    "stage": "5b-cross",
