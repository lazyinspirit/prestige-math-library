...
role: alpha
label: gate-batch-3-all

# Step 5a gate repair batch

Stage: 5a-adjudicate. Evidence: research/phase-2-fourier-support-2-5a-adjudicate-gate-batch-3.json. Group: all (serial writer).
Write your report to research/phase-2-fourier-support-2-5a-adjudicate-gate-review-3-all.md. Briefs and task templates are read-only.
