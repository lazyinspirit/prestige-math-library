...
| 3 | `lem-separated-frequency-blocks-do-not-disturb-earlier-partial-sum-maxima` (lemma) — frequency translation separates support, preserves internal maxima up to the chosen scalar amplitude, and leaves earlier cutoffs unchanged. Completed-block smallness requires independent amplitude control, not frequency translation. | Makes the gliding-hump induction legitimate. | literature-derived | ai-altered | G §4.2.1; exact coefficient identities and independent summable amplitudes supply the corrected route. Modulation preserves completed magnitude. |
