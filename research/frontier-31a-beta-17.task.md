# Batch 17 of run `frontier-31a` — The Exterior Derivative and Cartan Calculus
...
| | |
|---|---|
| A page | `the-exterior-derivative-and-cartan-calculus` · order **465** · `differential-geometry` |
| B page | `the-exterior-derivative-and-cartan-calculus-examples` |
| title | The Exterior Derivative and Cartan Calculus |
| requires | `vector-fields-flows-and-lie-derivatives`, `distributions-integral-manifolds-and-the-frobenius-theorem`, `tensor-fields-exterior-algebra-and-differential-forms` |
| design | `research/plan-differential-geometry-track.md` L2964 |
