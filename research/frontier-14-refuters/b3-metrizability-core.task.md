# Read-only proof-refuter — run `frontier-14`, cluster `b3-metrizability-core`
...
`research/frontier-14-refuters/b3-metrizability-core.report.md`.

## Your scope — 40 draft items
...
- `cor-completely-metrizable-spaces-are-baire`
...
- `prop-closed-subspaces-of-cech-complete-spaces`
...
`research/frontier-14-refuters/b3-metrizability-core.report.md`, findings numbered
`B3-METRIZABILITY-CORE-1`, `B3-METRIZABILITY-CORE-2`, … **stably** — numbering is permanent.
