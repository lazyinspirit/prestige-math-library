# Read-only proof-refuter — run `frontier-14`, cluster `b1-contour-examples`
...
`research/frontier-14-refuters/b1-contour-examples.report.md`.

## Your scope — 12 draft items
...
- `fs-contour-length-is-the-length-of-its-trace`
...
`research/frontier-14-refuters/b1-contour-examples.report.md`, findings numbered
`B1-CONTOUR-EXAMPLES-1`, `B1-CONTOUR-EXAMPLES-2`, … **stably** — numbering is permanent.
