...
Correct research/no-such-run-at-all-refute-4.json for batch 4.
Read research/no-such-run-at-all-step6-scope-4.json and audit exactly its frozen `refuter_scope`.
Set the top-level `batch` field to exactly "4".
