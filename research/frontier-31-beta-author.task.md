...
# Step 5 — author batch `<i>`, `frontier-31`

Required inputs are `research/frontier-31-batch-<i>.pages.json`,
`research/frontier-31-batch-<i>.notes.md`,
`research/frontier-31-batch-<i>.coverage.json`, and
`research/frontier-31-beta-<i>.task.md`. Use `research/frontier-31-alpha-groups.json`
to find the group whose `covers` includes this batch, then read its
`research/frontier-31-alpha-GROUP-step3-verdicts.json` and
`research/frontier-31-alpha-GROUP-step3-scaffold-review.md` (replace GROUP with
...
`research/frontier-31-batch-<i>.proof-contracts.json` is an output to complete;
...
`node tools/content-policy.mjs research/frontier-31-batch-<i>.pages.json`, and
`node tools/proof-contract.mjs research/frontier-31-batch-<i>.proof-contracts.json --strict`.
