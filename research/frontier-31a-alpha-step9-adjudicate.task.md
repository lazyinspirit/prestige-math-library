# Step 9 — changed-mathematics adjudication, `frontier-31a`

Act only on ids in `research/frontier-31a-step9-changes.json`. Read their current
...
`research/frontier-31a-alpha-step9-adjudicate.md` with every tuple, outcome,
