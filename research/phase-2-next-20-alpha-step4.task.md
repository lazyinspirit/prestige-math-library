# Step 4 — splice-refusal adjudication, `phase-2-next-20`

Read `research/phase-2-next-20-splice-refusals.json` and every reported undeclared
...
`research/phase-2-next-20-alpha-step4.md` with each edge, evidence, disposition, edit,
