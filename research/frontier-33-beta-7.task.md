# Batch 7 of run `frontier-33` — Regular Local Rings and Homological Dimension
...
| | |
|---|---|
| A page | `regular-local-rings-and-homological-dimension` · order **365.905** · `commutative-algebra` |
| B page | `regular-local-rings-and-homological-dimension-examples` |
| title | Regular Local Rings and Homological Dimension |
| requires | `depth-and-cohen-macaulay-modules-examples`, `tor-flatness-and-global-dimension` |
| design | `research/plan-commutative-algebra-track.md` L3813 |
