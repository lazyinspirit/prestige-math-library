...
covers: all
output: research/frontier-24-pathway-closure.json

# Step 10 — pathway closure, `frontier-24`

Read `research/frontier-24-pathway.json` and
`research/frontier-24-pathway-closure.json`. For every pending receipt row, rewrite
