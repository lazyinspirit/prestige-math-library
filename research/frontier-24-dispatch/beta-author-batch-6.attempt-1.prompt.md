...
covers: 6
output: research/frontier-24-batch-6.proof-contracts.json

> The dispatch block supplies batch `6`.

# Step 5 — author batch `6`, `frontier-24`

Use `research/frontier-24-batch-6.pages.json`, `.notes.md`, `.coverage.json`,
