...
# Batch 10 of run `frontier-24` — Deterministic Finite Automata and Regular Languages · Context-Free Grammars and Normal Forms
...
| | |
|---|---|
| A page | `deterministic-finite-automata-and-regular-languages` · order **583** · `computability-theory` |
...
| design | `plan-computability-theory-track.md` L216<br>`plan-computability-theory-track.md` L239 |
...
| | |
|---|---|
| A page | `context-free-grammars-and-normal-forms` · order **591** · `computability-theory` |
...
| design | `plan-computability-theory-track.md` L358<br>`plan-computability-theory-track.md` L384 |
