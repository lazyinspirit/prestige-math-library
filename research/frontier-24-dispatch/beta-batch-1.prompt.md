...
# Batch 1 of run `frontier-24` — Noether Normalisation and Nullstellensatz
...
| | |
|---|---|
| A page | `noether-normalisation-and-nullstellensatz` · order **111.013** · `commutative-algebra` |
| B page | `noether-normalisation-and-nullstellensatz-examples` |
| title | Noether Normalisation and Nullstellensatz |
| requires | `integral-extensions-and-going-up-examples` |
| design | `plan-commutative-algebra-track.md` L3320 |
