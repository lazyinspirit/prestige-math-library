...
# Contract-detector adjudication — `frontier-24`
...
Merge the batch contracts into `research/frontier-24-proof-contracts.json` and
rerun the failed detector. Write `research/frontier-24-alpha-contract-audit.md`
