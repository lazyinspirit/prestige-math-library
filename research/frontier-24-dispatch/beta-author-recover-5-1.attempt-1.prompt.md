...
run: frontier-24
role: beta
label: author-recover-5-1
covers: 5
output: research/frontier-24-batch-5.proof-contracts.json

> The dispatch block supplies batch `5`.

# Step 5 — author batch `5`, `frontier-24`

Use `research/frontier-24-batch-5.pages.json`, `.notes.md`, `.coverage.json`,
