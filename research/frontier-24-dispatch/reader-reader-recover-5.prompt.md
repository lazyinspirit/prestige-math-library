...
run: frontier-24
role: reader
label: reader-recover-5
covers: 5
output: research/frontier-24-step6-scope-5.json

# Step 6 reader routing-artifact correction

Correct research/frontier-24-reader-findings-5.json for batch 5.
Set the top-level `batch` field to exactly "5"; it identifies this batch, not the run number.
