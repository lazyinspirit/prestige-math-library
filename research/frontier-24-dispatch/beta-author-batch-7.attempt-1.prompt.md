...
covers: 7
output: research/frontier-24-batch-7.proof-contracts.json

> The dispatch block supplies batch `7`.

# Step 5 — author batch `7`, `frontier-24`

Use `research/frontier-24-batch-7.pages.json`, `.notes.md`, `.coverage.json`,
