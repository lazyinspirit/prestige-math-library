...
run: frontier-24
role: beta
label: scaffold-fix-1-b9
covers: 9

> The dispatch block supplies batch `9`.

# Post-recheck scaffold repair — batch `9`, `frontier-24`

Read `research/frontier-24-scaffold-closure.json` and take only `work[]` entries
whose pages belong to batch `9` in the scope ledger. Apply or push back on
