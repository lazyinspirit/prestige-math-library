...
label: 6b-d
covers: 10
output: research/frontier-24-alpha-d-6b.md

# Step 6b — routed group adjudication

Work only on the dispatched group. For every batch, read its
`research/frontier-24-step6-scope-10.json`, reader report and findings JSON, refuter
...
Write `research/frontier-24-alpha-<g>-6b.md` and
`research/frontier-24-alpha-<g>-6b-decisions.json` with `{version:1,run,group,decisions}`.
