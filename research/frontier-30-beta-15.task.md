# Batch 15 of run `frontier-30` — Distributions Integral Manifolds and the Frobenius Theorem
...
| | |
|---|---|
| A page | `distributions-integral-manifolds-and-the-frobenius-theorem` · order **461** · `differential-geometry` |
...
| requires | `tangent-cotangent-and-the-differential`, `rank-theorems-and-embedded-submanifolds`, `smooth-vector-bundles-and-sections`, `euclidean-ordinary-differential-equations-with-smooth-dependence`, `vector-fields-flows-and-lie-derivatives` |
| design | `plan-differential-geometry-track.md` L2520 |
