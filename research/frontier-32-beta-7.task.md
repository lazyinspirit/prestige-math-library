# Batch 7 of run `frontier-32` — Perron Inversion and the Explicit Formula · Prime Ideal Decomposition Ramification and the Different
...
| | |
|---|---|
| A page | `perron-inversion-and-the-explicit-formula` · order **348.013** · `number-theory` |
| B page | `perron-inversion-and-the-explicit-formula-examples` |
| title | Perron Inversion and the Explicit Formula |
| requires | `primitive-dirichlet-l-functions-and-functional-equations-examples` |
| design | `research/plan-number-theory-track.md` L1350 |
...
| | |
|---|---|
| A page | `prime-ideal-decomposition-ramification-and-the-different` · order **365.913** · `number-theory` |
| B page | `prime-ideal-decomposition-ramification-and-the-different-examples` |
| title | Prime Ideal Decomposition Ramification and the Different |
| requires | `number-fields-rings-of-integers-and-discriminants-examples` |
| design | `research/plan-number-theory-track.md` L1719 |
