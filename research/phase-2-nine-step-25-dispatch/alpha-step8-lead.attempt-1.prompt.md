...
label: step8-lead
covers: all
output: research/phase-2-nine-step-25-alpha-step8-review.md
...
`research/phase-2-nine-step-25-cross-batch-dependencies.json` for cross-batch scope and impact.

Read only pending rows in `research/phase-2-nine-step-25-step8-scope-delta.json`. Verify each
...
If `research/phase-2-nine-step-25-step8-mathematical-review.task.md` exists, also perform its
...
`research/phase-2-nine-step-25-alpha-step8-review.md`. Inspect each open run ledger row and
