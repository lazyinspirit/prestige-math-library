...
You are the group Alpha for batches **14**, **15**, **16**: 5 A/B pair(s), 10 page(s), 215 item(s), 29 open rejection(s) over 29 item(s).
...
|---|---|---|---|
| `cor-elementary-membership-chains-and-collapse-compatibility` | `reflection-absoluteness-and-elementary-submodels` | gpt-5.6-terra | `e90e64e4d564ca4eaa74c515059d462c5a4f755c75cb29443383cbdfc647fcbe` |
| `cor-unraveling-covers-give-determinacy` | `borel-analytic-sets-perfect-sets-and-determinacy` | gpt-5.6-terra | `6e6345a8cf8c32d656aa0bb4cbc049ba93d3d763aef58fac372f199da1659927` |
| `def-countable-paracompactness-and-dowker-space` | `pcf-scales-and-zfc-dowker-spaces` | gpt-5.6-terra | `b58d15c9f800a68f21f19deac1a558debb83910a49d86569817c5c78999c1e20` |
| `def-effective-interpretation-and-proof-translation` | `arithmetization-incompleteness-and-relative-consistency` | gpt-5.6-terra | `c103666b1a9372103a0449c7e814e74bde4bf7ed11c1672cbf71d51f6615b50f` |
| `ex-consistent-theory-with-an-internal-false-proof` | `arithmetization-incompleteness-and-relative-consistency-examples` | gpt-5.6-terra | `b4e9109178ad770f8b89ca6e238f1241092ccc2c68335bd9ebcb20b2f75685fc` |
| `ex-godel-diagonal-substitution-calculation` | `arithmetization-incompleteness-and-relative-consistency-examples` | gpt-5.6-terra | `07422dd6da59fe3c7b7f00a9681b3caa811df9b8c07a9d9523b2e95285d84d83` |
| `lem-directed-progressive-products-have-club-continuous-chains` | `pcf-scales-and-zfc-dowker-spaces` | gpt-5.6-terra | `c80745a83873edc7c7f637a29570bc64773c5695fded094fdb7a82b844c24a4b` |
| `lem-eventual-products-below-aleph-omega-have-a-continuous-long-chain` | `pcf-scales-and-zfc-dowker-spaces` | gpt-5.6-terra | `ed3c1f53180e4305167be39d0fe0576f44d5e7046935edd6466c92ddbac34cd3` |
| `lem-finite-formula-witness-rank-bounds` | `reflection-absoluteness-and-elementary-submodels` | gpt-5.6-terra | `c9f3346f7040b6ac7f02e8efbc7855a38ae0227e51796520ffb8fa7c8a4f4eb0` |
| `lem-interpretation-translates-finite-derivations` | `arithmetization-incompleteness-and-relative-consistency` | gpt-5.6-terra | `4adb942e031d6a28604f938b6a70d9aed90324f8e8bc41c6d28ab2f2c120400a` |
| `lem-kojman-shelah-subspace-is-closed` | `pcf-scales-and-zfc-dowker-spaces` | gpt-5.6-terra | `423f7dec61a651d1d3f0e67135d41a325b78d0d86ffb0b40cc8cb51122f46f40` |
| `lem-natural-number-game-strategies-have-continuum-many-plays` | `borel-analytic-sets-perfect-sets-and-determinacy` | gpt-5.6-terra | `3556a0a5afb17f3f294ace59a81533900de875a6f7e14ded4e854c2aab1e4188` |
| `lem-perfect-set-game-strategy-dichotomy` | `borel-analytic-sets-perfect-sets-and-determinacy` | gpt-5.6-terra | `66b0b7ae77ec87be31645a54a9086816c1787a31d4b744d0f3626137fd893777` |
| `lem-primitive-recursive-syntax-and-proof-checking` | `arithmetization-incompleteness-and-relative-consistency` | gpt-5.6-terra | `cddcaaade180d0f752d6bb21593c3cabc17cd430e238ae2304fd069f0a5f2314` |
| `lem-rudin-bounded-cofinality-hull-transfer` | `pcf-scales-and-zfc-dowker-spaces` | gpt-5.6-terra | `40f59858373698c5411d72a59a9b39285cbda3a00ee89a276b6e402fd2ab25f3` |
| `lem-rudin-disjoint-box-refinement` | `pcf-scales-and-zfc-dowker-spaces` | gpt-5.6-terra | `b47077ae35b5fe5e4b560979c667e2d990db590cdbf4bef8e27230bf697818da` |
| `lem-rudin-neighborhoods-of-initial-top-slices-contain-tails` | `pcf-scales-and-zfc-dowker-spaces` | gpt-5.6-terra | `137ac3d7b998c8eb2d0d1638ee8d0545ead0fd3e4a2c879eed9092e0af678b69` |
| `lem-sequence-spaces-continuously-inject-into-the-real-line` | `borel-analytic-sets-perfect-sets-and-determinacy` | gpt-5.6-terra | `86006a65186dd98b3320d9fa0375f57852eade3e9a3f1e6d37197e3e0ce5323e` |
| `lem-uncountable-analytic-splitting` | `borel-analytic-sets-perfect-sets-and-determinacy` | gpt-5.6-terra | `2b6e89149a37ed2b5369e2cb27e65401419131dcbb12b0f3fdec8108c6f0e39f` |
| `thm-ad-and-dc-imply-lebesgue-measurability` | `borel-analytic-sets-perfect-sets-and-determinacy` | gpt-5.6-terra | `e9aef8119ca94f57478aa37717a64df39a084c6341bb6a61f463c2615d559d84` |
| `thm-ad-implies-perfect-set-property-for-sequence-spaces` | `borel-analytic-sets-perfect-sets-and-determinacy` | gpt-5.6-terra | `a72ec94e2e7410faac6a8f554c533cacd94d432971e1beed24736683ba9eedc4` |
| `thm-bpi-equivalent-to-boolean-filter-extension` | `boolean-algebras-stone-duality-and-the-prime-ideal-theorem` | gpt-5.6-terra | `c891aadee286c4f111a90df7dd169d6cb348e12317b7a3646831fc0d55e0b4bb` |
| `thm-kojman-shelah-space-weight-and-character` | `pcf-scales-and-zfc-dowker-spaces` | gpt-5.6-terra | `42075790a0777b7f3988c36adb5acd6e631d412231aad496bdaa0901f573e392` |
| `thm-lob-from-derivability-conditions` | `arithmetization-incompleteness-and-relative-consistency` | gpt-5.6-terra | `0e9a7ea901e7c6fe1cf131f7414f8ea580acb94f973d15aeb65437f2de124a3f` |
| `thm-order-continuous-homomorphisms-extend-to-boolean-completions` | `boolean-algebras-stone-duality-and-the-prime-ideal-theorem` | gpt-5.6-terra | `8d9b5dae6ed12fa3f5ba30fe6927f39d16b8953115b50573e5f26b4087ba9cb9` |
| `thm-primitive-recursive-numeralwise-representability` | `arithmetization-incompleteness-and-relative-consistency` | gpt-5.6-terra | `92fd59675b0a94143d84566d9805ab80fc60dced9f5b758bd52e6cb13116fb6a` |
| `thm-souslin-operation-preserves-lebesgue-measurability` | `borel-analytic-sets-perfect-sets-and-determinacy` | gpt-5.6-terra | `20ec0dd518d93d94115487775f9003883ac7a69d9429458ec037389d04c77b20` |
| `thm-stone-regular-open-boolean-completion` | `boolean-algebras-stone-duality-and-the-prime-ideal-theorem` | gpt-5.6-terra | `1682383fdb527ad1276d370ab1e2723b8796a179a9f35e2fe75f1d235e2fda34` |
| `thm-tarski-arithmetic-truth-undefinability` | `arithmetization-incompleteness-and-relative-consistency` | gpt-5.6-terra | `ea6f0dd203643f277529bf8eba4841c6c3055d8ea732ed6fe087e6dfc08404bb` |
