...
You are the group Alpha for batches **5**, **6**, **7**: 4 A/B pair(s), 8 page(s), 117 item(s), 20 open rejection(s) over 20 item(s).
...
| `def-cohomological-spectral-sequence` | `spectral-sequences` | gpt-5.6-terra | `a20f18acdb94edc30f4ecfae4a92a8c964eb01d01baec779a03d335c399fad15` |
...
| `ex-a-flat-nonprojective-module` | `tor-flatness-and-global-dimension-examples` | gpt-5.6-terra | `39fe86238b961141b1a8dcfbf33de99a95435620617689b42d84db1183648d04` |
| `ex-pid-kunneth-over-a-field-has-no-tor-correction` | `kunneth-exactness-and-splittings-over-principal-ideal-domains-examples` | gpt-5.6-terra | `c646a627f44508f3cc791fd69860d2797f6aa0c962ef6f837fc029349e48adf1` |
| `ex-pid-polynomial-ring-kunneth-tor-class` | `kunneth-exactness-and-splittings-over-principal-ideal-domains-examples` | gpt-5.6-terra | `cc755b440af143d20d9de488597b0a1b07ffa3a736f3e249908aac0af347d2a5` |
...
| `lem-associated-graded-quotients-are-well-defined-subquotients` | `spectral-sequences` | gpt-5.6-terra | `53f143d8d9ae9837944021a08eee8eeb47e63e228ff46a0de9bd88ace38a6167` |
...
| `prop-a-spectral-sequence-supported-in-one-row-or-column-collapses` | `spectral-sequences` | gpt-5.6-terra | `08c9f51a0b7e2202b0d5e8e7fcf4738818f137dce0a4c191fd2f089acc757197` |
| `prop-e-zero-is-the-associated-graded-complex` | `spectral-sequences` | gpt-5.6-terra | `ff1fa9f5a41501849268eea26ddac9e04ece3c2b24463dd598355ee85548fecf` |
...
| `prop-the-tor-balance-isomorphism-is-natural-and-coherent-under-change-of-resolutions` | `tor-flatness-and-global-dimension` | gpt-5.6-terra | `6046ab8abd98e854723bd7c2a05951f5258975f91e2d27ca5c176c0dd952983e` |
...
| `thm-pid-kunneth-exactness-from-cycle-boundary-presentations` | `kunneth-exactness-and-splittings-over-principal-ideal-domains` | gpt-5.6-terra | `396f0c04a74d6c6672cff74af43c1d1029c470b4d7de193359d1cc6a675e2b80` |
