...
covers: all
output: research/phase-2-nine-step-25-pathway-closure.json

# Step 9 — pathway closure, `phase-2-nine-step-25`

Read `research/phase-2-nine-step-25-pathway.json` and
`research/phase-2-nine-step-25-pathway-closure.json`. For every pending receipt row, rewrite
