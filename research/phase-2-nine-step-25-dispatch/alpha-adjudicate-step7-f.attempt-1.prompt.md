...
You are the group Alpha for batches **12**, **13**: 2 A/B pair(s), 4 page(s), 21 item(s), 8 open rejection(s) over 8 item(s).
...
|---|---|---|---|
| `cex-deleting-stay-put-moves-does-not-preserve-computation` | `one-tape-simulation-normal-forms-examples` | gpt-5.6-terra | `419124756a9b1537047185626e05452bcb79407cfba023a66b201d9f002a8d4a` |
| `def-boone-group-presentation-and-special-word` | `boone-machine-simulation-and-fixed-presentation-undecidability` | gpt-5.6-terra | `c0b3594ea60632f67924c423086d19bfac06e08bc327215180b4bb4bee4688c9` |
| `ex-boone-sharp-is-not-word-inversion` | `boone-machine-simulation-and-fixed-presentation-undecidability-examples` | gpt-5.6-terra | `ecab52c2ab198397db7b094455354a896879e02402f7fe6c518157d2d2e35cbf` |
| `lem-boone-commutator-extracts-an-auxiliary-history` | `boone-machine-simulation-and-fixed-presentation-undecidability` | gpt-5.6-terra | `348c9b8211884cafab195734a678edcc667f480597fbb81dfc077566834cc803` |
| `lem-boone-hnn-tower-and-auxiliary-subgroups` | `boone-machine-simulation-and-fixed-presentation-undecidability` | gpt-5.6-terra | `a7182971f4237ba658ce4ac909da62dd61a4c04f48ecce3fa839561b90ae7688` |
| `lem-boone-positive-history-reconstruction` | `boone-machine-simulation-and-fixed-presentation-undecidability` | gpt-5.6-terra | `606acaaf9fff441cb0e6754da84e3770ca0847b550e3b7919d9f87aebe1ff560` |
| `thm-fixed-finite-semigroup-has-undecidable-terminal-equality` | `boone-machine-simulation-and-fixed-presentation-undecidability` | gpt-5.6-terra | `d4ba50c87e54785fb792e7a9b3e483208d8cc0e1693c8bca89723fbe597eb6ba` |
| `thm-novikov-boone-undecidability-of-the-word-problem` | `boone-machine-simulation-and-fixed-presentation-undecidability` | gpt-5.6-terra | `4920c28b84ddfffa064c3f3671299d2931b8f35acb3e4ea3ed4788102a8a4e06` |
