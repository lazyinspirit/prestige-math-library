...
You are the group Alpha for batches **10**, **11**: 3 A/B pair(s), 6 page(s), 98 item(s), 23 open rejection(s) over 23 item(s).
...
|---|---|---|---|
| `cex-imaginary-root-spaces-need-not-have-multiplicity-one` | `kac-moody-algebras-from-generalized-cartan-matrices-examples` | gpt-5.6-terra | `2e466f7f243013461e1f63869aa61e892764a51154e5783473e51dc0c49530c4` |
| `cor-normalized-haar-probability-on-a-compact-group` | `haar-measure-existence-and-uniqueness` | gpt-5.6-terra | `3a2be3aa0f73228780001f662417500f1193e7aab2a75b5199ead3072032ca2b` |
| `def-block-bimodule-for-the-double-group` | `blocks-defect-groups-and-the-brauer-homomorphism` | gpt-5.6-terra | `5e3090eddf4d2afaac6c0d1a3c540b4e309f6b8fdb1c8c36d699e8186b662d6e` |
| `def-kac-moody-verma-module` | `kac-moody-algebras-from-generalized-cartan-matrices` | gpt-5.6-terra | `c1e8cf88e7e97972441286f601b70b96455980b156b492583079a4e1b90f9607` |
...
| `ex-haar-measure-on-an-infinite-product-of-compact-groups` | `haar-measure-existence-and-uniqueness-examples` | gpt-5.6-terra | `2699f5df7e86fffd2d0fdd82ebdfa4410f7c99e2f70ab3b16f7e69ac44c45bfe` |
| `ex-normalized-haar-measure-on-a-finite-group` | `haar-measure-existence-and-uniqueness-examples` | gpt-5.6-terra | `61972e2ab6d40e17f003858d6d7f23eb85cfddbd4429d065c5e4777825a653a5` |
| `lem-block-centre-locality-and-trace-ideal-sums` | `blocks-defect-groups-and-the-brauer-homomorphism` | gpt-5.6-terra | `1fbca6e52b07d895ae2a18dd076e29c45a2b1f6d202f1a88a3ca7b4646ef4178` |
| `lem-block-defect-is-an-intersection-of-two-sylow-subgroups` | `blocks-defect-groups-and-the-brauer-homomorphism` | gpt-5.6-terra | `3030d49d19b791149aca15e9b88d32843760fe45f4969461c6d79afe7b20b45b` |
| `lem-haar-measure-is-positive-on-nonempty-open-sets-and-finite-on-compact-sets` | `haar-measure-existence-and-uniqueness` | gpt-5.6-terra | `bf929369358212ee6ba3fec3e3f0769cf5cb8e61c33608cc91b7cfcc9d9f977f` |
...
| `lem-relative-brauer-homomorphisms-are-transitive` | `blocks-defect-groups-and-the-brauer-homomorphism` | gpt-5.6-terra | `229396f989ef88442969da5a02fe9575b10ea853f673092b939b139d1aeb3202` |
...
| `prop-principal-block-has-sylow-defect` | `blocks-defect-groups-and-the-brauer-homomorphism` | gpt-5.6-terra | `664e4ddc528847e338f13aa3ec5e91ca68ce9665f8f5af1a5efc59c4f69df75f` |
| `thm-brauer-pair-order-is-independent-of-the-normal-chain` | `blocks-defect-groups-and-the-brauer-homomorphism` | gpt-5.6-terra | `dd43dac0e547d00aab5c577ee12256febf262d559134ecda53141503ebfa262e` |
| `thm-every-brauer-pair-determines-a-unique-global-block` | `blocks-defect-groups-and-the-brauer-homomorphism` | gpt-5.6-terra | `e7f9da3bccc4d86d1a5268028a2116a49f8814070d6d26a1025e62a641e4f67c` |
| `thm-existence-of-a-left-haar-integral` | `haar-measure-existence-and-uniqueness` | gpt-5.6-terra | `5e6048fa194ab8d5a8c483a1ab4c2e39717693c54b766aaa08247e26dad7d721` |
...
| `thm-maximal-brauer-pairs-exist-and-are-conjugate` | `blocks-defect-groups-and-the-brauer-homomorphism` | gpt-5.6-terra | `52551c1ade658adde2986845d36bda3414f11f58ff9207c9acbadf72fa5d5e2a` |
| `thm-unique-normal-subpair-below-a-brauer-pair` | `blocks-defect-groups-and-the-brauer-homomorphism` | gpt-5.6-terra | `21e9aea3f6b1e22a7b5ca508a68a352d407e60b1a2336e01934c51acd0e10e98` |
| `thm-uniqueness-of-left-haar-measure-up-to-scale` | `haar-measure-existence-and-uniqueness` | gpt-5.6-terra | `6a0d40cc383d8e650312a4d07befdd675143b3db3cf96843ca16a2a0bb304620` |
