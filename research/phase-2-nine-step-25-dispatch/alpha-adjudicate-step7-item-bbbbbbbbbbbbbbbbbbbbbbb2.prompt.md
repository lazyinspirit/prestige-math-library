...
label: step7-item-bbbbbbbbbbbbbbbbbbbbbbb2

# Step 7 adjudication — group **g**, run `phase-2-nine-step-25`

You are the group Alpha for batches **14**, **15**, **16**: 5 A/B pair(s), 10 page(s), 215 item(s), 7 open rejection(s) over 7 item(s).
