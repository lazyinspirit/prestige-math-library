# Batch 19 of run `frontier-30` — Post Correspondence and Language Undecidability · Acceptable Numberings, the s-m-n Theorem, and Recursion
...
| | |
|---|---|
| A page | `post-correspondence-and-language-undecidability` · order **607** · `computability-theory` |
...
| design | `plan-computability-theory-track.md` L650<br>`plan-computability-theory-track.md` L673 |
...
| | |
|---|---|
| A page | `acceptable-numberings-smn-and-the-recursion-theorem` · order **611** · `computability-theory` |
...
| design | `plan-computability-theory-track.md` L721 |
