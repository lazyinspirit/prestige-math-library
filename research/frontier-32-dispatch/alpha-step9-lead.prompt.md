...
label: step9-lead
covers: all
output: research/frontier-32-alpha-step9-review.md

# Step 9 — scope-denial delta review, `frontier-32`

Read only pending rows in `research/frontier-32-step9-scope-delta.json`. Verify each
...
If `research/frontier-32-step9-mathematical-review.task.md` exists, also perform its
...
`research/frontier-32-alpha-step9-review.md`. Inspect each open run ledger row and
