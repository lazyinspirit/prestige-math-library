...
The task and `research/frontier-32-step6-scope-<i>.json` define `refuter_scope`.
...
run: frontier-32
role: refuter
label: refute-recover-8

# Step 6a — refuter

Read `research/frontier-32-step6-scope-<i>.json` and audit exactly its `refuter_scope`,
