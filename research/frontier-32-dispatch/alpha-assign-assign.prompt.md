...
label: assign
covers: all
output: research/frontier-32-alpha-groups.json

# Assign batches to group Alphas

This dispatch produces only `research/frontier-32-alpha-groups.json`. It assigns the
...
```sh
node tools/alpha-groups.mjs --run frontier-32 --facts
```
...
```sh
node tools/alpha-groups.mjs --run frontier-32
```
