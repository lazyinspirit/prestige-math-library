...
covers: 7
output: research/frontier-32-batch-7.pages.json

> The dispatch block supplies batch `7`.

# Step 5 — author batch `7`, `frontier-32`

Required inputs are `research/frontier-32-batch-7.pages.json`,
`research/frontier-32-batch-7.notes.md`,
`research/frontier-32-batch-7.coverage.json`, and
`research/frontier-32-beta-7.task.md`. Use `research/frontier-32-alpha-groups.json`
...
`research/frontier-32-batch-7.proof-contracts.json` is an output to complete;
...
`node tools/content-policy.mjs research/frontier-32-batch-7.pages.json`, and
