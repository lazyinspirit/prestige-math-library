...
# Batch 6 of run `frontier-32` — Lacunary Fourier Series and Sidon Sets
...
| | |
|---|---|
| A page | `lacunary-fourier-series-and-sidon-sets` · order **288.14014** · `fourier-analysis` |
| B page | `lacunary-fourier-series-and-sidon-sets-examples` |
| title | Lacunary Fourier Series and Sidon Sets |
| requires | `absolute-convergence-and-the-wiener-algebra-examples` |
| design | `research/plan-fourier-analysis-track.md` L24 (id mention, not a heading — locate the section yourself) |
