...
The task and `research/frontier-32-step6-scope-17.json` define `refuter_scope`.
...
label: refute-17
covers: 17
output: research/frontier-32-refute-17.json

# Step 6a — refuter

Read `research/frontier-32-step6-scope-17.json` and audit exactly its `refuter_scope`,
