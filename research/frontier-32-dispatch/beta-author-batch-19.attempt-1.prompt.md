...
covers: 19
output: research/frontier-32-batch-19.pages.json

> The dispatch block supplies batch `19`.

# Step 5 — author batch `19`, `frontier-32`

Required inputs are `research/frontier-32-batch-19.pages.json`,
`research/frontier-32-batch-19.notes.md`,
`research/frontier-32-batch-19.coverage.json`, and
`research/frontier-32-beta-19.task.md`. Use `research/frontier-32-alpha-groups.json`
...
`research/frontier-32-batch-19.proof-contracts.json` is an output to complete;
...
`node tools/content-policy.mjs research/frontier-32-batch-19.pages.json`, and
