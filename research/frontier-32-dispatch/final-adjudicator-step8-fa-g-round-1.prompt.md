...
# Final Adjudicator queue — frontier-32, group g, round 1

This is the exact queue frozen in `research/frontier-32-step8-fa-g-round-1.json`. It contains 2 item(s).
Work in the numbered order below. Do not substantively review the next item until the recorder accepts the current one.

## 1. `ex-an-h-five-overlap-class-and-its-terminal-quotient` (run)

1. Read `items/ex-an-h-five-overlap-class-and-its-terminal-quotient.md`, its cited dependencies, pair/page context, proof contract, judge and Alpha evidence, and this group's conventions.
...
3. Write concrete evidence to `research/frontier-32-step8-fa-g-1-ex-an-h-five-overlap-class-and-its-terminal-quotient.md`, including exact source URLs and what they support, or explain why the mathematics was familiar.
...
```bash
node tools/step8-terminal-resolution.mjs record --run frontier-32 --id ex-an-h-five-overlap-class-and-its-terminal-quotient --resolved-by final-adjudicator --group g --queue research/frontier-32-step8-fa-g-round-1.json --state-dir /home/lazyinspirit/Projects/prestige-math-library/.autopilot/frontier-32 --disposition accepted-after-review --source-status verified --basis-file research/frontier-32-step8-fa-g-1-ex-an-h-five-overlap-class-and-its-terminal-quotient.md
node tools/step8-terminal-resolution.mjs record --run frontier-32 --id ex-an-h-five-overlap-class-and-its-terminal-quotient --resolved-by final-adjudicator --group g --queue research/frontier-32-step8-fa-g-round-1.json --state-dir /home/lazyinspirit/Projects/prestige-math-library/.autopilot/frontier-32 --disposition repaired --source-status verified --basis-file research/frontier-32-step8-fa-g-1-ex-an-h-five-overlap-class-and-its-terminal-quotient.md
```
...
## 2. `lem-co-e-free-external-purity-survives-h-five-overlap-quotients` (run)

1. Read `items/lem-co-e-free-external-purity-survives-h-five-overlap-quotients.md`, its cited dependencies, pair/page context, proof contract, judge and Alpha evidence, and this group's conventions.
2. Independently adjudicate the Terra rejudge rejection and decide whether the current Sol repair is correct. If unfamiliar or uncertain, use web search and verify against authoritative sources.
3. Write concrete evidence to `research/frontier-32-step8-fa-g-2-lem-co-e-free-external-purity-survives-h-five-overlap-quotients.md`, including exact source URLs and what they support, or explain why the mathematics was familiar.
4. Either accept the current Sol repair or independently repair it and its directly required local metadata/contracts. If that repair changes a run-local direct dependency, record the exact final-adjudicator prerequisite-repair licence required by the FA brief. Run focused checks. Do not append a Sol adjudication and do not request another judge call.
5. Record the exact final bytes with exactly one of these commands:

```bash
node tools/step8-terminal-resolution.mjs record --run frontier-32 --id lem-co-e-free-external-purity-survives-h-five-overlap-quotients --resolved-by final-adjudicator --group g --queue research/frontier-32-step8-fa-g-round-1.json --state-dir /home/lazyinspirit/Projects/prestige-math-library/.autopilot/frontier-32 --disposition accepted-after-review --source-status verified --basis-file research/frontier-32-step8-fa-g-2-lem-co-e-free-external-purity-survives-h-five-overlap-quotients.md
node tools/step8-terminal-resolution.mjs record --run frontier-32 --id lem-co-e-free-external-purity-survives-h-five-overlap-quotients --resolved-by final-adjudicator --group g --queue research/frontier-32-step8-fa-g-round-1.json --state-dir /home/lazyinspirit/Projects/prestige-math-library/.autopilot/frontier-32 --disposition repaired --source-status verified --basis-file research/frontier-32-step8-fa-g-2-lem-co-e-free-external-purity-survives-h-five-overlap-quotients.md
```
