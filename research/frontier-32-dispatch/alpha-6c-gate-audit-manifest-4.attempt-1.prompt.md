...
Reason: liveness unreadable — summary line did not match /over (\d+) item\(s\) in/; treating as unknown, not as a pass
...
- [dependency; published-backward] def-etale-space-of-sheaf-of-sets (presheaves-sheaves-stalks-and-sheafification, frontier-32-batch-12) -> def-topology-basis-subbasis (topological-spaces-and-continuity)
- [dependency; published-backward] lem-first-plus-construction-is-separated (presheaves-sheaves-stalks-and-sheafification, frontier-32-batch-12) -> lem-equality-in-a-filtered-colimit-of-sets-is-eventual (limits-and-colimits)
- [dependency; published-backward] thm-sheafification-preserves-stalks (presheaves-sheaves-stalks-and-sheafification, frontier-32-batch-12) -> lem-equality-in-a-filtered-colimit-of-sets-is-eventual (limits-and-colimits)
- [dependency; published-backward] ex-empty-space-unique-sheaf-sections (presheaves-sheaves-stalks-and-sheafification-examples, frontier-32-batch-12) -> def-topological-space (topological-spaces-and-continuity)
- [dependency; published-backward] def-classical-algebraic-prevariety-regular-maps-and-varieties (schemes-subschemes-and-morphisms-locally-of-finite-type, frontier-32-batch-12) -> def-algebraically-closed-field (eigenvalues-eigenvectors-and-the-characteristic-polynomial)
- [dependency; published-backward] def-classical-algebraic-prevariety-regular-maps-and-varieties (schemes-subschemes-and-morphisms-locally-of-finite-type, frontier-32-batch-12) -> def-affine-algebraic-set (affine-algebraic-sets-and-coordinate-rings)
- [dependency; published-backward] def-classical-algebraic-prevariety-regular-maps-and-varieties (schemes-subschemes-and-morphisms-locally-of-finite-type, frontier-32-batch-12) -> def-ringed-space (sheaf-operations-exactness-ringed-spaces-and-module-pullback)
- [dependency; published-backward] def-classical-algebraic-prevariety-regular-maps-and-varieties (schemes-subschemes-and-morphisms-locally-of-finite-type, frontier-32-batch-12) -> def-morphism-ringed-spaces (sheaf-operations-exactness-ringed-spaces-and-module-pullback)
- [dependency; published-backward] def-classical-algebraic-prevariety-regular-maps-and-varieties (schemes-subschemes-and-morphisms-locally-of-finite-type, frontier-32-batch-12) -> def-irreducible-topological-space-and-subset (zariski-topology-on-prime-spectra)
- [dependency; published-backward] def-scheme (schemes-subschemes-and-morphisms-locally-of-finite-type, frontier-32-batch-12) -> def-locally-ringed-space (sheaf-operations-exactness-ringed-spaces-and-module-pullback)
- [dependency; published-backward] def-scheme (schemes-subschemes-and-morphisms-locally-of-finite-type, frontier-32-batch-12) -> def-affine-scheme (affine-schemes-and-the-structure-sheaf)
- [dependency; published-backward] def-affine-open-subscheme (schemes-subschemes-and-morphisms-locally-of-finite-type, frontier-32-batch-12) -> def-affine-scheme (affine-schemes-and-the-structure-sheaf)
- [dependency; published-backward] lem-intersection-affine-opens-covered-principal-opens (schemes-subschemes-and-morphisms-locally-of-finite-type, frontier-32-batch-12) -> lem-spectrum-localization-open-immersion (affine-schemes-and-the-structure-sheaf)
- [dependency; published-backward] thm-gluing-affine-schemes (schemes-subschemes-and-morphisms-locally-of-finite-type, frontier-32-batch-12) -> def-affine-scheme (affine-schemes-and-the-structure-sheaf)
- [dependency; published-backward] thm-gluing-affine-schemes (schemes-subschemes-and-morphisms-locally-of-finite-type, frontier-32-batch-12) -> def-gluing-datum-sheaves (sheaf-operations-exactness-ringed-spaces-and-module-pullback)
- [dependency; published-backward] thm-gluing-affine-schemes (schemes-subschemes-and-morphisms-locally-of-finite-type, frontier-32-batch-12) -> thm-gluing-ringed-and-locally-ringed-spaces (sheaf-operations-exactness-ringed-spaces-and-module-pullback)
