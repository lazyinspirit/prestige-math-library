...
covers: 11
output: research/frontier-32-batch-11.pages.json

> The dispatch block supplies batch `11`.

# Step 5 — author batch `11`, `frontier-32`

Required inputs are `research/frontier-32-batch-11.pages.json`,
`research/frontier-32-batch-11.notes.md`,
`research/frontier-32-batch-11.coverage.json`, and
`research/frontier-32-beta-11.task.md`. Use `research/frontier-32-alpha-groups.json`
...
`research/frontier-32-batch-11.proof-contracts.json` is an output to complete;
...
`node tools/content-policy.mjs research/frontier-32-batch-11.pages.json`, and
`node tools/proof-contract.mjs research/frontier-32-batch-11.proof-contracts.json --strict`.
