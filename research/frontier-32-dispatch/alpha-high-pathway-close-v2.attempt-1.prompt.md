...
covers: all
output: research/frontier-32-pathway-closure.json

# Step 10 — pathway closure, `frontier-32`

Read `research/frontier-32-pathway.json` and
`research/frontier-32-pathway-closure.json`. For every pending receipt row, rewrite
