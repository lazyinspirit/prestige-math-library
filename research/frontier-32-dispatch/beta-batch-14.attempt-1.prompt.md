...
# Batch 14 of run `frontier-32` — Harmonic Functions and Mean Values in Rn
...
| | |
|---|---|
| A page | `harmonic-functions-and-mean-values-in-rn` · order **458.003** · `pde` |
| B page | `harmonic-functions-and-mean-values-in-rn-examples` |
| title | Harmonic Functions and Mean Values in Rn |
| requires | `quasilinear-characteristics-and-cauchy-kovalevskaya-examples` |
| design | `research/plan-pde-track.md` L18 (id mention, not a heading — locate the section yourself) |
