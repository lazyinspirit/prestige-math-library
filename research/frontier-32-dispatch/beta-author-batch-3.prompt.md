...
covers: 3
output: research/frontier-32-batch-3.pages.json

> The dispatch block supplies batch `3`.

# Step 5 — author batch `3`, `frontier-32`

Required inputs are `research/frontier-32-batch-3.pages.json`,
`research/frontier-32-batch-3.notes.md`,
`research/frontier-32-batch-3.coverage.json`, and
`research/frontier-32-beta-3.task.md`. Use `research/frontier-32-alpha-groups.json`
...
`research/frontier-32-batch-3.proof-contracts.json` is an output to complete;
...
`node tools/content-policy.mjs research/frontier-32-batch-3.pages.json`, and
