...
run: frontier-32
role: reader
label: reader-recover-15

# Step 6 reader routing-artifact correction

Correct research/frontier-32-reader-findings-15.json for batch 15.
Set the top-level `batch` field to exactly "15"; it identifies this batch, not the run number.
