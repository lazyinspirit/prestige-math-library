...
# Batch 2 of run `frontier-32` — Interactive Proof Systems and Public Coins · Kolmogorov Complexity and Algorithmic Randomness
...
| | |
|---|---|
| A page | `interactive-proof-systems-and-public-coins` · order **639** · `computability-theory` |
...
| design | `research/plan-computability-theory-track.md` L1240<br>`research/plan-computability-theory-track.md` L1264 |
...
| | |
|---|---|
| A page | `kolmogorov-complexity-and-algorithmic-randomness` · order **653** · `computability-theory` |
...
| design | `research/plan-computability-theory-track.md` L1501<br>`research/plan-computability-theory-track.md` L1531 |
