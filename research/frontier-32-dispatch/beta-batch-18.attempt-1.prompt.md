...
# Batch 18 of run `frontier-32` — Stable Unstable Manifolds and Morse Smale Transversality

1 A/B pair, differential-topology. You own every page here and you author them all at step 5.

## `stable-unstable-manifolds-and-morse-smale-transversality`

| | |
|---|---|
| A page | `stable-unstable-manifolds-and-morse-smale-transversality` · order **523** · `differential-topology` |
...
| requires | `gradient-like-vector-fields-and-morse-trajectories-examples` |
| design | `research/plan-differential-topology-track.md` L437 |
