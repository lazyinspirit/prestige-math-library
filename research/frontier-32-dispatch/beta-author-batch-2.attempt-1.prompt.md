...
covers: 2
output: research/frontier-32-batch-2.pages.json

> The dispatch block supplies batch `2`.

# Step 5 — author batch `2`, `frontier-32`

Required inputs are `research/frontier-32-batch-2.pages.json`,
`research/frontier-32-batch-2.notes.md`,
`research/frontier-32-batch-2.coverage.json`, and
`research/frontier-32-beta-2.task.md`. Use `research/frontier-32-alpha-groups.json`
...
`research/frontier-32-batch-2.proof-contracts.json` is an output to complete;
...
`node tools/content-policy.mjs research/frontier-32-batch-2.pages.json`, and
`node tools/proof-contract.mjs research/frontier-32-batch-2.proof-contracts.json --strict`.
