...
# Batch 12 of run `frontier-32` — Presheaves Sheaves Stalks and Sheafification · Schemes Subschemes and Morphisms Locally of Finite Type

2 A/B pairs, scheme-theory. You own every page here and you author them all at step 5.

## `presheaves-sheaves-stalks-and-sheafification`

| | |
|---|---|
| A page | `presheaves-sheaves-stalks-and-sheafification` · order **366.057** · `scheme-theory` |
| B page | `presheaves-sheaves-stalks-and-sheafification-examples` |
| title | Presheaves Sheaves Stalks and Sheafification |
| requires | `plane-curves-local-intersection-multiplicity-and-bezout-examples` |
| design | `research/plan-algebraic-geometry-track.md` L545 |
...
| | |
|---|---|
| A page | `schemes-subschemes-and-morphisms-locally-of-finite-type` · order **366.063** · `scheme-theory` |
| B page | `schemes-subschemes-and-morphisms-locally-of-finite-type-examples` |
| title | Schemes Subschemes and Morphisms Locally of Finite Type |
| requires | `affine-schemes-and-the-structure-sheaf-examples` |
| design | `research/plan-algebraic-geometry-track.md` L720 |
