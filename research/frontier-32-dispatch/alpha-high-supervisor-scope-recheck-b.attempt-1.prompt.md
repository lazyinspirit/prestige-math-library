...
run: frontier-32
role: alpha-high
label: supervisor-scope-recheck-b
covers: 3, 5, 6
...
Read `research/frontier-32-alpha-<group>-step3-scaffold-review.md` and each
...
Refresh and check `research/frontier-32-alpha-<your-group>-scope-decisions.json`
with `tools/scope-decisions.mjs`. Resolve any newly pending row from current
evidence before the check.

Write `research/frontier-32-alpha-<your-group>-recheck.md` with one disposition per
finding. Update `research/frontier-32-alpha-<your-group>-step3-verdicts.json` only
