...
run: frontier-32
role: beta
label: scaffold-fix-1-b12
covers: 12

> The dispatch block supplies batch `12`.

# Post-recheck scaffold repair — batch `12`, `frontier-32`

Read `research/frontier-32-scaffold-closure.json` and take only `work[]` entries
whose pages belong to batch `12` in the scope ledger. Apply or push back on
