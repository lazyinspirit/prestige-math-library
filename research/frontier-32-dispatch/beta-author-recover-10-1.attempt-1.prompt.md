...
run: frontier-32
role: beta
label: author-recover-10-1
covers: 10
output: research/frontier-32-batch-10.pages.json

> The dispatch block supplies batch `10`.

# Step 5 — author batch `10`, `frontier-32`

Required inputs are `research/frontier-32-batch-10.pages.json`,
`research/frontier-32-batch-10.notes.md`,
`research/frontier-32-batch-10.coverage.json`, and
`research/frontier-32-beta-10.task.md`. Use `research/frontier-32-alpha-groups.json`
...
`research/frontier-32-batch-10.proof-contracts.json` is an output to complete;
...
`node tools/content-policy.mjs research/frontier-32-batch-10.pages.json`, and
