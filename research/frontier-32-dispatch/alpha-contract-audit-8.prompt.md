...
# Contract-detector adjudication — `frontier-32`
...
Merge the batch contracts into `research/frontier-32-proof-contracts.json` and
rerun the failed detector. Write `research/frontier-32-alpha-contract-audit.md`
