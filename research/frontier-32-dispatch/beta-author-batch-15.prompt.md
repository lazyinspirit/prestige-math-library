...
covers: 15
output: research/frontier-32-batch-15.pages.json

> The dispatch block supplies batch `15`.

# Step 5 — author batch `15`, `frontier-32`

Required inputs are `research/frontier-32-batch-15.pages.json`,
`research/frontier-32-batch-15.notes.md`,
`research/frontier-32-batch-15.coverage.json`, and
`research/frontier-32-beta-15.task.md`. Use `research/frontier-32-alpha-groups.json`
...
`research/frontier-32-batch-15.proof-contracts.json` is an output to complete;
...
`node tools/content-policy.mjs research/frontier-32-batch-15.pages.json`, and
