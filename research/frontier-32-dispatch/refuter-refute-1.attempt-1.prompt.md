...
The task and `research/frontier-32-step6-scope-1.json` define `refuter_scope`.
...
label: refute-1
covers: 1
output: research/frontier-32-refute-1.json

# Step 6a — refuter

Read `research/frontier-32-step6-scope-1.json` and audit exactly its `refuter_scope`,
