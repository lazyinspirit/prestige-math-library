...
The task and `research/frontier-32-step6-scope-6.json` define `refuter_scope`.
...
label: refute-6
covers: 6
output: research/frontier-32-refute-6.json

# Step 6a — refuter

Read `research/frontier-32-step6-scope-6.json` and audit exactly its `refuter_scope`,
