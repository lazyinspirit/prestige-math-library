...
label: 6b-g
covers: 13
output: research/frontier-32-alpha-g-6b.md

# Step 6b — routed group adjudication

Work only on the dispatched group. For every batch, read its
`research/frontier-32-step6-scope-13.json`, reader report and findings JSON, refuter
...
Write `research/frontier-32-alpha-<g>-6b.md` and
`research/frontier-32-alpha-<g>-6b-decisions.json` with `{version:1,run,group,decisions}`.
