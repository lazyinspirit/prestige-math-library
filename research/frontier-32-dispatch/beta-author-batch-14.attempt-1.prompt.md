...
covers: 14
output: research/frontier-32-batch-14.pages.json

> The dispatch block supplies batch `14`.

# Step 5 — author batch `14`, `frontier-32`

Required inputs are `research/frontier-32-batch-14.pages.json`,
`research/frontier-32-batch-14.notes.md`,
`research/frontier-32-batch-14.coverage.json`, and
`research/frontier-32-beta-14.task.md`. Use `research/frontier-32-alpha-groups.json`
...
`research/frontier-32-batch-14.proof-contracts.json` is an output to complete;
...
`node tools/content-policy.mjs research/frontier-32-batch-14.pages.json`, and
