...
covers: 18
output: research/frontier-32-batch-18.pages.json

> The dispatch block supplies batch `18`.

# Step 5 — author batch `18`, `frontier-32`

Required inputs are `research/frontier-32-batch-18.pages.json`,
`research/frontier-32-batch-18.notes.md`,
`research/frontier-32-batch-18.coverage.json`, and
`research/frontier-32-beta-18.task.md`. Use `research/frontier-32-alpha-groups.json`
...
`research/frontier-32-batch-18.proof-contracts.json` is an output to complete;
...
`node tools/content-policy.mjs research/frontier-32-batch-18.pages.json`, and
`node tools/proof-contract.mjs research/frontier-32-batch-18.proof-contracts.json --strict`.
