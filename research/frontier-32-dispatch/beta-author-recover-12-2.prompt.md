...
run: frontier-32
role: beta
label: author-recover-12-2
covers: 12
output: research/frontier-32-batch-12.pages.json

> The dispatch block supplies batch `12`.

# Step 5 — author batch `12`, `frontier-32`

Required inputs are `research/frontier-32-batch-12.pages.json`,
`research/frontier-32-batch-12.notes.md`,
`research/frontier-32-batch-12.coverage.json`, and
`research/frontier-32-beta-12.task.md`. Use `research/frontier-32-alpha-groups.json`
...
`research/frontier-32-batch-12.proof-contracts.json` is an output to complete;
...
`node tools/content-policy.mjs research/frontier-32-batch-12.pages.json`, and
