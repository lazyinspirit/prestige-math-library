...
covers: 8
output: research/frontier-32-batch-8.pages.json

> The dispatch block supplies batch `8`.

# Step 5 — author batch `8`, `frontier-32`

Required inputs are `research/frontier-32-batch-8.pages.json`,
`research/frontier-32-batch-8.notes.md`,
`research/frontier-32-batch-8.coverage.json`, and
`research/frontier-32-beta-8.task.md`. Use `research/frontier-32-alpha-groups.json`
...
`research/frontier-32-batch-8.proof-contracts.json` is an output to complete;
...
`node tools/content-policy.mjs research/frontier-32-batch-8.pages.json`, and
