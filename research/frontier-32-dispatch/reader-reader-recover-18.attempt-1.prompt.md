...
run: frontier-32
role: reader
label: reader-recover-18

# Step 6 reader routing-artifact correction

Correct research/frontier-32-reader-findings-18.json for batch 18.
Set the top-level `batch` field to exactly "18"; it identifies this batch, not the run number.
