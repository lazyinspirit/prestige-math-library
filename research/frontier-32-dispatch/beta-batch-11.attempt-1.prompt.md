...
# Batch 11 of run `frontier-32` — Products Segre and Veronese Embeddings and Grassmannians

1 A/B pair, algebraic-geometry. You own every page here and you author them all at step 5.

## `products-segre-and-veronese-embeddings-and-grassmannians`

| | |
|---|---|
| A page | `products-segre-and-veronese-embeddings-and-grassmannians` · order **366.047** · `algebraic-geometry` |
| B page | `products-segre-and-veronese-embeddings-and-grassmannians-examples` |
| title | Products Segre and Veronese Embeddings and Grassmannians |
| requires | `projective-algebraic-sets-projective-morphisms-and-cones-examples`, `exterior-powers-orientation-and-hodge-duality` |
| design | `research/plan-algebraic-geometry-track.md` L260 |
