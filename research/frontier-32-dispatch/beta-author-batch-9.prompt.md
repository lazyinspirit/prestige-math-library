...
covers: 9
output: research/frontier-32-batch-9.pages.json

> The dispatch block supplies batch `9`.

# Step 5 — author batch `9`, `frontier-32`

Required inputs are `research/frontier-32-batch-9.pages.json`,
`research/frontier-32-batch-9.notes.md`,
`research/frontier-32-batch-9.coverage.json`, and
`research/frontier-32-beta-9.task.md`. Use `research/frontier-32-alpha-groups.json`
...
`research/frontier-32-batch-9.proof-contracts.json` is an output to complete;
...
`node tools/content-policy.mjs research/frontier-32-batch-9.pages.json`, and
`node tools/proof-contract.mjs research/frontier-32-batch-9.proof-contracts.json --strict`.
