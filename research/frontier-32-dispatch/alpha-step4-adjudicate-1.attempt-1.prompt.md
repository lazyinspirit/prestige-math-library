...
# Step 4 — splice-refusal adjudication, `frontier-32`

Read `research/frontier-32-splice-refusals.json` and every reported undeclared
...
`research/frontier-32-alpha-step4.md` with each edge, evidence, disposition, edit,
