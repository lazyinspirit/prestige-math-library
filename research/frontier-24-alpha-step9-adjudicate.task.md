# Step 9 — changed-mathematics adjudication, `frontier-24`

Act only on ids in `research/frontier-24-step9-changes.json`. Read their current
...
`research/frontier-24-alpha-step9-adjudicate.md` with every tuple, outcome,
