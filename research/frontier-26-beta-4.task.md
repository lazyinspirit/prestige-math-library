# Batch 4 of run `frontier-26` — Analytic Continuation, Monodromy, and Riemann Surfaces
...
| | |
|---|---|
| A page | `analytic-continuation-and-monodromy` · order **341** · `complex-analysis` |
| B page | `analytic-continuation-and-monodromy-examples` |
| title | Analytic Continuation, Monodromy, and Riemann Surfaces |
| requires | `simply-connected-plane-domains`, `the-identity-theorem-and-the-open-mapping-theorem`, `covering-spaces-and-lifting` |
| design | `plan-complex-analysis-track.md` L2619 |
