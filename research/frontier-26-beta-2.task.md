# Batch 2 of run `frontier-26` — Krylov Subspaces, Arnoldi and GMRES · Matrix Differentiation and First-order Spectral Perturbation

2 A/B pairs, linear-algebra. You own every page here and you author them all at step 5.

## `krylov-subspaces-arnoldi-and-gmres`

| | |
|---|---|
| A page | `krylov-subspaces-arnoldi-and-gmres` · order **168.009** · `linear-algebra` |
| B page | `krylov-subspaces-arnoldi-and-gmres-examples` |
| title | Krylov Subspaces, Arnoldi and GMRES |
| requires | `eigenvalue-iterations-and-the-qr-algorithm` |
| design | `plan-algebra-track-expansion-v2.md` L826 |
...
| | |
|---|---|
| A page | `matrix-differentiation-and-first-order-spectral-perturbation` · order **288.000021** · `linear-algebra` |
| B page | `matrix-differentiation-and-first-order-spectral-perturbation-examples` |
| title | Matrix Differentiation and First-order Spectral Perturbation |
| requires | `the-inverse-function-theorem-completed`, `the-moore-penrose-pseudoinverse-and-regularised-least-squares` |
| design | `plan-algebra-track-expansion-v2.md` L871 |
