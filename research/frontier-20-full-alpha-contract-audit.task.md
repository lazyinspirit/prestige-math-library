# Contract-detector adjudication — `frontier-20-full`
...
Merge the batch contracts into `research/frontier-20-full-proof-contracts.json` and
rerun the failed detector. Write `research/frontier-20-full-alpha-contract-audit.md`
