# Step 4 — splice-refusal adjudication, `phase-2-merged-25`

Read `research/phase-2-merged-25-splice-refusals.json` and every reported undeclared
...
`research/phase-2-merged-25-alpha-step4.md` with each edge, evidence, disposition, edit,
