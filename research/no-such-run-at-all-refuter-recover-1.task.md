...
Correct research/no-such-run-at-all-refute-1.json for batch 1.
Read research/no-such-run-at-all-step6-scope-1.json and audit exactly its frozen `refuter_scope`.
Set the top-level `batch` field to exactly "1".
