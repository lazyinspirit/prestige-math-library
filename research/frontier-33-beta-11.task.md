# Batch 11 of run `frontier-33` — Comb Structure in co-Bird-Free Graphs
...
| | |
|---|---|
| A page | `co-bird-free-comb-structure` · order **439** · `combinatorics` |
| B page | `co-bird-free-comb-structure-examples` |
| title | Comb Structure in co-Bird-Free Graphs |
| requires | `co-e-free-comb-structure` |
| design | `research/plan-combinatorics-and-categories.md` L3919 (id mention, not a heading — locate the section yourself) |
