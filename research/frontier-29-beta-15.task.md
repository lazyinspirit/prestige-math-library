# Batch 15 of run `frontier-29` — Generalized Niceness and Reduction Outcomes
...
| | |
|---|---|
| A page | `generalized-niceness-and-reduction-outcomes` · order **427** · `combinatorics` |
| B page | `generalized-niceness-and-reduction-outcomes-examples` |
| title | Generalized Niceness and Reduction Outcomes |
| requires | `leaf-reducibility-and-wonderful-families` |
| design | `plan-combinatorics-and-categories.md` L3913 (id mention, not a heading — locate the section yourself) |
