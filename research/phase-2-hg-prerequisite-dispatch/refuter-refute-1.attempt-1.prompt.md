...
The task and `research/phase-2-hg-prerequisite-step6-scope-1.json` define `refuter_scope`.
...
label: refute-1
covers: 1
output: research/phase-2-hg-prerequisite-refute-1.json

# Step 6a — refuter

Read `research/phase-2-hg-prerequisite-step6-scope-1.json` and audit exactly its `refuter_scope`,
