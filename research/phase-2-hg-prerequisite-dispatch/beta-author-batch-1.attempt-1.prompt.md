...
covers: 1
output: research/phase-2-hg-prerequisite-batch-1.pages.json

# Author batch `1` — `phase-2-hg-prerequisite`

Read these `research/` files:

- `phase-2-hg-prerequisite-batch-1.pages.json`, `phase-2-hg-prerequisite-batch-1.notes.md`, and
  `phase-2-hg-prerequisite-batch-1.coverage.json`;
- `phase-2-hg-prerequisite-beta-1.task.md` and its assigned design sections;
- `phase-2-hg-prerequisite-alpha-groups.json`: find your group by `covers`, then read
  `phase-2-hg-prerequisite-alpha-GROUP-step3-verdicts.json` and
  `phase-2-hg-prerequisite-alpha-GROUP-step3-scaffold-review.md` using that group's label.

Report missing inputs; do not substitute another run's artifacts. Preserve and
complete `research/phase-2-hg-prerequisite-batch-1.proof-contracts.json`, creating it if absent.
...
- `node tools/content-policy.mjs research/phase-2-hg-prerequisite-batch-1.pages.json`;
- `node tools/proof-contract.mjs research/phase-2-hg-prerequisite-batch-1.proof-contracts.json --strict`.
