# Step 9 — scope-denial delta review, `frontier-31`

Read only pending rows in `research/frontier-31-step9-scope-delta.json`. Verify each
...
`research/frontier-31-alpha-step9-review.md`. Inspect each open run ledger row and
