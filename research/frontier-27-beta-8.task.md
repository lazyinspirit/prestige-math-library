# Batch 8 of run `frontier-27` — Sard Theorem and Transversality · Tensor Fields Exterior Algebra and Differential Forms
...
| | |
|---|---|
| A page | `sard-theorem-and-transversality` · order **453** · `differential-geometry` |
| B page | `sard-theorem-and-transversality-examples` |
| title | Sard Theorem and Transversality |
| requires | `smooth-partitions-of-unity-and-exhaustions`, `rank-theorems-and-embedded-submanifolds`, `smooth-vector-bundles-and-sections` |
| design | `plan-differential-geometry-track.md` L1765 |
...
| | |
|---|---|
| A page | `tensor-fields-exterior-algebra-and-differential-forms` · order **463** · `differential-geometry` |
...
| requires | `tangent-cotangent-and-the-differential`, `smooth-vector-bundles-and-sections` |
| design | `plan-differential-geometry-track.md` L2724 |
