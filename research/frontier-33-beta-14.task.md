# Batch 14 of run `frontier-33` — Category O Finiteness Duality and Blocks

1 A/B pair, lie-theory. You own every page here and you author them all at step 5.

## `category-o-finiteness-duality-and-blocks`

| | |
|---|---|
| A page | `category-o-finiteness-duality-and-blocks` · order **510.007** · `lie-theory` |
| B page | `category-o-finiteness-duality-and-blocks-examples` |
| title | Category O Finiteness Duality and Blocks |
| requires | `homomorphisms-between-verma-modules-and-linkage-examples`, `chain-complexes-and-homology` |
| design | `research/plan-representation-theory-lie-track.md` L221 (id mention, not a heading — locate the section yourself) |
