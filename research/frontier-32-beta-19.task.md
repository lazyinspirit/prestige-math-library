# Batch 19 of run `frontier-32` — Oracle Computability, the Jump, and Turing Degrees

1 A/B pair, computability-theory. You own every page here and you author them all at step 5.

## `oracle-computability-the-jump-and-turing-degrees`

| | |
|---|---|
| A page | `oracle-computability-the-jump-and-turing-degrees` · order **615** · `computability-theory` |
...
| design | `research/plan-computability-theory-track.md` L795<br>`research/plan-computability-theory-track.md` L821 |
