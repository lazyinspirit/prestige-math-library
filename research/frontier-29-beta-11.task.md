# Batch 11 of run `frontier-29` — Derived Functors
...
| | |
|---|---|
| A page | `derived-functors` · order **365.047** · `homological-algebra` |
| B page | `derived-functors-examples` |
| title | Derived Functors |
| requires | `projective-and-injective-resolutions-examples` |
| design | `plan-combinatorics-and-categories.md` L3350<br>`plan-homological-algebra-track.md` L280<br>`plan-homological-algebra-track.md` L1326 |
