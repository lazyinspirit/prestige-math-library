# Batch 9 of run `frontier-28` — Leaf Reducibility and Wonderful Families
...
| | |
|---|---|
| A page | `leaf-reducibility-and-wonderful-families` · order **425** · `combinatorics` |
| B page | `leaf-reducibility-and-wonderful-families-examples` |
| title | Leaf Reducibility and Wonderful Families |
| requires | `small-graph-erdos-hajnal-consequences`, `iterative-restriction-and-comb-extraction-lemmas` |
| design | `plan-combinatorics-and-categories.md` L3912 (id mention, not a heading — locate the section yourself) |
