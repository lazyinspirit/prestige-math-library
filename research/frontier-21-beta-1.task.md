# Batch 1 of run `frontier-21` — Subgroups of Free Groups and Schreier Rewriting · Amenable Groups and Folner Criteria
...
| | |
|---|---|
| A page | `subgroups-of-free-groups-and-schreier-rewriting` · order **71.009** · `group-theory` |
| B page | `subgroups-of-free-groups-and-schreier-rewriting-examples` |
| title | Subgroups of Free Groups and Schreier Rewriting |
| requires | `socles-and-the-onan-scott-landscape-examples` |
| design | `plan-group-theory-track.md` L907<br>`plan-group-theory-track.md` L982 |
...
| | |
|---|---|
| A page | `amenable-groups-and-folner-criteria` · order **302.007** · `group-theory` |
| B page | `amenable-groups-and-folner-criteria-examples` |
| title | Amenable Groups and Folner Criteria |
| requires | `hyperbolic-spaces-and-hyperbolic-groups-examples` |
| design | `plan-group-theory-track.md` L1835 |
