...
Correct research/frontier-18-refute-10.json for batch 10.
Read research/frontier-18-step6-scope-10.json and audit exactly its frozen `refuter_scope`.
Set the top-level `batch` field to exactly "10".
