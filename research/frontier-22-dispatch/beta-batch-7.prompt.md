...
# Batch 7 of run `frontier-22` — The Holomorphic Inverse Function Theorem and Weierstrass Preparation
...
| | |
|---|---|
| A page | `holomorphic-inverse-and-weierstrass-preparation` · order **353** · `complex-analysis` |
| B page | `holomorphic-inverse-and-weierstrass-preparation-examples` |
| title | The Holomorphic Inverse Function Theorem and Weierstrass Preparation |
| requires | `holomorphic-functions-of-several-variables`, `inverse-and-implicit-function-theorems`, `the-argument-principle-and-rouche`, `euclidean-domains-pids-and-unique-factorisation` |
| design | `plan-complex-analysis-track.md` L3336 |
