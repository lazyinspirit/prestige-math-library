...
covers: 9
output: research/frontier-22-batch-9.proof-contracts.json

> The dispatch block supplies batch `9`.

# Step 5 — author batch `9`, `frontier-22`

Use `research/frontier-22-batch-9.pages.json`, `.notes.md`, `.coverage.json`,
