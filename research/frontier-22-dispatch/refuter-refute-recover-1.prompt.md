...
The task and `research/frontier-22-step6-scope-1.json` define `refuter_scope`.
...
run: frontier-22
role: refuter
label: refute-recover-1
covers: 1
output: research/frontier-22-refute-1.json

# Step 6a — refuter

Read `research/frontier-22-step6-scope-1.json` and audit exactly its `refuter_scope`,
