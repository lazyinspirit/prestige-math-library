...
covers: 4
output: research/frontier-22-batch-4.proof-contracts.json

> The dispatch block supplies batch `4`.

# Step 5 — author batch `4`, `frontier-22`

Use `research/frontier-22-batch-4.pages.json`, `.notes.md`, `.coverage.json`,
