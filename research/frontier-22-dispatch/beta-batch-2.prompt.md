...
# Batch 2 of run `frontier-22` — Associated Primes and Primary Decomposition
...
| | |
|---|---|
| A page | `associated-primes-and-primary-decomposition` · order **111.009** · `commutative-algebra` |
| B page | `associated-primes-and-primary-decomposition-examples` |
| title | Associated Primes and Primary Decomposition |
| requires | `artinian-rings-and-length-examples` |
| design | `plan-commutative-algebra-track.md` L522<br>`plan-commutative-algebra-track.md` L3241 |
