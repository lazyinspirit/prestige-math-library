...
covers: all
output: research/frontier-22-pathway-closure.json

# Step 10 — pathway closure, `frontier-22`

Read `research/frontier-22-pathway.json` and
`research/frontier-22-pathway-closure.json`. For every pending receipt row, rewrite
