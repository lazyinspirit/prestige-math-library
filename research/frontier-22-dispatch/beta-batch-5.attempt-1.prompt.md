...
# Batch 5 of run `frontier-22` — Modes of Convergence Egorov and Lusin
...
| | |
|---|---|
| A page | `modes-of-convergence-egorov-and-lusin` · order **288.019** · `measure-theory` |
| B page | `modes-of-convergence-egorov-and-lusin-examples` |
| title | Modes of Convergence Egorov and Lusin |
| requires | `the-lebesgue-and-riemann-integrals-compared-examples` |
| design | `plan-functional-analysis-track.md` L211 (id mention, not a heading — locate the section yourself)<br>`plan-measure-theory-track.md` L50 (id mention, not a heading — locate the section yourself)<br>`plan-probability-track.md` L208 (id mention, not a heading — locate the section yourself) |
