...
The task and `research/frontier-22-step6-scope-7.json` define `refuter_scope`.
...
label: refute-7
covers: 7
output: research/frontier-22-refute-7.json

# Step 6a — refuter

Read `research/frontier-22-step6-scope-7.json` and audit exactly its `refuter_scope`,
