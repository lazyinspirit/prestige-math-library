...
# Batch 1 of run `frontier-22` — Hnn Extensions and Brittons Lemma · Simplicial Trees and Group Actions
...
| | |
|---|---|
| A page | `hnn-extensions-and-brittons-lemma` · order **71.011** · `group-theory` |
| B page | `hnn-extensions-and-brittons-lemma-examples` |
| title | Hnn Extensions and Brittons Lemma |
| requires | `subgroups-of-free-groups-and-schreier-rewriting-examples` |
| design | `plan-group-theory-track.md` L1077 |
...
| | |
|---|---|
| A page | `simplicial-trees-and-group-actions` · order **302.009** · `group-theory` |
| B page | `simplicial-trees-and-group-actions-examples` |
| title | Simplicial Trees and Group Actions |
| requires | `amenable-groups-and-folner-criteria-examples` |
| design | `plan-group-theory-track.md` L1871<br>`plan-group-theory-track.md` L1937 |
