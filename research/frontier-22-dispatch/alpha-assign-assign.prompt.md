...
label: assign
covers: all
output: research/frontier-22-alpha-groups.json

# Assign batches to group Alphas

This dispatch produces only `research/frontier-22-alpha-groups.json`. It assigns the
...
```sh
node tools/alpha-groups.mjs --run frontier-22 --facts
```
...
```sh
node tools/alpha-groups.mjs --run frontier-22
```
