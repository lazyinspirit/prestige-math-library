...
Reconciled 2026-09-08: HA-18–HA-23 machine dependencies now encode the
external suppliers and preceding row inputs stated in prose, replacing the
serial placeholder chains. HA-24's explicit contracts are retained.
HA-18 requires the Tor/flatness page; HA-21 binds left-Noetherian and syzygy
inputs; HA-23 uses HA-15's finite-filtration abutment, not a first-quadrant
shortcut. The latter remains a prose-only supplier requiring later authoring.
No new pair or published-item edit was needed. Cross-category consumer and
closure evidence is generated by `research/audit-four-track-dependencies.mjs`.
