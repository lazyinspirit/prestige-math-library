# Step 10 — pathway closure, `frontier-20-full`

Read `research/frontier-20-full-pathway.json` and
`research/frontier-20-full-pathway-closure.json`. For every pending receipt row, rewrite
