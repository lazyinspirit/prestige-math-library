...
Correct research/no-such-run-at-all-refute-2.json for batch 2.
Read research/no-such-run-at-all-step6-scope-2.json and audit exactly its frozen `refuter_scope`.
