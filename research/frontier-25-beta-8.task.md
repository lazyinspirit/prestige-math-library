# Batch 8 of run `frontier-25` — The Five-Cycle and the Erdős–Hajnal Property
...
| | |
|---|---|
| A page | `the-five-cycle-and-erdos-hajnal` · order **415** · `combinatorics` |
| B page | `the-five-cycle-and-erdos-hajnal-examples` |
| title | The Five-Cycle and the Erdős–Hajnal Property |
| requires | `cographs-perfect-patterns-and-pure-pairs`, `bull-free-graphs-and-the-erdos-hajnal-property` |
| design | `plan-combinatorics-and-categories.md` L3907 (id mention, not a heading — locate the section yourself) |
