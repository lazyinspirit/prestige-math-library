<!-- TEMPLATE. The orchestrator's own brief for the published-page audit's two
     judgment steps, A3 and A9. Substitute 5 (wave). The workflow is
...
# Audit-orchestrator brief — wave 5 (steps A3 and A9)
...
- every `research/audit/wave5-<category>.findings.md` — the proposal registers;
- every `research/audit/wave5-<category>.provenance.jsonl` — the ledger rows;
- the batch manifests `research/audit/wave5-<category>.pages.json`;
...
Write `research/audit/wave5-A3.md` at A3, or `research/audit/wave5-A9.md` at
...
# A3 — Adjudicate Beta recommendations (wave 5)
...
**Your receipt:** write the decision to `research/audit/wave5-A3.md` — every proposal, approved or declined,
