# Contract-detector adjudication — `frontier-34`
...
Merge the batch contracts into `research/frontier-34-proof-contracts.json` and
rerun the failed detector. Write `research/frontier-34-alpha-contract-audit.md`
