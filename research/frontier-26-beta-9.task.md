# Batch 9 of run `frontier-26` — Smooth Vector Bundles and Sections
...
| | |
|---|---|
| A page | `smooth-vector-bundles-and-sections` · order **451** · `differential-geometry` |
| B page | `smooth-vector-bundles-and-sections-examples` |
| title | Smooth Vector Bundles and Sections |
| requires | `smooth-partitions-of-unity-and-exhaustions`, `tangent-cotangent-and-the-differential`, `rank-theorems-and-embedded-submanifolds` |
| design | `plan-differential-geometry-track.md` L1524 |
