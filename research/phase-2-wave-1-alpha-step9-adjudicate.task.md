# Step 9 — changed-mathematics adjudication, `phase-2-wave-1`

Act only on ids in `research/phase-2-wave-1-step9-changes.json`. Read their current
...
`research/phase-2-wave-1-alpha-step9-adjudicate.md` with every tuple, outcome,
