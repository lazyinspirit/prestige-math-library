# Batch 7 of run `frontier-26` — Mapping Cones Cylinders and Chain Triangles
...
| | |
|---|---|
| A page | `mapping-cones-cylinders-and-chain-triangles` · order **365.041** · `homological-algebra` |
| B page | `mapping-cones-cylinders-and-chain-triangles-examples` |
| title | Mapping Cones Cylinders and Chain Triangles |
| requires | `chain-homotopy-and-the-homotopy-category-examples` |
| design | `plan-homological-algebra-track.md` L774<br>`plan-homological-algebra-track.md` L901 |
