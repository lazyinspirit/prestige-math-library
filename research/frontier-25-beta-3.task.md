# Batch 3 of run `frontier-25` — The Radon Nikodym Theorem and Lebesgue Decomposition
...
| | |
|---|---|
| A page | `the-radon-nikodym-theorem-and-lebesgue-decomposition` · order **288.025** · `measure-theory` |
| B page | `the-radon-nikodym-theorem-and-lebesgue-decomposition-examples` |
| title | The Radon Nikodym Theorem and Lebesgue Decomposition |
| requires | `signed-and-complex-measures-hahn-and-jordan-examples` |
| design | `plan-functional-analysis-track.md` L214 (id mention, not a heading — locate the section yourself)<br>`plan-measure-theory-track.md` L53 (id mention, not a heading — locate the section yourself)<br>`plan-probability-track.md` L210 (id mention, not a heading — locate the section yourself) |
