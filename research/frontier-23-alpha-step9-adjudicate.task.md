# Step 9 — changed-mathematics adjudication, `frontier-23`

Act only on ids in `research/frontier-23-step9-changes.json`. Read their current
...
`research/frontier-23-alpha-step9-adjudicate.md` with every tuple, outcome,
