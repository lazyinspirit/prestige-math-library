...
# Batch 1 of run `frontier-29` — Group Extensions Complements and Schur Zassenhaus · Crossed Homomorphisms Complements and First Cohomology
...
| | |
|---|---|
| A page | `group-extensions-complements-and-schur-zassenhaus` · order **71.017** · `group-theory` |
| B page | `group-extensions-complements-and-schur-zassenhaus-examples` |
| title | Group Extensions Complements and Schur Zassenhaus |
| requires | `small-cancellation-and-dehn-algorithms-examples` |
| design | `plan-group-theory-track.md` L1333<br>`plan-group-theory-track.md` L1405 |
...
| | |
|---|---|
| A page | `crossed-homomorphisms-complements-and-first-cohomology` · order **365.071** · `group-theory` |
...
| requires | `grothendieck-spectral-sequences-and-computations-examples`, `group-extensions-complements-and-schur-zassenhaus` |
| design | `plan-group-theory-track.md` L2662<br>`plan-group-theory-track.md` L2723 |
