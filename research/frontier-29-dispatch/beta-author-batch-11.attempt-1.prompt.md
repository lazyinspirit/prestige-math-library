...
covers: 11
output: research/frontier-29-batch-11.proof-contracts.json

> The dispatch block supplies batch `11`.

# Step 5 — author batch `11`, `frontier-29`

Use `research/frontier-29-batch-11.pages.json`, `.notes.md`, `.coverage.json`,
