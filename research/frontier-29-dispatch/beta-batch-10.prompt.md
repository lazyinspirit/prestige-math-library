...
# Batch 10 of run `frontier-29` — Duality and Rigidity in Monoidal Categories
...
| | |
|---|---|
| A page | `duality-and-rigidity-in-monoidal-categories` · order **365.031** · `category-theory` |
| B page | `duality-and-rigidity-in-monoidal-categories-examples` |
| title | Duality and Rigidity in Monoidal Categories |
| requires | `braided-and-symmetric-monoidal-categories-examples` |
| design | `plan-category-theory-track.md` L2754<br>`plan-category-theory-track.md` L2831 |
