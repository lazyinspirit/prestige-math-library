...
covers: 14
output: research/frontier-29-batch-14.proof-contracts.json

> The dispatch block supplies batch `14`.

# Step 5 — author batch `14`, `frontier-29`

Use `research/frontier-29-batch-14.pages.json`, `.notes.md`, `.coverage.json`,
