...
# Batch 13 of run `frontier-29` — Affine Algebraic Sets and Coordinate Rings
...
| | |
|---|---|
| A page | `affine-algebraic-sets-and-coordinate-rings` · order **366.041** · `algebraic-geometry` |
| B page | `affine-algebraic-sets-and-coordinate-rings-examples` |
| title | Affine Algebraic Sets and Coordinate Rings |
| requires | `chern-and-pontryagin-classes-by-splitting-and-complexification-examples`, `noether-normalisation-and-nullstellensatz` |
| design | `plan-algebraic-geometry-track.md` L91 |
