...
# Step 4 — splice-refusal adjudication, `frontier-29`

Read `research/frontier-29-splice-refusals.json` and every reported undeclared
...
`research/frontier-29-alpha-step4.md` with each edge, evidence, disposition, edit,
