...
label: assign
covers: all
output: research/frontier-29-alpha-groups.json

# Assign batches to group Alphas

This dispatch produces only `research/frontier-29-alpha-groups.json`. It assigns the
...
```sh
node tools/alpha-groups.mjs --run frontier-29 --facts
```
...
```sh
node tools/alpha-groups.mjs --run frontier-29
```
