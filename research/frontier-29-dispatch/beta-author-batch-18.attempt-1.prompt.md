...
covers: 18
output: research/frontier-29-batch-18.proof-contracts.json

> The dispatch block supplies batch `18`.

# Step 5 — author batch `18`, `frontier-29`

Use `research/frontier-29-batch-18.pages.json`, `.notes.md`, `.coverage.json`,
