...
Reason: ERROR receipt-reviewer: research/frontier-29-impact-6c.json: reviewer is required
...
ERROR receipt-reviewer: research/frontier-29-impact-6c.json: reviewer is required
...
`node tools/cross-group-edges.mjs carrier --run frontier-29 --id ITEM_ID` after edits.
