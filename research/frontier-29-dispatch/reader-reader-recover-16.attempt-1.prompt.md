...
run: frontier-29
role: reader
label: reader-recover-16

# Step 6 reader routing-artifact correction

Correct research/frontier-29-reader-findings-16.json for batch 16.
Set the top-level `batch` field to exactly "16"; it identifies this batch, not the run number.
