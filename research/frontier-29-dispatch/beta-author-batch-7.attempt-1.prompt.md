...
covers: 7
output: research/frontier-29-batch-7.proof-contracts.json

> The dispatch block supplies batch `7`.

# Step 5 — author batch `7`, `frontier-29`

Use `research/frontier-29-batch-7.pages.json`, `.notes.md`, `.coverage.json`,
