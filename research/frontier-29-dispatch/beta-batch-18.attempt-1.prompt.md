...
# Batch 18 of run `frontier-29` — Computable Reductions and Rice's Theorem · The Cook--Levin Theorem
...
| | |
|---|---|
| A page | `computable-reductions-and-rices-theorem` · order **605** · `computability-theory` |
...
| design | `plan-computability-theory-track.md` L614 |
...
| | |
|---|---|
| A page | `the-cook-levin-theorem` · order **621** · `computability-theory` |
| B page | `the-cook-levin-theorem-examples` |
| title | The Cook--Levin Theorem |
| requires | `p-np-conp-and-polynomial-reductions` |
| design | `plan-computability-theory-track.md` L908<br>`plan-computability-theory-track.md` L932 |
