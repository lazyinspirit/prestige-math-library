...
covers: 16
output: research/frontier-29-batch-16.proof-contracts.json

> The dispatch block supplies batch `16`.

# Step 5 — author batch `16`, `frontier-29`

Use `research/frontier-29-batch-16.pages.json`, `.notes.md`, `.coverage.json`,
