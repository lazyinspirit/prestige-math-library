...
# Batch 2 of run `frontier-29` — Modular Representations and Projective Covers · Pro P Groups and the P Adic Integers
...
| | |
|---|---|
| A page | `modular-representations-and-projective-covers` · order **150.001** · `group-theory` |
| B page | `modular-representations-and-projective-covers-examples` |
| title | Modular Representations and Projective Covers |
| requires | `induced-representations-and-frobenius-reciprocity-examples`, `valuation-rings-and-discrete-valuation-rings`, `inverse-limits-and-noetherian-completion` |
| design | `plan-group-theory-track.md` L2316<br>`plan-group-theory-track.md` L2401 |
...
| | |
|---|---|
| A page | `pro-p-groups-and-the-p-adic-integers` · order **302.015** · `group-theory` |
| B page | `pro-p-groups-and-the-p-adic-integers-examples` |
| title | Pro P Groups and the P Adic Integers |
| requires | `inverse-systems-profinite-groups-and-completion-examples` |
| design | `plan-group-theory-track.md` L2209<br>`plan-group-theory-track.md` L2279 |
