...
The task and `research/frontier-29-step6-scope-2.json` define `refuter_scope`.
...
label: refute-2
covers: 2
output: research/frontier-29-refute-2.json

# Step 6a — refuter

Read `research/frontier-29-step6-scope-2.json` and audit exactly its `refuter_scope`,
