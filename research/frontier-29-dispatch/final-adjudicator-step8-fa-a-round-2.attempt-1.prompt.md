...
# Final Adjudicator queue — frontier-29, group a, round 2

This is the exact queue frozen in `research/frontier-29-step8-fa-a-round-2.json`. It contains 6 item(s).
Work in the numbered order below. Do not substantively review the next item until the recorder accepts the current one.

## 1. `def-pro-p-completion-of-an-abstract-group` (run)

1. Read `items/def-pro-p-completion-of-an-abstract-group.md`, its cited dependencies, pair/page context, proof contract, judge and Alpha evidence, and this group's conventions.
...
3. Write concrete evidence to `research/frontier-29-step8-fa-a-1-def-pro-p-completion-of-an-abstract-group.md`, including exact source URLs and what they support, or explain why the mathematics was familiar.
...
```bash
node tools/step8-terminal-resolution.mjs record --run frontier-29 --id def-pro-p-completion-of-an-abstract-group --resolved-by final-adjudicator --group a --queue research/frontier-29-step8-fa-a-round-2.json --state-dir /home/lazyinspirit/Projects/prestige-math-library/.autopilot-frontier-29 --disposition accepted-after-review --source-status verified --basis-file research/frontier-29-step8-fa-a-1-def-pro-p-completion-of-an-abstract-group.md
...
## 2. `def-relative-projectivity` (run)

1. Read `items/def-relative-projectivity.md`, its cited dependencies, pair/page context, proof contract, judge and Alpha evidence, and this group's conventions.
2. Independently decide whether the Alpha repair is correct. If unfamiliar or uncertain, use web search and verify against authoritative sources.
3. Write concrete evidence to `research/frontier-29-step8-fa-a-2-def-relative-projectivity.md`, including exact source URLs and what they support, or explain why the mathematics was familiar.
4. Either accept the current repair or independently repair it and its directly required local metadata/contracts. If that repair changes a run-local direct dependency, record the exact final-adjudicator prerequisite-repair licence required by the FA brief. Run focused checks.
5. Record the exact final bytes with exactly one of these commands:

```bash
node tools/step8-terminal-resolution.mjs record --run frontier-29 --id def-relative-projectivity --resolved-by final-adjudicator --group a --queue research/frontier-29-step8-fa-a-round-2.json --state-dir /home/lazyinspirit/Projects/prestige-math-library/.autopilot-frontier-29 --disposition accepted-after-review --source-status verified --basis-file research/frontier-29-step8-fa-a-2-def-relative-projectivity.md
node tools/step8-terminal-resolution.mjs record --run frontier-29 --id def-relative-projectivity --resolved-by final-adjudicator --group a --queue research/frontier-29-step8-fa-a-round-2.json --state-dir /home/lazyinspirit/Projects/prestige-math-library/.autopilot-frontier-29 --disposition repaired --source-status verified --basis-file research/frontier-29-step8-fa-a-2-def-relative-projectivity.md
```

Both commands default to `--source-status verified` and require at least one authoritative http(s) URL in the evidence file. Change only that exact word to `familiar` when no external verification was needed.

## 3. `ex-the-dimension-of-a-vector-space-is-its-linear-dimension` (run)

1. Read `items/ex-the-dimension-of-a-vector-space-is-its-linear-dimension.md`, its cited dependencies, pair/page context, proof contract, judge and Alpha evidence, and this group's conventions.
2. Independently decide whether the Alpha repair is correct. If unfamiliar or uncertain, use web search and verify against authoritative sources.
3. Write concrete evidence to `research/frontier-29-step8-fa-a-3-ex-the-dimension-of-a-vector-space-is-its-linear-dimension.md`, including exact source URLs and what they support, or explain why the mathematics was familiar.
4. Either accept the current repair or independently repair it and its directly required local metadata/contracts. If that repair changes a run-local direct dependency, record the exact final-adjudicator prerequisite-repair licence required by the FA brief. Run focused checks.
5. Record the exact final bytes with exactly one of these commands:

```bash
node tools/step8-terminal-resolution.mjs record --run frontier-29 --id ex-the-dimension-of-a-vector-space-is-its-linear-dimension --resolved-by final-adjudicator --group a --queue research/frontier-29-step8-fa-a-round-2.json --state-dir /home/lazyinspirit/Projects/prestige-math-library/.autopilot-frontier-29 --disposition accepted-after-review --source-status verified --basis-file research/frontier-29-step8-fa-a-3-ex-the-dimension-of-a-vector-space-is-its-linear-dimension.md
node tools/step8-terminal-resolution.mjs record --run frontier-29 --id ex-the-dimension-of-a-vector-space-is-its-linear-dimension --resolved-by final-adjudicator --group a --queue research/frontier-29-step8-fa-a-round-2.json --state-dir /home/lazyinspirit/Projects/prestige-math-library/.autopilot-frontier-29 --disposition repaired --source-status verified --basis-file research/frontier-29-step8-fa-a-3-ex-the-dimension-of-a-vector-space-is-its-linear-dimension.md
```

Both commands default to `--source-status verified` and require at least one authoritative http(s) URL in the evidence file. Change only that exact word to `familiar` when no external verification was needed.

## 4. `ex-the-regular-module-of-cp-in-characteristic-p` (run)

1. Read `items/ex-the-regular-module-of-cp-in-characteristic-p.md`, its cited dependencies, pair/page context, proof contract, judge and Alpha evidence, and this group's conventions.
2. Independently decide whether the Alpha repair is correct. If unfamiliar or uncertain, use web search and verify against authoritative sources.
3. Write concrete evidence to `research/frontier-29-step8-fa-a-4-ex-the-regular-module-of-cp-in-characteristic-p.md`, including exact source URLs and what they support, or explain why the mathematics was familiar.
4. Either accept the current repair or independently repair it and its directly required local metadata/contracts. If that repair changes a run-local direct dependency, record the exact final-adjudicator prerequisite-repair licence required by the FA brief. Run focused checks.
5. Record the exact final bytes with exactly one of these commands:

```bash
node tools/step8-terminal-resolution.mjs record --run frontier-29 --id ex-the-regular-module-of-cp-in-characteristic-p --resolved-by final-adjudicator --group a --queue research/frontier-29-step8-fa-a-round-2.json --state-dir /home/lazyinspirit/Projects/prestige-math-library/.autopilot-frontier-29 --disposition accepted-after-review --source-status verified --basis-file research/frontier-29-step8-fa-a-4-ex-the-regular-module-of-cp-in-characteristic-p.md
node tools/step8-terminal-resolution.mjs record --run frontier-29 --id ex-the-regular-module-of-cp-in-characteristic-p --resolved-by final-adjudicator --group a --queue research/frontier-29-step8-fa-a-round-2.json --state-dir /home/lazyinspirit/Projects/prestige-math-library/.autopilot-frontier-29 --disposition repaired --source-status verified --basis-file research/frontier-29-step8-fa-a-4-ex-the-regular-module-of-cp-in-characteristic-p.md
```

Both commands default to `--source-status verified` and require at least one authoritative http(s) URL in the evidence file. Change only that exact word to `familiar` when no external verification was needed.

## 5. `rem-what-is-needed-before-a-trace-can-be-written` (run)

1. Read `items/rem-what-is-needed-before-a-trace-can-be-written.md`, its cited dependencies, pair/page context, proof contract, judge and Alpha evidence, and this group's conventions.
2. Independently decide whether the Alpha repair is correct. If unfamiliar or uncertain, use web search and verify against authoritative sources.
3. Write concrete evidence to `research/frontier-29-step8-fa-a-5-rem-what-is-needed-before-a-trace-can-be-written.md`, including exact source URLs and what they support, or explain why the mathematics was familiar.
4. Either accept the current repair or independently repair it and its directly required local metadata/contracts. If that repair changes a run-local direct dependency, record the exact final-adjudicator prerequisite-repair licence required by the FA brief. Run focused checks.
5. Record the exact final bytes with exactly one of these commands:

```bash
node tools/step8-terminal-resolution.mjs record --run frontier-29 --id rem-what-is-needed-before-a-trace-can-be-written --resolved-by final-adjudicator --group a --queue research/frontier-29-step8-fa-a-round-2.json --state-dir /home/lazyinspirit/Projects/prestige-math-library/.autopilot-frontier-29 --disposition accepted-after-review --source-status verified --basis-file research/frontier-29-step8-fa-a-5-rem-what-is-needed-before-a-trace-can-be-written.md
node tools/step8-terminal-resolution.mjs record --run frontier-29 --id rem-what-is-needed-before-a-trace-can-be-written --resolved-by final-adjudicator --group a --queue research/frontier-29-step8-fa-a-round-2.json --state-dir /home/lazyinspirit/Projects/prestige-math-library/.autopilot-frontier-29 --disposition repaired --source-status verified --basis-file research/frontier-29-step8-fa-a-5-rem-what-is-needed-before-a-trace-can-be-written.md
```

Both commands default to `--source-status verified` and require at least one authoritative http(s) URL in the evidence file. Change only that exact word to `familiar` when no external verification was needed.

## 6. `thm-schur-zassenhaus-existence` (run)

1. Read `items/thm-schur-zassenhaus-existence.md`, its cited dependencies, pair/page context, proof contract, judge and Alpha evidence, and this group's conventions.
2. Independently decide whether the Alpha repair is correct. If unfamiliar or uncertain, use web search and verify against authoritative sources.
3. Write concrete evidence to `research/frontier-29-step8-fa-a-6-thm-schur-zassenhaus-existence.md`, including exact source URLs and what they support, or explain why the mathematics was familiar.
4. Either accept the current repair or independently repair it and its directly required local metadata/contracts. If that repair changes a run-local direct dependency, record the exact final-adjudicator prerequisite-repair licence required by the FA brief. Run focused checks.
5. Record the exact final bytes with exactly one of these commands:

```bash
node tools/step8-terminal-resolution.mjs record --run frontier-29 --id thm-schur-zassenhaus-existence --resolved-by final-adjudicator --group a --queue research/frontier-29-step8-fa-a-round-2.json --state-dir /home/lazyinspirit/Projects/prestige-math-library/.autopilot-frontier-29 --disposition accepted-after-review --source-status verified --basis-file research/frontier-29-step8-fa-a-6-thm-schur-zassenhaus-existence.md
node tools/step8-terminal-resolution.mjs record --run frontier-29 --id thm-schur-zassenhaus-existence --resolved-by final-adjudicator --group a --queue research/frontier-29-step8-fa-a-round-2.json --state-dir /home/lazyinspirit/Projects/prestige-math-library/.autopilot-frontier-29 --disposition repaired --source-status verified --basis-file research/frontier-29-step8-fa-a-6-thm-schur-zassenhaus-existence.md
```
