...
# Batch 5 of run `frontier-29` — Finite Dimensional Normed Spaces and Riesz Lemma
...
| | |
|---|---|
| A page | `finite-dimensional-normed-spaces-and-riesz-lemma` · order **288.051** · `functional-analysis` |
| B page | `finite-dimensional-normed-spaces-and-riesz-lemma-examples` |
| title | Finite Dimensional Normed Spaces and Riesz Lemma |
| requires | `bounded-linear-operators-and-quotient-spaces-examples` |
| design | `plan-functional-analysis-track.md` L31 (id mention, not a heading — locate the section yourself) |
