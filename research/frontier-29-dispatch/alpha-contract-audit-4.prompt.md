...
# Contract-detector adjudication — `frontier-29`
...
Merge the batch contracts into `research/frontier-29-proof-contracts.json` and
rerun the failed detector. Write `research/frontier-29-alpha-contract-audit.md`
