...
covers: 10
output: research/frontier-29-batch-10.proof-contracts.json

> The dispatch block supplies batch `10`.

# Step 5 — author batch `10`, `frontier-29`

Use `research/frontier-29-batch-10.pages.json`, `.notes.md`, `.coverage.json`,
