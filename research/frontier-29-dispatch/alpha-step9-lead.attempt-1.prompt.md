...
label: step9-lead
covers: all
output: research/frontier-29-alpha-step9-review.md

# Step 9 — scope-denial delta review, `frontier-29`

Read only pending rows in `research/frontier-29-step9-scope-delta.json`. Verify each
...
`research/frontier-29-alpha-step9-review.md`. Inspect each open run ledger row and
