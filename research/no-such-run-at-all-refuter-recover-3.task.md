...
Correct research/no-such-run-at-all-refute-3.json for batch 3.
Read research/no-such-run-at-all-step6-scope-3.json and audit exactly its frozen `refuter_scope`.
