  ...
  "failures": [
    {
      "id": "judge-closure",
      "stage": "8-rejudge",
      "why": "ERROR judge-adjudication-missing [thm-a-braided-rigid-category-has-a-drinfeld-morphism]: thm-a-braided-rigid-category-has-a-drinfeld-morphism: current gpt-5.6-terra rejection has no exact Alpha outcome for context a6aebdf047e8a1bf3ef7a9f9c8",
      "output": "level-coverage --judge-only: 734/755 current configured-judge verdict set(s); 21 terminal manual resolution(s), 0 need rejudge, 1 unadjudicated, 0 open fatal, 193 adjudicated rejection(s) closed nonfatally; legacy gate counter 734/755 current pairs (one per-item configured verdict set, including singleton lineups)\nERROR judge-adjudication-missing [thm-a-braided-rigid-category-has-a-drinfeld-morphism]: thm-a-braided-rigid-category-has-a-drinfeld-morphism: current gpt-5.6-terra rejection has no exact Alpha outcome for context a6aebdf047e8a1bf3ef7a9f9c858bbed448509739640f0ecef56b67ce3dff65a\n",
      "named_ids": [
  ...
  "live_tuples": [
    {
      "id": "thm-a-braided-rigid-category-has-a-drinfeld-morphism",
      "model": "gpt-5.6-terra",
      "context_sha256": "a6aebdf047e8a1bf3ef7a9f9c858bbed448509739640f0ecef56b67ce3dff65a",
      "scope": "run",
...
You are the group Alpha for batches **1**, **2**, **10**: 5 A/B pair(s), 10 page(s), 172 item(s), 1 open rejection(s) over 1 item(s).
...
|---|---|---|---|
| `thm-a-braided-rigid-category-has-a-drinfeld-morphism` | `duality-and-rigidity-in-monoidal-categories` | gpt-5.6-terra | `a6aebdf047e8a1bf3ef7a9f9c858bbed448509739640f0ecef56b67ce3dff65a` |
