...
covers: 9
output: research/frontier-28-batch-9.proof-contracts.json

> The dispatch block supplies batch `9`.

# Step 5 — author batch `9`, `frontier-28`

Use `research/frontier-28-batch-9.pages.json`, `.notes.md`, `.coverage.json`,
