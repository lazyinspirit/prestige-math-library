...
The task and `research/frontier-28-step6-scope-10.json` define `refuter_scope`.
...
label: refute-10
covers: 10
output: research/frontier-28-refute-10.json

# Step 6a — refuter

Read `research/frontier-28-step6-scope-10.json` and audit exactly its `refuter_scope`,
