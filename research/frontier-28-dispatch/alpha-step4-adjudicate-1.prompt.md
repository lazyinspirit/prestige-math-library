...
# Step 4 — splice-refusal adjudication, `frontier-28`

Read `research/frontier-28-splice-refusals.json` and every reported undeclared
...
`research/frontier-28-alpha-step4.md` with each edge, evidence, disposition, edit,
