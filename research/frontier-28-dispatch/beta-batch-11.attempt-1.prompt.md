...
# Batch 11 of run `frontier-28` — Diagonalization and the Halting Problem · P, NP, coNP, and Polynomial Reductions
...
| | |
|---|---|
| A page | `diagonalization-and-the-halting-problem` · order **603** · `computability-theory` |
...
| design | `plan-computability-theory-track.md` L579<br>`plan-computability-theory-track.md` L602 |
...
| | |
|---|---|
| A page | `p-np-conp-and-polynomial-reductions` · order **619** · `computability-theory` |
...
| design | `plan-computability-theory-track.md` L871<br>`plan-computability-theory-track.md` L896 |
