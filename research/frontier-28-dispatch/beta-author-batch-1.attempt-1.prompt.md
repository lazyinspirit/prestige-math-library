...
covers: 1
output: research/frontier-28-batch-1.proof-contracts.json

> The dispatch block supplies batch `1`.

# Step 5 — author batch `1`, `frontier-28`

Use `research/frontier-28-batch-1.pages.json`, `.notes.md`, `.coverage.json`,
