...
The task and `research/frontier-28-step6-scope-6.json` define `refuter_scope`.
...
run: frontier-28
role: refuter
label: refute-recover-6
covers: 6
output: research/frontier-28-step6-scope-6.json

# Step 6a — refuter

Read `research/frontier-28-step6-scope-6.json` and audit exactly its `refuter_scope`,
