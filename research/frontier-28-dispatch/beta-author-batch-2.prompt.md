...
covers: 2
output: research/frontier-28-batch-2.proof-contracts.json

> The dispatch block supplies batch `2`.

# Step 5 — author batch `2`, `frontier-28`

Use `research/frontier-28-batch-2.pages.json`, `.notes.md`, `.coverage.json`,
