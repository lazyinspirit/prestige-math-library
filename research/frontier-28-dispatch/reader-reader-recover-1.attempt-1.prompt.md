...
run: frontier-28
role: reader
label: reader-recover-1
covers: 1
output: research/frontier-28-step6-scope-1.json

# Step 6 reader routing-artifact correction

Correct research/frontier-28-reader-findings-1.json for batch 1.
Set the top-level `batch` field to exactly "1"; it identifies this batch, not the run number.
