...
covers: all
output: research/frontier-28-pathway-closure.json

# Step 10 — pathway closure, `frontier-28`

Read `research/frontier-28-pathway.json` and
`research/frontier-28-pathway-closure.json`. For every pending receipt row, rewrite
