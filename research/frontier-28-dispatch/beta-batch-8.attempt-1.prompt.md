...
# Batch 8 of run `frontier-28` — Projective and Injective Resolutions
...
| | |
|---|---|
| A page | `projective-and-injective-resolutions` · order **365.045** · `homological-algebra` |
| B page | `projective-and-injective-resolutions-examples` |
| title | Projective and Injective Resolutions |
| requires | `long-exact-sequences-in-homology-examples` |
| design | `plan-homological-algebra-track.md` L1101<br>`plan-homological-algebra-track.md` L1278 |
