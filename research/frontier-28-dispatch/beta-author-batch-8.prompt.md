...
covers: 8
output: research/frontier-28-batch-8.proof-contracts.json

> The dispatch block supplies batch `8`.

# Step 5 — author batch `8`, `frontier-28`

Use `research/frontier-28-batch-8.pages.json`, `.notes.md`, `.coverage.json`,
