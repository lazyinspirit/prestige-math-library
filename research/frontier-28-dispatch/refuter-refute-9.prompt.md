...
The task and `research/frontier-28-step6-scope-9.json` define `refuter_scope`.
...
label: refute-9
covers: 9
output: research/frontier-28-refute-9.json

# Step 6a — refuter

Read `research/frontier-28-step6-scope-9.json` and audit exactly its `refuter_scope`,
