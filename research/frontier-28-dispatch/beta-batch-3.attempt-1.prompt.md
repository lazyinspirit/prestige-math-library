...
# Batch 3 of run `frontier-28` — Inverse Limits and Noetherian Completion
...
| | |
|---|---|
| A page | `inverse-limits-and-noetherian-completion` · order **111.025** · `commutative-algebra` |
| B page | `inverse-limits-and-noetherian-completion-examples` |
| title | Inverse Limits and Noetherian Completion |
| requires | `flatness-and-faithful-flatness-examples` |
| design | `plan-commutative-algebra-track.md` L1118 |
