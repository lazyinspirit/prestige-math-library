...
# Batch 1 of run `frontier-28` — Small Cancellation and Dehn Algorithms · Inverse Systems Profinite Groups and Completion
...
| | |
|---|---|
| A page | `small-cancellation-and-dehn-algorithms` · order **71.015** · `group-theory` |
| B page | `small-cancellation-and-dehn-algorithms-examples` |
| title | Small Cancellation and Dehn Algorithms |
| requires | `decision-problems-for-finitely-presented-groups-examples` |
| design | `plan-group-theory-track.md` L1226<br>`plan-group-theory-track.md` L1293 |
...
| | |
|---|---|
| A page | `inverse-systems-profinite-groups-and-completion` · order **302.013** · `group-theory` |
| B page | `inverse-systems-profinite-groups-and-completion-examples` |
| title | Inverse Systems Profinite Groups and Completion |
| requires | `graphs-of-groups-and-bass-serre-theory-examples` |
| design | `plan-group-theory-track.md` L2083<br>`plan-group-theory-track.md` L2171 |
