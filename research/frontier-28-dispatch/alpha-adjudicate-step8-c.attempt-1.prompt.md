...
You are the group Alpha for batches **4**, **5**, **6**: 3 A/B pair(s), 6 page(s), 80 item(s), 40 open rejection(s) over 40 item(s).
...
|---|---|---|---|
| `cex-a-closed-subspace-need-not-have-a-best-approximation` | `bounded-linear-operators-and-quotient-spaces-examples` | gpt-5.6-terra | `0b26af3167bd3e193cfc9682fd51ef274dcc7853fac0730cd03ef491a563768d` |
| `cex-shoups-product-bound-does-not-determine-mertens-constant` | `chebyshev-bounds-and-mertens-theorems-examples` | gpt-5.6-terra | `c79ac933d7421725684254e43adccdd209a5f57452905da8c6e9b8fe76c15c5c` |
| `cor-ell-p-duality-by-counting-measure` | `the-duality-of-lp-and-lq` | gpt-5.6-terra | `7a8e5e67b5637ee0c676a247f85015b78b03abc45f8630ea3466c88a4ff3dcb4` |
| `def-bounded-bilinear-map` | `bounded-linear-operators-and-quotient-spaces` | gpt-5.6-terra | `28de8b3136542d4defd8be63cdba683a09c6e1c366e5230545a9f0269562aefd` |
| `def-bounded-linear-operator` | `bounded-linear-operators-and-quotient-spaces` | gpt-5.6-terra | `0b75742f80077c13823984b4320e642945d9d1f974021fd7b3524bf51bbc9371` |
| `def-operator-norm` | `bounded-linear-operators-and-quotient-spaces` | gpt-5.6-terra | `7169d09b4dd71fc332382bcab61952c1af57027f27875146fd01f88ada9f0e89` |
| `def-quotient-seminorm` | `bounded-linear-operators-and-quotient-spaces` | gpt-5.6-terra | `0cbf7ff3e4cbeb10da22bc899cf91b317e9ad90981a3d4365a5c352a5ec95d73` |
| `ex-bertrand-finite-range-verification` | `chebyshev-bounds-and-mertens-theorems-examples` | gpt-5.6-terra | `55d098c7b32955d4b37e54c180c456d37eebc92ba3f2bff667825150585d92fe` |
| `ex-coordinate-projections-and-inclusions-on-product-banach-spaces` | `bounded-linear-operators-and-quotient-spaces-examples` | gpt-5.6-terra | `7f5739ccaeedde9df55873219cdc0e12c228a41782e2e387e2ce2574bc1c50e2` |
| `ex-differentiation-on-polynomials-is-unbounded-in-the-supremum-norm` | `bounded-linear-operators-and-quotient-spaces-examples` | gpt-5.6-terra | `e98f66ff5171b1d342c1748b419f8083cec8bdd544ee987b787cb2ef763e541c` |
| `ex-evaluation-functional-on-c-of-k` | `bounded-linear-operators-and-quotient-spaces-examples` | gpt-5.6-terra | `57799bc568021caf78a00589f9b2e30b4cc127add66febd681ab88363f4c0515` |
| `ex-first-and-second-mertens-numerics` | `chebyshev-bounds-and-mertens-theorems-examples` | gpt-5.6-terra | `dd4f4b34ec1626baa40bd656430354d7ab83e3c2d6f891e85c50b954e62d3f9e` |
| `ex-quotient-by-the-kernel-is-isometric-to-the-range-with-the-induced-quotient-norm` | `bounded-linear-operators-and-quotient-spaces-examples` | gpt-5.6-terra | `826df8ea03c04ee3a2546cd8726fe7a8a92acae60f101012fc37fe20cc2f0eff` |
| `lem-bounded-functionals-on-finite-l-p-define-finite-signed-or-complex-measures` | `the-duality-of-lp-and-lq` | gpt-5.6-terra | `af0adccbf3bf7a6913caaa3c57d7401ac2cdeefe07b8755acc61b1d937c48129` |
| `lem-central-binomial-coefficient-bounds` | `chebyshev-bounds-and-mertens-theorems` | gpt-5.6-terra | `96a8c8ef743930335aeb85d58e3205936ca239cd2266b054bd407133a79313f4` |
| `lem-central-binomial-coefficient-prime-valuation` | `chebyshev-bounds-and-mertens-theorems` | gpt-5.6-terra | `1800e28ff332e77af8dacfc5be54387ff4a64379158460b556b4471e05d44b8a` |
| `lem-chebyshev-functions-prime-power-comparison` | `chebyshev-bounds-and-mertens-theorems` | gpt-5.6-terra | `daffaf69f045ad2cee658655af54efe9535f363e9a57d611f75792f018a41d17` |
| `lem-chebyshev-psi-prime-power-expansion` | `chebyshev-bounds-and-mertens-theorems` | gpt-5.6-terra | `da280d2e1f6087bf7ce25e0cb8a88d91961a0fa43815e40f5cc15255ff3620d6` |
| `lem-composition-operator-norm-inequality` | `bounded-linear-operators-and-quotient-spaces` | gpt-5.6-terra | `5188cdf1295c597d1d2185361cdfc9c7198855c1d937ba0b787c24ee4f437f4f` |
| `lem-finite-measure-bounded-l-p-functionals-are-integration-against-rn-densities` | `the-duality-of-lp-and-lq` | gpt-5.6-terra | `9b7f2d925698dc4dcd8268a93ec4e7f08b0c3db16546c14e9daf60145327c6ff` |
| `lem-functional-induced-measures-are-absolutely-continuous-with-respect-to-mu` | `the-duality-of-lp-and-lq` | gpt-5.6-terra | `9aa72c6212bc6410570ee3016d0a6407d58dfbd62fa7b026bd2da91a25c39617` |
| `lem-prime-counting-chebyshev-partial-summation` | `chebyshev-bounds-and-mertens-theorems` | gpt-5.6-terra | `132446ed02570b9dd7c6249b5a49d67810991d3d500338f0c3b7f4ef25c4eb02` |
| `lem-quotient-seminorm-triangle-inequality` | `bounded-linear-operators-and-quotient-spaces` | gpt-5.6-terra | `ffc4b3b63845266dd3951d1aea9fd38da616f5a898e01e591d3b96696c037fc5` |
| `lem-rn-densities-of-bounded-l-p-functionals-belong-to-l-q` | `the-duality-of-lp-and-lq` | gpt-5.6-terra | `a98b031eb22f148242d5c983dbb215ef78ee14d339f28b95673e0be4ec20cbbe` |
| `lem-weighted-von-mangoldt-harmonic-estimate` | `chebyshev-bounds-and-mertens-theorems` | gpt-5.6-terra | `30305d6634e9d54853c3cf3bbe0b5c7d2d1c0662dfe46c7312846f00afb8624a` |
| `prop-lambda-g-has-operator-norm-equal-to-the-l-q-norm` | `the-duality-of-lp-and-lq` | gpt-5.6-terra | `f6c3d9cd92e286ad147a18c09b8e278c74db537d0c165594943587ef74e996af` |
| `thm-an-l-q-function-defines-a-bounded-linear-functional-on-l-p` | `the-duality-of-lp-and-lq` | gpt-5.6-terra | `36215f949a065682425bf4b3dd59fd2d4e95bd1a9eca06e232830966aa1a6b69` |
| `thm-arbitrary-measure-duality-for-l-p-when-one-less-p-less-infinity` | `the-duality-of-lp-and-lq` | gpt-5.6-terra | `935c22d6f190d4e625e76601523a6990430265f3c0c6a197849cf1c95b279c9a` |
| `thm-bertrands-postulate` | `chebyshev-bounds-and-mertens-theorems` | gpt-5.6-terra | `b78b860f94bb58a20dace41abe4d8c1f7435675c13d41077bb2bfdc2af6f9763` |
| `thm-bounded-below-iff-injective-with-closed-range` | `bounded-linear-operators-and-quotient-spaces` | gpt-5.6-terra | `62b237eaaa2d739c58c4a3744926a746b2b21b9fa791efa9fe2dc5d546e5bf45` |
| `thm-bounded-operator-space-is-banach` | `bounded-linear-operators-and-quotient-spaces` | gpt-5.6-terra | `3ee069c212b2bd437546fe4bf32da552d4ea79e112c58989fad9b5a5e2763f5d` |
| `thm-chebyshev-prime-counting-bounds` | `chebyshev-bounds-and-mertens-theorems` | gpt-5.6-terra | `4eb04537de09e90ca40286fd5ad386336b005f1975568c6cd6849fdd52e1a06f` |
| `thm-chebyshev-theta-linear-bounds` | `chebyshev-bounds-and-mertens-theorems` | gpt-5.6-terra | `bd83ab8e91430e4adee74816a3b4ca2622ac96eaa3f30c5a3fe2096c65340c41` |
| `thm-complemented-subspace-iff-range-of-a-bounded-projection` | `bounded-linear-operators-and-quotient-spaces` | gpt-5.6-terra | `5b4232f9a7a2ea5ef36a9377f5f105c9ad9d76e0409fa7b368e5e88d3ba3b311` |
| `thm-extension-of-a-bounded-map-from-a-dense-subspace` | `bounded-linear-operators-and-quotient-spaces` | gpt-5.6-terra | `fad9fbcb2e4c22c03eb8444394475ddbac8ed382bfd796ea0c132cbd0fb15ec9` |
| `thm-first-mertens-theorem-for-primes` | `chebyshev-bounds-and-mertens-theorems` | gpt-5.6-terra | `bd69248a631a5adfeb27b4604fe9d3de8d39beec661b655159ce7e75401b0159` |
| `thm-quotient-of-banach-by-closed-subspace-is-banach` | `bounded-linear-operators-and-quotient-spaces` | gpt-5.6-terra | `0dcc6228c111d64ac47eba521fe580dee22fa962e90087d9708f17b136cfadad` |
| `thm-sigma-finite-duality-for-bounded-functionals-on-l-p` | `the-duality-of-lp-and-lq` | gpt-5.6-terra | `b2ac24da06a5fbef1cf1ced225242e59900f9b05e6ba3d69d495c91ac97529ce` |
| `thm-third-mertens-theorem-for-primes` | `chebyshev-bounds-and-mertens-theorems` | gpt-5.6-terra | `40a60ac14270ee6440f21af3eb46749df0f857d4bfb7be62a9502735a1dbc304` |
| `thm-universal-property-of-the-normed-quotient` | `bounded-linear-operators-and-quotient-spaces` | gpt-5.6-terra | `0fc1ba9bed200e5bdfaa7c1deb0f202a9c51d2229b6a0bb42526c298434337f5` |
