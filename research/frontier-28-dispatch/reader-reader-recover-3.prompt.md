...
covers: 3
output: research/frontier-28-step6-scope-3.json

# Step 6 reader routing-artifact correction

Correct research/frontier-28-reader-findings-3.json for batch 3.
Set the top-level `batch` field to exactly "3"; it identifies this batch, not the run number.
