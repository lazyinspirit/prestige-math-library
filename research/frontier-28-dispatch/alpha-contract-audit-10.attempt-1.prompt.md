...
run: frontier-28
role: alpha
label: contract-audit-10

# Contract-detector adjudication — `frontier-28`
...
Merge the batch contracts into `research/frontier-28-proof-contracts.json` and
rerun the failed detector. Write `research/frontier-28-alpha-contract-audit.md`
