...
# Batch 5 of run `frontier-28` — Bounded Linear Operators and Quotient Spaces
...
| | |
|---|---|
| A page | `bounded-linear-operators-and-quotient-spaces` · order **288.049** · `functional-analysis` |
| B page | `bounded-linear-operators-and-quotient-spaces-examples` |
| title | Bounded Linear Operators and Quotient Spaces |
| requires | `normed-and-banach-spaces-examples` |
| design | `plan-functional-analysis-track.md` L30 (id mention, not a heading — locate the section yourself) |
