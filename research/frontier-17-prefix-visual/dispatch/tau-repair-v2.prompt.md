...
You are Tau, Claude Opus 5 at xhigh. Read the initial Sigma receipt, its render
...
Write `research/frontier-17-tau.json` with:
...
```json
{
  ...
  "run": "frontier-17",
  "repairer": "Tau",
  "sigma_receipt": "research/frontier-17-sigma-initial.json",
  "findings": [
...
label: repair-v2
covers: all
output: research/frontier-17-tau.json
