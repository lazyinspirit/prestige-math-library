...
## Step 6a — independent read of the batch named in your dispatch
...
Scope: every item on the pages in `research/frontier-14-batch-<i>.pages.json`.
...
`research/frontier-14-reader-1.md`, findings numbered `R<i>-1`, `R<i>-2`, …
