# Batch 15 of run `frontier-33` — Clifford Theory over Normal Subgroups
...
| | |
|---|---|
| A page | `clifford-theory-over-normal-subgroups` · order **510.037** · `representation-theory` |
| B page | `clifford-theory-over-normal-subgroups-examples` |
| title | Clifford Theory over Normal Subgroups |
| requires | `schur-indices-and-fields-of-definition-examples` |
| design | `research/plan-representation-theory-groups-track.md` L35 (id mention, not a heading — locate the section yourself) |
