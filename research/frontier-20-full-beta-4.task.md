# Batch 4 of run `frontier-20-full` — The Fundamental Theorem of Algebra
...
| | |
|---|---|
| A page | `the-fundamental-theorem-of-algebra` · order **139** · `abstract-algebra` |
| B page | `the-fundamental-theorem-of-algebra-examples` |
| title | The Fundamental Theorem of Algebra |
| requires | `solvability-by-radicals-and-kummer-theory`, `sylow-theorems-and-nilpotent-groups`, `continuity-ivt-evt-and-uniform-continuity` |
| design | `plan-algebra-track.md` L2001<br>`plan-algebra-track.md` L4005 |
