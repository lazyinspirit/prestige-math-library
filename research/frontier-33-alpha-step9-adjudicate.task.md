# Step 9 — changed-mathematics adjudication, `frontier-33`

Act only on ids in `research/frontier-33-step9-changes.json`. Read their current
...
`research/frontier-33-alpha-step9-adjudicate.md` with every tuple, outcome,
