# Batch 4 of run `frontier-27` — Normed and Banach Spaces
...
| | |
|---|---|
| A page | `normed-and-banach-spaces` · order **288.047** · `functional-analysis` |
| B page | `normed-and-banach-spaces-examples` |
| title | Normed and Banach Spaces |
| requires | `rn-as-a-normed-space`, `completeness-and-uniform-continuity`, `the-lp-spaces-holder-minkowski-and-riesz-fischer` |
| design | `plan-functional-analysis-track.md` L295 |
