...
update `research/frontier-15-batch-3.proof-contracts.json` whenever you change
...
`research/frontier-15-reader-3.md`, every change and every finding in it.
...
`research/frontier-15-reader-3.md`. Per finding: item id, exact location, what is
...
label: reader-3
covers: 3
output: research/frontier-15-reader-3.md
