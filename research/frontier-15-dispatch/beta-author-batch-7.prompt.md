...
# Authoring brief — run `frontier-15`, batch `7` (step 5)
...
- update only your own `research/frontier-15-batch-7.proof-contracts.json` so it
...
- keep your own `research/frontier-15-batch-7.coverage.json` **true of what you
...
research/frontier-15-batch-7.proof-contracts.json --strict` before reporting.
