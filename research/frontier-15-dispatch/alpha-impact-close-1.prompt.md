...
half, `research/frontier-15-alpha-<g>-6b-findings.json` — a JSON array with one row
...
`research/frontier-15-dispatch/` and read the LATEST prior result and log for your
