...
update `research/frontier-15-batch-4.proof-contracts.json` whenever you change
...
`research/frontier-15-reader-4.md`, every change and every finding in it.
...
`research/frontier-15-reader-4.md`. Per finding: item id, exact location, what is
...
label: reader-4
covers: 4
output: research/frontier-15-reader-4.md
