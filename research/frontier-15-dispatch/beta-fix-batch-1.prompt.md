<!-- Dispatched as-is. `frontier-15` and `1` are substituted by tools/dispatch.mjs
...
# Scaffolding brief — run `frontier-15`, batch `1` (steps 1 and 2)
...
`research/frontier-15-batch-1.notes.md`: current substage, owned artifact paths,
...
```
node tools/source-fetch-check.mjs --coverage research/frontier-15-batch-1.coverage.json --stamp
```
...
```
node tools/coverage-checklist.mjs research/frontier-15-batch-1.coverage.json
```
...
- `research/frontier-15-batch-1.pages.json` — your batch's page objects in final
...
- `research/frontier-15-batch-1.notes.md` — prose-scaffold amendments as precise
  ...
  route, and necessity.
- `research/frontier-15-batch-1.proof-contracts.json` — the version-1
