<!-- Dispatched as-is. `frontier-15` and `3` are substituted by tools/dispatch.mjs
...
# Scaffolding brief — run `frontier-15`, batch `3` (steps 1 and 2)
...
You are **Beta-3**, running **GPT 5.6 Sol via the Codex subscription plan
at `xhigh` reasoning with a 1,000,000-token context window** (owner, 2026-07-31),
scaffolding run `frontier-15` of the public math library, whose checkout is the
...
`research/frontier-15-batch-3.notes.md`: current substage, owned artifact paths,
...
`research/frontier-15-batch-3.coverage.json`:
...
```
node tools/coverage-checklist.mjs research/frontier-15-batch-3.coverage.json
```
...
- `research/frontier-15-batch-3.pages.json` — your batch's page objects in final
...
- `research/frontier-15-batch-3.notes.md` — prose-scaffold amendments as precise
  ...
  route, and necessity.
- `research/frontier-15-batch-3.proof-contracts.json` — the version-1
...
6. **Cross-batch dependencies** — anything your batch needs from the other
   batch of run `frontier-15`, or that you believe the other batch will need from you.
