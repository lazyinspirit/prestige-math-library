...
update `research/frontier-15-batch-1.proof-contracts.json` whenever you change
...
`research/frontier-15-reader-1.md`, every change and every finding in it.
...
`research/frontier-15-reader-1.md`. Per finding: item id, exact location, what is
...
label: reader-1
covers: 1
output: research/frontier-15-reader-1.md
