<!-- Dispatched as-is. `frontier-15` and `2` are substituted by tools/dispatch.mjs
...
# Scaffolding brief — run `frontier-15`, batch `2` (steps 1 and 2)
...
`research/frontier-15-batch-2.notes.md`: current substage, owned artifact paths,
...
`research/frontier-15-batch-2.coverage.json`:
...
- `research/frontier-15-batch-2.pages.json` — your batch's page objects in final
...
- `research/frontier-15-batch-2.notes.md` — prose-scaffold amendments as precise
  ...
  route, and necessity.
- `research/frontier-15-batch-2.proof-contracts.json` — the version-1
