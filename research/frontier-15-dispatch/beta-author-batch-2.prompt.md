...
# Authoring brief — run `frontier-15`, batch `2` (step 5)
...
- update only your own `research/frontier-15-batch-2.proof-contracts.json` so it
...
- keep your own `research/frontier-15-batch-2.coverage.json` **true of what you
...
research/frontier-15-batch-2.proof-contracts.json --strict` before reporting.
