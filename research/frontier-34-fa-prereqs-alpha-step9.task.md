# Step 9 — scope-denial delta review, `frontier-34-fa-prereqs`

Read only pending rows in `research/frontier-34-fa-prereqs-step9-scope-delta.json`. Verify each
...
If `research/frontier-34-fa-prereqs-step9-mathematical-review.task.md` exists, also perform its
...
`research/frontier-34-fa-prereqs-alpha-step9-review.md`. Inspect each open run ledger row and
