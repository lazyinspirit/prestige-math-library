# Step 9 — changed-mathematics adjudication, `phase-2-hg-prerequisite`

Act only on ids in `research/phase-2-hg-prerequisite-step9-changes.json`. Read their current
...
`research/phase-2-hg-prerequisite-alpha-step9-adjudicate.md` with every tuple, outcome,
