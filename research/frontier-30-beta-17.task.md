# Batch 17 of run `frontier-30` — Artin Induction and Rational Characters

1 A/B pair, representation-theory. You own every page here and you author them all at step 5.

## `artin-induction-and-rational-characters`

| | |
|---|---|
| A page | `artin-induction-and-rational-characters` · order **510.031** · `representation-theory` |
| B page | `artin-induction-and-rational-characters-examples` |
| title | Artin Induction and Rational Characters |
| requires | `the-weyl-kac-character-formula-examples`, `the-group-algebra-and-representations`, `maschkes-theorem-and-complete-reducibility`, `characters-and-the-orthogonality-relations`, `induced-representations-and-frobenius-reciprocity` |
| design | `plan-representation-theory-groups-track.md` L221 |
