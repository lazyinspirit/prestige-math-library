# Batch 20 of run `frontier-30` — Classical NP-Completeness Reductions
...
| | |
|---|---|
| A page | `classical-np-completeness-reductions` · order **623** · `computability-theory` |
...
| design | `plan-computability-theory-track.md` L944<br>`plan-computability-theory-track.md` L969 |
