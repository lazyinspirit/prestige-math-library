# Batch 4 of run `frontier-29` — The Maximal Function and Lebesgue Differentiation
...
| | |
|---|---|
| A page | `the-maximal-function-and-lebesgue-differentiation` · order **288.033** · `measure-theory` |
| B page | `the-maximal-function-and-lebesgue-differentiation-examples` |
| title | The Maximal Function and Lebesgue Differentiation |
| requires | `the-duality-of-lp-and-lq-examples` |
| design | `plan-measure-theory-track.md` L3285 |
