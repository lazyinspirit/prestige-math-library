...
covers: all
output: research/frontier-17-step10-report.md

# Step 10 owner report — run `frontier-17`

Write the final evidence-led account to
`research/frontier-17-step10-report.md`. Do not edit mathematics, prompts, workflow
...
`research/frontier-17-publication-readiness.json`.
