<!-- Dispatched as-is. `frontier-17` and `2` are substituted by tools/dispatch.mjs
...
# Scaffolding brief — run `frontier-17`, batch `2` (steps 1 and 2)
...
`research/frontier-17-batch-2.notes.md`: current substage, owned artifact paths,
...
`research/frontier-17-batch-2.coverage.json`:
...
```
node tools/coverage-checklist.mjs research/frontier-17-batch-2.coverage.json
```
...
- `research/frontier-17-batch-2.pages.json` — your batch's page objects in final
...
- `research/frontier-17-batch-2.notes.md` — prose-scaffold amendments as precise
  ...
  route, and necessity.
- `research/frontier-17-batch-2.proof-contracts.json` — the version-1
...
# Batch 2 of run `frontier-17` — Frattini Subgroups and the Burnside Basis Theorem

1 A/B pair, group-theory. You own every page here and you author them all at step 5.

## `frattini-subgroups-and-the-burnside-basis-theorem`

| | |
|---|---|
| A page | `frattini-subgroups-and-the-burnside-basis-theorem` · order **71.001** · `group-theory` |
| B page | `frattini-subgroups-and-the-burnside-basis-theorem-examples` |
| title | Frattini Subgroups and the Burnside Basis Theorem |
| requires | `sylow-theorems-and-nilpotent-groups-examples` |
| design | `plan-group-theory-track.md` L451<br>`plan-group-theory-track.md` L531 |
