...
update `research/frontier-17-batch-8.proof-contracts.json` whenever you change
...
`research/frontier-17-reader-8.md`, every change and every finding in it.
...
`research/frontier-17-reader-8.md`. Per finding: item id, exact location, what is
...
label: reader-8
covers: 8
output: research/frontier-17-reader-8.md

# Step 6a — independent read of batch `8` of run `frontier-17`
...
`research/frontier-17-batch-8.pages.json`.

**Write your report to:** `research/frontier-17-reader-8.md`

Both `8` and `research/frontier-17-reader-8.md` are substituted by the dispatcher from values the
...
Findings numbered `R8-1`, `R8-2`, … and **stable**: a later pass refers to
