...
update `research/frontier-17-batch-4.proof-contracts.json` whenever you change
...
`research/frontier-17-reader-4.md`, every change and every finding in it.
...
`research/frontier-17-reader-4.md`. Per finding: item id, exact location, what is
...
label: reader-4
covers: 4
output: research/frontier-17-reader-4.md

# Step 6a — independent read of batch `4` of run `frontier-17`
...
`research/frontier-17-batch-4.pages.json`.

**Write your report to:** `research/frontier-17-reader-4.md`

Both `4` and `research/frontier-17-reader-4.md` are substituted by the dispatcher from values the
...
Findings numbered `R4-1`, `R4-2`, … and **stable**: a later pass refers to
