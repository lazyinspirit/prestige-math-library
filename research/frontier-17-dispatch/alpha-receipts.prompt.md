...
label: receipts
covers: all
output: research/frontier-17-audit-coverage.json

# The whole-level receipts, run `frontier-17`
...
```
node tools/level-coverage.mjs --template research/frontier-17-audit-coverage.json \
  --contracts research/frontier-17-proof-contracts.json \
  --judge-ledger research/frontier-17-judge.jsonl \
  research/frontier-17-batch-*.pages.json
```
