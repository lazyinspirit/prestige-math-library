...
update `research/frontier-17-batch-3.proof-contracts.json` whenever you change
...
`research/frontier-17-reader-3.md`, every change and every finding in it.
...
`research/frontier-17-reader-3.md`. Per finding: item id, exact location, what is
...
label: reader-3
covers: 3
output: research/frontier-17-reader-3.md

# Step 6a — independent read of batch `3` of run `frontier-17`
...
`research/frontier-17-batch-3.pages.json`.

**Write your report to:** `research/frontier-17-reader-3.md`

Both `3` and `research/frontier-17-reader-3.md` are substituted by the dispatcher from values the
