<!-- Dispatched as-is. `frontier-17` and `4` are substituted by tools/dispatch.mjs
...
# Scaffolding brief — run `frontier-17`, batch `4` (steps 1 and 2)
...
You are **Beta-4**, running **GPT 5.6 Sol via the Codex subscription plan
at `xhigh` reasoning with a 1,000,000-token context window** (owner, 2026-07-31),
scaffolding run `frontier-17` of the public math library, whose checkout is the
...
`research/frontier-17-batch-4.notes.md`: current substage, owned artifact paths,
...
`research/frontier-17-batch-4.coverage.json`:
...
```
node tools/source-fetch-check.mjs --coverage research/frontier-17-batch-4.coverage.json --stamp
```
...
```
node tools/coverage-checklist.mjs research/frontier-17-batch-4.coverage.json
```
...
- `research/frontier-17-batch-4.pages.json` — your batch's page objects in final
...
- `research/frontier-17-batch-4.notes.md` — prose-scaffold amendments as precise
  ...
  route, and necessity.
- `research/frontier-17-batch-4.proof-contracts.json` — the version-1
...
6. **Cross-batch dependencies** — anything your batch needs from the other
   batch of run `frontier-17`, or that you believe the other batch will need from you.
...
# Batch 4 of run `frontier-17` — Constant Rank, Submersions, Immersions and Regular Level Sets · Trigonometric and Oscillatory Examples in Several Variables

2 A/B pairs, real-analysis. You own every page here and you author them all at step 5.

## `constant-rank-submersions-and-regular-level-sets`

| | |
|---|---|
| A page | `constant-rank-submersions-and-regular-level-sets` · order **288.00003** · `real-analysis` |
| B page | `constant-rank-submersions-and-regular-level-sets-examples` |
| title | Constant Rank, Submersions, Immersions and Regular Level Sets |
| requires | `the-inverse-function-theorem-completed`, `linear-maps-rank-nullity-and-quotient-spaces` |
| design | `plan-realanalysis-completion-track.md` L226 |
...
| | |
|---|---|
| A page | `trigonometric-and-oscillatory-examples-in-several-variables` · order **288.00025** · `real-analysis` |
| B page | `trigonometric-and-oscillatory-examples-in-several-variables-examples` |
| title | Trigonometric and Oscillatory Examples in Several Variables |
| requires | `trigonometric-and-oscillatory-examples-in-one-variable`, `the-inverse-function-theorem-completed`, `fubini-and-change-of-variables` |
| design | `plan-realanalysis-completion-track.md` L631 |
