<!-- Dispatched as-is. `frontier-17` and `1` are substituted by tools/dispatch.mjs
...
# Scaffolding brief — run `frontier-17`, batch `1` (steps 1 and 2)
...
`research/frontier-17-batch-1.notes.md`: current substage, owned artifact paths,
...
`research/frontier-17-batch-1.coverage.json`:
...
```
node tools/coverage-checklist.mjs research/frontier-17-batch-1.coverage.json
```
...
- `research/frontier-17-batch-1.pages.json` — your batch's page objects in final
...
- `research/frontier-17-batch-1.notes.md` — prose-scaffold amendments as precise
  ...
  route, and necessity.
- `research/frontier-17-batch-1.proof-contracts.json` — the version-1
...
# Batch 1 of run `frontier-17` — Sums of Two Squares
...
| | |
|---|---|
| A page | `sums-of-two-squares` · order **57.007** · `number-theory` |
| B page | `sums-of-two-squares-examples` |
| title | Sums of Two Squares |
| requires | `quadratic-reciprocity-and-the-jacobi-symbol-examples` |
| design | `plan-number-theory-track.md` L505 (id mention, not a heading — locate the section yourself) |
