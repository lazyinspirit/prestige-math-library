<!-- Dispatched as-is. `frontier-17` and `6` are substituted by tools/dispatch.mjs
...
# Scaffolding brief — run `frontier-17`, batch `6` (steps 1 and 2)
...
`research/frontier-17-batch-6.notes.md`: current substage, owned artifact paths,
...
`research/frontier-17-batch-6.coverage.json`:
...
```
node tools/source-fetch-check.mjs --coverage research/frontier-17-batch-6.coverage.json --stamp
```
...
```
node tools/coverage-checklist.mjs research/frontier-17-batch-6.coverage.json
```
...
- `research/frontier-17-batch-6.pages.json` — your batch's page objects in final
...
- `research/frontier-17-batch-6.notes.md` — prose-scaffold amendments as precise
  ...
  route, and necessity.
- `research/frontier-17-batch-6.proof-contracts.json` — the version-1
...
# Batch 6 of run `frontier-17` — Outer Measure and the Caratheodory Extension Theorem

1 A/B pair, measure-theory. You own every page here and you author them all at step 5.

## `outer-measure-and-the-caratheodory-extension-theorem`

| | |
|---|---|
| A page | `outer-measure-and-the-caratheodory-extension-theorem` · order **288.005** · `measure-theory` |
| B page | `outer-measure-and-the-caratheodory-extension-theorem-examples` |
| title | Outer Measure and the Caratheodory Extension Theorem |
| requires | `measures-and-their-basic-properties-examples` |
| design | `plan-measure-theory-track.md` L43 (id mention, not a heading — locate the section yourself) |
