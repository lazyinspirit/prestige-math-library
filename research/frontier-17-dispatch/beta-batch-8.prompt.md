<!-- Dispatched as-is. `frontier-17` and `8` are substituted by tools/dispatch.mjs
...
# Scaffolding brief — run `frontier-17`, batch `8` (steps 1 and 2)
...
You are **Beta-8**, running **GPT 5.6 Sol via the Codex subscription plan
...
`research/frontier-17-batch-8.notes.md`: current substage, owned artifact paths,
...
`research/frontier-17-batch-8.coverage.json`:
...
```
node tools/coverage-checklist.mjs research/frontier-17-batch-8.coverage.json
```
...
- `research/frontier-17-batch-8.pages.json` — your batch's page objects in final
...
- `research/frontier-17-batch-8.notes.md` — prose-scaffold amendments as precise
  ...
  route, and necessity.
- `research/frontier-17-batch-8.proof-contracts.json` — the version-1
...
# Batch 8 of run `frontier-17` — The Identity Theorem, the Maximum Principle and the Open Mapping Theorem
...
| | |
|---|---|
| A page | `the-identity-theorem-and-the-open-mapping-theorem` · order **313** · `complex-analysis` |
| B page | `the-identity-theorem-and-the-open-mapping-theorem-examples` |
| title | The Identity Theorem, the Maximum Principle and the Open Mapping Theorem |
| requires | `analyticity-liouville-and-morera` |
| design | `plan-complex-analysis-track.md` L1197 |
