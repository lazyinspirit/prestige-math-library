<!-- Dispatched as-is. `frontier-17` and `10` are substituted by tools/dispatch.mjs
...
# Scaffolding brief — run `frontier-17`, batch `10` (steps 1 and 2)
...
You are **Beta-10**, running **GPT 5.6 Sol via the Codex subscription plan
...
`research/frontier-17-batch-10.notes.md`: current substage, owned artifact paths,
...
`research/frontier-17-batch-10.coverage.json`:
...
```
node tools/coverage-checklist.mjs research/frontier-17-batch-10.coverage.json
```
...
- `research/frontier-17-batch-10.pages.json` — your batch's page objects in final
...
- `research/frontier-17-batch-10.notes.md` — prose-scaffold amendments as precise
  ...
  route, and necessity.
- `research/frontier-17-batch-10.proof-contracts.json` — the version-1
...
# Batch 10 of run `frontier-17` — Regular Surfaces and Surface Integrals

1 A/B pair, real-analysis. You own every page here and you author them all at step 5.

## `regular-surfaces-and-surface-integrals`

| | |
|---|---|
| A page | `regular-surfaces-and-surface-integrals` · order **288.00015** · `real-analysis` |
| B page | `regular-surfaces-and-surface-integrals-examples` |
| title | Regular Surfaces and Surface Integrals |
| requires | `line-integrals-and-the-gradient-theorem`, `constant-rank-submersions-and-regular-level-sets` |
| design | `plan-realanalysis-completion-track.md` L452 |
