<!-- Dispatched as-is. `frontier-17` and `7` are substituted by tools/dispatch.mjs
...
# Scaffolding brief — run `frontier-17`, batch `7` (steps 1 and 2)
...
`research/frontier-17-batch-7.notes.md`: current substage, owned artifact paths,
...
`research/frontier-17-batch-7.coverage.json`:
...
```
node tools/source-fetch-check.mjs --coverage research/frontier-17-batch-7.coverage.json --stamp
```
...
```
node tools/coverage-checklist.mjs research/frontier-17-batch-7.coverage.json
```
...
- `research/frontier-17-batch-7.pages.json` — your batch's page objects in final
...
- `research/frontier-17-batch-7.notes.md` — prose-scaffold amendments as precise
  ...
  route, and necessity.
- `research/frontier-17-batch-7.proof-contracts.json` — the version-1
...
# Batch 7 of run `frontier-17` — Applications of the Fundamental Group

1 A/B pair, topology. You own every page here and you author them all at step 5.

## `applications-of-the-fundamental-group`

| | |
|---|---|
| A page | `applications-of-the-fundamental-group` · order **301** · `topology` |
| B page | `applications-of-the-fundamental-group-examples` |
| title | Applications of the Fundamental Group |
| requires | `the-seifert-van-kampen-theorem`, `classification-of-covering-spaces` |
| design | `plan-topology-set-theory-track.md` L1104 |
