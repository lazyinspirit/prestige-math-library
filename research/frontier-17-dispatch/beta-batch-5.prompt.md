<!-- Dispatched as-is. `frontier-17` and `5` are substituted by tools/dispatch.mjs
...
# Scaffolding brief — run `frontier-17`, batch `5` (steps 1 and 2)
...
You are **Beta-5**, running **GPT 5.6 Sol via the Codex subscription plan
...
`research/frontier-17-batch-5.notes.md`: current substage, owned artifact paths,
...
`research/frontier-17-batch-5.coverage.json`:
...
```
node tools/source-fetch-check.mjs --coverage research/frontier-17-batch-5.coverage.json --stamp
```
...
```
node tools/coverage-checklist.mjs research/frontier-17-batch-5.coverage.json
```
...
- `research/frontier-17-batch-5.pages.json` — your batch's page objects in final
...
- `research/frontier-17-batch-5.notes.md` — prose-scaffold amendments as precise
  ...
  route, and necessity.
- `research/frontier-17-batch-5.proof-contracts.json` — the version-1
...
# Batch 5 of run `frontier-17` — Volumes of Elementary Solids and Solids of Revolution · The Real Gamma and Beta Functions
...
| | |
|---|---|
| A page | `volumes-of-elementary-solids-and-solids-of-revolution` · order **288.00009** · `real-analysis` |
| B page | `volumes-of-elementary-solids-and-solids-of-revolution-examples` |
| title | Volumes of Elementary Solids and Solids of Revolution |
| requires | `areas-of-elementary-plane-figures`, `the-topology-of-euclidean-space` |
| design | `plan-realanalysis-completion-track.md` L331 |
...
| | |
|---|---|
| A page | `the-real-gamma-and-beta-functions` · order **288.00013** · `real-analysis` |
| B page | `the-real-gamma-and-beta-functions-examples` |
| title | The Real Gamma and Beta Functions |
| requires | `improper-and-parameter-dependent-multiple-integrals`, `the-logarithm-and-general-powers`, `convexity` |
| design | `plan-realanalysis-completion-track.md` L406 |
