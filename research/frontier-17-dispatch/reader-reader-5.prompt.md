...
update `research/frontier-17-batch-5.proof-contracts.json` whenever you change
...
`research/frontier-17-reader-5.md`, every change and every finding in it.
...
`research/frontier-17-reader-5.md`. Per finding: item id, exact location, what is
...
label: reader-5
covers: 5
output: research/frontier-17-reader-5.md

# Step 6a — independent read of batch `5` of run `frontier-17`
...
`research/frontier-17-batch-5.pages.json`.

**Write your report to:** `research/frontier-17-reader-5.md`

Both `5` and `research/frontier-17-reader-5.md` are substituted by the dispatcher from values the
...
Findings numbered `R5-1`, `R5-2`, … and **stable**: a later pass refers to
