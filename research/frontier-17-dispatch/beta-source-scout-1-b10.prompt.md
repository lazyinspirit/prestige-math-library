...
run: frontier-17
role: beta
label: source-scout-1-b10
covers: 10

> **Source-scouting round.** Your batch number is in the "This dispatch"
> section appended below; substitute it wherever `10` appears.

# Batch `10` of run `frontier-17` — scout a live full-text URL
...
```
node tools/source-fetch-check.mjs --coverage research/frontier-17-batch-10.coverage.json
```
...
`research/frontier-17-batch-10.coverage.json` and `.notes.md` only. Keep
