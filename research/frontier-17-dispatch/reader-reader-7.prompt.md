# Independent reader brief — run `frontier-17`, step 6a
...
update `research/frontier-17-batch-7.proof-contracts.json` whenever you change
...
`research/frontier-17-reader-7.md`, every change and every finding in it.
...
`research/frontier-17-reader-7.md`. Per finding: item id, exact location, what is
...
label: reader-7
covers: 7
output: research/frontier-17-reader-7.md

# Step 6a — independent read of batch `7` of run `frontier-17`
...
`research/frontier-17-batch-7.pages.json`.

**Write your report to:** `research/frontier-17-reader-7.md`

Both `7` and `research/frontier-17-reader-7.md` are substituted by the dispatcher from values the
...
Findings numbered `R7-1`, `R7-2`, … and **stable**: a later pass refers to
