...
> `research/frontier-17-alpha-<your-group>-…` path for your own group label.
...
- the reader report for each of your batches (findings `R<i>-…`, in the
  reader's output file under `research/frontier-17-dispatch/`)
- the items themselves, on disk
- `research/frontier-17-batch-<i>.proof-contracts.json`
...
1. **The prose report**, `research/frontier-17-alpha-<your-group>-6b.md`: per finding
...
2. **`research/frontier-17-alpha-<your-group>-6b-findings.json`** — a JSON array,
