...
# Batch 9 of run `frontier-17` — Monadicity and Becks Theorem
...
| | |
|---|---|
| A page | `monadicity-and-becks-theorem` · order **365.007** · `category-theory` |
| B page | `monadicity-and-becks-theorem-examples` |
| title | Monadicity and Becks Theorem |
| requires | `monads-comonads-and-their-algebras-examples` |
| design | `plan-category-theory-track.md` L1423 |
