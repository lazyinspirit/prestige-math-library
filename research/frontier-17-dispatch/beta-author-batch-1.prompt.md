...
# Authoring brief — run `frontier-17`, batch `1` (step 5)
...
- update only your own `research/frontier-17-batch-1.proof-contracts.json` so it
...
- keep your own `research/frontier-17-batch-1.coverage.json` **true of what you
...
research/frontier-17-batch-1.proof-contracts.json --strict` before reporting.
...
run: frontier-17
role: beta
label: author-batch-1
covers: 1

> **Generic task.** Your batch number is in the "This dispatch" section
> appended below; substitute it wherever `1` appears.

# Batch `1` of run `frontier-17` — step 5, authoring
...
- `research/frontier-17-batch-1.pages.json` — the spliced scaffold
- `research/frontier-17-batch-1.notes.md` — your source ledger and rationales
- `research/frontier-17-batch-1.coverage.json` — the harvest
- `research/frontier-17-batch-1.proof-contracts.json` — extend it as you author
- group Alpha's step-3 review and re-check, for the findings you resolved
- `research/frontier-17-beta-1.task.md` — your batch's pages and design section;
...
node tools/content-policy.mjs research/frontier-17-batch-1.pages.json
```
...
Append `## Step-5 authoring` to `research/frontier-17-batch-1.notes.md`: items
