...
# Batch `2` of run `frontier-17` — step-3 fix pass
...
```
node tools/coverage-checklist.mjs research/frontier-17-batch-2.coverage.json
node tools/content-policy.mjs --manifest-only research/frontier-17-batch-2.pages.json
node tools/validate-plan.mjs research/plan-spec.json
```

5. Append `## Step-3 fix pass` to `research/frontier-17-batch-2.notes.md`, one
