...
# Scaffolding brief — run `frontier-17`, batch `3` (steps 1 and 2)
...
`research/frontier-17-batch-3.coverage.json`:
...
- `research/frontier-17-batch-3.pages.json` — your batch's page objects in final
...
- `research/frontier-17-batch-3.notes.md` — prose-scaffold amendments as precise
  ...
  route, and necessity.
- `research/frontier-17-batch-3.proof-contracts.json` — the version-1
...
# Batch 3 of run `frontier-17` — The Galois Correspondence · Modules over a Principal Ideal Domain and the Canonical Forms

2 A/B pairs, abstract-algebra. You own every page here and you author them all at step 5.

## `the-galois-correspondence`

| | |
|---|---|
| A page | `the-galois-correspondence` · order **100** · `abstract-algebra` |
| B page | `the-galois-correspondence-examples` |
| title | The Galois Correspondence |
| requires | `algebraic-closure-embeddings-and-separability-examples` |
| design | `plan-algebra-track.md` L2687 |
...
| | |
|---|---|
| A page | `modules-over-a-pid-and-canonical-forms` · order **110** · `abstract-algebra` |
| B page | `modules-over-a-pid-and-canonical-forms-examples` |
| title | Modules over a Principal Ideal Domain and the Canonical Forms |
| requires | `chain-conditions-and-semisimple-modules`, `euclidean-domains-pids-and-unique-factorisation`, `triangularisation-and-jordan-canonical-form`, `the-structure-of-finite-abelian-groups` |
| design | `plan-algebra-track-expansion.md` L1313 |
