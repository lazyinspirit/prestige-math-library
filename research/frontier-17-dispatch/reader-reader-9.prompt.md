...
update `research/frontier-17-batch-9.proof-contracts.json` whenever you change
...
`research/frontier-17-reader-9.md`, every change and every finding in it.
...
`research/frontier-17-reader-9.md`. Per finding: item id, exact location, what is
...
label: reader-9
covers: 9
output: research/frontier-17-reader-9.md

# Step 6a — independent read of batch `9` of run `frontier-17`
...
**Write your report to:** `research/frontier-17-reader-9.md`

Both `9` and `research/frontier-17-reader-9.md` are substituted by the dispatcher from values the
