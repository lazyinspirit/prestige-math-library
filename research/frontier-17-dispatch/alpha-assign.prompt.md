...
label: assign
covers: all
output: research/frontier-17-alpha-groups.json

# Assign batches to group Alphas — run `frontier-17`
...
`research/frontier-17-alpha-groups.json` and stop.
...
```
node tools/alpha-groups.mjs --run frontier-17 --facts
```
...
`research/frontier-17-alpha-groups.json`:
...
```
node tools/alpha-groups.mjs --run frontier-17
```
