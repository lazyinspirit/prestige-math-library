...
run: frontier-17
role: alpha
label: impact-close-1

# Impact-receipt closure, run `frontier-17`

The `impact-receipt` gate is red. The receipt at `research/frontier-17-impact.json`
...
```
node tools/impact-audit.mjs --touches research/frontier-17-touches.json \
  --from pre-author --to post-step9 --receipt research/frontier-17-impact.json
```
...
anything** (`research/frontier-17-dispatch/`). **No permission prompts of any
