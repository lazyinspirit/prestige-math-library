# Step 9 — changed-mathematics adjudication, `frontier-34-fa-prereqs`

Act only on ids in `research/frontier-34-fa-prereqs-step9-changes.json`. Read their current
...
`research/frontier-34-fa-prereqs-alpha-step9-adjudicate.md` with every tuple, outcome,
