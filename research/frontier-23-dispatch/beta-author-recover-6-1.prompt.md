...
run: frontier-23
role: beta
label: author-recover-6-1
covers: 6
output: research/frontier-23-batch-6.proof-contracts.json

> The dispatch block supplies batch `6`.

# Step 5 — author batch `6`, `frontier-23`
...
`research/frontier-23-batch-6.proof-contracts.json`, and the Step-5 notes, then
...
Use `research/frontier-23-batch-6.pages.json`, `.notes.md`, `.coverage.json`,
