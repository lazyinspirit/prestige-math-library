...
covers: all
output: research/frontier-23-pathway-closure.json

# Step 10 — pathway closure, `frontier-23`

Read `research/frontier-23-pathway.json` and
`research/frontier-23-pathway-closure.json`. For every pending receipt row, rewrite
