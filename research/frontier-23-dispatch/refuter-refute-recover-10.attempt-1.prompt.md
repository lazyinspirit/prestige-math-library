...
The task and `research/frontier-23-step6-scope-10.json` define `refuter_scope`.
...
run: frontier-23
role: refuter
label: refute-recover-10
covers: 10
output: research/frontier-23-step6-scope-10.json

# Step 6a — refuter

Read `research/frontier-23-step6-scope-10.json` and audit exactly its `refuter_scope`,
