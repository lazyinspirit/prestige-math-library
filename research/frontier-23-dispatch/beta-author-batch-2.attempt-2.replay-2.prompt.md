...
covers: 2
output: research/frontier-23-batch-2.proof-contracts.json

> The dispatch block supplies batch `2`.

# Step 5 — author batch `2`, `frontier-23`
...
`research/frontier-23-batch-2.proof-contracts.json`, and the Step-5 notes, then
...
Use `research/frontier-23-batch-2.pages.json`, `.notes.md`, `.coverage.json`,
