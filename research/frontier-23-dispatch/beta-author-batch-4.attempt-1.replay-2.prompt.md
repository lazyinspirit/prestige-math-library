...
covers: 4
output: research/frontier-23-batch-4.proof-contracts.json

> The dispatch block supplies batch `4`.

# Step 5 — author batch `4`, `frontier-23`
...
`research/frontier-23-batch-4.proof-contracts.json`, and the Step-5 notes, then
...
Use `research/frontier-23-batch-4.pages.json`, `.notes.md`, `.coverage.json`,
