...
# Step 5 — author batch `7`, `frontier-23`
...
`research/frontier-23-batch-7.proof-contracts.json`, and the Step-5 notes, then
...
Use `research/frontier-23-batch-7.pages.json`, `.notes.md`, `.coverage.json`,
