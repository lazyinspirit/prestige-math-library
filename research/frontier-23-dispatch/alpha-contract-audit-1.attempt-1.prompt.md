...
# Contract-detector adjudication — `frontier-23`
...
Merge the batch contracts into `research/frontier-23-proof-contracts.json` and
rerun the failed detector. Write `research/frontier-23-alpha-contract-audit.md`
