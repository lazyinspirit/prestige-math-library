...
# Batch 3 of run `frontier-23` — Integral Extensions and Going Up
...
| | |
|---|---|
| A page | `integral-extensions-and-going-up` · order **111.011** · `commutative-algebra` |
| B page | `integral-extensions-and-going-up-examples` |
| title | Integral Extensions and Going Up |
| requires | `associated-primes-and-primary-decomposition-examples` |
| design | `plan-commutative-algebra-track.md` L3282 |
