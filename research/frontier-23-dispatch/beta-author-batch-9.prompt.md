...
covers: 9
output: research/frontier-23-batch-9.proof-contracts.json

> The dispatch block supplies batch `9`.

# Step 5 — author batch `9`, `frontier-23`
...
`research/frontier-23-batch-9.proof-contracts.json`, and the Step-5 notes, then
...
Use `research/frontier-23-batch-9.pages.json`, `.notes.md`, `.coverage.json`,
