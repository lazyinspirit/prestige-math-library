...
# Step 4 — splice-refusal adjudication, `frontier-23`

Read `research/frontier-23-splice-refusals.json` and every reported undeclared
...
`research/frontier-23-alpha-step4.md` with each edge, evidence, disposition, edit,
