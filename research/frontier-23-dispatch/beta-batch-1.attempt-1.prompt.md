...
# Batch 1 of run `frontier-23` — Decision Problems for Finitely Presented Groups · Graphs of Groups and Bass Serre Theory
...
| | |
|---|---|
| A page | `decision-problems-for-finitely-presented-groups` · order **71.013** · `group-theory` |
| B page | `decision-problems-for-finitely-presented-groups-examples` |
| title | Decision Problems for Finitely Presented Groups |
| requires | `hnn-extensions-and-brittons-lemma-examples` |
| design | `plan-group-theory-track.md` L1114<br>`plan-group-theory-track.md` L1188 |
...
| | |
|---|---|
| A page | `graphs-of-groups-and-bass-serre-theory` · order **302.011** · `group-theory` |
| B page | `graphs-of-groups-and-bass-serre-theory-examples` |
| title | Graphs of Groups and Bass Serre Theory |
| requires | `simplicial-trees-and-group-actions-examples` |
| design | `plan-group-theory-track.md` L1971<br>`plan-group-theory-track.md` L2047 |
