...
covers: 5
output: research/frontier-23-batch-5.proof-contracts.json

> The dispatch block supplies batch `5`.

# Step 5 — author batch `5`, `frontier-23`
...
`research/frontier-23-batch-5.proof-contracts.json`, and the Step-5 notes, then
...
Use `research/frontier-23-batch-5.pages.json`, `.notes.md`, `.coverage.json`,
