...
The task and `research/frontier-23-step6-scope-3.json` define `refuter_scope`.
...
label: refute-3
covers: 3
output: research/frontier-23-refute-3.json

# Step 6a — refuter

Read `research/frontier-23-step6-scope-3.json` and audit exactly its `refuter_scope`,
