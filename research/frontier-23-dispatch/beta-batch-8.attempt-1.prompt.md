...
# Batch 8 of run `frontier-23` — Exactness and the Member Calculus
...
| | |
|---|---|
| A page | `exactness-and-the-member-calculus` · order **365.019** · `category-theory` |
| B page | `exactness-and-the-member-calculus-examples` |
| title | Exactness and the Member Calculus |
| requires | `subobject-lattices-generators-and-the-grothendieck-axioms-examples` |
| design | `plan-category-theory-track.md` L2066<br>`plan-category-theory-track.md` L2175 |
