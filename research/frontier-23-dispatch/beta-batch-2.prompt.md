...
# Batch 2 of run `frontier-23` — Complexification, Realification and Real Structures · Exterior Powers, Orientation and Hodge Duality
...
| | |
|---|---|
| A page | `complexification-realification-and-real-structures` · order **107.001** · `linear-algebra` |
| B page | `complexification-realification-and-real-structures-examples` |
| title | Complexification, Realification and Real Structures |
| requires | `tensor-products-of-modules` |
| design | `plan-algebra-track-expansion-v2.md` L503 |
...
| | |
|---|---|
| A page | `exterior-powers-orientation-and-hodge-duality` · order **107.003** · `linear-algebra` |
| B page | `exterior-powers-orientation-and-hodge-duality-examples` |
| title | Exterior Powers, Orientation and Hodge Duality |
| requires | `tensor-products-of-modules`, `inner-product-spaces-and-orthogonality` |
| design | `plan-algebra-track-expansion-v2.md` L557 |
