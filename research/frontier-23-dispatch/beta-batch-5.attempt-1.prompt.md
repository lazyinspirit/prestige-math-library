...
# Batch 5 of run `frontier-23` — Matrix Norms, Condition Numbers and Numerical Stability
...
| | |
|---|---|
| A page | `matrix-norms-condition-numbers-and-numerical-stability` · order **168.001** · `linear-algebra` |
| B page | `matrix-norms-condition-numbers-and-numerical-stability-examples` |
| title | Matrix Norms, Condition Numbers and Numerical Stability |
| requires | `rn-as-a-normed-space`, `the-spectral-theorem-and-singular-value-decomposition` |
| design | `plan-algebra-track-expansion-v2.md` L618 |
