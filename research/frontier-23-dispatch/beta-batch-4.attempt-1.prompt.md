...
# Batch 4 of run `frontier-23` — Characters and the Orthogonality Relations
...
| | |
|---|---|
| A page | `characters-and-the-orthogonality-relations` · order **147** · `abstract-algebra` |
| B page | `characters-and-the-orthogonality-relations-examples` |
| title | Characters and the Orthogonality Relations |
| requires | `maschkes-theorem-and-complete-reducibility`, `inner-product-spaces-and-orthogonality`, `tensor-products-of-modules` |
| design | `plan-algebra-track-expansion.md` L1532 |
