...
covers: 10
output: research/frontier-23-batch-10.proof-contracts.json

> The dispatch block supplies batch `10`.

# Step 5 — author batch `10`, `frontier-23`
...
`research/frontier-23-batch-10.proof-contracts.json`, and the Step-5 notes, then
...
Use `research/frontier-23-batch-10.pages.json`, `.notes.md`, `.coverage.json`,
