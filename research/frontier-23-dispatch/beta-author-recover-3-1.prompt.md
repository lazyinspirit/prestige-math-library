...
run: frontier-23
role: beta
label: author-recover-3-1
covers: 3
output: research/frontier-23-batch-3.proof-contracts.json

> The dispatch block supplies batch `3`.

# Step 5 — author batch `3`, `frontier-23`
...
`research/frontier-23-batch-3.proof-contracts.json`, and the Step-5 notes, then
...
Use `research/frontier-23-batch-3.pages.json`, `.notes.md`, `.coverage.json`,
