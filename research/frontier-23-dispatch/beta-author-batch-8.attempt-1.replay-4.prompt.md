...
covers: 8
output: research/frontier-23-batch-8.proof-contracts.json

> The dispatch block supplies batch `8`.

# Step 5 — author batch `8`, `frontier-23`
...
`research/frontier-23-batch-8.proof-contracts.json`, and the Step-5 notes, then
...
Use `research/frontier-23-batch-8.pages.json`, `.notes.md`, `.coverage.json`,
