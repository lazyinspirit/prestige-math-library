...
covers: 1
output: research/frontier-23-batch-1.proof-contracts.json

> The dispatch block supplies batch `1`.

# Step 5 — author batch `1`, `frontier-23`
...
`research/frontier-23-batch-1.proof-contracts.json`, and the Step-5 notes, then
...
Use `research/frontier-23-batch-1.pages.json`, `.notes.md`, `.coverage.json`,
