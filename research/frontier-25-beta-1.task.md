# Batch 1 of run `frontier-25` — Valuation Rings and Discrete Valuation Rings
...
| | |
|---|---|
| A page | `valuation-rings-and-discrete-valuation-rings` · order **111.015** · `commutative-algebra` |
| B page | `valuation-rings-and-discrete-valuation-rings-examples` |
| title | Valuation Rings and Discrete Valuation Rings |
| requires | `noether-normalisation-and-nullstellensatz-examples` |
| design | `plan-commutative-algebra-track.md` L748 |
