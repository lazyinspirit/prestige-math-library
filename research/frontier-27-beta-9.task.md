# Batch 9 of run `frontier-27` — Myhill--Nerode Theory and DFA Minimization · Decidable, Recognizable, and Enumerable Languages
...
| | |
|---|---|
| A page | `myhill-nerode-theory-and-dfa-minimization` · order **589** · `computability-theory` |
...
| design | `plan-computability-theory-track.md` L322<br>`plan-computability-theory-track.md` L346 |
...
| | |
|---|---|
| A page | `decidable-recognizable-and-enumerable-languages` · order **601** · `computability-theory` |
...
| design | `plan-computability-theory-track.md` L544<br>`plan-computability-theory-track.md` L567 |
