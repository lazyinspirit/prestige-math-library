...
# Step 5 — author batch `<i>`, `frontier-31a`

Required inputs are `research/frontier-31a-batch-<i>.pages.json`,
`research/frontier-31a-batch-<i>.notes.md`,
`research/frontier-31a-batch-<i>.coverage.json`, and
`research/frontier-31a-beta-<i>.task.md`. Use `research/frontier-31a-alpha-groups.json`
...
`research/frontier-31a-batch-<i>.proof-contracts.json` is an output to complete;
...
`node tools/content-policy.mjs research/frontier-31a-batch-<i>.pages.json`, and
`node tools/proof-contract.mjs research/frontier-31a-batch-<i>.proof-contracts.json --strict`.
