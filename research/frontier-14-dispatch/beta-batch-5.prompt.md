...
`research/frontier-14-batch-5.coverage.json`. Per A page: at least two
...
- `research/frontier-14-batch-5.pages.json` — the machine scaffold
- `research/frontier-14-batch-5.notes.md` — source ledger, provenance
  rationales, convention disagreements, split proposals, licensing notes
- `research/frontier-14-batch-5.coverage.json` — the harvest
- `research/frontier-14-batch-5.proof-contracts.json` — begun at scaffold time
...
section to your own `research/frontier-14-batch-5.notes.md`: owned artifacts,
...
**Write the report to `research/frontier-14-batch-5.notes.md` as well as
