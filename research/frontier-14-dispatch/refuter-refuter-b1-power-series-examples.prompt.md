# Read-only proof-refuter — run `frontier-14`, cluster `b1-power-series-examples`
...
`research/frontier-14-refuters/b1-power-series-examples.report.md`.

## Your scope — 11 draft items
...
`research/frontier-14-refuters/b1-power-series-examples.report.md`, findings numbered
`B1-POWER-SERIES-EXAMPLES-1`, `B1-POWER-SERIES-EXAMPLES-2`, … **stably** — numbering is permanent.
