...
`research/frontier-14-batch-1.coverage.json`. Per A page: at least two
...
```
node tools/coverage-checklist.mjs research/frontier-14-batch-1.coverage.json
```
...
- `research/frontier-14-batch-1.pages.json` — the machine scaffold
- `research/frontier-14-batch-1.notes.md` — source ledger, provenance
  rationales, convention disagreements, split proposals, licensing notes
- `research/frontier-14-batch-1.coverage.json` — the harvest
- `research/frontier-14-batch-1.proof-contracts.json` — begun at scaffold time
...
section to your own `research/frontier-14-batch-1.notes.md`: owned artifacts,
...
**Write the report to `research/frontier-14-batch-1.notes.md` as well as
