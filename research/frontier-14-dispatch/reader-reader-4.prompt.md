...
## Step 6a — independent read of batch 4
...
Scope: every item on the pages in `research/frontier-14-batch-4.pages.json`.
...
`research/frontier-14-reader-4.md`, findings numbered `R4-1`, `R4-2`, …
