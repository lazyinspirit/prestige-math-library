# Read-only proof-refuter — run `frontier-14`, cluster `b2-ascoli`
...
`research/frontier-14-refuters/b2-ascoli.report.md`.

## Your scope — 24 draft items
...
- `cor-real-and-euclidean-vector-valued-ascoli-arzela`
...
3. **Boundary rows that are boilerplate.** `research/frontier-14-batch-2.proof-contracts.json`
...
`research/frontier-14-refuters/b2-ascoli.report.md`, findings numbered
`B2-ASCOLI-1`, `B2-ASCOLI-2`, … **stably** — numbering is permanent.
