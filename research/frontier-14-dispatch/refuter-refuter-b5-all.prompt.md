...
## This dispatch — refuter `b5-all`, run `frontier-14`, batch 5
...
fact. The batch's proof contract is `research/frontier-14-batch-5.proof-contracts.json`;
