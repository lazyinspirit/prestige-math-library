...
## Step 6a — independent read of batch 3
...
Scope: every item on the pages in `research/frontier-14-batch-3.pages.json`.
...
`research/frontier-14-reader-3.md`, findings numbered `R3-1`, `R3-2`, …
