...
## Group Alpha **a** — re-check before the step-4 splice

You reviewed batches 1, 2, 3 at step 3 and returned numbered findings. The owning
...
1. Read your own report: `research/frontier-14-alpha-a-step3-scaffold-review.md`
...
`research/frontier-14-alpha-a-recheck.md`, with one line per finding id:
