...
`research/frontier-14-batch-3.coverage.json`. Per A page: at least two
...
- `research/frontier-14-batch-3.pages.json` — the machine scaffold
- `research/frontier-14-batch-3.notes.md` — source ledger, provenance
...
- `research/frontier-14-batch-3.proof-contracts.json` — begun at scaffold time
...
section to your own `research/frontier-14-batch-3.notes.md`: owned artifacts,
...
**Write the report to `research/frontier-14-batch-3.notes.md` as well as
