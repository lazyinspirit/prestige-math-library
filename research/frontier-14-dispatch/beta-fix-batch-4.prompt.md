...
## Batch 4 of run `frontier-14` — step-3 fix pass
...
node tools/content-policy.mjs --manifest-only research/frontier-14-batch-4.pages.json
node tools/validate-plan.mjs research/plan-spec.json
```

5. Append a section to `research/frontier-14-batch-4.notes.md` titled
