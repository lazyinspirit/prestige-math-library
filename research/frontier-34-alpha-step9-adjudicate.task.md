# Step 9 — changed-mathematics adjudication, `frontier-34`

Act only on ids in `research/frontier-34-step9-changes.json`. Read their current
...
`research/frontier-34-alpha-step9-adjudicate.md` with every tuple, outcome,
