# Step 4 — splice-refusal adjudication, `frontier-34-fa-prereqs`

Read `research/frontier-34-fa-prereqs-splice-refusals.json` and every reported undeclared
...
`research/frontier-34-fa-prereqs-alpha-step4.md` with each edge, evidence, disposition, edit,
