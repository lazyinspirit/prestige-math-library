...
label: drift-review
covers: drift
output: research/phase-2-next-15-alpha-step1-drift.md

# Step 1 — prerequisite drift, `phase-2-next-15`

Read `research/phase-2-next-15-scope-ledger.json`, every assigned batch manifest,
...
Write `research/phase-2-next-15-alpha-step1-drift.md`, with one `### PAGE_ID` section
...
Run `node tools/drift-review-check.mjs --run phase-2-next-15 --before-apply` and
