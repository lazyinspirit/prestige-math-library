# Step 4 — adjudicate the splice refusals, run `frontier-18`
...
**Read `research/frontier-18-splice-refusals.json`.** Each row names the batch, the
...
3. **An edge the scaffold does not need, or one you judge wrong: strike it
   from the batch manifest** (`research/frontier-18-batch-<i>.pages.json`), with
...
**Write `research/frontier-18-alpha-step4.md`**: per edge — the evidence you read,
