# Step 4 — splice-refusal adjudication, `phase-2-hg-prerequisite`

Read `research/phase-2-hg-prerequisite-splice-refusals.json` and every reported undeclared
...
`research/phase-2-hg-prerequisite-alpha-step4.md` with each edge, evidence, disposition, edit,
