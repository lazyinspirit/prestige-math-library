# Step 9 — changed-mathematics adjudication, `phase-2-catchup-24`

Act only on ids in `research/phase-2-catchup-24-step9-changes.json`. Read their current
...
`research/phase-2-catchup-24-alpha-step9-adjudicate.md` with every tuple, outcome,
