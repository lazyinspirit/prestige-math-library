# Step 4 — splice-refusal adjudication, `phase-2-fourier-support-2`

Read `research/phase-2-fourier-support-2-splice-refusals.json` and every reported undeclared
...
`research/phase-2-fourier-support-2-alpha-step4.md` with each edge, evidence, disposition, edit,
