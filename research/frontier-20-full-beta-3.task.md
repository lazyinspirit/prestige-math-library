# Batch 3 of run `frontier-20-full` — Prime Spectra and Radicals
...
| | |
|---|---|
| A page | `prime-spectra-and-radicals` · order **111.005** · `commutative-algebra` |
| B page | `prime-spectra-and-radicals-examples` |
| title | Prime Spectra and Radicals |
| requires | `localisation-of-modules-and-support-examples` |
| design | `plan-commutative-algebra-track.md` L380 |
