# Step 9 — scope-denial delta review, `phase-2-catchup-24`

First follow `briefs/tasks/frontier-dependency-ledger.md`. Refresh and read
`research/phase-2-catchup-24-cross-batch-dependencies.json` for cross-batch scope and impact.

Read only pending rows in `research/phase-2-catchup-24-step9-scope-delta.json`. Verify each
...
If `research/phase-2-catchup-24-step9-mathematical-review.task.md` exists, also perform its
...
`research/phase-2-catchup-24-alpha-step9-review.md`. Inspect each open run ledger row and
