...
# Step 8 — exact closure recovery, `phase-2-wave-1`

Read `research/phase-2-wave-1-judge-closure.json`,
`research/phase-2-wave-1-judge.jsonl`,
`research/phase-2-wave-1-judge-adjudications.jsonl`, and the generated `by_item`
ownership map in `research/phase-2-wave-1-step8-scope.json`. Take only current
...
`research/phase-2-wave-1-step8-cross-group.jsonl`, never repair that item.

Every `confirmed_fatal` row must also set `defect_type` to exactly one of
`logic`, `dependency_citation`, or `other`. Do not use a descriptive
defect-ledger subclass in that field.

Write `research/phase-2-wave-1-alpha-step8-closure-recovery-<group>.md` with the rows
