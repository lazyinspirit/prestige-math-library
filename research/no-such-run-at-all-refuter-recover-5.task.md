...
Correct research/no-such-run-at-all-refute-5.json for batch 5.
Read research/no-such-run-at-all-step6-scope-5.json and audit exactly its frozen `refuter_scope`.
Set the top-level `batch` field to exactly "5".
