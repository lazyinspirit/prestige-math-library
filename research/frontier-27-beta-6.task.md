# Batch 6 of run `frontier-27` — Long Exact Sequences in Homology
...
| | |
|---|---|
| A page | `long-exact-sequences-in-homology` · order **365.043** · `homological-algebra` |
| B page | `long-exact-sequences-in-homology-examples` |
| title | Long Exact Sequences in Homology |
| requires | `mapping-cones-cylinders-and-chain-triangles-examples` |
| design | `plan-homological-algebra-track.md` L937<br>`plan-homological-algebra-track.md` L1061 |
