# Batch 4 of run `frontier-30` — The Analytic Hahn Banach Theorem
...
| | |
|---|---|
| A page | `the-analytic-hahn-banach-theorem` · order **288.053** · `functional-analysis` |
| B page | `the-analytic-hahn-banach-theorem-examples` |
| title | The Analytic Hahn Banach Theorem |
| requires | `finite-dimensional-normed-spaces-and-riesz-lemma-examples` |
| design | `plan-functional-analysis-track.md` L478 |
