# Step 10 — pathway closure, `frontier-34`

Read `research/frontier-34-pathway.json` and
`research/frontier-34-pathway-closure.json`. For every pending receipt row, rewrite
