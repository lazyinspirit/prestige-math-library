# Batch 7 of run `frontier-20-full` — The Lebesgue Integral and the Convergence Theorems
...
| | |
|---|---|
| A page | `the-lebesgue-integral-and-the-convergence-theorems` · order **288.015** · `measure-theory` |
| B page | `the-lebesgue-integral-and-the-convergence-theorems-examples` |
| title | The Lebesgue Integral and the Convergence Theorems |
| requires | `measurable-functions-and-simple-approximation-examples` |
| design | `plan-measure-theory-track.md` L2361 |
