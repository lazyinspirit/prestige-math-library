# Step 10 — pathway closure, `phase-2-merged-25`

Read `research/phase-2-merged-25-pathway.json` and
`research/phase-2-merged-25-pathway-closure.json`. For every pending receipt row, rewrite
