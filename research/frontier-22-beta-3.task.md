# Batch 3 of run `frontier-22` — Maschke's Theorem, Complete Reducibility and the Structure of $k[G]$
...
| | |
|---|---|
| A page | `maschkes-theorem-and-complete-reducibility` · order **145** · `abstract-algebra` |
| B page | `maschkes-theorem-and-complete-reducibility-examples` |
| title | Maschke's Theorem, Complete Reducibility and the Structure of $k[G]$ |
| requires | `the-group-algebra-and-representations` |
| design | `plan-algebra-track-expansion.md` L1466 |
