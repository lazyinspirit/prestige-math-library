...
# Batch `<i>` of run `frontier-16` — a source is gone; its results are not
...
**`research/frontier-16-reharvest-plan.json`** — read `work[]`. Each entry gives
...
```
node tools/source-backing.mjs --coverage research/frontier-16-batch-<i>.coverage.json \
  --liveness research/frontier-16-url-liveness.json
```
...
```
node tools/source-backing.mjs --coverage research/frontier-16-batch-<i>.coverage.json --liveness research/frontier-16-url-liveness.json
node tools/coverage-checklist.mjs research/frontier-16-batch-<i>.coverage.json --require-destination
node tools/url-sweep.mjs --coverage research/frontier-16-batch-<i>.coverage.json --recover --fail-on-dead
node tools/source-fetch-check.mjs --coverage research/frontier-16-batch-<i>.coverage.json --stamp
```

## Report

Append `## Re-harvest round` to `research/frontier-16-batch-<i>.notes.md`: the dead
...
`research/frontier-16-batch-<i>.coverage.json` and `.notes.md`. Keep `original_url`
