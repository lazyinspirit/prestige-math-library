# Contract-detector adjudication — `frontier-33`
...
Merge the batch contracts into `research/frontier-33-proof-contracts.json` and
rerun the failed detector. Write `research/frontier-33-alpha-contract-audit.md`
