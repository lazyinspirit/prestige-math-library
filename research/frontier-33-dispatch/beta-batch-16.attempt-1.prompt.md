...
# Batch 16 of run `frontier-33` — Sublevel Deformation and the Handle Attachment Theorem
...
| | |
|---|---|
| A page | `sublevel-deformation-and-the-handle-attachment-theorem` · order **525** · `differential-topology` |
...
| requires | `stable-unstable-manifolds-and-morse-smale-transversality-examples`, `cw-complexes-and-cellular-homology` |
| design | `research/plan-differential-topology-track.md` L477 |
