...
covers: all
output: research/frontier-33-pathway-closure.json

# Step 10 — pathway closure, `frontier-33`

Read `research/frontier-33-pathway.json` and
`research/frontier-33-pathway-closure.json`. For every pending receipt row, rewrite
