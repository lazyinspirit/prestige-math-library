...
run: frontier-33
role: beta
label: reharvest-2-b14
covers: 14
output: research/frontier-33-alpha-6c.md

> The dispatch block supplies batch `14`.

# Reharvest — batch `14`, `frontier-33`

Read `research/frontier-33-reharvest-plan.json` and use its `work[]` rows belonging
