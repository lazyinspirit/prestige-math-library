...
run: frontier-33
role: beta
label: author-batch-12
covers: 12
output: research/frontier-33-batch-12.pages.json

> The dispatch block supplies batch `12`.

# Step 5 — author batch `12`, `frontier-33`

Required inputs are `research/frontier-33-batch-12.pages.json`,
`research/frontier-33-batch-12.notes.md`,
`research/frontier-33-batch-12.coverage.json`, and
`research/frontier-33-beta-12.task.md`. Use `research/frontier-33-alpha-groups.json`
...
`research/frontier-33-batch-12.proof-contracts.json` is an output to complete;
...
`node tools/content-policy.mjs research/frontier-33-batch-12.pages.json`, and
`node tools/proof-contract.mjs research/frontier-33-batch-12.proof-contracts.json --strict`.
