...
# Batch 20 of run `frontier-33` — Weak Choice Principles and Sierpiński's Theorem · Club, Stationary Sets, and Pressing Down
...
| | |
|---|---|
| A page | `weak-choice-principles-and-sierpinskis-theorem` · order **665** · `foundations` |
| B page | `weak-choice-principles-and-sierpinskis-theorem-examples` |
| title | Weak Choice Principles and Sierpiński's Theorem |
| requires | `cardinal-arithmetic-and-cofinality`, `filters-and-ultrafilters` |
| design | `research/plan-set-theory-completion-track.md` L236 |
...
| | |
|---|---|
| A page | `club-stationary-sets-and-pressing-down` · order **669** · `foundations` |
| B page | `club-stationary-sets-and-pressing-down-examples` |
| title | Club, Stationary Sets, and Pressing Down |
| requires | `cardinal-arithmetic-and-cofinality` |
| design | `research/plan-set-theory-completion-track.md` L265 |
