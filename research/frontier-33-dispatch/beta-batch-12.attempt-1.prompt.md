...
# Batch 12 of run `frontier-33` — Maximum Principles Harnack and Liouville in Rn
...
| | |
|---|---|
| A page | `maximum-principles-harnack-and-liouville-in-rn` · order **458.005** · `pde` |
| B page | `maximum-principles-harnack-and-liouville-in-rn-examples` |
| title | Maximum Principles Harnack and Liouville in Rn |
| requires | `harmonic-functions-and-mean-values-in-rn-examples` |
| design | `research/plan-pde-track.md` L19 (id mention, not a heading — locate the section yourself) |
