...
run: frontier-33
role: beta
label: author-batch-16
covers: 16
output: research/frontier-33-batch-16.pages.json

> The dispatch block supplies batch `16`.

# Step 5 — author batch `16`, `frontier-33`

Required inputs are `research/frontier-33-batch-16.pages.json`,
`research/frontier-33-batch-16.notes.md`,
`research/frontier-33-batch-16.coverage.json`, and
`research/frontier-33-beta-16.task.md`. Use `research/frontier-33-alpha-groups.json`
...
`research/frontier-33-batch-16.proof-contracts.json` is an output to complete;
...
`node tools/content-policy.mjs research/frontier-33-batch-16.pages.json`, and
`node tools/proof-contract.mjs research/frontier-33-batch-16.proof-contracts.json --strict`.
