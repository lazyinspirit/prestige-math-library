...
run: frontier-33
role: beta
label: author-batch-18
covers: 18
output: research/frontier-33-batch-18.pages.json

> The dispatch block supplies batch `18`.

# Step 5 — author batch `18`, `frontier-33`

Required inputs are `research/frontier-33-batch-18.pages.json`,
`research/frontier-33-batch-18.notes.md`,
`research/frontier-33-batch-18.coverage.json`, and
`research/frontier-33-beta-18.task.md`. Use `research/frontier-33-alpha-groups.json`
...
`research/frontier-33-batch-18.proof-contracts.json` is an output to complete;
...
`node tools/content-policy.mjs research/frontier-33-batch-18.pages.json`, and
`node tools/proof-contract.mjs research/frontier-33-batch-18.proof-contracts.json --strict`.
