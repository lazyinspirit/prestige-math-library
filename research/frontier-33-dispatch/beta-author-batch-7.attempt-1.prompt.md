...
covers: 7
output: research/frontier-33-batch-7.pages.json

> The dispatch block supplies batch `7`.

# Step 5 — author batch `7`, `frontier-33`

Required inputs are `research/frontier-33-batch-7.pages.json`,
`research/frontier-33-batch-7.notes.md`,
`research/frontier-33-batch-7.coverage.json`, and
`research/frontier-33-beta-7.task.md`. Use `research/frontier-33-alpha-groups.json`
...
`research/frontier-33-batch-7.proof-contracts.json` is an output to complete;
...
`node tools/content-policy.mjs research/frontier-33-batch-7.pages.json`, and
`node tools/proof-contract.mjs research/frontier-33-batch-7.proof-contracts.json --strict`.
