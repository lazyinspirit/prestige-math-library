...
run: frontier-33
role: beta
label: scaffold-fix-1-b2
covers: 2

> The dispatch block supplies batch `2`.

# Post-recheck scaffold repair — batch `2`, `frontier-33`

Read `research/frontier-33-scaffold-closure.json` and take only `work[]` entries
whose pages belong to batch `2` in the scope ledger. Apply or push back on
