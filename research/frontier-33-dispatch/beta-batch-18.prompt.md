...
# Batch 18 of run `frontier-33` — Arithmetization and the Sum-Check Protocol
...
| | |
|---|---|
| A page | `arithmetization-and-the-sum-check-protocol` · order **641** · `computability-theory` |
...
| design | `research/plan-computability-theory-track.md` L1276<br>`research/plan-computability-theory-track.md` L1301 |
