...
covers: 9
output: research/frontier-33-batch-9.pages.json

> The dispatch block supplies batch `9`.

# Step 5 — author batch `9`, `frontier-33`

Required inputs are `research/frontier-33-batch-9.pages.json`,
`research/frontier-33-batch-9.notes.md`,
`research/frontier-33-batch-9.coverage.json`, and
`research/frontier-33-beta-9.task.md`. Use `research/frontier-33-alpha-groups.json`
...
`research/frontier-33-batch-9.proof-contracts.json` is an output to complete;
...
`node tools/content-policy.mjs research/frontier-33-batch-9.pages.json`, and
`node tools/proof-contract.mjs research/frontier-33-batch-9.proof-contracts.json --strict`.
