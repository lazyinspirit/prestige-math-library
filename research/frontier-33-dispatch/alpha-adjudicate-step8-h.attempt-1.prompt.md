...
You are the group Alpha for batches **19**, **20**: 4 A/B pair(s), 8 page(s), 127 item(s), 11 open rejection(s) over 11 item(s).
...
|---|---|---|---|
| `def-cofinality-strata-and-stationary-trace` | `club-stationary-sets-and-pressing-down` | gpt-5.6-terra | `282c6a1c6733abc28005c5aa289d772dcf11e8ea3d91f78de14fe7db99bf2498` |
| `ex-finite-character-partial-choice-graphs` | `weak-choice-principles-and-sierpinskis-theorem-examples` | gpt-5.6-terra | `9a0a766d97502076d40fc0cde44bd7046801f938fedf080c63c9337263362ba1` |
| `ex-transfinite-subway-pressing-down` | `club-stationary-sets-and-pressing-down-examples` | gpt-5.6-terra | `25e4cdaa5bae4f7af558f5bd03e1f6bcf990ad8c0a01d82caa43fd5944802863` |
| `lem-compatible-well-founded-recursion-attempts` | `well-founded-relations-rank-and-the-cumulative-hierarchy` | gpt-5.6-terra | `f0395051ea8015801c48d34325357cdec400d185a1a5f8de4a4fbeb874e9760a` |
| `prop-capture-avoiding-substitution` | `formal-set-theoretic-syntax-structures-and-satisfaction` | gpt-5.6-terra | `8383195f612101ff87bd7b5a05f96240ec41ce43d036fc0a26013a6b9a3909b2` |
| `prop-ranks-of-ordinals-and-hierarchy-stages` | `well-founded-relations-rank-and-the-cumulative-hierarchy` | gpt-5.6-terra | `1a1a3bb574c454a52a6879b70104f8be40040bae4e99c579c08bfe874ff1fda7` |
| `thm-elementary-initial-segments-form-a-club` | `club-stationary-sets-and-pressing-down` | gpt-5.6-terra | `4a45ef6409dd424b420941e5002d3c55912ab4f4cf7f5d888d1304c8a81df9f8` |
| `thm-mostowski-collapse-for-extensional-relations` | `well-founded-relations-rank-and-the-cumulative-hierarchy` | gpt-5.6-terra | `7ab24ac335fd20b1c6da5af1812f62f55552fce2c350a8cddb7fe7fcbba3e4be` |
| `thm-normal-function-fixed-points-form-a-club` | `club-stationary-sets-and-pressing-down` | gpt-5.6-terra | `bedd17fc0ddf25ac2d735083c91ab084505605cd574d756799a97d4d9d80cc61` |
| `thm-normality-and-positive-pressing-down` | `club-stationary-sets-and-pressing-down` | gpt-5.6-terra | `33e8e0502c52053ea2d4c31a3d2a38d9cbea96e84e353379ff01f7bb816c6a2a` |
| `thm-tukey-finite-character-equivalent-to-choice` | `weak-choice-principles-and-sierpinskis-theorem` | gpt-5.6-terra | `1d653a676da69294d9f1f0cb6f155965dfa8283a21f3e041ba19ffdf14680e01` |
