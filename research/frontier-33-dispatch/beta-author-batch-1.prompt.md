...
covers: 1
output: research/frontier-33-batch-1.pages.json

> The dispatch block supplies batch `1`.

# Step 5 — author batch `1`, `frontier-33`

Required inputs are `research/frontier-33-batch-1.pages.json`,
`research/frontier-33-batch-1.notes.md`,
`research/frontier-33-batch-1.coverage.json`, and
`research/frontier-33-beta-1.task.md`. Use `research/frontier-33-alpha-groups.json`
...
`research/frontier-33-batch-1.proof-contracts.json` is an output to complete;
...
`node tools/content-policy.mjs research/frontier-33-batch-1.pages.json`, and
`node tools/proof-contract.mjs research/frontier-33-batch-1.proof-contracts.json --strict`.
