...
You are the group Alpha for batches **9**, **10**: 2 A/B pair(s), 4 page(s), 109 item(s), 6 open rejection(s) over 6 item(s).
...
- `def-geometric-fibre` · definition — Choose an algebraic closure Omega of kappa(s); define X_bar-s=X_s times_kappa(s) Spec Omega. A geometric point more generally has algebraically closed residue target; this page uses algebraic closures for fibre tests.
...
|---|---|---|---|
| `cor-dimension-birational-invariant` | `dimension-constructible-images-and-dimensions-of-fibres` | gpt-5.6-terra | `872d5a264b82342b9932fc467becfdbd27dab9e5372ad41120109a182fbbc316` |
| `def-geometric-fibre` | `fibre-products-base-change-and-scheme-theoretic-fibres` | gpt-5.6-terra | `972e43f7dd6c4388d4541ee4bd74708d4488c6f28266505d510efe9bac744f5f` |
| `ex-linear-system-fibre-dimension-rank-loci` | `dimension-constructible-images-and-dimensions-of-fibres-examples` | gpt-5.6-terra | `89f6704486de26fa714ee54d587e92966c2a6c0a225106c2fc487ccff3c6b0ae` |
| `lem-base-change-affine-morphisms` | `fibre-products-base-change-and-scheme-theoretic-fibres` | gpt-5.6-terra | `3dfff7d3cf681762e5c3a4149d7862354529785b311d8bb26917ecdecc4d1652` |
| `lem-base-extension-field-coordinate-ring` | `fibre-products-base-change-and-scheme-theoretic-fibres` | gpt-5.6-terra | `cd3a71596360367d74efe11eeb7c590a0175418eff79f14fe15a0322804428fe` |
| `thm-dimension-product-varieties` | `dimension-constructible-images-and-dimensions-of-fibres` | gpt-5.6-terra | `5903fdba70350e0d7b159bcde141ca9b23c729f1b41b502108cbeca72f36dcc8` |
