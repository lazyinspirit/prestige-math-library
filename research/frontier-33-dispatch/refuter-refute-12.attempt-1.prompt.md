...
The task and `research/frontier-33-step6-scope-12.json` define `refuter_scope`.
...
label: refute-12
covers: 12
output: research/frontier-33-refute-12.json

# Step 6a — refuter

Read `research/frontier-33-step6-scope-12.json` and audit exactly its `refuter_scope`,
