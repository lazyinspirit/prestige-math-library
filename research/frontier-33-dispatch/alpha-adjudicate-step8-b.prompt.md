...
You are the group Alpha for batches **2**, **12**: 2 A/B pair(s), 4 page(s), 77 item(s), 3 open rejection(s) over 3 item(s).
...
|---|---|---|---|
| `cex-unbounded-punctured-harmonic-singularity-is-not-removable` | `maximum-principles-harnack-and-liouville-in-rn-examples` | gpt-5.6-terra | `b56517554437cfa7a126d143a203d079df71fe2c395b5623c683b40b1e1608d3` |
| `cor-transpose-preserves-invertibility` | `dual-spaces-adjoint-operators-and-annihilators` | gpt-5.6-terra | `be6202acc47eab77c58f8d3d0988745cccfb499e502faba0f5e7a9a3ddd4ff76` |
| `lem-transpose-reverses-composition` | `dual-spaces-adjoint-operators-and-annihilators` | gpt-5.6-terra | `e93943cb31181619aff28d630dfa2f8f437c505310dfddb0f64aa1bb93835e96` |
