...
covers: 6
output: research/frontier-33-batch-6.pages.json

> The dispatch block supplies batch `6`.

# Step 5 — author batch `6`, `frontier-33`

Required inputs are `research/frontier-33-batch-6.pages.json`,
`research/frontier-33-batch-6.notes.md`,
`research/frontier-33-batch-6.coverage.json`, and
`research/frontier-33-beta-6.task.md`. Use `research/frontier-33-alpha-groups.json`
...
`research/frontier-33-batch-6.proof-contracts.json` is an output to complete;
...
`node tools/content-policy.mjs research/frontier-33-batch-6.pages.json`, and
