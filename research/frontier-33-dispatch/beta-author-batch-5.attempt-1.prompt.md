...
covers: 5
output: research/frontier-33-batch-5.pages.json

> The dispatch block supplies batch `5`.

# Step 5 — author batch `5`, `frontier-33`

Required inputs are `research/frontier-33-batch-5.pages.json`,
`research/frontier-33-batch-5.notes.md`,
`research/frontier-33-batch-5.coverage.json`, and
`research/frontier-33-beta-5.task.md`. Use `research/frontier-33-alpha-groups.json`
...
`research/frontier-33-batch-5.proof-contracts.json` is an output to complete;
...
`node tools/content-policy.mjs research/frontier-33-batch-5.pages.json`, and
`node tools/proof-contract.mjs research/frontier-33-batch-5.proof-contracts.json --strict`.
