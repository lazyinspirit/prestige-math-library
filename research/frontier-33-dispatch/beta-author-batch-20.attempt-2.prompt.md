...
run: frontier-33
role: beta
label: author-batch-20
covers: 20
output: research/frontier-33-batch-20.pages.json

> The dispatch block supplies batch `20`.

# Step 5 — author batch `20`, `frontier-33`

Required inputs are `research/frontier-33-batch-20.pages.json`,
`research/frontier-33-batch-20.notes.md`,
`research/frontier-33-batch-20.coverage.json`, and
`research/frontier-33-beta-20.task.md`. Use `research/frontier-33-alpha-groups.json`
...
`research/frontier-33-batch-20.proof-contracts.json` is an output to complete;
...
`node tools/content-policy.mjs research/frontier-33-batch-20.pages.json`, and
`node tools/proof-contract.mjs research/frontier-33-batch-20.proof-contracts.json --strict`.
