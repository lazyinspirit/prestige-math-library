...
covers: 4
output: research/frontier-33-batch-4.pages.json

> The dispatch block supplies batch `4`.

# Step 5 — author batch `4`, `frontier-33`

Required inputs are `research/frontier-33-batch-4.pages.json`,
`research/frontier-33-batch-4.notes.md`,
`research/frontier-33-batch-4.coverage.json`, and
`research/frontier-33-beta-4.task.md`. Use `research/frontier-33-alpha-groups.json`
...
`research/frontier-33-batch-4.proof-contracts.json` is an output to complete;
...
`node tools/content-policy.mjs research/frontier-33-batch-4.pages.json`, and
`node tools/proof-contract.mjs research/frontier-33-batch-4.proof-contracts.json --strict`.
