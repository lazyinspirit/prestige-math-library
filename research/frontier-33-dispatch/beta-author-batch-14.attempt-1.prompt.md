...
run: frontier-33
role: beta
label: author-batch-14
covers: 14
output: research/frontier-33-batch-14.pages.json

> The dispatch block supplies batch `14`.

# Step 5 — author batch `14`, `frontier-33`

Required inputs are `research/frontier-33-batch-14.pages.json`,
`research/frontier-33-batch-14.notes.md`,
`research/frontier-33-batch-14.coverage.json`, and
`research/frontier-33-beta-14.task.md`. Use `research/frontier-33-alpha-groups.json`
...
`research/frontier-33-batch-14.proof-contracts.json` is an output to complete;
...
`node tools/content-policy.mjs research/frontier-33-batch-14.pages.json`, and
`node tools/proof-contract.mjs research/frontier-33-batch-14.proof-contracts.json --strict`.
