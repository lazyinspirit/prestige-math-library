...
run: frontier-33
role: beta
label: author-batch-19
covers: 19
output: research/frontier-33-batch-19.pages.json

> The dispatch block supplies batch `19`.

# Step 5 — author batch `19`, `frontier-33`

Required inputs are `research/frontier-33-batch-19.pages.json`,
`research/frontier-33-batch-19.notes.md`,
`research/frontier-33-batch-19.coverage.json`, and
`research/frontier-33-beta-19.task.md`. Use `research/frontier-33-alpha-groups.json`
...
`research/frontier-33-batch-19.proof-contracts.json` is an output to complete;
...
`node tools/content-policy.mjs research/frontier-33-batch-19.pages.json`, and
`node tools/proof-contract.mjs research/frontier-33-batch-19.proof-contracts.json --strict`.
