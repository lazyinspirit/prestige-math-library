...
run: frontier-33
role: beta
label: author-batch-13
covers: 13
output: research/frontier-33-batch-13.pages.json

> The dispatch block supplies batch `13`.

# Step 5 — author batch `13`, `frontier-33`

Required inputs are `research/frontier-33-batch-13.pages.json`,
`research/frontier-33-batch-13.notes.md`,
`research/frontier-33-batch-13.coverage.json`, and
`research/frontier-33-beta-13.task.md`. Use `research/frontier-33-alpha-groups.json`
...
`research/frontier-33-batch-13.proof-contracts.json` is an output to complete;
...
`node tools/content-policy.mjs research/frontier-33-batch-13.pages.json`, and
`node tools/proof-contract.mjs research/frontier-33-batch-13.proof-contracts.json --strict`.
