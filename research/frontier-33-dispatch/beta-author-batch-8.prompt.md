...
covers: 8
output: research/frontier-33-batch-8.pages.json

> The dispatch block supplies batch `8`.

# Step 5 — author batch `8`, `frontier-33`

Required inputs are `research/frontier-33-batch-8.pages.json`,
`research/frontier-33-batch-8.notes.md`,
`research/frontier-33-batch-8.coverage.json`, and
`research/frontier-33-beta-8.task.md`. Use `research/frontier-33-alpha-groups.json`
...
`research/frontier-33-batch-8.proof-contracts.json` is an output to complete;
...
`node tools/content-policy.mjs research/frontier-33-batch-8.pages.json`, and
`node tools/proof-contract.mjs research/frontier-33-batch-8.proof-contracts.json --strict`.
