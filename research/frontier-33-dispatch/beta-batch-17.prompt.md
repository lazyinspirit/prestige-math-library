...
# Batch 17 of run `frontier-33` — The Polynomial Hierarchy and Relativization · Expander Graphs and Constraint Graphs
...
| | |
|---|---|
| A page | `the-polynomial-hierarchy-and-relativization` · order **633** · `computability-theory` |
| B page | `the-polynomial-hierarchy-and-relativization-examples` |
| title | The Polynomial Hierarchy and Relativization |
| requires | `boolean-circuits-and-nonuniform-complexity`, `space-complexity-savitch-and-tqbf` |
| design | `research/plan-computability-theory-track.md` L1126<br>`research/plan-computability-theory-track.md` L1150 |
...
| | |
|---|---|
| A page | `expander-graphs-and-constraint-graphs` · order **645** · `computability-theory` |
| B page | `expander-graphs-and-constraint-graphs-examples` |
| title | Expander Graphs and Constraint Graphs |
...
| design | `research/plan-computability-theory-track.md` L1349<br>`research/plan-computability-theory-track.md` L1374 |
