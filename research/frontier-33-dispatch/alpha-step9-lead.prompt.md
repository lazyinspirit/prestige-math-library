...
label: step9-lead
covers: all
output: research/frontier-33-alpha-step9-review.md

# Step 9 — scope-denial delta review, `frontier-33`

Read only pending rows in `research/frontier-33-step9-scope-delta.json`. Verify each
...
If `research/frontier-33-step9-mathematical-review.task.md` exists, also perform its
...
`research/frontier-33-alpha-step9-review.md`. Inspect each open run ledger row and
