...
`research/frontier-33-step6-scope-<i>.json`, reader report and findings JSON, refuter
report, current carrier, and cited dependencies.

Compare each post-reader hash snapshot with `research/frontier-33-step6-hash-<i>-pre-6b.json`.
...
Write `research/frontier-33-alpha-<g>-6b.md` and
`research/frontier-33-alpha-<g>-6b-decisions.json` with `{version:1,run,group,decisions}`.
