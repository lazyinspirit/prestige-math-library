...
run: frontier-33
role: beta
label: author-batch-15
covers: 15
output: research/frontier-33-batch-15.pages.json

> The dispatch block supplies batch `15`.

# Step 5 — author batch `15`, `frontier-33`

Required inputs are `research/frontier-33-batch-15.pages.json`,
`research/frontier-33-batch-15.notes.md`,
`research/frontier-33-batch-15.coverage.json`, and
`research/frontier-33-beta-15.task.md`. Use `research/frontier-33-alpha-groups.json`
to find the group whose `covers` includes this batch, then read its
`research/frontier-33-alpha-GROUP-step3-verdicts.json` and
`research/frontier-33-alpha-GROUP-step3-scaffold-review.md` (replace GROUP with
...
`research/frontier-33-batch-15.proof-contracts.json` is an output to complete;
...
`node tools/content-policy.mjs research/frontier-33-batch-15.pages.json`, and
`node tools/proof-contract.mjs research/frontier-33-batch-15.proof-contracts.json --strict`.
