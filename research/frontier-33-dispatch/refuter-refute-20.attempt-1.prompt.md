...
The task and `research/frontier-33-step6-scope-20.json` define `refuter_scope`.
...
label: refute-20
covers: 20
output: research/frontier-33-refute-20.json

# Step 6a — refuter

Read `research/frontier-33-step6-scope-20.json` and audit exactly its `refuter_scope`,
