...
# Batch 1 of run `frontier-33` — Hausdorff Measure and Hausdorff Dimension
...
| | |
|---|---|
| A page | `hausdorff-measure-and-hausdorff-dimension` · order **288.041** · `measure-theory` |
| B page | `hausdorff-measure-and-hausdorff-dimension-examples` |
| title | Hausdorff Measure and Hausdorff Dimension |
| requires | `radon-measures-and-the-riesz-markov-kakutani-theorem-examples` |
| design | `research/plan-measure-theory-track.md` L3700 |
