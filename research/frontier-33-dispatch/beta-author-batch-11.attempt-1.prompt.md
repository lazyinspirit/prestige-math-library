...
run: frontier-33
role: beta
label: author-batch-11
covers: 11
output: research/frontier-33-batch-11.pages.json

> The dispatch block supplies batch `11`.

# Step 5 — author batch `11`, `frontier-33`

Required inputs are `research/frontier-33-batch-11.pages.json`,
`research/frontier-33-batch-11.notes.md`,
`research/frontier-33-batch-11.coverage.json`, and
`research/frontier-33-beta-11.task.md`. Use `research/frontier-33-alpha-groups.json`
...
`research/frontier-33-batch-11.proof-contracts.json` is an output to complete;
...
`node tools/content-policy.mjs research/frontier-33-batch-11.pages.json`, and
`node tools/proof-contract.mjs research/frontier-33-batch-11.proof-contracts.json --strict`.
