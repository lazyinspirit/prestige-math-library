...
# Batch 9 of run `frontier-33` — Dimension Constructible Images and Dimensions of Fibres
...
| | |
|---|---|
| A page | `dimension-constructible-images-and-dimensions-of-fibres` · order **366.049** · `algebraic-geometry` |
| B page | `dimension-constructible-images-and-dimensions-of-fibres-examples` |
| title | Dimension Constructible Images and Dimensions of Fibres |
| requires | `products-segre-and-veronese-embeddings-and-grassmannians-examples` |
| design | `research/plan-algebraic-geometry-track.md` L313 |
