...
covers: 10
output: research/frontier-33-batch-10.pages.json

> The dispatch block supplies batch `10`.

# Step 5 — author batch `10`, `frontier-33`

Required inputs are `research/frontier-33-batch-10.pages.json`,
`research/frontier-33-batch-10.notes.md`,
`research/frontier-33-batch-10.coverage.json`, and
`research/frontier-33-beta-10.task.md`. Use `research/frontier-33-alpha-groups.json`
...
`research/frontier-33-batch-10.proof-contracts.json` is an output to complete;
...
`node tools/content-policy.mjs research/frontier-33-batch-10.pages.json`, and
`node tools/proof-contract.mjs research/frontier-33-batch-10.proof-contracts.json --strict`.
