...
# Step 4 — splice-refusal adjudication, `frontier-33`

Read `research/frontier-33-splice-refusals.json` and every reported undeclared
...
`research/frontier-33-alpha-step4.md` with each edge, evidence, disposition, edit,
