# Step 4 — splice-refusal adjudication, `phase-2-wave-1`

Read `research/phase-2-wave-1-splice-refusals.json` and every reported undeclared
...
`research/phase-2-wave-1-alpha-step4.md` with each edge, evidence, disposition, edit,
