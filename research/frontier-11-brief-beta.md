...
`research/frontier-11-batch-<i>.coverage.json`. Per A page: at least two
...
```
node tools/coverage-checklist.mjs research/frontier-11-batch-<i>.coverage.json
```
...
- `research/frontier-11-batch-<i>.pages.json` — the machine scaffold
- `research/frontier-11-batch-<i>.notes.md` — source ledger, provenance
  rationales, convention disagreements, split proposals, licensing notes
- `research/frontier-11-batch-<i>.coverage.json` — the harvest
- `research/frontier-11-batch-<i>.proof-contracts.json` — begun at scaffold time
