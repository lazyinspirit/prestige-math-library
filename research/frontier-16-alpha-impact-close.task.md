# Impact-receipt closure, run `frontier-16`

The `impact-receipt` gate is red. The receipt at `research/frontier-16-impact.json`
...
node tools/impact-audit.mjs --touches research/frontier-16-touches.json \
  --from pre-author --to post-step9 --receipt research/frontier-16-impact.json
```
...
anything** (`research/frontier-16-dispatch/`). **No permission prompts of any
