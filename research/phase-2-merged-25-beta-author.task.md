# Author batch `<i>` — `phase-2-merged-25`

Read these `research/` files:

- `phase-2-merged-25-batch-<i>.pages.json`, `phase-2-merged-25-batch-<i>.notes.md`, and
  `phase-2-merged-25-batch-<i>.coverage.json`;
- `phase-2-merged-25-beta-<i>.task.md` and its assigned design sections;
- `phase-2-merged-25-alpha-groups.json`: find your group by `covers`, then read
  `phase-2-merged-25-alpha-GROUP-step3-verdicts.json` and
  `phase-2-merged-25-alpha-GROUP-step3-scaffold-review.md` using that group's label.

Report missing inputs; do not substitute another run's artifacts. Preserve and
complete `research/phase-2-merged-25-batch-<i>.proof-contracts.json`, creating it if absent.
...
- `node tools/content-policy.mjs research/phase-2-merged-25-batch-<i>.pages.json`;
- `node tools/proof-contract.mjs research/phase-2-merged-25-batch-<i>.proof-contracts.json --strict`.
