# Batch 10 of run `frontier-25` — Nondeterministic Finite Automata and Subset Construction · Pushdown Automata and Context-Free Languages

2 A/B pairs, computability-theory. You own every page here and you author them all at step 5.

## `nondeterministic-finite-automata-and-subset-construction`

| | |
|---|---|
| A page | `nondeterministic-finite-automata-and-subset-construction` · order **585** · `computability-theory` |
...
| design | `plan-computability-theory-track.md` L251<br>`plan-computability-theory-track.md` L274 |
...
| | |
|---|---|
| A page | `pushdown-automata-and-context-free-languages` · order **593** · `computability-theory` |
| B page | `pushdown-automata-and-context-free-languages-examples` |
| title | Pushdown Automata and Context-Free Languages |
| requires | `context-free-grammars-and-normal-forms`, `deterministic-finite-automata-and-regular-languages` |
| design | `plan-computability-theory-track.md` L396<br>`plan-computability-theory-track.md` L420 |
