# Batch 2 of run `frontier-27` — Conjugate Gradients, MINRES and Preconditioning
...
| | |
|---|---|
| A page | `conjugate-gradients-minres-and-preconditioning` · order **288.000061** · `linear-algebra` |
| B page | `conjugate-gradients-minres-and-preconditioning-examples` |
| title | Conjugate Gradients, MINRES and Preconditioning |
| requires | `krylov-subspaces-arnoldi-and-gmres`, `convex-and-semicontinuous-functions-on-rn` |
| design | `plan-algebra-track-expansion-v2.md` L924 |
