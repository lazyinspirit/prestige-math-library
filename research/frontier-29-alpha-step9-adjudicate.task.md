# Step 9 — changed-mathematics adjudication, `frontier-29`

Act only on ids in `research/frontier-29-step9-changes.json`. Read their current
...
`research/frontier-29-alpha-step9-adjudicate.md` with every tuple, outcome,
