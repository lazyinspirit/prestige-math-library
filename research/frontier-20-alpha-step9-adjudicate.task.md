# Step 9 — changed-mathematics adjudication, `frontier-20`

Act only on ids in `research/frontier-20-step9-changes.json`. Read their current
...
`research/frontier-20-alpha-step9-adjudicate.md` with every tuple, outcome,
