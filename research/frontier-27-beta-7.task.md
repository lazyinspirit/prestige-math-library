# Batch 7 of run `frontier-27` — Small-Graph Erdős–Hajnal Consequences · Iterative Restriction and Comb-Extraction Lemmas
...
| | |
|---|---|
| A page | `small-graph-erdos-hajnal-consequences` · order **421** · `combinatorics` |
| B page | `small-graph-erdos-hajnal-consequences-examples` |
| title | Small-Graph Erdős–Hajnal Consequences |
| requires | `star-expansions-and-erdos-hajnal`, `iterative-sparsification-and-the-five-vertex-path` |
| design | `plan-combinatorics-and-categories.md` L3910 (id mention, not a heading — locate the section yourself) |
...
| | |
|---|---|
| A page | `iterative-restriction-and-comb-extraction-lemmas` · order **423** · `combinatorics` |
| B page | `iterative-restriction-and-comb-extraction-lemmas-examples` |
| title | Iterative Restriction and Comb-Extraction Lemmas |
| requires | `iterative-sparsification-and-the-five-vertex-path` |
| design | `plan-combinatorics-and-categories.md` L3911 (id mention, not a heading — locate the section yourself) |
