# Batch 9 of run `frontier-24` — Smooth Partitions of Unity and Exhaustions · Tangent Cotangent and the Differential
...
| | |
|---|---|
| A page | `smooth-partitions-of-unity-and-exhaustions` · order **445** · `differential-geometry` |
| B page | `smooth-partitions-of-unity-and-exhaustions-examples` |
| title | Smooth Partitions of Unity and Exhaustions |
| requires | `smooth-manifolds-and-smooth-maps-examples` |
| design | `plan-differential-geometry-track.md` L827 |
...
| | |
|---|---|
| A page | `tangent-cotangent-and-the-differential` · order **447** · `differential-geometry` |
...
| design | `plan-differential-geometry-track.md` L1053 |
