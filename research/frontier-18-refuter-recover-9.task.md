...
Correct research/frontier-18-refute-9.json for batch 9.
Read research/frontier-18-step6-scope-9.json and audit exactly its frozen `refuter_scope`.
Set the top-level `batch` field to exactly "9".
