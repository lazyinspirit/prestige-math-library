...
# Batch `<i>` of run `frontier-18` — step 5, authoring
...
- `research/frontier-18-batch-<i>.pages.json` — the spliced scaffold
- `research/frontier-18-batch-<i>.notes.md` — your source ledger and rationales
- `research/frontier-18-batch-<i>.coverage.json` — the harvest
- `research/frontier-18-batch-<i>.proof-contracts.json` — extend it as you author
- group Alpha's step-3 review and re-check, for the findings you resolved
- `research/frontier-18-beta-<i>.task.md` — your batch's pages and design section;
...
node tools/content-policy.mjs research/frontier-18-batch-<i>.pages.json
```
...
Append `## Step-5 authoring` to `research/frontier-18-batch-<i>.notes.md`: items
