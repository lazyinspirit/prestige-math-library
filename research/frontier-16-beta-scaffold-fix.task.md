...
# Batch `<i>` of run `frontier-16` — post-recheck scaffold repair
...
**`research/frontier-16-scaffold-closure.json`** — read `work[]`. Each entry names
...
map in `research/frontier-16-scope-ledger.json`, and touch nothing outside your
batch.

## What to do

1. For each of your findings: apply the remedy to your batch's scaffold files
   (`research/frontier-16-batch-<i>.pages.json`, `.coverage.json`, `.notes.md`),
...
4. Append `## Scaffold-fix round` to `research/frontier-16-batch-<i>.notes.md`,
