# Step 4 — splice-refusal adjudication, `frontier-20-full`

Read `research/frontier-20-full-splice-refusals.json` and every reported undeclared
...
`research/frontier-20-full-alpha-step4.md` with each edge, evidence, disposition, edit,
