...
# Step 5 — author batch `<i>`, `frontier-33`

Required inputs are `research/frontier-33-batch-<i>.pages.json`,
`research/frontier-33-batch-<i>.notes.md`,
`research/frontier-33-batch-<i>.coverage.json`, and
`research/frontier-33-beta-<i>.task.md`. Use `research/frontier-33-alpha-groups.json`
...
`research/frontier-33-batch-<i>.proof-contracts.json` is an output to complete;
...
`node tools/content-policy.mjs research/frontier-33-batch-<i>.pages.json`, and
`node tools/proof-contract.mjs research/frontier-33-batch-<i>.proof-contracts.json --strict`.
