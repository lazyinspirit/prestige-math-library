# Step 4 — splice-refusal adjudication, `phase-2-catchup-24`

Read `research/phase-2-catchup-24-splice-refusals.json` and every reported undeclared
...
`research/phase-2-catchup-24-alpha-step4.md` with each edge, evidence, disposition, edit,
