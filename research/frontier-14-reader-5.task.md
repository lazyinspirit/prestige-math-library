## Step 6a — independent read of batch 5
...
Scope: every item on the pages in `research/frontier-14-batch-5.pages.json`.
...
`research/frontier-14-reader-5.md`, findings numbered `R5-1`, `R5-2`, …
