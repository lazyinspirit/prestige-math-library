# Contract-detector adjudication — `phase-2-nine-step-25`
...
Merge the batch contracts into `research/phase-2-nine-step-25-proof-contracts.json` and
rerun the failed detector. Write `research/phase-2-nine-step-25-alpha-contract-audit.md`
