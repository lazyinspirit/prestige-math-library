# Batch 5 of run `frontier-21` — The Group Algebra and Representations of Finite Groups
...
| | |
|---|---|
| A page | `the-group-algebra-and-representations` · order **143** · `abstract-algebra` |
| B page | `the-group-algebra-and-representations-examples` |
| title | The Group Algebra and Representations of Finite Groups |
| requires | `chain-conditions-and-semisimple-modules`, `the-fundamental-theorem-of-algebra`, `sylow-theorems-and-nilpotent-groups`, `matrices-and-the-matrix-of-a-linear-map` |
| design | `plan-algebra-track-expansion.md` L1388 |
