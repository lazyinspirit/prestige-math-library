# Step 9 — changed-mathematics adjudication, `frontier-22`

Act only on ids in `research/frontier-22-step9-changes.json`. Read their current
...
`research/frontier-22-alpha-step9-adjudicate.md` with every tuple, outcome,
