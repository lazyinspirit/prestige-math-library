# Step 9 — changed-mathematics adjudication, `frontier-28`

Act only on ids in `research/frontier-28-step9-changes.json`. Read their current
...
`research/frontier-28-alpha-step9-adjudicate.md` with every tuple, outcome,
