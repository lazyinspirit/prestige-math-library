...
```json
{
  ...
  "failures": [
    ...
    },
    {
      ...
      "stage": "8-preflight",
      "why": "FAIL",
      "output": "  [multiline-display] items/def-evaluation-map-from-cohomology-to-hom-of-homology.md: display math must be one source line between `$$`; a hard line break mis-renders\n      $$\\operatorname{ev}_n:H^n\\operatorname{Hom}_R(C,G)longrightarrow \\operatorname{Hom}_R(H_nC,G),\\q…\n  [multiline-display] items/def-group-homology-as-a-derived-functor.md: display math must be one source line between `$$`; a hard line break mis-renders\n      $$H_n^P(G;M):=L_n^P((-) _G)(M) =H_n\\!\\left(\\mathbb Z\\otimes_{\\mathbb Z[G]}P_\\bullet(M)\\right),$$\n  [multiline-display] items/def-normalized-bar-resolution.md: display math must be one source line between `$$`; a hard line break mis-renders\n      $$\\overline B_\\bullet(G)=B_\\bullet(G)/D_\\bullet(G) \\longrightarrow\\mathbb Z,$$\n  [multiline-display] items/def-restriction-and-corestriction-on-group-cohomology.md: display math must be one source line between `$$`; a hard line break mis-renders\n      $$N_H^G:M^H\\longrightarrow M^G,\\qquad N_H^G(m)=\\sum_{xH\\in G/H}xm.$$\n  [multiline-display] items/lem-the-kunneth-tor-map.md: display math must be one source line between `$$`; a hard line break mis-renders\n      $$H_n(C\\otimes_RD)\\longrightarrow \\bigoplus_{p+q=n-1}\\operatorname{Tor}_1^R(H_pC,H_qD).$$\n  [multiline-display] items/thm-universal-coefficient-theorem-for-cohomology-over-a-pid.md: display math must be one source line between `$$`; a hard line break mis-renders\n      $$0\\to\\operatorname{Ext}^1_R(H_{n-1}C,G) \\to H^n\\operatorname{Hom}_R(C,G) \\xrightarrow{\\operator…\n  [katex-parse-error] items/thm-universal-coefficient-theorem-for-cohomology-over-a-pid.md: KaTeX parse error: Unexpected character: '\b' at position 33: …}_R(B_{n-1}C,G)\b̲ig/ \\operatorna…\n      \\operatorname{Hom}_R(B_{n-1}C,G)\big/ \\operatorname{im}\\bigl(\\operatorname{Hom}_R(Z_{n-1}C,G)\\big…\n\n7 ERROR(s) across 14640 file(s)\n\nFAIL\n",
      "named_ids": [
        "katex-parse-error",
        "def-evaluation-map-from-cohomology-to-hom-of-homology",
    ...
    },
    {
      "id": "proof-contract",
      "stage": "8-preflight",
      "why": "ERROR step-entry-input-omitted [thm-an-absolutely-continuous-function-with-zero-derivative-almost-everywhere-is-constant]: step-3-1 omits 1.1, cited by 3.1",
      "output": "proof-contract: 135 error(s), 0 warning(s), 704/704 item(s) checked\nERROR citation-source-not-in-fact [lem-countable-product-cylinder-premeasure-is-countably-additive]: F2 does not link [[thm-continuity-from-above-for-measures]]\nERROR citation-source-not-in-fact [lem-countable-product-cylinder-premeasure-is-countably-additive]: F3 does not link [[def-countable-choice]]\nERROR citation-source-not-in-fact [lem-countable-product-cylinder-premeasure-is-countably-additive]: F4 does not link [[thm-countable-union-of-countable]]\nERROR citation-source-not-in-fact [lem-countable-product-cylinder-premeasure-is-countably-additive]: F5 does not link [[def-dependent-choice]]\nERROR citation-fact-uncontracted [lem-countable-product-cylinder-premeasure-is-countably-additive]: F3 -> thm-continuity-from-above-for-measures needs an exact citation contract\nERROR citation-fact-uncontracted [lem-countable-product-cylinder-premeasure-is-countably-additive]: F4 -> def-countable-choice needs an exact citation contract\nERROR citation-fact-uncontracted [lem-countable-product-cylinder-premeasure-is-countably-additive]: F5 -> thm-countable-union-of-countable needs an exact citation contract\nERROR citation-fact-uncontracted [lem-countable-product-cylinder-premeasure-is-countably-additive]: F6 -> def-dependent-choice needs an exact citation contract\nERROR citation-fact-uncontracted [cor-holomorphic-functional-calculus-in-the-wiener-algebra]: L3 -> thm-global-cauchy-integral-formula-homology needs an exact citation contract\nERROR citation-fact-uncontracted [prop-positive-ext-vanishes-on-a-projective-first-variable]: L2 -> prop-positive-right-derived-functors-vanish-on-injective-objects needs an exact citation contract\nERROR step-entry-input-omitted [prop-positive-ext-vanishes-on-a-projective-first-variable]: routine-1 omits L2, cited by 1.1\nERROR citation-source-not-in-fact [thm-ext-dimension-shifting-in-the-first-variable]: L1 does not link [[def-ext-via-a-projective-resolution-of-the-first-variable]]\nERROR citation-undeclared-dependency [thm-ext-dimension-shifting-in-the-first-variable]: L1 cites def-ext-via-a-projective-resolution-of-the-first-variable, which is absent from deps/justified_by/forward_refs\nERROR citation-use-not-supported [thm-ext-dimension-shifting-in-the-first-variable]: L1 is not cited by declared use 2.1\nERROR citation-fact-uncontracted [thm-ext-dimension-shifting-in-the-first-variable]: L1 -> thm-long-exact-ext-sequence-in-the-first-variable needs an exact citation contract\nERROR step-entry-input-omitted [lem-the-kunneth-tor-map]: local-1 omits 3.6, cited by 1.1\nERROR step-entry-input-omitted [thm-the-kunneth-sequence-splits-nonnaturally]: local-1 omits 3.6, cited by 1.1",
      "named_ids": [
  ...
  "live_items": [
    ...
    {
      "id": "forward-same-page",
      "scope": "unknown",
      "owner": null
    },
    {
      "id": "katex-parse-error",
      "scope": "unknown",
      "owner": null
    },
    {
