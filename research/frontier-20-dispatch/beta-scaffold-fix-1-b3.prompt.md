...
run: frontier-20
role: beta
label: scaffold-fix-1-b3
covers: 3

> The dispatch block supplies batch `3`.

# Post-recheck scaffold repair — batch `3`, `frontier-20`

Read `research/frontier-20-scaffold-closure.json` and take only `work[]` entries
whose pages belong to batch `3` in the scope ledger. Apply or push back on
