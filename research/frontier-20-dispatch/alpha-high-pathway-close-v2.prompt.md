...
covers: all
output: research/frontier-20-pathway-closure.json

# Step 10 — pathway closure, `frontier-20`

Read `research/frontier-20-pathway.json` and
`research/frontier-20-pathway-closure.json`. For every pending receipt row, rewrite
