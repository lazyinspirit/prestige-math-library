...
# Contract-detector adjudication — `frontier-20`
...
Merge the batch contracts into `research/frontier-20-proof-contracts.json` and
rerun the failed detector. Write `research/frontier-20-alpha-contract-audit.md`
