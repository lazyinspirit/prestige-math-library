...
You are the group Alpha for batches **3**, **9**: 3 A/B pair(s), 6 page(s), 98 item(s), 11 open rejection(s) over 11 item(s).
...
|---|---|---|---|
| `ex-keyhole-evaluates-x-alpha-minus-one-over-one-plus-x` | `the-residue-theorem-examples` | gpt-5.6-terra | `09ec59a7f2765b88befa3f79dc24dd0bc2fe9942c588ffd381b86535fd3feb96` |
| `ex-residue-evaluates-sine-over-x-principal-value` | `the-residue-theorem-examples` | gpt-5.6-terra | `0f29e56d27bc907b587399a369056e92b75f495131e214da5ad0e9b343008799` |
| `fs-the-pointwise-supremum-of-an-arbitrary-family-of-subharmonic-functions-is-subharmonic` | `subharmonic-functions-and-the-dirichlet-problem-examples` | gpt-5.6-terra | `acdc1bb311786f5e7c263ee9eb250d7bab3aa78717b983f3c0d0dcce8885f445` |
| `lem-gluing-lemma-for-plane-subharmonic-functions` | `subharmonic-functions-and-the-dirichlet-problem` | gpt-5.6-terra | `9a2c04cdf903d5311602c09e1c30030b2a4d26393fadd66763ff2ae4af9b99a1` |
| `lem-indented-arc-residue-limit` | `the-residue-theorem` | gpt-5.6-terra | `1c3180746e1943346d3d56cd58ced87d36c5bb17ad45462efb20837de731f458` |
| `lem-local-boundedness-of-separately-holomorphic-functions` | `the-hartogs-phenomena` | gpt-5.6-terra | `554fb52218ab283cc9acd6db3ea3dab4448baf3064c28008fc9663d8ed69bc94` |
| `lem-positive-linear-combinations-and-finite-maxima-preserve-subharmonicity` | `subharmonic-functions-and-the-dirichlet-problem` | gpt-5.6-terra | `6b824d1ee5a18814e362af82edfa1783140662cb6a539e4e5c99a2e9c87c98fe` |
| `thm-exterior-disc-and-exterior-cone-points-are-regular` | `subharmonic-functions-and-the-dirichlet-problem` | gpt-5.6-terra | `b9396ee0aa8134e4466925db34f5caca941d98c3aa2ad3f5c171b36a36de95de` |
| `thm-keyhole-residue-formula-mellin-rational-integrals` | `the-residue-theorem` | gpt-5.6-terra | `513bbb4e34ac78d8781c19cf0cbd8c4e12b0844820d89851e560973f2f5bf81d` |
| `thm-plane-subharmonic-functions-are-locally-integrable` | `subharmonic-functions-and-the-dirichlet-problem` | gpt-5.6-terra | `22a3eafcb903869b7bdf7d6303c1db7e9e4140ea64ff8807fe6d01354db5b331` |
| `thm-residue-evaluation-principal-value-real-poles` | `the-residue-theorem` | gpt-5.6-terra | `c2d728e1bdd28594d1a74b330ac567e66e2189b3b99438c14ec982445e9c4de3` |
