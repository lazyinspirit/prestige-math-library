...
# Step 4 — splice-refusal adjudication, `frontier-20`

Read `research/frontier-20-splice-refusals.json` and every reported undeclared
...
`research/frontier-20-alpha-step4.md` with each edge, evidence, disposition, edit,
