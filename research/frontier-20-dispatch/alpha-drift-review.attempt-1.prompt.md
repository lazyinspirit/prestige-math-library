...
label: drift-review
covers: drift
output: research/frontier-20-alpha-step0-drift.md

## Step-0 prerequisite drift review — run `frontier-20`
...
**Evidence assembled for you:** `research/frontier-20-drift-evidence.json`
...
Write `research/frontier-20-alpha-step0-drift.md`, one section per A page:
