...
# Batch 4 of run `frontier-20` — Socles and the Onan Scott Landscape · Hyperbolic Spaces and Hyperbolic Groups
...
| | |
|---|---|
| A page | `socles-and-the-onan-scott-landscape` · order **71.007** · `group-theory` |
| B page | `socles-and-the-onan-scott-landscape-examples` |
| title | Socles and the Onan Scott Landscape |
| requires | `blocks-primitivity-and-multiple-transitivity-examples` |
| design | `plan-group-theory-track.md` L867 |
...
| | |
|---|---|
| A page | `hyperbolic-spaces-and-hyperbolic-groups` · order **302.005** · `group-theory` |
| B page | `hyperbolic-spaces-and-hyperbolic-groups-examples` |
| title | Hyperbolic Spaces and Hyperbolic Groups |
| requires | `geometric-actions-svarc-milnor-and-growth-examples` |
| design | `plan-group-theory-track.md` L1659<br>`plan-group-theory-track.md` L1730 |
