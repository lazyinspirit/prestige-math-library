...
Reason: ERROR receipt-reviewer: research/frontier-20-impact-6c.json: reviewer is required
Owning Alpha group: (repository-scoped or mixed)
Live item ids: `fs-separate-holomorphy-can-fail-to-imply-local-boundedness`, `thm-hartogs-separate-holomorphy`
...
```text
impact-audit: 3 changed public interface(s), 2 affected item(s)
...
ERROR receipt-reviewer: research/frontier-20-impact-6c.json: reviewer is required
ERROR receipt-disposition-status: research/frontier-20-impact-6c.json: fs-separate-holomorphy-can-fail-to-imply-local-boundedness has an invalid or unresolved status
ERROR receipt-disposition-notes: research/frontier-20-impact-6c.json: fs-separate-holomorphy-can-fail-to-imply-local-boundedness needs a concrete review note
ERROR receipt-disposition-status: research/frontier-20-impact-6c.json: thm-hartogs-separate-holomorphy has an invalid or unresolved status
ERROR receipt-disposition-notes: research/frontier-20-impact-6c.json: thm-hartogs-separate-holomorphy needs a concrete review note
