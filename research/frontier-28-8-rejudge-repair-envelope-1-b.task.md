  ...
  "failures": [
    {
      "id": "judge-closure",
      "stage": "8-rejudge",
      "why": "ERROR judge-adjudication-missing [lem-a-generic-projection-can-preserve-properness]: lem-a-generic-projection-can-preserve-properness: current gpt-5.6-terra rejection has no exact Alpha outcome for context 43fcaaddd92a59de49e7873d3416bbe687",
      "output": "level-coverage --judge-only: 389/424 current configured-judge verdict set(s); 35 terminal manual resolution(s), 0 need rejudge, 1 unadjudicated, 0 open fatal, 167 adjudicated rejection(s) closed nonfatally; legacy gate counter 389/424 current pairs (one per-item configured verdict set, including singleton lineups)\nERROR judge-adjudication-missing [lem-a-generic-projection-can-preserve-properness]: lem-a-generic-projection-can-preserve-properness: current gpt-5.6-terra rejection has no exact Alpha outcome for context 43fcaaddd92a59de49e7873d3416bbe6877fff6c2b651498799fb35867ce27a4\n",
      "named_ids": [
  ...
  "live_tuples": [
    {
      "id": "lem-a-generic-projection-can-preserve-properness",
      "model": "gpt-5.6-terra",
      "context_sha256": "43fcaaddd92a59de49e7873d3416bbe6877fff6c2b651498799fb35867ce27a4",
      "scope": "run",
...
You are the group Alpha for batches **1**, **7**, **10**: 4 A/B pair(s), 8 page(s), 163 item(s), 1 open rejection(s) over 1 item(s).
...
|---|---|---|---|
| `lem-a-generic-projection-can-preserve-properness` | `whitney-embedding-tubular-neighbourhoods-and-approximation` | gpt-5.6-terra | `43fcaaddd92a59de49e7873d3416bbe6877fff6c2b651498799fb35867ce27a4` |
