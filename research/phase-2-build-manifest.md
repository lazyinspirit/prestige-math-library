...
Execution checkpoint: `phase-2-nine-step-25` is COMPLETE and its 25 pairs
were published in commit `10e5a6d9f`. The asymptotic-cones supplier is now
published; the quantitative hyperbolic toolkit is selected in the new run.
...
|---|---:|---|---|
| abstract-algebra | D | published | `finite-averaging-and-character-theory-prerequisites` |
| algebraic-geometry | D | published | `classical-affine-varieties-coordinate-rings-morphisms-and-rational-maps-interface` |
| algebraic-topology | D | published | `simplicial-subdivision-and-simplicial-approximation` |
| combinatorics | D | published | `quantitative-induced-density-and-the-loglog-step` |
...
| group-theory | D | published | `small-cancellation-disc-diagrams-and-torsion-toolkit` |
...
| pde | D | published | `euclidean-surface-measure-divergence-and-green-identities` |
| representation-theory | D | published | `galois-orbits-and-descent-of-simple-finite-group-modules` |
...
| differential-geometry | P | published | `the-de-rham-complex-homotopy-and-mayer-vietoris` |
...
| foundations | R | published | `pcf-scales-and-zfc-dowker-spaces` |
...
| category | role | current state | A page id |
|---|---:|---|---|
| commutative-algebra | D | published | `koszul-euler-characteristics-and-hilbert-samuel-multiplicity` |
