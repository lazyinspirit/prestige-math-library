...
covers: 12
output: research/phase-2-catchup-24-batch-12.pages.json

# Author batch `12` — `phase-2-catchup-24`

Read these `research/` files:

- `phase-2-catchup-24-batch-12.pages.json`, `phase-2-catchup-24-batch-12.notes.md`, and
  `phase-2-catchup-24-batch-12.coverage.json`;
- `phase-2-catchup-24-beta-12.task.md` and its assigned design sections;
...
complete `research/phase-2-catchup-24-batch-12.proof-contracts.json`, creating it if absent.
...
- `node tools/content-policy.mjs research/phase-2-catchup-24-batch-12.pages.json`;
- `node tools/proof-contract.mjs research/phase-2-catchup-24-batch-12.proof-contracts.json --strict`.
