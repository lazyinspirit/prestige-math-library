...
# Batch 8 of run `phase-2-catchup-24` — Higher Homotopy Groups and Cofiber Sequences
...
| requires | `cw-complexes-and-cellular-homology`, `the-fundamental-group`, `homotopy-and-homotopy-equivalence`, `mapping-cones-cylinders-and-chain-triangles` |
| design | `research/plan-algebraic-topology-track.md` L1190<br>`research/plan-algebraic-topology-track.md` L1222 |
