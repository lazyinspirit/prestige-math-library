...
# Batch 4 of run `phase-2-catchup-24` — Standard-Borel Real Codings and Determining Classes · Conditional Expectation
...
| | |
|---|---|
| A page | `standard-borel-real-codings-and-determining-classes` · order **288.1101** · `probability` |
| B page | `standard-borel-real-codings-and-determining-classes-examples` |
| title | Standard-Borel Real Codings and Determining Classes |
| requires | `infinite-product-measures-and-kolmogorov-extension`, `complete-metrizability-and-baire` |
| design | `research/plan-functional-analysis-track.md` L3495 (id mention, not a heading — locate the section yourself)<br>`research/plan-probability-track.md` L262 (id mention, not a heading — locate the section yourself) |
