...
covers: 9
output: research/phase-2-catchup-24-batch-9.pages.json

# Author batch `9` — `phase-2-catchup-24`

Read these `research/` files:

- `phase-2-catchup-24-batch-9.pages.json`, `phase-2-catchup-24-batch-9.notes.md`, and
  `phase-2-catchup-24-batch-9.coverage.json`;
- `phase-2-catchup-24-beta-9.task.md` and its assigned design sections;
...
complete `research/phase-2-catchup-24-batch-9.proof-contracts.json`, creating it if absent.
...
- `node tools/content-policy.mjs research/phase-2-catchup-24-batch-9.pages.json`;
- `node tools/proof-contract.mjs research/phase-2-catchup-24-batch-9.proof-contracts.json --strict`.
