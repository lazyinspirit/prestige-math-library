...
covers: 14
output: research/phase-2-catchup-24-batch-14.pages.json

# Author batch `14` — `phase-2-catchup-24`

Read these `research/` files:

- `phase-2-catchup-24-batch-14.pages.json`, `phase-2-catchup-24-batch-14.notes.md`, and
  `phase-2-catchup-24-batch-14.coverage.json`;
- `phase-2-catchup-24-beta-14.task.md` and its assigned design sections;
...
complete `research/phase-2-catchup-24-batch-14.proof-contracts.json`, creating it if absent.
...
- `node tools/content-policy.mjs research/phase-2-catchup-24-batch-14.pages.json`;
- `node tools/proof-contract.mjs research/phase-2-catchup-24-batch-14.proof-contracts.json --strict`.
