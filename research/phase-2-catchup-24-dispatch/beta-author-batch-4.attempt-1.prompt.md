...
covers: 4
output: research/phase-2-catchup-24-batch-4.pages.json

# Author batch `4` — `phase-2-catchup-24`

Read these `research/` files:

- `phase-2-catchup-24-batch-4.pages.json`, `phase-2-catchup-24-batch-4.notes.md`, and
  `phase-2-catchup-24-batch-4.coverage.json`;
- `phase-2-catchup-24-beta-4.task.md` and its assigned design sections;
...
complete `research/phase-2-catchup-24-batch-4.proof-contracts.json`, creating it if absent.
...
- `node tools/content-policy.mjs research/phase-2-catchup-24-batch-4.pages.json`;
- `node tools/proof-contract.mjs research/phase-2-catchup-24-batch-4.proof-contracts.json --strict`.
