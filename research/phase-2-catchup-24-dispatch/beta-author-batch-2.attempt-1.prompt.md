...
covers: 2
output: research/phase-2-catchup-24-batch-2.pages.json

# Author batch `2` — `phase-2-catchup-24`

Read these `research/` files:

- `phase-2-catchup-24-batch-2.pages.json`, `phase-2-catchup-24-batch-2.notes.md`, and
  `phase-2-catchup-24-batch-2.coverage.json`;
- `phase-2-catchup-24-beta-2.task.md` and its assigned design sections;
...
complete `research/phase-2-catchup-24-batch-2.proof-contracts.json`, creating it if absent.
