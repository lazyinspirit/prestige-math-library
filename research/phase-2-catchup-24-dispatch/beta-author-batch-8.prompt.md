...
covers: 8
output: research/phase-2-catchup-24-batch-8.pages.json

# Author batch `8` — `phase-2-catchup-24`

Read these `research/` files:

- `phase-2-catchup-24-batch-8.pages.json`, `phase-2-catchup-24-batch-8.notes.md`, and
  `phase-2-catchup-24-batch-8.coverage.json`;
- `phase-2-catchup-24-beta-8.task.md` and its assigned design sections;
...
complete `research/phase-2-catchup-24-batch-8.proof-contracts.json`, creating it if absent.
...
- `node tools/content-policy.mjs research/phase-2-catchup-24-batch-8.pages.json`;
- `node tools/proof-contract.mjs research/phase-2-catchup-24-batch-8.proof-contracts.json --strict`.
