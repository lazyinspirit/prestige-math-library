...
role: alpha
label: step3a-d-24c939cae9cbe3e2
covers: 8, 9
...
- Run: phase-2-catchup-24
- Batches: 8, 9
- A pages: higher-homotopy-groups-and-cofiber-sequences, the-de-rham-complex-homotopy-and-mayer-vietoris, riemannian-metrics-length-distance-and-volume
- Read current manifests, coverage, prose, plan and dependency records.
- Write research/phase-2-catchup-24-step3a-d.md.
