...
label: drift-review
covers: drift
output: research/phase-2-catchup-24-alpha-step0-drift.md

## Step-0 prerequisite drift review — run `phase-2-catchup-24`
...
**Evidence assembled for you:** `research/phase-2-catchup-24-drift-evidence.json`
...
Write `research/phase-2-catchup-24-alpha-step0-drift.md`, one section per A page:
