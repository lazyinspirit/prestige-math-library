...
role: beta
label: author-recover-15-1
covers: 15
output: research/phase-2-catchup-24-batch-15.pages.json

# Author batch `15` — `phase-2-catchup-24`

Read these `research/` files:

- `phase-2-catchup-24-batch-15.pages.json`, `phase-2-catchup-24-batch-15.notes.md`, and
  `phase-2-catchup-24-batch-15.coverage.json`;
- `phase-2-catchup-24-beta-15.task.md` and its assigned design sections;
...
complete `research/phase-2-catchup-24-batch-15.proof-contracts.json`, creating it if absent.
...
- `node tools/content-policy.mjs research/phase-2-catchup-24-batch-15.pages.json`;
- `node tools/proof-contract.mjs research/phase-2-catchup-24-batch-15.proof-contracts.json --strict`.
