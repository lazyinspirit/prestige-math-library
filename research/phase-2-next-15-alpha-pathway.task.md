# Step 9 — pathway closure, `phase-2-next-15`

Read `research/phase-2-next-15-pathway.json` and
`research/phase-2-next-15-pathway-closure.json`. For every pending receipt row, rewrite
