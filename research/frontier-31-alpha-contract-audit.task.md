# Contract-detector adjudication — `frontier-31`
...
Merge the batch contracts into `research/frontier-31-proof-contracts.json` and
rerun the failed detector. Write `research/frontier-31-alpha-contract-audit.md`
