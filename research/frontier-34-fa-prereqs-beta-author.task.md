# Author batch `<i>` — `frontier-34-fa-prereqs`

Read these `research/` files:

- `frontier-34-fa-prereqs-batch-<i>.pages.json`, `frontier-34-fa-prereqs-batch-<i>.notes.md`, and
  `frontier-34-fa-prereqs-batch-<i>.coverage.json`;
- `frontier-34-fa-prereqs-beta-<i>.task.md` and its assigned design sections;
- `frontier-34-fa-prereqs-alpha-groups.json`: find your group by `covers`, then read
  `frontier-34-fa-prereqs-alpha-GROUP-step3-verdicts.json` and
  `frontier-34-fa-prereqs-alpha-GROUP-step3-scaffold-review.md` using that group's label.

Report missing inputs; do not substitute another run's artifacts. Preserve and
complete `research/frontier-34-fa-prereqs-batch-<i>.proof-contracts.json`, creating it if absent.
...
- `node tools/content-policy.mjs research/frontier-34-fa-prereqs-batch-<i>.pages.json`;
- `node tools/proof-contract.mjs research/frontier-34-fa-prereqs-batch-<i>.proof-contracts.json --strict`.
