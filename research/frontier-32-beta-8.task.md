# Batch 8 of run `frontier-32` — Triangulated Categories
...
| | |
|---|---|
| A page | `triangulated-categories` · order **365.061** · `homological-algebra` |
| B page | `triangulated-categories-examples` |
| title | Triangulated Categories |
| requires | `group-cohomology-as-a-derived-functor-examples` |
| design | `research/plan-homological-algebra-track.md` L291<br>`research/plan-homological-algebra-track.md` L2503<br>`research/plan-homological-algebra-track.md` L2651 |
