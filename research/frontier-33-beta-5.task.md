# Batch 5 of run `frontier-33` — Classical Zero Free Region and the Prime Number Theorem · Decomposition Inertia and Frobenius
...
| | |
|---|---|
| A page | `classical-zero-free-region-and-the-prime-number-theorem` · order **348.015** · `number-theory` |
| B page | `classical-zero-free-region-and-the-prime-number-theorem-examples` |
| title | Classical Zero Free Region and the Prime Number Theorem |
| requires | `perron-inversion-and-the-explicit-formula-examples` |
| design | `research/plan-number-theory-track.md` L1413 |
...
| | |
|---|---|
| A page | `decomposition-inertia-and-frobenius` · order **365.915** · `number-theory` |
| B page | `decomposition-inertia-and-frobenius-examples` |
| title | Decomposition Inertia and Frobenius |
| requires | `prime-ideal-decomposition-ramification-and-the-different-examples` |
| design | `research/plan-number-theory-track.md` L1788 |
