# Batch 7 of run `frontier-29` — Dirichlet Kernel Localisation and Pointwise Fourier Convergence
...
| | |
|---|---|
| A page | `dirichlet-kernel-localisation-and-pointwise-fourier-convergence` · order **288.14002** · `fourier-analysis` |
...
| requires | `itos-formula-and-brownian-martingales-examples`, `density-separability-and-convolution-in-lp` |
| design | `plan-fourier-analysis-track.md` L21 (id mention, not a heading — locate the section yourself)<br>`plan-realanalysis-completion-track.md` L718 (id mention, not a heading — locate the section yourself) |
