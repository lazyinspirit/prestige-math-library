# Batch 9 of run `frontier-32` — Depth and Cohen Macaulay Modules
...
| | |
|---|---|
| A page | `depth-and-cohen-macaulay-modules` · order **365.903** · `commutative-algebra` |
| B page | `depth-and-cohen-macaulay-modules-examples` |
| title | Depth and Cohen Macaulay Modules |
| requires | `koszul-complexes-and-regular-sequences-examples`, `ext-and-balanced-resolutions` |
| design | `research/plan-commutative-algebra-track.md` L1363<br>`research/plan-commutative-algebra-track.md` L3763 |
