...
6. Your own `research/frontier-12-batch-7.notes.md` and
...
## Batch 7 — step 5, author your batch

You scaffolded these pages and Alpha cleared them. **Author every item on them
now.** 63 items across 2 pages.

| order | kind | page | category | items |
|---|---|---|---|---|
| 363 | A | `limits-and-colimits` | category-theory | **46** |
| 364 | B | `limits-and-colimits-examples` | category-theory | **17** |
...
- `research/frontier-12-batch-7.notes.md` — your provenance rationales,
  convention decisions and proof-obligation reasoning.
- `research/frontier-12-batch-7.proof-contracts.json` — the proof design you
