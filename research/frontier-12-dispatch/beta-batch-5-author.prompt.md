...
6. Your own `research/frontier-12-batch-5.notes.md` and
...
## Batch 5 — step 5, author your batch

You scaffolded these pages and Alpha cleared them. **Author every item on them
now.** 79 items across 4 pages.

| order | kind | page | category | items |
|---|---|---|---|---|
| 220.2 | A | `finite-probability-spaces-and-random-variables` | combinatorics | **37** |
| 220.4 | B | `finite-probability-spaces-and-random-variables-examples` | combinatorics | **8** |
| 221 | A | `finite-probability-and-the-probabilistic-method` | combinatorics | **28** |
| 222 | B | `finite-probability-and-the-probabilistic-method-examples` | combinatorics | **6** |
...
- `research/frontier-12-batch-5.notes.md` — your provenance rationales,
  convention decisions and proof-obligation reasoning.
- `research/frontier-12-batch-5.proof-contracts.json` — the proof design you
