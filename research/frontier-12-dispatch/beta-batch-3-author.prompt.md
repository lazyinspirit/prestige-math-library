...
6. Your own `research/frontier-12-batch-3.notes.md` and
...
## Batch 3 — step 5, author your batch

You scaffolded these pages and Alpha cleared them. **Author every item on them
now.** 75 items across 4 pages.

| order | kind | page | category | items |
|---|---|---|---|---|
| 86 | A | `eigenvalues-eigenvectors-and-the-characteristic-polynomial` | linear-algebra | **23** |
| 87 | B | `eigenvalues-eigenvectors-and-the-characteristic-polynomial-examples` | linear-algebra | **7** |
| 92 | A | `dual-spaces-bilinear-forms-and-inertia` | linear-algebra | **33** |
| 93 | B | `dual-spaces-bilinear-forms-and-inertia-examples` | linear-algebra | **12** |
...
- `research/frontier-12-batch-3.notes.md` — your provenance rationales,
  convention decisions and proof-obligation reasoning.
- `research/frontier-12-batch-3.proof-contracts.json` — the proof design you
