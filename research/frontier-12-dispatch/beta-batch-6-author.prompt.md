...
6. Your own `research/frontier-12-batch-6.notes.md` and
...
## Batch 6 — step 5, author your batch

You scaffolded these pages and Alpha cleared them. **Author every item on them
now.** 41 items across 2 pages.

| order | kind | page | category | items |
|---|---|---|---|---|
| 303 | A | `complex-differentiability-and-cauchy-riemann` | complex-analysis | **28** |
| 304 | B | `complex-differentiability-and-cauchy-riemann-examples` | complex-analysis | **13** |
...
**You create `library/complex-analysis/`.** It is the first page in a new
category carrying 54 planned pages. The renderer discovers categories by reading
the directory, so no renderer change is needed and none is permitted:
presentation is FROZEN and the category renders with the existing neutral
fallback, exactly as `topology` and `category-theory` do. Do not touch the app
repo.

### Your own record is the design you author to

- `research/frontier-12-batch-6.notes.md` — your provenance rationales,
  convention decisions and proof-obligation reasoning.
- `research/frontier-12-batch-6.proof-contracts.json` — the proof design you
