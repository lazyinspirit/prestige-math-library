...
`research/frontier-12-batch-2.coverage.json`. Per A page: at least two
...
- `research/frontier-12-batch-2.pages.json` — the machine scaffold
- `research/frontier-12-batch-2.notes.md` — source ledger, provenance
  rationales, convention disagreements, split proposals, licensing notes
- `research/frontier-12-batch-2.coverage.json` — the harvest
- `research/frontier-12-batch-2.proof-contracts.json` — begun at scaffold time
