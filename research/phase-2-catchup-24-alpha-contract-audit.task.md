# Contract-detector adjudication — `phase-2-catchup-24`
...
Merge the batch contracts into `research/phase-2-catchup-24-proof-contracts.json` and
rerun the failed detector. Write `research/phase-2-catchup-24-alpha-contract-audit.md`
