# Contract-detector adjudication — `phase-2-wave-1`
...
Merge the batch contracts into `research/phase-2-wave-1-proof-contracts.json` and
rerun the failed detector. Write `research/phase-2-wave-1-alpha-contract-audit.md`
