# Batch 7 of run `frontier-24` — The Diagram Lemmas in an Abelian Category
...
| | |
|---|---|
| A page | `the-diagram-lemmas-in-an-abelian-category` · order **365.021** · `category-theory` |
| B page | `the-diagram-lemmas-in-an-abelian-category-examples` |
| title | The Diagram Lemmas in an Abelian Category |
| requires | `exactness-and-the-member-calculus-examples` |
| design | `plan-category-theory-track.md` L2212<br>`plan-category-theory-track.md` L2308 |
