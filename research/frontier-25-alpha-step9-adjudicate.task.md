# Step 9 — changed-mathematics adjudication, `frontier-25`

Act only on ids in `research/frontier-25-step9-changes.json`. Read their current
...
`research/frontier-25-alpha-step9-adjudicate.md` with every tuple, outcome,
