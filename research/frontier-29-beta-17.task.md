# Batch 17 of run `frontier-29` — Morse Critical Points Hessians and Indices
...
| | |
|---|---|
| A page | `morse-critical-points-hessians-and-indices` · order **517** · `differential-topology` |
| B page | `morse-critical-points-hessians-and-indices-examples` |
| title | Morse Critical Points Hessians and Indices |
| requires | `moment-maps-and-symplectic-reduction-examples` |
| design | `plan-differential-topology-track.md` L317 |
