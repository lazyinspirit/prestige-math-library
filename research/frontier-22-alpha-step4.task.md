# Step 4 — splice-refusal adjudication, `frontier-22`

Read `research/frontier-22-splice-refusals.json` and every reported undeclared
...
`research/frontier-22-alpha-step4.md` with each edge, evidence, disposition, edit,
