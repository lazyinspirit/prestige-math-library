# Batch 14 of run `frontier-30` — From Generalized Niceness to Erdős–Hajnal · Property (*) and Comb Outcomes
...
| | |
|---|---|
| A page | `from-generalized-niceness-to-erdos-hajnal` · order **429** · `combinatorics` |
| B page | `from-generalized-niceness-to-erdos-hajnal-examples` |
| title | From Generalized Niceness to Erdős–Hajnal |
| requires | `generalized-niceness-and-reduction-outcomes` |
| design | `plan-combinatorics-and-categories.md` L3914 (id mention, not a heading — locate the section yourself) |
...
| | |
|---|---|
| A page | `property-star-and-comb-outcomes` · order **431** · `combinatorics` |
| B page | `property-star-and-comb-outcomes-examples` |
| title | Property (*) and Comb Outcomes |
| requires | `generalized-niceness-and-reduction-outcomes` |
| design | `plan-combinatorics-and-categories.md` L3915 (id mention, not a heading — locate the section yourself) |
