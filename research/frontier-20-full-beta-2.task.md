# Batch 2 of run `frontier-20-full` — Regular Continued Fractions and Diophantine Approximation
...
| | |
|---|---|
| A page | `regular-continued-fractions-and-diophantine-approximation` · order **78.3** · `number-theory` |
...
| requires | `positive-definite-binary-quadratic-forms-and-reduction-examples` |
| design | `plan-number-theory-track.md` L746 |
