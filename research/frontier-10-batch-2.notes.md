...
> Free products of arbitrary families are defined by their coproduct property and constructed from reduced syllable words. The van der Waerden permutation action supplies associativity and the normal-form theorem, hence factor embeddings, uniqueness, retractions, union presentations, and the identification of free products of free groups on disjoint bases. In particular, the free product of two infinite cyclic groups is the free group of rank two.
>
...
The machine harvest enumerates 78 headings across four independent treatments:

- finite abelian groups: 31 included, 12 inline, one already published, one deferred, and one out of scope;
- free products and amalgamation: 27 included, three inline, one already published, and one out of scope;
- combined: **73 incorporated** (58 included and 15 inline), **two already published**, and **three declined**.
...
The harvest checker passed with zero errors and zero warnings before handoff. The exact heading-by-heading dispositions are in `research/frontier-10-batch-2.coverage.json`.
