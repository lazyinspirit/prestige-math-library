...
`homological algebra` track of the prestige-math-library and nothing else.
...
research. **Tell each one, in its first line, "You are an expert of homological algebra."**
...
textbooks in homological algebra, plus a rich corpus of lecture notes and other open-web
