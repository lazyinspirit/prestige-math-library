...
`differential geometry` track of the prestige-math-library and nothing else.
...
an expert of differential geometry."** Keep at most **4** running at once. Subagents research,
...
textbooks in differential geometry, plus a rich corpus of lecture notes and other open-web
