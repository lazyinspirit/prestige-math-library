...
`number theory` track of the prestige-math-library and nothing else.
...
an expert of number theory."** Keep at most **4** running at once. Subagents research,
...
textbooks in number theory, plus a rich corpus of lecture notes and other open-web
