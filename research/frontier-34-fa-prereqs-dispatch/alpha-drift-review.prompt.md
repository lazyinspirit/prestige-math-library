...
label: drift-review
covers: drift
output: research/frontier-34-fa-prereqs-alpha-step0-drift.md

## Step-0 prerequisite drift review — run `frontier-34-fa-prereqs`
...
**Evidence assembled for you:** `research/frontier-34-fa-prereqs-drift-evidence.json`
...
Write `research/frontier-34-fa-prereqs-alpha-step0-drift.md`, one section per A page:
