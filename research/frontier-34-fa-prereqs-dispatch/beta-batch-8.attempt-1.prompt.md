...
# Batch 8 of run `frontier-34-fa-prereqs` — Fourier Transform Convolution and Approximate Identities · Schwartz Space and the Plancherel Theorem
...
| requires | `unbounded-self-adjoint-operators-and-stones-theorem-examples` |
| design | `research/plan-functional-analysis-track.md` L1615 |
...
| requires | `fourier-transform-convolution-and-approximate-identities-examples` |
| design | `research/plan-complex-analysis-track.md` L161 (id mention, not a heading — locate the section yourself)<br>`research/plan-fourier-analysis-track.md` L114 (id mention, not a heading — locate the section yourself)<br>`research/plan-functional-analysis-track.md` L51 (id mention, not a heading — locate the section yourself) |
