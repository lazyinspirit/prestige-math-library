# Batch 4 of run `frontier-31a` — Infinite Product Measures and Kolmogorov Extension

1 A/B pair, probability. You own every page here and you author them all at step 5.

## `infinite-product-measures-and-kolmogorov-extension`

| | |
|---|---|
| A page | `infinite-product-measures-and-kolmogorov-extension` · order **288.101** · `probability` |
...
| design | `research/plan-probability-track.md` L435 |
