...
## Your cluster — `w2-algebra-rest`

The algebra items not already assigned to the `finite-abelian` and `polyrings` refuters. Your scope is wide, so prioritise theorems and corollaries over examples, and say what you did not reach.

**Polynomial rings.** Every statement has a coefficient-ring hypothesis — commutative ring, ring with 1, integral domain, UFD, field — and they are not interchangeable. Degree additivity needs a domain; the root bound needs a domain; the division algorithm needs a field or a monic divisor. Check each item's hypothesis against what its proof uses.

**Free products.** The normal-form theorem is load-bearing and the classic error is proving **existence** of a normal form and then using **uniqueness**. Check which is proved. Check the universal property of the free product is verified in both existence and uniqueness of the induced map.

**Finite abelian groups.** Check `thm-internal-direct-product-recognition`'s hypotheses (trivial pairwise intersection is not enough for more than two factors — the standard condition is each factor meeting the product of the others trivially) and that the \(p\)-primary decomposition is proved, not assumed.

**Symmetric groups.** `thm-parity-of-transposition-factorisations-is-well-defined` is the foundation of the sign homomorphism and of the whole determinant page. Check its proof is not circular — the standard routes are via the inversion count or via a polynomial action, and each must avoid presupposing the sign map it defines.

## Your assigned items

Every one of these is `high` or `critical` on `risk-report.mjs`. Read each in full, from disk, with every dependency it cites.

**symmetric-groups-and-the-sign-homomorphism** (3)
...
**the-structure-of-finite-abelian-groups** (5)

- `thm-primary-decomposition-of-a-finite-abelian-group`
- `lem-elementary-divisors-regroup-into-invariant-factors`
- `cor-finite-abelian-group-cyclic-iff-one-invariant-factor`
- `cor-indecomposable-finite-abelian-groups-are-cyclic-prime-power`
- `cor-abelian-p-groups-of-order-pn-are-counted-by-partitions`

**the-structure-of-finite-abelian-groups-examples** (3)

- `ex-successive-p-layers-read-a-cyclic-decomposition`
- `ex-the-six-abelian-groups-of-order-three-hundred-sixty`
- `fs-every-finite-group-is-a-product-of-cyclic-prime-power-groups`

**free-products-and-amalgamation** (9)

- `thm-reduced-syllable-words-form-the-free-product`
- `thm-normal-form-for-free-products`
- `cor-free-product-factor-maps-are-injective`
- `cor-free-products-are-unique-up-to-unique-isomorphism`
- `thm-free-product-of-free-groups-on-disjoint-bases`
- `lem-factor-elements-act-on-amalgamated-normal-words`
- `cor-factors-embed-in-a-free-product-with-amalgamation`
- `cor-trivial-amalgamation-is-the-free-product`
- `prop-kernels-of-amalgamating-maps-collapse-in-the-pushout`

**free-products-and-amalgamation-examples** (5)

- `ex-two-involutions-generate-the-infinite-dihedral-group`
- `ex-c-two-free-product-c-three-is-infinite`
- `ex-canonical-map-from-free-product-to-direct-product`
- `fs-free-product-of-abelian-groups-is-abelian`
- `ex-amalgamating-c-two-inside-c-four-and-c-six`

**polynomial-rings-and-roots** (11)
...
- `cor-polynomial-ring-over-a-field-is-euclidean`
- `cor-polynomial-ring-over-a-field-is-a-pid`
- `lem-polynomial-gcd-is-stable-under-field-extension`
- `lem-gauss-content-lemma`
- `thm-eisenstein-irreducibility-criterion`
- `cor-xn-minus-p-is-irreducible-over-q`

**polynomial-rings-and-roots-examples** (4)

- `cex-quadratics-can-have-four-roots-over-composite-residue-rings`
- `ex-x-squared-minus-two-is-irreducible-over-q`
- `ex-eisenstein-proves-a-family-irreducible`
- `ex-translation-makes-x-four-plus-one-eisenstein`
