# Step 9 — scope-denial delta review, `phase-2-hg-prerequisite`

First follow `briefs/tasks/frontier-dependency-ledger.md`. Refresh and read
`research/phase-2-hg-prerequisite-cross-batch-dependencies.json` for cross-batch scope and impact.

Read only pending rows in `research/phase-2-hg-prerequisite-step9-scope-delta.json`. Verify each
...
If `research/phase-2-hg-prerequisite-step9-mathematical-review.task.md` exists, also perform its
explicitly scoped supervising review after the Step-8 freeze. Keep its blocking
obligation open pending the engine's Step-9 recertification; do not judge or stamp
...
`research/phase-2-hg-prerequisite-alpha-step9-review.md`. Inspect each open run ledger row and
