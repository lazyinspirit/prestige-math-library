# Contract-detector adjudication — `phase-2-hg-prerequisite`
...
Merge the batch contracts into `research/phase-2-hg-prerequisite-proof-contracts.json` and
rerun the failed detector. Write `research/phase-2-hg-prerequisite-alpha-contract-audit.md`
