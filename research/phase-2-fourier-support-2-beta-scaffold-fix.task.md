...
# Post-recheck scaffold repair — batch `<i>`, `phase-2-fourier-support-2`

Read `research/phase-2-fourier-support-2-scaffold-closure.json` and take only `work[]` entries
