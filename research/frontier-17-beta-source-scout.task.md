...
# Batch `<i>` of run `frontier-17` — scout a live full-text URL
...
```
node tools/source-fetch-check.mjs --coverage research/frontier-17-batch-<i>.coverage.json
```
...
`research/frontier-17-batch-<i>.coverage.json` and `.notes.md` only. Keep
