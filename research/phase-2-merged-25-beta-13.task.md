# Batch 13 of run `phase-2-merged-25` — Boone Machine Simulation and Fixed-Presentation Undecidability
...
| design | `research/plan-computability-theory-track.md` L3461 (id mention, not a heading — locate the section yourself)<br>`research/plan-group-theory-track.md` L4632 (id mention, not a heading — locate the section yourself) |
