...
export async function repairGateBatch(args: any, deps: any) {
  ...
  for (const group of lanes) {
    ...
    writeFileSync(join(ctx.repo, task), [
      ...
      'At 5a, maintain authored decisions and matching defect-ledger records under briefs/tasks/alpha-step5-gate.md; preserve supplemental decisions in historical scopes.',
