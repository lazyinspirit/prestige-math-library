...
//
// Each judge call gets the full target plus compact interfaces for its A/B pair.
// An interface edit can therefore move a neighbour's `context_sha256`, while
// the neighbour's own proof remains byte-identical.
//
