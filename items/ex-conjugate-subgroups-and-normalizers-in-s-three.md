...
provenance:
  ...
  proof: ai-altered
deps: [thm-conjugate-subgroups-are-counted-by-the-normalizer, def-normalizer-of-a-subgroup, def-symmetric-group, lem-symmetric-group-is-a-group]
justified_by: []
aliases: []
landmark: false
...
3.1 By [L1], $[S_3:N_{S_3}(H)]=3$. Since $|S_3|=6$, the normalizer has order $2$; it contains $H$, so it equals $H$. The same holds for each conjugate subgroup. [step 1.1, step 2.1, L1, L2, algebra] ∎
