...
kind: theorem
title: "Every metrizable Čech-complete space is completely metrizable"
status: draft
origin: session
provenance:
  statement: literature-derived
  proof: ai-altered
deps: [def-cech-complete-space, thm-cech-completeness-is-independent-of-compactification, thm-metric-completion-exists, cor-tychonoff-spaces-have-compactifications-under-the-ultrafilter-lemma, thm-g-delta-subspaces-of-complete-metric-spaces-are-completely-metrizable]
justified_by: []
aliases: []
landmark: false
...
Assume the ultrafilter lemma. Every metrizable Čech-complete space is completely metrizable.
...
[F2] Assume the ultrafilter lemma. A Tychonoff space is a $G_\delta$ subset of some Hausdorff compactification if and only if it is a $G_\delta$ subset of every Hausdorff compactification. ([[thm-cech-completeness-is-independent-of-compactification]]).
...
[F5] If $(X,d)$ is a complete metric space and $Y\subseteq X$ is $G_\delta$ in $X$, then the subspace $Y$ is completely metrizable. ([[thm-g-delta-subspaces-of-complete-metric-spaces-are-completely-metrizable]]).
...
2.1 Otherwise embed the space densely in its metric completion, compactify that completion, and observe that the resulting compact space is also a compactification of the original dense subspace. [step 1.1, F3, F1, F2]
