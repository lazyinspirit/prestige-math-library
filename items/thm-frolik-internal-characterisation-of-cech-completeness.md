...
kind: theorem
title: "Frolík's internal open-cover characterisation of Čech-completeness"
status: draft
origin: session
provenance:
  statement: literature-derived
  proof: ai-altered
deps: [def-cech-complete-space, thm-cech-completeness-is-independent-of-compactification, thm-compact-iff-fip, thm-the-separation-implication-chain, def-filter-base]
justified_by: []
aliases: []
landmark: true
...
Assume the ultrafilter lemma. A Tychonoff space $X$ is Čech-complete if and only if there is a sequence $(\mathcal U_n)$ of open covers of $X$ such that every centred family of closed subsets of $X$ which is subordinate to every $\mathcal U_n$ has nonempty intersection.
...
1.1 From a $G_\delta$ presentation in a compactification, use compact Hausdorff regularity to choose open covers whose ambient closures lie in the successive layers. [given, F1, F2, F3]
