...
1.1 By [L1], the series partial sums are bounded exactly when the values $\int_1^Nf$ at positive integer $N$ are bounded. By [L2], this is exactly convergence of the corresponding two monotone sequences.
