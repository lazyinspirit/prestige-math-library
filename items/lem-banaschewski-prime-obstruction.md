...
2.1 Expanding the finite product would put $1_X$ in $A$, a contradiction. Hence some $A_x=n_x\mathbb Z$ has $n_x>1$; any prime divisor $p$ of $n_x$ has the stated property. Permutation characters are integer-valued fixed-point counts, so their span is a subring of this form. $\square$ [step 1.1, discharge-contrapositive]
