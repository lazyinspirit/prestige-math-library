...
provenance:
  ...
  proof: ai-altered
deps: [def-axiom-of-choice, def-radon-nikodym-derivative, thm-chain-rule-for-radon-nikodym-derivatives, thm-radon-nikodym-density-exists-and-is-unique-up-to-almost-everywhere-equality]
...
[L3] AC supplies existence of the two RN densities and the hypotheses of the chain rule; identifying the density1 itself requires no new choice. ([[def-axiom-of-choice]])

## Proof

**Proof technique:** direct.

1.1 Choose increasing finite-measure exhaustions $(A_n)$ for $\mu$ and $(B_n)$ for $\nu$, and put $X_n:=A_n\cap B_n$. After replacing both exhaustions by finite unions, $(X_n)$ is increasing, covers $X$, and is finite for both measures. Under AC as in [L3], apply [L1] to the chain $\mu\ll\nu\ll\mu$ on this common exhaustion. Then $$\frac{d\mu}{d\mu}=\frac{d\mu}{d\nu}\frac{d\nu}{d\mu}\qquad\mu\text{-almost everywhere.}$$ By [L2], $d\mu/d\mu=1$ almost everywhere, so $$\frac{d\mu}{d\nu}\frac{d\nu}{d\mu}=1\qquad\mu\text{-almost everywhere.}$$ [L1, L2, L3, construct]
