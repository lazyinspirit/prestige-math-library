...
- **Half of this page cites claim 2.** It is what turns every pointwise estimate on an integrand into an estimate on the integral, and it is the only tool used for that purpose below.
