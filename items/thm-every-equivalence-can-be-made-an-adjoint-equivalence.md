...
provenance:
  ...
  proof: ai-altered
deps: [def-equivalence-and-adjoint-equivalence-of-categories, def-natural-isomorphism, thm-fully-faithful-split-essentially-surjective-characterises-equivalence, prop-fully-faithful-functors-reflect-isomorphisms]
justified_by: []
aliases: []
landmark: true
...
[L1] An adjoint equivalence is equivalence data satisfying two triangle identities ([[def-equivalence-and-adjoint-equivalence-of-categories]]), and natural isomorphisms have invertible components ([[def-natural-isomorphism]]).
