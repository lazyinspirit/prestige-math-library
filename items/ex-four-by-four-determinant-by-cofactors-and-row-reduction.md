...
1.2 Alternatively, replace row $3$ by row $3-4$ times row $1$. The result is upper triangular with diagonal $1,3,2,5$, and the operation does not change the determinant. [L2, algebra]
