...
provenance:
  ...
  proof: ai-altered
deps: [def-complex-exponential, def-complex-trigonometric-and-hyperbolic-functions, thm-absolute-convergence-of-complex-series, thm-cauchy-hadamard-for-complex-power-series]
aliases: []
landmark: true
...
[L1] The complex exponential is defined by the everywhere absolutely convergent series $\exp z=\sum_{n\ge0}z^n/n!$ ([[def-complex-exponential]]).
...
1.1 Substitute the series [L1] at $z,-z,iz,-iz$ into [L2]. Absolute convergence allows [L3] to separate the even and odd indices. [L1, L2, L3]
...
3.1 Their factorial coefficients have root limsup $0$, so [L4] gives infinite radius. The constant terms are retained in the even series and absent from the odd series. [step 2.1, L4] ∎
