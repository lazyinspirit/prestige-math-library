...
deps: ["def-lebesgue-measure-and-the-lebesgue-sigma-algebra", "thm-lebesgue-measure-of-a-box-of-every-kind", "def-axiom-of-choice"]
sources:
  references:
...
Work on $[0,1)$ with completed Lebesgue measure as in [[def-lebesgue-measure-and-the-lebesgue-sigma-algebra]]. Assume [[def-axiom-of-choice]] for the actual measure assertions: it supplies the countable choice in [[thm-lebesgue-measure-of-a-box-of-every-kind]]. The finite interval recursion itself is choice-free.
