...
[L1] A linear map satisfies $T(au+bv)=aT(u)+bT(v)$
([[def-linear-map]]).

[L2] The additive structure of a vector space is an abelian group, so it has
identities, inverses, cancellation, and $u-v=u+(-v)$; also
$0_Fv=0_V$ and $(-1_F)v=-v$
...
1.1 Linearity gives $T(0_V)=T(1_F0_V+1_F0_V)=T(0_V)+T(0_V)$; cancellation in $W$ gives $T(0_V)=0_W$. [L1, L2, given]
