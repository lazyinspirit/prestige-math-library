...
[L1] Completeness means that every small diagram has a limit; continuity means preservation of every small limit ([[def-small-finite-and-large-limits-completeness-and-cocompleteness]]).
