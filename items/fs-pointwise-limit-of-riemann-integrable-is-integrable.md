...
- **The listing is fixed once and no choice is used.** [[lem-countable-iff-surjection-from-n]] produces a single surjection $s$, and every $f_n$ is defined from it by a formula; the $\delta$ of step 2.1 is a minimum of a finite set, not a selection. See [[rem-riemann-integral-choice-ledger]].
