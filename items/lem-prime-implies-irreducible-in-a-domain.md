...
[L1] A prime element divides one factor of every product it divides; an
irreducible element has a unit factor in each of its factorizations
([[def-irreducible-and-prime-elements-in-a-domain]]).

[L2] Multiplicative cancellation by a nonzero element holds in an integral
domain ([[lem-domain-cancellation]]).

[L3] An element is a unit when it has a two-sided multiplicative inverse
