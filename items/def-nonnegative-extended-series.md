...
This recursion is legitimate by [[thm-recursion]]: addition of two nonnegative extended reals is always defined, including when either is $+\infty$. The sequence $(s_n)$ is nondecreasing, and its **nonnegative extended sum** is
