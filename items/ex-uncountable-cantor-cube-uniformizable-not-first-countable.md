...
kind: example
title: "An uncountable Cantor cube is compact Hausdorff and uniformizable but not first countable, hence not metrizable"
status: published
origin: session
deps: [thm-compact-hausdorff-space-has-a-unique-compatible-uniformity, def-product-topology, thm-compact-hausdorff-tychonoff-from-the-ultrafilter-lemma, def-first-countable-top, lem-metric-ball-neighbourhood-base, thm-cantor-powerset, def-countable-choice, thm-countable-union-of-countable]
aliases: []
landmark: false
...
1.1 Each two-point factor is compact Hausdorff, so [L1] makes $2^I$ compact Hausdorff; [L5] makes it uniformizable. [L1, L5]
