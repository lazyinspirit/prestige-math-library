...
$$\phi(x,y):=\int_a^xF_1(t,b)\,dt+\int_b^yF_2(x,t)\,dt$$
...
[L1] A $C^1$ field is closed when $\partial_yF_1=\partial_xF_2$, and it is exact when it is the gradient of a $C^2$ potential ([[def-closed-and-exact-c1-vector-fields]]).
...
1.1 Direct differentiation gives $$\partial_yF_1=2x+2y=\partial_xF_2,$$ so $F$ is closed by [L1]. [given, L1, algebra]
...
2.1 Differentiating step 1.2 yields $\partial_x\phi=2xy+y^2=F_1$ and $\partial_y\phi=x^2+2xy=F_2$. Thus [L1] makes $\phi$ a potential, and substitution gives $\phi(a,b)=0$. [step 1.2, L1, algebra]
