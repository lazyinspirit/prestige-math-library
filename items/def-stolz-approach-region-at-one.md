...
A net or sequence approaches $1$ **within a Stolz region** if all sufficiently late points lie in one fixed $S_C$. The definition uses the complex modulus of [[def-complex-conjugate-real-imaginary-part-and-modulus]]. Radial approach through $0\le r<1$ lies in $S_1$.
