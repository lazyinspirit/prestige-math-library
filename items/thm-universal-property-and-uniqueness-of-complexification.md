...
provenance:
  ...
  proof: ai-altered
deps: [def-complexification-of-a-real-vector-space, thm-tensor-and-direct-sum-models-of-complexification-agree, thm-universal-property-of-module-tensor-products, cor-module-tensor-products-are-unique-up-to-unique-isomorphism]
aliases: []
landmark: true
