...
3.1 The exponent $m$ divides $|G|$, so $\mathbb Q(\zeta_{|G|})$ contains every $m$-th root of unity. Applying the proved assertion to this field gives the final statement. $\square$ [step 2.1]
