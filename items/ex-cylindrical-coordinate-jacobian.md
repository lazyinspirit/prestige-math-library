...
is injective on $[1,2]\times[0,\pi/2]\times[-1,1]$ and has absolute Jacobian determinant $r$ there.
...
2.1 The third image coordinate recovers $z$. The first two recover $r$ from their Euclidean norm and then $\theta$ from strict cosine monotonicity [L2]. Hence the map is injective, and $r\ge1$ makes its derivative invertible. [L1, L2, step 1.1]
