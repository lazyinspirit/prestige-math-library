...
provenance:
  ...
  proof: ai-altered
deps: [prop-counting-measure-is-a-measure, def-finite-sigma-finite-and-semifinite-measures, def-countable-choice, thm-countable-union-of-countable, thm-r-uncountable]
justified_by: []
aliases: []
landmark: false
...
[L1] Counting measure is a measure and assigns finite measure exactly to finite sets ([[prop-counting-measure-is-a-measure]]).
