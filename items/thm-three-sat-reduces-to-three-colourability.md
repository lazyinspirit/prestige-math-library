...
provenance:
  ...
  proof: ai-altered
deps: [def-reduction-gadget-and-interface-invariant, def-three-colourability, def-polynomial-time-many-one-reduction]
...
verification:
  verified:
    ...
    verdict: pass
    date: 2026-09-08
    scope: "Local NAE gadget, totality and direct prerequisite repair; not independent review"
    delegated_by: owner
  precheck: pass
---
