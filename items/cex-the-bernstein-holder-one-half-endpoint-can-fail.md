...
Every $C^{1/2}(\mathbb T)$ function belongs to $A(\mathbb T)$.
...
3.1 For $H=0$ the difference vanishes; for $H>0$, steps 1.2 and 2.2 give $|g(x+h)-g(x)|\le C_3H^{1/2}$, so $g\in C^{1/2}(\mathbb T)$ but $g\notin A(\mathbb T)$. [step 2.1, step 1.2, step 2.2] ∎
