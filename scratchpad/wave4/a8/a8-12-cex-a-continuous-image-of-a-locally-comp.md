# Wave 4 audit — A8 rejection lane `a8-12-cex-a-continuous-image-of-a-locally-comp`
...
`items/cex-a-continuous-image-of-a-locally-compact-space.md` — read the whole file from disk, including frontmatter
...
> Reports a specific, verified defect (missing citation of the completeness/LUB property used at step 2.1) via the required ReportFindings tool, matching the review task's instructions.
