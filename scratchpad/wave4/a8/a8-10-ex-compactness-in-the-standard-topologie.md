# Wave 4 audit — A8 rejection lane `a8-10-ex-compactness-in-the-standard-topologie`
...
`items/ex-compactness-in-the-standard-topologies.md` — read the whole file from disk, including frontmatter
...
> Remarks claim every theorem on the companion page concluding something interesting from compactness carries a Hausdorff hypothesis, but the companion page's own thm-compactness-under-continuous-maps proves continuous images of compact spaces are compact and the extreme value theorem from compactness alone, no Hausdorff hypothesis.
