# Wave 4 audit — A8 rejection lane `a8-03-thm-cardinal-comparability-iff-ac`
...
`items/thm-cardinal-comparability-iff-ac.md` — read the whole file from disk, including frontmatter
...
> Reviewer found a genuine miscitation: step 1.2 needs the least-element property of ordinals, which the stated L5 fact omits.
