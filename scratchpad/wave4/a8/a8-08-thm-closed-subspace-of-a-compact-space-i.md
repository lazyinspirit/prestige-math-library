# Wave 4 audit — A8 rejection lane `a8-08-thm-closed-subspace-of-a-compact-space-i`
...
`items/thm-closed-subspace-of-a-compact-space-is-compact.md` — read the whole file from disk, including frontmatter
...
> Remarks claim the converse of claim 1 is the subject of the next item, but the next item on the page (thm-compact-iff-fip) is about the finite intersection property and does not address the converse. This misstates the library's contents.
