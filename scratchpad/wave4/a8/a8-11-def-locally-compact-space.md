# Wave 4 audit — A8 rejection lane `a8-11-def-locally-compact-space`
...
`items/def-locally-compact-space.md` — read the whole file from disk, including frontmatter
...
> The metric characterization claims 'the open set B(x,r)' but openness of metric balls is not cited; it relies on thm-metric-open-set-algebra, which is not in the dependencies. The step is unlicensed.
