# Wave 4 audit — A8 rejection lane `a8-07-thm-locally-compact-hausdorff-basics`
...
`items/thm-locally-compact-hausdorff-basics.md` — read the whole file from disk, including frontmatter
...
> Remarks claim 4 is the route thm-one-point-compactification-properties uses to separate a point of X from infinity, but that sibling's own proof (step 1.4) cites claim 1 (via its fact L7), not claim 4.
