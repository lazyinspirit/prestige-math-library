# Wave 4 audit — A8 rejection lane `a8-01-def-cofinality`
...
`items/def-cofinality.md` — read the whole file from disk, including frontmatter
...
> Missing dependency: 'infinite cardinal' used to define regular/singular but cited items def-cardinal and def-aleph-and-beth-hierarchies do not define it. The definition is in def-cardinal-arithmetic, not cited. This is an incorrect citation.
