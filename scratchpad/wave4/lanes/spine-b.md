# Spine proof reading — wave 4, lane spine-b
...
1. `items/lem-of-inverse-unique.md`
2. `items/lem-of-inverse-positive.md`
3. `items/lem-of-naturals-positive.md`
4. `items/lem-of-abs-value.md`
5. `items/lem-of-triangle-inequality.md`
6. `items/thm-of-archimedean.md`
7. `items/lem-of-q-embeds.md`
8. `items/cor-archimedean-reciprocal.md`
