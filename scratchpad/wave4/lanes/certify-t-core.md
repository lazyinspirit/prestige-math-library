# Wave 4 audit repair certifier — lane `t-core`
...
**What was repaired here:** A4 (Beta, A3-amended): the ambient-invariance sentence was corrected.

### `items/lem-compactness-of-a-subspace-is-ambient.md`

**What was repaired here:** A4 (Beta, A3-amended): the ambient-invariance sentence corrected. A6 (Alpha): the metric analogue is described as quantifying over open subsets, not balls.

### `items/lem-tube-lemma-for-a-compact-factor.md`
...
### `items/thm-alexander-subbase-lemma.md`

**What was repaired here:** A4 (Beta): unused Fact [L8] removed; def-topological-space stays a dependency through the Statement.

### `items/thm-tychonoff.md`
...
### `items/lem-dependent-choice-along-a-sequence-of-relations.md`

**What was repaired here:** A4 (Beta): same def-sequence to def-sequence-convergence-top repair.

### `items/def-baire-space.md`

**What was repaired here:** A4 (Beta): def-sequence replaced by def-sequence-convergence-top, whose clause covers sequences in an arbitrary space.

### `items/thm-baire-category-locally-compact-hausdorff.md`

**What was repaired here:** A4 (Beta): same def-sequence to def-sequence-convergence-top repair.

### `items/lem-the-order-topology-on-an-ordinal.md`
...
### `items/rem-compactness-conventions-and-choice-ledger.md`

**What was repaired here:** A4 (Beta, A3-amended): ambient-invariance sentence corrected. A6 (Alpha): the choice ledger no longer claims the Hausdorff proof avoids finite selection, cites def-compactness-variants for the metric agreement of the variants, and now accounts for all five false statements.

### `items/cor-heine-borel-in-the-product-topology.md`
