# Wave 4 audit repair certifier — lane `f-core`
...
### `items/lem-cardinal-operations-are-well-defined.md`
...
### `items/thm-cardinal-arithmetic-agrees-with-finite-counting.md`

**What was repaired here:** A4 (Beta): Fact [L3] trimmed to what lem-omega-least-limit-ordinal claim (ii) states, and [L3] added to the tag lists of steps 1.1 and 1.2.

### `items/thm-cardinal-power-set-and-cantor.md`

**What was repaired here:** A4 retag plus an A6 (Alpha) repair adjudicated from a read-only refuter finding; read the current text and judge it on its own terms.

### `items/cor-cardinal-absorption.md`
