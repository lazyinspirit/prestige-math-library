...
Read `research/{{run}}-judge-closure.json`. Its `unadjudicated_rows` array is
...
Write `research/{{run}}-alpha-step8-closure-recovery.md`, listing every exact
