# Step 9 — changed-mathematics adjudication, `{{run}}`

Act only on ids in `research/{{run}}-step9-changes.json`. Read their current
...
`research/{{run}}-alpha-step9-adjudicate.md` with every tuple, outcome,
