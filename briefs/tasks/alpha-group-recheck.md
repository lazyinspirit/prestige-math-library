...
Read any research/{{run}}-scaffold-owner-<A-page>.json decision first.
...
node tools/scaffold-resolution.mjs record --run {{run}} --page A_ID --decision accept --confidence 1 --reason "Exact evidence and report path"
node tools/scaffold-resolution.mjs record --run {{run}} --page A_ID --decision repaired --confidence 1 --reason "Applied repair, checks and report path"
node tools/scaffold-resolution.mjs record --run {{run}} --page A_ID --decision escalate --reason "Exact uncertainty and owner decision needed"
