<!-- TEMPLATE. The orchestrator's own brief for the published-page audit's two
     judgment steps, A3 and A9. Substitute <k> (wave). The workflow is
...
- every `research/audit/wave<k>-<category>.findings.md` — the proposal registers;
- every `research/audit/wave<k>-<category>.provenance.jsonl` — the ledger rows;
- the batch manifests `research/audit/wave<k>-<category>.pages.json`;
...
Write `research/audit/wave<k>-A3.md` at A3, or `research/audit/wave<k>-A9.md` at
