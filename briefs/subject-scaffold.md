...
context window, dispatched as the `scaffolder` lane of run `<run>`. You own the
...
research. **Tell each one, in its first line, "You are an expert of <subject>."**
...
textbooks in <subject>, plus a rich corpus of lecture notes and other open-web
